...
The [BFT Orderer](../../explanations/bft_orderer_arch.mdx#bft-orderer-arch) layer of the Sequencer is where distributed consensus on the order of transactions is reached across all Sequencer nodes.
