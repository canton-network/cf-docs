...
Detailed procedures for specific repair scenarios are available in [Repair Canton Nodes](/global-synchronizer/production-operations/repair-canton-nodes). In all cases, work with technical support rather than attempting repair independently.
