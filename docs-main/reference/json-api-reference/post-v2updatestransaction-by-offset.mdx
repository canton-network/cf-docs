---
title: "POST /v2/updates/transaction-by-offset"
...
sidebarTitle: "/v2/updates/transaction-by-offset"
---
...
<div class="x2mdx-ref-hero">
  ...
  <p class="x2mdx-ref-summary">Get transaction by offset. Provided for backwards compatibility, it will be removed in the Canton version 3.5.0, use v2/updates/update-by-offset instead.</p>
...
const response = await fetch('http://localhost:7575/v2/updates/transaction-by-offset', {
  method: 'POST',
  headers: {
...
curl_setopt_array($curl, [
    CURLOPT_URL => 'http://localhost:7575/v2/updates/transaction-by-offset',
...
func main() {
  req, _ := http.NewRequest("POST", "http://localhost:7575/v2/updates/transaction-by-offset", bytes.NewBufferString(`{
  "offset": 123,
  "requestingParties": [
    "<string>"
  ],
...
var request = HttpRequest.newBuilder()
    .uri(URI.create("http://localhost:7575/v2/updates/transaction-by-offset"))
    .header("Authorization", "Bearer <token>")
    .header("Content-Type", "application/json")
...
uri = URI('http://localhost:7575/v2/updates/transaction-by-offset')
