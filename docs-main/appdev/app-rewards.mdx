...
On DevNet, you can register your application as self-featured for testing purposes. Log into the Wallet UI as the validator operator user & Use the "Self-grant featured app rights" button in your Wallet UI to self-feature your party. This lets you verify that your reward-earning logic works correctly before going through the formal featuring process on TestNet or MainNet.
