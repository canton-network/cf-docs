...
SV deployment is significantly more involved than a standard validator. If you are setting up a regular validator, see the [Installation](/global-synchronizer/deployment/installation) page instead.
...
The Splice node bundle contains Helm charts and sample values for SV deployment. Download the bundle as described in the [Installation](/global-synchronizer/deployment/installation) guide.
