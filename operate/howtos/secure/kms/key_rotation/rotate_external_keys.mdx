{/* source: canton / canton/3.4/participant/howtos/secure/kms/key_rotation/rotate_external_keys.rst */}
...
To do that, you can use the [standard rotate key commands](../../keys/key_management.mdx#rotating-canton-keys), or
