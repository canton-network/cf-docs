...
- [Canton Network Explorer](https://scan.sv-1.dev.global.canton.network.sync.global)
...
1. Review [infrastructure requirements](/devnet/global-synchronizer/understand/infrastructure-requirements)
...
1. Start with the [QuickStart](/devnet/appdev/quickstart)
2. Learn [Daml](https://docs.daml.com)
