---
title: "POST /v2/package-vetting/list"
...
sidebarTitle: "/v2/package-vetting/list"
---
...
<div class="x2mdx-ref-hero">
  ...
  <p class="x2mdx-ref-summary">Lists which participant node vetted what packages on which synchronizer. Can be called by any authenticated user.</p>
...
const response = await fetch('http://localhost:7575/v2/package-vetting/list', {
  method: 'POST',
  headers: {
...
curl_setopt_array($curl, [
    CURLOPT_URL => 'http://localhost:7575/v2/package-vetting/list',
...
func main() {
  req, _ := http.NewRequest("POST", "http://localhost:7575/v2/package-vetting/list", bytes.NewBufferString(`{
  "packageMetadataFilter": {
    "packageIds": [
      "<string>"
    ],
...
var request = HttpRequest.newBuilder()
    .uri(URI.create("http://localhost:7575/v2/package-vetting/list"))
    .header("Authorization", "Bearer <token>")
    .header("Content-Type", "application/json")
...
uri = URI('http://localhost:7575/v2/package-vetting/list')
...
<div class="x2mdx-ref-history" aria-label="Reference history">
  ...
  <div class="x2mdx-ref-history-event x2mdx-ref-history-event--changed" id="history-updated-3-5">
    ...
    <p class="x2mdx-ref-history-event-detail">The POST /v2/package-vetting/list operation was updated in this snapshot.</p>
