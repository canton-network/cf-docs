...
<Card title="Core Concepts" icon="book" href="/devnet/overview/understand/core-concepts">
  Understand parties, validators, and synchronizers.
</Card>

<Card title="Start Building" icon="code" href="/devnet/appdev/get-started/choose-your-path">
