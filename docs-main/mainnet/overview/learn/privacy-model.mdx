...
- **[The Global Synchronizer](/mainnet/overview/understand/global-synchronizer)** - Understand the public network infrastructure
- **[Developer Track Module 3: Daml Development](/mainnet/appdev/modules/m3-dev-environment)** - Apply privacy patterns in code
- **[Glossary](/mainnet/overview/understand/glossary)** - Terminology reference including privacy-related terms
