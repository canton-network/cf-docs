...
- roll out a new synchronizer as a repair strategy in order to [recover from a lost synchronizer](repairing.md#recovering-from-lost-synchronizer)
...
When the key is stored in a [KMS](../secure/kms/kms.md#kms), the situation is simpler
...
[keys.secret.register_kms_encryption_key](../../reference/console.md#keys-secret-register-kms-encryption-key) or [keys.secret.register_kms_signing_key](../../reference/console.md#keys-secret-register-kms-signing-key).
...
* [Synchronizer connection configuration](../operate/synchronizers/connectivity.md#synchronizer-connections)
* [User management](../operate/users/users.md#user-management)
* [DAR upload](../operate/packages/packages.md#manage-daml-packages-and-archives)
* [Repairs](repairing.md#repairing-howto)
* [Party replication](../operate/parties/party_replication.md#party-replication)
