...
[Upgrade Limitations](/mainnet/appdev/modules/m6-limitations)). Non-breaking upgrades (adding optional fields, new choices) happen within the same package name -- SCU handles those transparently.
...
- [Upgrade Limitations](/mainnet/appdev/modules/m6-limitations) -- Constraints that drive package naming decisions
- [Upgrade Compatibility](/mainnet/appdev/modules/m6-upgrade-compatibility) -- Rules for what constitutes a breaking vs. non-breaking change
- [Building and Packaging](/mainnet/appdev/modules/m3-building-packaging) -- How to compile and package Daml code with `dpm build`
