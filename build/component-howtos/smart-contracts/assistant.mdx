...
Given a `daml.yaml` and `.daml` source files, the `daml build` command will generate a .dar for this package. See [How to build Daml Archives](../../sdlc-howtos/smart-contracts/build/how-to-build-dar-files.mdx#build-howto-build-dar-files) for how to define a package and build it to a DAR.
...
and direct support within [Daml Studio](daml-studio.mdx#daml-studio). Daml Test runs these scripts against a reference Ledger called the IDE Ledger, which implements the core functionality of the Canton Ledger
...
- `daml studio`:
  <br/>
  See [Daml Studio](daml-studio.mdx#daml-studio)
  <br/>
...
- `daml start`:
  <br/>
  Starts a Daml Sandbox and upload this package. See [Daml Sandbox](../application-development/dpm-sandbox.mdx#sandbox-manual)
  <br/>
- `daml sandbox`:
  <br/>
  Starts a Daml Sandbox. See [Daml Sandbox](../application-development/dpm-sandbox.mdx#sandbox-manual)
  <br/>
- `daml damlc`:
...
- `daml codegen`:
  <br/>
  See [Daml Codegen for Java](../application-development/daml-codegen-java.mdx#component-howtos-application-development-daml-codegen-java) and [Daml Codegen for Javascript](../application-development/daml-codegen-javascript.mdx#component-howtos-application-development-daml-codegen-javascript)
  <br/>
- `daml script`:
  <br/>
  See Daml Script
...
- `canton-console`:
  <br/>
  See [Canton Console](../application-development/dpm-sandbox.mdx#running-canton-console-against-daml-sandbox)
  <br/>
- `upgrade-check`:
  <br/>
  See [Upgrade Check Tool](../../sdlc-howtos/smart-contracts/upgrade/smart-contract-upgrades.mdx#upgrade-check-tool)
  <br/>
...
See [Daml Assistant Flags](flags.mdx#daml-assistant-flags)

### Configuration files

See [Daml Asssistant Configuration Files](assistant/config-files.mdx#daml-assistant-config-files)
