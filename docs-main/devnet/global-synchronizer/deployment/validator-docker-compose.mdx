...
This page walks through deploying a Canton Network validator using Docker Compose. For Kubernetes, see [Kubernetes Validator Deployment](/devnet/global-synchronizer/deployment/validator-kubernetes).
