...
For a full description of these steps, see [Transaction Lifecycle](/devnet/overview/reference/transaction-lifecycle).
...
- **Topology store** -- identity mappings, key registrations, and party-to-participant assignments (see [Topology](/devnet/overview/reference/topology))
...
<Card title="Transaction Lifecycle" icon="arrows-spin" href="/devnet/overview/reference/transaction-lifecycle">
  How the Canton protocol processes a transaction from submission to commit.
</Card>

<Card title="Topology" icon="sitemap" href="/devnet/overview/reference/topology">
  Identity management, key registrations, and party-to-participant mappings.
</Card>

<Card title="Super Validator Components" icon="server" href="/devnet/overview/reference/super-validator-components">
  Additional components that Super Validators operate beyond a standard validator.
</Card>

<Card title="Canton Coin Tokenomics" icon="coins" href="/devnet/overview/reference/canton-coin-tokenomics">
