...
<Note>
  The Proof of Transfer API is supporting the validation of multiple transaction within an UpdateID, that means also Batch Transfer can be validated. In order to enable it from a wallet perspective, ensure that 
</Note>
