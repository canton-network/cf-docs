...
import CantonDocsIntegrationsExchangesSdkDownloadL30 from "/snippets/canton-docs/integrations_exchanges_sdk-download_L30.mdx";
...
- **JavaScript/TypeScript** — Use the functions from the [Wallet SDK](https://github.com/hyperledger-labs/splice-wallet-kernel) to simplify building your integration
...
<CantonDocsIntegrationsExchangesSdkDownloadL30 />
...
- [Exchange Integration Guidance](/docs-main/integrations/exchanges/guidance) — Workflows, architecture, and deployment
