...
<Card title="Migration Checklist" icon="list-check" href="/devnet/appdev/modules/m2-migration-checklist">
  Practical checklist for migrating from Ethereum.
</Card>

<Card title="Module 3: Daml" icon="code" href="/devnet/appdev/modules/m3-dev-environment">
