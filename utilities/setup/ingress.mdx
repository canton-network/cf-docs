{/* source: canton-network-utilities / canton-network-utilities/devnet/setup/ingress.rst */}

<a id="ingress"></a>

# Ingress

<Warning>Your ingress must be created in the same namespace where you have installed your validator, participant and utilities app.</Warning>
