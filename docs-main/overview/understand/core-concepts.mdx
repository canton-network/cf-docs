...
Understanding Canton requires grasping four fundamental concepts: **parties**, **validators** (participant nodes), **synchronizers**, and **templates** (smart contracts). This page introduces each and explains how they work together.
...
Unlike Solidity contracts with mutable state, Daml contracts (template instances) are immutable:
...
<Card title="Global Synchronizer" icon="globe" href="/docs-main/overview/understand/global-synchronizer">
