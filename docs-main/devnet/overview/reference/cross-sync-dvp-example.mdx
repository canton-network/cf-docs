...
- [Reassignment Protocol](/devnet/overview/reference/reassignment-protocol) -- detailed protocol mechanics for unassignment and assignment
- [Architecture Overview](/devnet/overview/learn/architecture) -- how synchronizers, validators, and the Global Synchronizer fit together
