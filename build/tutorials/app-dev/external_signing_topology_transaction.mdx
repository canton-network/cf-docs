{/* source: canton / canton/3.4/sdk/tutorials/app-dev/external_signing_topology_transaction.rst */}
{/* Copyright (c) 2025 Digital Asset (Switzerland) GmbH and/or its affiliates. All rights reserved. */}
{/* SPDX-License-Identifier: Apache-2.0 */}

<a id="externally-signed-topology-transaction"></a>

# Externally Signed Topology Transactions

Canton’s [Topology](identity-manager-1) formalizes a shared state on a synchronizer and provides a secure, distributed mechanism for modifying this state.
...
<a id="tutorial-topology-transaction-setup"></a>
...
<a id="canton-external-topology-manager-write-service"></a>
...
<a id="topology-transaction-hash"></a>
...
<a id="topology-transaction-fingerprint"></a>
...
<a id="topology-transaction-namespace-mapping"></a>
...
The topology state is scoped to a synchronizer. Each synchronizer supports a specific version of the Canton protocol, called `Protocol Version` (more details on the versioning page).
...
The protobuf version becomes relevant in the [Version Wrapper section](#topology-transaction-version-wrapper).

<Note>The versioning of protobuf messages is relatively stable and is not expected to change often.
The rest of the tutorial assumes the protobuf version used is `30`.</Note>

Topology transactions consist of three parts:

### Topology Mapping

See the [Namespace Delegation Mapping section](#topology-transaction-namespace-mapping)
...
<a id="topology-transaction-version-wrapper"></a>
