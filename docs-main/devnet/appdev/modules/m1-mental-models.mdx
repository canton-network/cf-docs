...
<Card title="Development Stack" icon="layer-group" href="/devnet/appdev/modules/m1-development-stack">
  Understand the tools you'll use.
</Card>

<Card title="Architecture Overview" icon="diagram-project" href="/devnet/overview/learn/architecture">
