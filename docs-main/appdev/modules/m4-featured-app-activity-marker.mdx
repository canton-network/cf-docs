...
After [CIP-0078](https://github.com/global-synchronizer-foundation/CIPs), only **featured** apps receive rewards. Unfeatured apps can still create markers, but they will not generate reward coupons.
...
The `FeaturedAppActivityMarker` contract is specified in [CIP-0047](https://github.com/global-synchronizer-foundation/CIPs). Your Daml code creates the marker as part of the transaction that performs the economically meaningful action.
...
The marker contract includes fields that identify your application, the type of activity, and metadata about the event. Refer to [CIP-0047](https://github.com/global-synchronizer-foundation/CIPs) for the exact contract interface and required fields.
...
- [CIP-0047](https://github.com/global-synchronizer-foundation/CIPs) -- The specification for FeaturedAppActivityMarker
- [CIP-0078](https://github.com/global-synchronizer-foundation/CIPs) -- The change restricting rewards to featured apps
