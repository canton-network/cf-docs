...
<div class="x2mdx-ref-hero">
  ...
  <p class="x2mdx-ref-summary">Read a page of ledger&#x27;s filtered updates. It returns the event types in accordance with the specified contents and filters. Additionally, the selection criteria for individual events depends on the transaction shape chosen. - ACS delta: an event is included only if the requesting party is a stakeholder. - ledger effects: an event is included if the requesting party is a witness.</p>
...
const response = await fetch('http://localhost:7575/v2/updates/get-updates-page', {
  method: 'POST',
  headers: {
...
curl_setopt_array($curl, [
    CURLOPT_URL => 'http://localhost:7575/v2/updates/get-updates-page',
...
func main() {
  req, _ := http.NewRequest("POST", "http://localhost:7575/v2/updates/get-updates-page", bytes.NewBufferString(`{
  "beginOffsetExclusive": 123,
  "endOffsetInclusive": 123,
  "maxPageSize": 123,
  "updateFormat": {
...
var request = HttpRequest.newBuilder()
    .uri(URI.create("http://localhost:7575/v2/updates/get-updates-page"))
    .header("Authorization", "Bearer <token>")
    .header("Content-Type", "application/json")
...
uri = URI('http://localhost:7575/v2/updates/get-updates-page')
