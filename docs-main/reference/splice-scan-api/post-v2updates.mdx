...
description: "Returns the update history in ascending order, paged, from ledger begin or optionally starting after a record time. Compared to `/v1/updates`, the `/v2/updates` removes the `offset` field in responses, which was hardcoded to 1 in `/v1/updates` for compatibility, and is now removed."
api: "POST https://scan.sv-1.global.canton.network.sync.global/api/scan/v2/updates"
playground: "interactive"
sidebarTitle: "/v2/updates"
---
...
<div class="x2mdx-ref-hero">
  ...
  <p class="x2mdx-ref-summary">Returns the update history in ascending order, paged, from ledger begin or optionally starting after a record time. Compared to `/v1/updates`, the `/v2/updates` removes the `offset` field in responses, which was hardcoded to 1 in `/v1/updates` for compatibility, and is now removed.</p>
