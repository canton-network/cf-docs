...
| Resource | Content |
|----------|---------|
| [Validator Setup](/global-synchronizer/deploy/validator-setup) | Infrastructure deployment |
| [Ledger API](/appdev/reference/ledger-api) | API integration |
| [Support](/shared/support-channels) | Technical assistance |
