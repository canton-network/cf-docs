...
However, a sequencer may use its own cryptographic material distinct from other sequencers. In that case, the owner-to-key mapping that lists the keys that pertain to the decommissioned sequencer should be removed:
