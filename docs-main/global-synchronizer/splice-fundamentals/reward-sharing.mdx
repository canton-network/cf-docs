...
provided by the `splice-api-reward-assignment-v1` interface package. API
reference docs for this package are [forthcoming](https://github.com/canton-network/cf-docs/issues/838).
