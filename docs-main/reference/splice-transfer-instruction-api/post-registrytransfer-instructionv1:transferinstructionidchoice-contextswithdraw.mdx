---
title: "POST /registry/transfer-instruction/v1/:transferInstructionId/choice-contexts/withdraw"
...
sidebarTitle: "/registry/transfer-instruction/v1/:transferInstructionId/choice-contexts/withdraw"
---
...
<div class="x2mdx-ref-hero">
  ...
  <p class="x2mdx-ref-summary">Get the choice context to withdraw a transfer instruction.</p>
...
const response = await fetch('https://example.com/registry/transfer-instruction/v1/{transferInstructionId}/choice-contexts/withdraw', {
  method: 'POST',
  headers: {
...
curl_setopt_array($curl, [
    CURLOPT_URL => 'https://example.com/registry/transfer-instruction/v1/{transferInstructionId}/choice-contexts/withdraw',
...
func main() {
  req, _ := http.NewRequest("POST", "https://example.com/registry/transfer-instruction/v1/{transferInstructionId}/choice-contexts/withdraw", bytes.NewBufferString(`{
  "meta": {},
  "excludeDebugFields": false
}`))
...
var request = HttpRequest.newBuilder()
    .uri(URI.create("https://example.com/registry/transfer-instruction/v1/{transferInstructionId}/choice-contexts/withdraw"))
    .header("Content-Type", "application/json")
...
uri = URI('https://example.com/registry/transfer-instruction/v1/{transferInstructionId}/choice-contexts/withdraw')
