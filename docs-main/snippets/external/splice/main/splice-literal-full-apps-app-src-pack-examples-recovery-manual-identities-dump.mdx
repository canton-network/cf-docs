<!-- source-snippet repo="splice" path="apps/app/src/pack/examples/recovery/manual-identities-dump.sc" commit="889595d950391fec6acb767c4750ab37bd189a4b" snippet="splice-literal-full-apps-app-src-pack-examples-recovery-manual-identities-dump" location="fullFile" -->
```scala
