...
description: "Bootstrap, configure, and operate Canton synchronizer nodes"
---
...
@ participant1.health.ping(participant1)
    res5: Duration = 1387 milliseconds
```
...
<img src="decentralized-synchronizer-bootstrap-data-exchange.png" class="align-center" style="width:80.0%" alt="image" />
...
@ val initialSnapshot = sequencer1.topology.transactions.export_topology_snapshot(store = sequencer1TempStore)
    initialSnapshot : com.google.protobuf.ByteString = <ByteString@36452c36 size=6275 contents="\n\3760\n\301\002\n\v\b\344\326\337\313\006\020\240\334\306Q\032\244\002\n\237\002\n\215\001\n\210\001\b\001\020\001\032\201\001\n\177\nD1220c...">
```
...
@ val initialSnapshot = sequencer2.topology.transactions.export_topology_snapshot(store = sequencer2TempStore)
    initialSnapshot : com.google.protobuf.ByteString = <ByteString@16a7f36f size=6289 contents="\n\2141\n\303\002\n\f\b\344\326\337\313\006\020\300\214\340\250\001\032\244\002\n\237\002\n\215\001\n\210\001\b\001\020\001\032\201\001\n\177\nD1220...">
```
...
@ participant1.health.ping(participant2)
    res43: Duration = 1341 milliseconds
```
...
``` none
@ val initialSnapshot = sequencer1.topology.transactions.export_topology_snapshot(store = sequencer1TempStore)
    initialSnapshot : com.google.protobuf.ByteString = <ByteString@4eaa1eef size=8473 contents="\n\224B\n\303\002\n\f\b\370\326\337\313\006\020\330\211\227\236\003\032\244\002\n\237\002\n\215\001\n\210\001\b\001\020\001\032\201\001\n\177\nD1220...">
```
...
``` none
@ val initialSnapshot = sequencer2.topology.transactions.export_topology_snapshot(store = sequencer2TempStore)
    initialSnapshot : com.google.protobuf.ByteString = <ByteString@5243be5a size=8475 contents="\n\226B\n\301\002\n\v\b\371\326\337\313\006\020\270\370\363>\032\244\002\n\237\002\n\215\001\n\210\001\b\001\020\001\032\201\001\n\177\nD1220c...">
```
...
@ val initialSnapshot = utils.read_byte_string_from_file("tmp/synchronizer-bootstrapping-files/initial-snapshot.proto")
    initialSnapshot : com.google.protobuf.ByteString = <ByteString@54e1843a size=8473 contents="\n\224B\n\303\002\n\f\b\370\326\337\313\006\020\330\211\227\236\003\032\244\002\n\237\002\n\215\001\n\210\001\b\001\020\001\032\201\001\n\177\nD1220...">
```
...
``` none
@ participant1.health.ping(participant2)
    res56: Duration = 1369 milliseconds
```
...
@ participant1.synchronizers.register(sequencer1, alias = synchronizerName, manualConnect = true)
    ERROR com.digitalasset.canton.integration.EnvironmentDefinition$$anon$3:SynchronizerInstallationManual - Request failed for participant1.
      GrpcRequestRefusedByServer: FAILED_PRECONDITION/INITIAL_ONBOARDING_ERROR(9,aa1957bb): Transport(Status{code=FAILED_PRECONDITION, description=TOPOLOGY_PARTICIPANT_ONBOARDING_REFUSED(9,aa1957bb): The PAR::participant1::12201ff69b1d... can not join the synchronizer because onboarding restrictions are in place, cause=null})
      ...
      cause = "Transport(Status{code=FAILED_PRECONDITION, description=TOPOLOGY_PARTICIPANT_ONBOARDING_REFUSED(9,aa1957bb): The PAR::participant1::12201ff69b1d... can not join the synchronizer because onboarding restrictions are in place, cause=null})",
      traceId = 'aa1957bbd2248340267f90bcfff07c84',
...
``` none
@ participant1.health.ping(participant1)
    res15: Duration = 1265 milliseconds
```
...
{/* TODO: Link the reference documentation. https://github.com/DACH-NY/canton/issues/25963 */}
...
#\. [Link to reference with all dynamic synchronizer parameters](https://github.com/DACH-NY/canton/issues/25806)

\<<https://github.com/DACH-NY/canton/issues/25684>\> \#. Explain the concept of synchronizer owner and that for changes to become affective one needs a threshold of them to submit the same proposal
      ...
      trafficStatesOrErrors = Map(
        PAR::participant1::12201ff69b1d... -> Right(
          value = TrafficState(
            ...
            lastConsumedCost = 0,
            timestamp = 2026-01-26T22:30:51.620374Z,
...
\<<https://github.com/DACH-NY/canton/issues/25832>\> \#. Link to the reference documentation of the `SequencerSynchronizerState` topology mapping above.
      ...
      trafficStatesOrErrors = Map(
        PAR::participant1::12201ff69b1d... -> Right(
          value = TrafficState(
            ...
            baseTrafficRemainder = 20000,
            lastConsumedCost = 0,
            timestamp = 2026-01-26T22:30:52.143511Z,
            serial = 2,
...
``` none
@ participant1.health.ping(participant2)
    res10: Duration = 1560 milliseconds
```

``` none
@ participant2.health.ping(participant3)
    res11: Duration = 1004 milliseconds
```
      ...
      trafficStatesOrErrors = Map(
        PAR::participant1::12201ff69b1d... -> Right(
          value = TrafficState(
            extraTrafficLimit = 1000000,
            extraTrafficConsumed = 0,
            baseTrafficRemainder = 18842,
            lastConsumedCost = 0,
            timestamp = 2026-01-26T22:30:54.902028Z,
            serial = 2,
            availableTraffic = 1018842
          )
        ),
        MED::mediator1::122009299340... -> Right(
          value = TrafficState(
        ...
        PAR::participant3::1220d6908163... -> Right(
          value = TrafficState(
            extraTrafficLimit = 0,
            extraTrafficConsumed = 0,
            baseTrafficRemainder = 16011,
            lastConsumedCost = 0,
            timestamp = 2026-01-26T22:30:54.902028Z,
            availableTraffic = 16011
          )
        ),
        PAR::participant2::1220a4d7463b... -> Right(
          value = TrafficState(
            extraTrafficLimit = 0,
            extraTrafficConsumed = 0,
            baseTrafficRemainder = 12974,
            lastConsumedCost = 0,
            timestamp = 2026-01-26T22:30:54.902028Z,
            availableTraffic = 12974
          )
        )
      )
    )
...
Link to explanation of the trade-off between retention period length to allow offline participants to catch up and storage costs. Explain how `CantonParameters.retentionPeriodDefaults` is used
...
Review and update content. Link to participant HA docs for general configuration. Link to internal architecture/explanation of replication vs. multiple independent nodes. Mediator: cover both replicated node with shared DB as well as multiple mediators in a group. Sequencer: cover db sequencer HA using shared database. cover multiple sequencer nodes with BFT orderer.
...
Link to participant for API security for Admin API for mediator and sequencer. Link to participant for TLS config on Public API. Cover authentication token manager config for the Public API auth. Link to explanation on sequencer Public API authentication. Highlight no mutual TLS option on the Public API.
...
Replace with references to the commands. [\#22919](https://github.com/DACH-NY/canton/issues/22919)
...
Review and update the existing content. Cover sequencer and mediator removal. BFT orderer remove peer endpoint.
...
[\#22917: Fix broken ref](https://github.com/DACH-NY/canton/issues/22917) \#. Remove the mappings for its exclusively owned keys using the ref:topology.owner_to_key_mappings.authorize \ command.
...
[\#22917: Fix broken ref](https://github.com/DACH-NY/canton/issues/22917) If other mediators exist on the synchronizer, a mediator can be decommissioned using a single console command ref:setup.offboard_mediator \.
...
Deduplicate and link with backup&restore in participant docs. Cover synchronous replication in storage config for sequencers.
...
#\. [Ability to recover from partial data loss on a synchronizer](https://github.com/DACH-NY/canton/issues/4839).
...
- [How incremental backups work in PostgreSQL](https://kcaps.medium.com/how-incremental-backups-work-in-postgresql-and-how-to-implement-them-in-10-minutes-d3689e8414d9)
...
For detailed instructions on how to setup a replicated database and how to perform failovers, we refer to the database system documentation, e.g. [the high availability documentation](https://www.postgresql.org/docs/current/high-availability.html) of PostgreSQL.
