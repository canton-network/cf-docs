{/* source: canton / canton/3.4/sdk/explanations/json-api/migration_v2.rst */}
{/* Copyright (c) 2025 Digital Asset (Switzerland) GmbH and/or its affiliates. All rights reserved. */}
{/* SPDX-License-Identifier: Apache-2.0 */}

<a id="json-api-migration"></a>
...
> Always  consult [JSON Ledger API OpenAPI definition](../../reference/json-api/openapi.mdx#reference-json-api-openapi) for exact details and usage.
...
Check [JSON Ledger API OpenAPI definition](../../reference/json-api/openapi.mdx#reference-json-api-openapi) for details.
