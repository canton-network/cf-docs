...
Individual Canton release notes are available in the [Canton release notes directory](https://github.com/DACH-NY/canton/tree/main/release-notes) (requires repository access).
