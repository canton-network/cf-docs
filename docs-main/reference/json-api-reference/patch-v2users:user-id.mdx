...
<div class="x2mdx-ref-hero">
  ...
  <p class="x2mdx-ref-summary">Update selected modifiable attribute of a user resource described by the ``User`` message.</p>
...
func main() {
  req, _ := http.NewRequest("PATCH", "http://localhost:7575/v2/users/{user-id}", bytes.NewBufferString(`{
  "user": {
    "id": "<string>",
    "primaryParty": "<string>",
    "isDeactivated": false,
