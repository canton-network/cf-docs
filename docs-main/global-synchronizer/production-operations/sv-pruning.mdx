...
{/* Generated from sv-pruning.source.mdx. Edit sv-pruning.source.mdx, then run npm run snippets:generate. */}
...
{/* snippet-source: https://github.com/canton-network/splice/blob/4c670142843c198ed93f106824d8e33d9dec5c8c/apps/app/src/pack/examples/sv-helm/sv-values.yaml; authored-at: docs-main/global-synchronizer/production-operations/sv-pruning.source.mdx:16 */}
```yaml
synchronizers:
  current:
...
{/* snippet-source: https://github.com/canton-network/splice/blob/4c670142843c198ed93f106824d8e33d9dec5c8c/cluster/helm/splice-cometbft/values-template.yaml; authored-at: docs-main/global-synchronizer/production-operations/sv-pruning.source.mdx:34 */}
```yaml
...
{/* snippet-source: https://github.com/canton-network/splice/blob/4c670142843c198ed93f106824d8e33d9dec5c8c/apps/app/src/pack/examples/sv-helm/sv-validator-values.yaml; authored-at: docs-main/global-synchronizer/production-operations/sv-pruning.source.mdx:46 */}
```yaml
