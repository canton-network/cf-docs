...
<div className="x2mdx-ref-operation-shell">
  <div className="x2mdx-ref-operation-main">
    ...
    <div class="x2mdx-ref-hero">
      ...
      <p>An OpenRPC specification for remotely hosted Wallet Providers. Due to the remote nature, an implementing provider must bridge certain functionality on the client-side to satisfy the general dApp API spec.</p>
