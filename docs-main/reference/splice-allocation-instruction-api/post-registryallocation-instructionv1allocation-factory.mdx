---
title: "POST /registry/allocation-instruction/v1/allocation-factory"
description: "Get the factory and choice context for creating allocations using the `AllocationFactory_Allocate` choice."
api: "POST https://example.com/registry/allocation-instruction/v1/allocation-factory"
playground: "interactive"
sidebarTitle: "/registry/allocation-instruction/v1/allocation-factory"
---
...
<div class="x2mdx-ref-hero">
  ...
  <p class="x2mdx-ref-summary">Get the factory and choice context for creating allocations using the `AllocationFactory_Allocate` choice.</p>
