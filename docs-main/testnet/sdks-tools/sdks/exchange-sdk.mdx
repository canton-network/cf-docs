...
<CardGroup cols={2}>
  <Card title="Exchange Integration" icon="arrows-rotate" href="/testnet/integrations/overview">
...
1. Review the [Integrations overview](/testnet/integrations/overview) for the full context on exchange and wallet integrations
...
- Familiarity with the [Ledger API](/testnet/sdks-tools/api-reference/ledger-api) and [Java bindings](/testnet/sdks-tools/language-bindings/java)

## Related Pages

- [Integrations overview](/testnet/integrations/overview) -- Wallet and exchange integration patterns
- [Java bindings](/testnet/sdks-tools/language-bindings/java) -- Code generation for Java
- [PQS](/testnet/sdks-tools/development-tools/pqs) -- SQL-based ledger queries used by the Exchange SDK
