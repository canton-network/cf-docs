...
| **Canton Coin & Traffic** | Simulated CC and traffic provided | Real CC required to buy traffic (auto-top-up configurable) |
| **DAR Deployment** | Direct DAR upload | Upload via validator participant node; may require synchronization with counterparties |
