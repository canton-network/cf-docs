...
import CANTON_DOCS_CN_GS_CANTON_CONSOLE_CONSOLE_OVERVIEW_0 from "/snippets/external/canton/main/docs-open/target/snippet_json_data/docs-cn/global-synchronizer-canton-console-console-overview-0.mdx";
import ExternalCantonMainDocsOpenTargetSnippetJsonDataDocsCnDocsGlobalSynchronizerReferenceCantonConsoleReferenceParticipantLocalhostHocon0 from "/snippets/external/canton/main/docs-open/target/snippet_json_data/docs-cn/docs-global-synchronizer-reference-canton-console-reference-participant-localhost-hocon-0.mdx";
import ExternalCantonMainDocsOpenTargetSnippetJsonDataDocsCnDocsGlobalSynchronizerReferenceCantonConsoleReferenceSequencerHocon2 from "/snippets/external/canton/main/docs-open/target/snippet_json_data/docs-cn/docs-global-synchronizer-reference-canton-console-reference-sequencer-hocon-2.mdx";
import ExternalCantonMainDocsOpenTargetSnippetJsonDataDocsCnDocsGlobalSynchronizerReferenceCantonConsoleReferenceMediatorHocon3 from "/snippets/external/canton/main/docs-open/target/snippet_json_data/docs-cn/docs-global-synchronizer-reference-canton-console-reference-mediator-hocon-3.mdx";
...
<ExternalCantonMainDocsOpenTargetSnippetJsonDataDocsCnDocsGlobalSynchronizerReferenceCantonConsoleReferenceParticipantLocalhostHocon0 />
...
Replace `3.3.0` with the Canton version matching your deployment. Check available versions at [Docker Hub](https://hub.docker.com/r/digitalasset/canton/tags).
...
<ExternalCantonMainDocsOpenTargetSnippetJsonDataDocsCnDocsGlobalSynchronizerReferenceCantonConsoleReferenceSequencerHocon2 />
...
<ExternalCantonMainDocsOpenTargetSnippetJsonDataDocsCnDocsGlobalSynchronizerReferenceCantonConsoleReferenceMediatorHocon3 />
...
<CANTON_DOCS_CN_GS_CANTON_CONSOLE_CONSOLE_OVERVIEW_0 />


## Next Steps

- [Essential Commands](/global-synchronizer/canton-console/essential-commands) — Key commands for health checks, party and package management
- [Debugging Workflows](/global-synchronizer/canton-console/debugging-workflows) — Step-by-step diagnostic procedures
