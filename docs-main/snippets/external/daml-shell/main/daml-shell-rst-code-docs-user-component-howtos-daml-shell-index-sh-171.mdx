<!-- source-snippet repo="daml-shell" path="docs/user/component-howtos/daml-shell/index.rst" commit="8b355e9ae559d6d3698a8c05f1e348eb1b784144" snippet="daml-shell-rst-code-docs-user-component-howtos-daml-shell-index-sh-171" location="lines:171-205" -->
```sh
   $ ./daml-shell.jar --help
