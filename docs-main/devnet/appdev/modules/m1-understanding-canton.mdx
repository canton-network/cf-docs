...
- **Understand** what Canton is ([Five-Minute Overview](/devnet/overview/understand/five-minute-overview))
- **Know** the basic components ([Core Concepts](/devnet/overview/understand/core-concepts))
...
<Card title="Mental Models" icon="brain" href="/devnet/appdev/modules/m1-mental-models">
  Build intuition for Canton's approach to distributed ledgers.
</Card>

<Card title="Development Stack" icon="wrench" href="/devnet/appdev/modules/m1-development-stack">
...
- **[Module 2](/devnet/appdev/modules/m2-canton-for-ethereum-devs)**: If you have Ethereum/blockchain experience
