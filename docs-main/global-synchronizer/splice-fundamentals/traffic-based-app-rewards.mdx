...
1. The **Scan app** ingests traffic summaries from the sequencer alongside
   ...
   minting allowance and coupon threshold defined in `RewardConfig`, and builds
   a Merkle tree commitment of the results.
...
| Reward sharing | Not supported | Provider can [assign beneficiaries](/global-synchronizer/splice-fundamentals/reward-sharing) before minting |
