---
title: "Module 1: Understanding Canton"
description: "Build the foundational understanding needed for Canton development"
---
...
- **Understand** what Canton is ([Five-Minute Overview](/testnet/overview/understand/five-minute-overview))
- **Know** the basic components ([Core Concepts](/testnet/overview/understand/core-concepts))
...
<Card title="Mental Models" icon="brain" href="/testnet/appdev/modules/m1-mental-models">
  Build intuition for Canton's approach to distributed ledgers.
</Card>

<Card title="Development Stack" icon="wrench" href="/testnet/appdev/modules/m1-development-stack">
...
- **[Module 2](/testnet/appdev/modules/m2-canton-for-ethereum-devs)**: If you have Ethereum/blockchain experience
