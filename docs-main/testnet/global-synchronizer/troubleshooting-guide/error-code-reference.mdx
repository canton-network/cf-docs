...
- **Resolution:** Purchase additional traffic via the validator API or enable auto-top-up. See [Transaction Failures](/testnet/global-synchronizer/troubleshooting-guide/transaction-failures) for details.
...
- **Resolution:** Check the path mentioned in the error against your configuration files and environment variables. See [Configuration Problems](/testnet/global-synchronizer/troubleshooting-guide/configuration-problems).
