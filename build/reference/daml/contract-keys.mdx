...
<Danger>Contract keys are not supported in this release of Canton 3.x.
...
The documentation below is kept for completeness, but can be ignored for this release of Canton 3.x.</Danger>
