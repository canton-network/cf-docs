...
<Card title="Validators & Operators" icon="server" href="/global-synchronizer/understand/introduction">
...
| Write my first smart contract | [Module 3: Daml Smart Contracts](/appdev/modules/m3-daml) |
| Run the example application | [QuickStart](/appdev/quickstart) |
| Deploy a validator node | [Validator Setup](/global-synchronizer/deploy/validator-setup) |
| Integrate a wallet into my app | [Wallets for Developers](/building-blocks/wallets/for-developers) |
