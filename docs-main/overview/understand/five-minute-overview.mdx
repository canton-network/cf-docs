---
title: "Canton Network in 5 Minutes"
description: "A rapid introduction to Canton Network's approach to privacy-preserving blockchain"
---
...
Traditional blockchains replicate all data to all nodes. This provides strong integrity guarantees but makes privacy impossible without additional layers.
...
### 2. Synchronizers Coordinate, Don't Store
...
- **Signatories**: Who must authorize and always sees the contract
...
flowchart TB
    ...
    V1[Validator A<br>hosts Alice] <--> GS
    V2[Validator B<br>hosts Bob] <--> GS
    V3[Validator C<br>hosts Charlie] <--> GS

    App[Your Application] --> V1
```
...
|----------|------------------|
| **Regulated finance** | Data stays with entitled parties; compliance possible |
...
| Gas fees | Traffic fees (Canton Coin) |
| EOA/Address | Party |
...
<Card title="Why Canton?" icon="question" href="/docs-main/overview/understand/the-problem">
...
<Card title="For Ethereum Devs" icon="ethereum" href="/docs-main/appdev/modules/m2-canton-for-ethereum-devs">
  Translate your blockchain knowledge to Canton.
</Card>

<Card title="Architecture" icon="diagram-project" href="/docs-main/overview/learn/architecture">
