...
3. Follow the [validator upgrade guide](/global-synchronizer/production-operations/validator-upgrades) — applies to both Docker Compose (`docker-compose` bundle update) and Kubernetes (`helm upgrade`) deployments.
</Accordion>
