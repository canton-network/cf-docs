<!-- source: canton / canton/3.5/synchronizer/howtos/secure/key_management.rst -->
...
of a Participant node. Just ensure that `myNode` refers to the correct Sequencer or
...
participant KMS section. The configuration process is similar for both Participant and
Synchronizer nodes.
