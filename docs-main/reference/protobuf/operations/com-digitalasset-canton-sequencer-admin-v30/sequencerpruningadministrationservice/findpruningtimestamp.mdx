...
<div class="x2mdx-ref-operation-bar">
  ...
  <code>/com.digitalasset.canton.sequencer.admin.v30.SequencerPruningAdministrationService/FindPruningTimestamp</code>
...
grpcurl \
  -d @ \
  <HOST:PORT> \
  com.digitalasset.canton.sequencer.admin.v30.SequencerPruningAdministrationService/FindPruningTimestamp <<'EOF'
{
  "index": 0
}
EOF
