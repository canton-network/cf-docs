{/* source: canton / canton/3.4/participant/howtos/decommission/index.rst */}
{/* Copyright (c) 2025 Digital Asset (Switzerland) GmbH and/or its affiliates. All rights reserved. */}
{/* SPDX-License-Identifier: Apache-2.0 */}
<Note>This page is a work in progress. It may contain incomplete or incorrect information.</Note>

<a id="decommissioning-nodes"></a>

# Decommissioning Canton Nodes and Synchronizer Entities

This guide assumes general familiarity with Canton, in particular [Canton identity management concepts](../operate/identity_management.mdx#identity-management-user-manual)
and [operations from the Canton console](../operate/console/console.mdx#canton-console).
...
<a id="decommissioning-participants"></a>
...
<Note>More specifically, for a contract action to be committed:
...
of the Daml application and should be accounted and tested for in the initial Daml design process.</Note>
...
1. Stop applications from sending commands to the Ledger API of the participant to be decommissioned
   to avoid failed commands and errors.
2. Disconnect the participant to be decommissioned from all synchronizers as described in
   [enabling and disabling connections](../operate/synchronizers/connectivity.mdx#connectivity-participant-reconnect).
