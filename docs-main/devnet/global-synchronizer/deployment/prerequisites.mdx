...
<Card title="Onboarding Process" icon="user-plus" href="/devnet/global-synchronizer/deployment/onboarding-process">
  Get onboarded with an SV sponsor.
</Card>

<Card title="Installation" icon="download" href="/devnet/global-synchronizer/deployment/deployment-options">
