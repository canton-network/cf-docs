...
Splice includes a token standard ([CIP-0054](https://github.com/global-synchronizer-foundation/cips/blob/main/cip-0054/cip-0054.md)) for creating tokens on Canton Network. This provides:
