...
The designated node must then submit a matching transaction to officially accept the hosting request. Instructions on how to do that can be found [here](../party-management/index.md#create-an-external-party).
...
* For exchanges, it’s suggested aiming for one, or few parties for the exchange vault and using memo tags for tracking deposits. See [here](../deposits-into-exchanges/index.md#deposits-into-exchanges) for more information.
