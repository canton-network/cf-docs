<!-- source: daml / daml/3.5/overview/reference/status-definitions.rst -->
...
Features or components covered by these docs are [Stable](#id2) by default. [Stable](#id2) features and components constitute Daml’s “public API” in the sense of [Semantic Versioning](releases.md#versioning). Feature and components that are not [Stable](#id2) are called “Early Access” and called out explicitly.
...
| Distribution and Releases                                | Distributed as part of regular [releases](releases.md).                                                     | Distributed as part of regular [releases](releases.md).                                                                       | Distributed as part of regular [releases](releases.md).                                                              | Releases and distribution may be separate.                                                                           |
...
| Covered by [Semantic Versioning](releases.md#versioning) | Yes, part of the “public API”.                                                                              | No, but breaking changes will be documented.                                                                                  | No, and changes may be poorly documented.                                                                            | No, and changes may be poorly documented.                                                                            |
| **Documentation**                                        |                                                                                                             |                                                                                                                               |                                                                                                                      |                                                                                                                      |
...
| Compatibility                                            | Covered by [Portability, Compatibility, and Support Durations](compatibility.md).                           | Covered by [Portability, Compatibility, and Support Durations](compatibility.md).                                             | Current compatibility documented as part of main docs.                                                               | May be undocumented.                                                                                                 |
