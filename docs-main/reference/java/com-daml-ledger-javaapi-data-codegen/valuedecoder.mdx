...
Upstream docs: [Open](<https://javadoc.io/doc/com.daml/bindings-java/3.5.8/com/daml/ledger/javaapi/data/codegen/ValueDecoder.html>)
...
| --- | --- | --- | --- | --- |
| [Open](<https://javadoc.io/doc/com.daml/bindings-java/3.5.8/com/daml/ledger/javaapi/data/codegen/ValueDecoder.html#decode%28com.daml.ledger.javaapi.data.Value%29>) | `decode(Value)` | `3.4.8` | - | - |
| [Open](<https://javadoc.io/doc/com.daml/bindings-java/3.5.8/com/daml/ledger/javaapi/data/codegen/ValueDecoder.html#decode%28com.daml.ledger.javaapi.data.Value,com.daml.ledger.javaapi.data.codegen.UnknownTrailingFieldPolicy%29>) | `decode(Value, UnknownTrailingFieldPolicy)` | `3.5.8` | - | - |
