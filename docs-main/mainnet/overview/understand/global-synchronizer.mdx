...
- **[Glossary](/mainnet/overview/understand/glossary)** - Terminology reference
- **[Validator Operations](/mainnet/global-synchronizer/understand/introduction)** - Deploy your own validator
- **[Deployment Progression](/mainnet/appdev/modules/m5-deployment-progression)** - Deploy applications across environments
<div className="todo">
