...
<Note>
This FAQ is derived from analysis of 120 production support tickets. Questions are organized by topic to help you find answers quickly.
</Note>
...
4. **Use Canton Console** for deeper investigation:
   ...
   participant.ledger_api.state.acs.of_party(party)
   ```
</Accordion>
