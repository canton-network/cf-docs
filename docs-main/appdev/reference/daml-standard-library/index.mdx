...
<div class="x2mdx-ref-badges">
  ...
  <span class="x2mdx-ref-badge x2mdx-ref-badge--added">Present since at least 3.4.9</span>
...
<div class="x2mdx-ref-history" aria-label="Reference history">
  ...
  <div class="x2mdx-ref-history-event x2mdx-ref-history-event--introduced" id="history-added-3-4-9">
    ...
    <p class="x2mdx-ref-history-event-detail">DA.Action</p>

    <p class="x2mdx-ref-history-event-detail">DA.Action.State</p>

    <p class="x2mdx-ref-history-event-detail">DA.Action.State.Class</p>

    <p class="x2mdx-ref-history-event-detail">DA.Assert</p>

    <p class="x2mdx-ref-history-event-detail">DA.Bifunctor</p>

    <p class="x2mdx-ref-history-event-detail">DA.Crypto.Text</p>

    <p class="x2mdx-ref-history-event-detail">DA.Date</p>

    <p class="x2mdx-ref-history-event-detail">DA.Either</p>

    <p class="x2mdx-ref-history-event-detail">DA.Exception</p>

    <p class="x2mdx-ref-history-event-detail">DA.Fail</p>

    <p class="x2mdx-ref-history-event-detail">DA.Foldable</p>

    <p class="x2mdx-ref-history-event-detail">DA.Functor</p>

    <p class="x2mdx-ref-history-event-detail">DA.Internal.Interface.AnyView</p>

    <p class="x2mdx-ref-history-event-detail">DA.Internal.Interface.AnyView.Types</p>

    <p class="x2mdx-ref-history-event-detail">DA.List</p>

    <p class="x2mdx-ref-history-event-detail">DA.List.BuiltinOrder</p>

    <p class="x2mdx-ref-history-event-detail">DA.List.Total</p>

    <p class="x2mdx-ref-history-event-detail">DA.Logic</p>

    <p class="x2mdx-ref-history-event-detail">DA.Map</p>

    <p class="x2mdx-ref-history-event-detail">DA.Math</p>

    <p class="x2mdx-ref-history-event-detail">DA.Monoid</p>

    <p class="x2mdx-ref-history-event-detail">DA.NonEmpty</p>

    <p class="x2mdx-ref-history-event-detail">DA.NonEmpty.Types</p>

    <p class="x2mdx-ref-history-event-detail">DA.Numeric</p>

    <p class="x2mdx-ref-history-event-detail">DA.Optional</p>

    <p class="x2mdx-ref-history-event-detail">DA.Record</p>

    <p class="x2mdx-ref-history-event-detail">DA.Semigroup</p>

    <p class="x2mdx-ref-history-event-detail">DA.Set</p>

    <p class="x2mdx-ref-history-event-detail">DA.Stack</p>

    <p class="x2mdx-ref-history-event-detail">DA.Text</p>

    <p class="x2mdx-ref-history-event-detail">DA.TextMap</p>

    <p class="x2mdx-ref-history-event-detail">DA.Time</p>

    <p class="x2mdx-ref-history-event-detail">DA.Traversable</p>

    <p class="x2mdx-ref-history-event-detail">DA.Tuple</p>

    <p class="x2mdx-ref-history-event-detail">DA.Validation</p>

    <p class="x2mdx-ref-history-event-detail">Prelude</p>
