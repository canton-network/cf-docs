{/* source: daml / daml/3.4/sdk/tutorials/smart-contracts/contracts.rst */}
{/* Copyright (c) 2023 Digital Asset (Switzerland) GmbH and/or its affiliates. All rights reserved. */}
{/* SPDX-License-Identifier: Apache-2.0 */}

<a id="basic-contracts"></a>
...
<Tip>Remember that you can load all the code for this section into a folder `intro-contracts` by running `dpm new intro-contracts  --template daml-intro-contracts`</Tip>
...
In [Test templates using Daml scripts](daml-scripts.mdx), you’ll learn about how to try out the `Token` contract template in Daml’s inbuilt Daml Script testing language.
