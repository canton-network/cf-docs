<!-- source-snippet repo="splice" path="apps/app/src/pack/examples/sv-helm/standalone-validator-values.yaml" commit="889595d950391fec6acb767c4750ab37bd189a4b" snippet="splice-literal-marker-apps-app-src-pack-examples-sv-helm-standalone-validator-values-synchronizer-configuration-start" location="stringMarker:SYNCHRONIZER_CONFIGURATION_START-&gt;SYNCHRONIZER_CONFIGURATION_END" -->
```yaml
  synchronizer:
    connectionType: "bft"
