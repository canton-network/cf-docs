...
<div class="x2mdx-ref-hero">
  ...
  <p class="x2mdx-ref-summary">Checks if the service is ready to serve requests</p>
...
const response = await fetch('http://localhost:7575/readyz', {
  method: 'GET',
  headers: {
...
curl_setopt_array($curl, [
    CURLOPT_URL => 'http://localhost:7575/readyz',
...
func main() {
  req, _ := http.NewRequest("GET", "http://localhost:7575/readyz", nil)
...
var request = HttpRequest.newBuilder()
    .uri(URI.create("http://localhost:7575/readyz"))
    .header("Authorization", "Bearer <token>")
...
uri = URI('http://localhost:7575/readyz')
