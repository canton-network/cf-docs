---
title: "Daml Error Codes"
description: "Reference for common error codes in Daml compilation, Canton runtime, and the Ledger API"
---
...
**Fix:** Retry the operation with exponential backoff. See [Development Issues](/docs-main/appdev/troubleshooting-guide/development-issues) for a retry pattern.

## Ledger API errors

Ledger API runtime error codes (AUTH_INVALID_TOKEN, PACKAGE_NOT_FOUND, PARTY_NOT_KNOWN, PERMISSION_DENIED, etc.) live on their own page: [Ledger API Errors](/docs-main/appdev/troubleshooting-guide/ledger-api-errors).
