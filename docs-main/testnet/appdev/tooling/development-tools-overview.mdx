...
DPM replaces the older `daml` CLI and is the recommended entry point for all build and project tasks. See the [DPM reference](/testnet/sdks-tools/cli-tools/dpm) for the full command set.
...
For full setup instructions, see [IDE Setup](/testnet/appdev/tooling/ide-setup).
...
See [Sandbox](/testnet/sdks-tools/development-tools/sandbox) for configuration options.
...
See [LocalNet](/testnet/sdks-tools/development-tools/localnet) for details.
...
See [PQS](/testnet/sdks-tools/development-tools/pqs) and the [PQS SQL Reference](/api-reference) for schema details and query examples.
...
- [IDE Setup](/testnet/appdev/tooling/ide-setup) -- Configure your editor for Canton development
- [Debugging Tools](/testnet/appdev/tooling/debugging-tools) -- Troubleshoot transactions and contract state
- [The Canton Development Stack](/testnet/appdev/modules/m1-development-stack) -- How all the pieces fit together
