...
**Use the [Sandbox](/testnet/sdks-tools/development-tools/sandbox)** when you need:
...
- [cn-quickstart](/testnet/sdks-tools/reference-projects/cn-quickstart) -- Repository overview and project structure
- [Sandbox](/testnet/sdks-tools/development-tools/sandbox) -- Lightweight single-node alternative
- [QuickStart walkthrough](/testnet/appdev/quickstart/running-the-demo) -- Step-by-step guide to running the demo application
