...
<Card title="Why Canton?" icon="question" href="/mainnet/overview/understand/the-problem">
...
<Card title="For Ethereum Devs" icon="ethereum" href="/mainnet/appdev/modules/m2-canton-for-ethereum-devs">
  Translate your blockchain knowledge to Canton.
</Card>

<Card title="Architecture" icon="diagram-project" href="/mainnet/overview/learn/architecture">
