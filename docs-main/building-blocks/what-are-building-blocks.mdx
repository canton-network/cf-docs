...
| Standard | Purpose |
|----------|---------|
| **[CIP-0056](https://github.com/global-synchronizer-foundation/cips/blob/main/cip-0056/cip-0056.md)** | Canton Network Token Standard |
...
<Card title="Wallet Integration" icon="code" href="/docs-main/integrations/overview">
...
| Integrate wallets | [Wallets for Developers](/docs-main/integrations/overview) |
| Create tokens | [Token Standard](/docs-main/overview/understand/cips-introduction) |
