<!-- source: quickstart / quickstart/3.5/sdk/quickstart/configure/dev-journey-in-cnqs-lifecycle.rst -->
...
The full list of make targets is maintained in the [CN App Quickstart Make target reference](../troubleshoot/cnqs-faq.md#make-target-reference).
