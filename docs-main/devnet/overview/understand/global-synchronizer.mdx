...
- **[Glossary](/devnet/overview/understand/glossary)** - Terminology reference
- **[Validator Operations](/devnet/global-synchronizer/understand/introduction)** - Deploy your own validator
- **[Deployment Progression](/devnet/appdev/modules/m5-deployment-progression)** - Deploy applications across environments
<div className="todo">

{/* COPIED_START source="docs-website:docs/replicated/canton/3.5/overview/explanations/canton/synchronizers.rst" hash="ff3b68a4" */}
