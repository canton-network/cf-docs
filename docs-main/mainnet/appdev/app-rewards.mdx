...
- [Canton Coin and Traffic](/mainnet/appdev/modules/m4-canton-coin) -- How traffic credits and CC work for application developers
- [Getting Your App Featured](/mainnet/overview/understand/getting-app-featured) -- Promotional opportunities on Canton Network
- [Canton Coin overview](/mainnet/overview/understand/canton-coin) -- Tokenomics, validator rewards, and governance
