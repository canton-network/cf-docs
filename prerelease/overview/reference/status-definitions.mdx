...
| Distribution and Releases                                | Distributed as part of regular [releases](releases).                                                     | Distributed as part of regular [releases](releases).                                                                       | Distributed as part of regular [releases](releases).                                                              | Releases and distribution may be separate.                                                                           |
...
| Compatibility                                            | Covered by [Portability, Compatibility, and Support Durations](compatibility).                           | Covered by [Portability, Compatibility, and Support Durations](compatibility).                                             | Current compatibility documented as part of main docs.                                                               | May be undocumented.                                                                                                 |
