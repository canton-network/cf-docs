---
title: "Required network parameters — source test"
description: "Hidden source-template copy for testing Mintlify editor visibility."
hidden: true
---
...
- **SPONSOR_SV_URL** — The URL of the SV app of your SV sponsor. This should be of the form <a href="|generic_sv_url|">|generic_sv_url|</a>, e.g., if the Global Synchronizer Foundation is your sponsor use <a href="|gsf_sv_url|">|gsf_sv_url|</a>.
