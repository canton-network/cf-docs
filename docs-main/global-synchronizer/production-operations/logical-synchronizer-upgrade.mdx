...
<Version
  ...
  description="This section changed after the original copy from Splice. Use the tab that matches the version you are following."
  defaultLabel="after"
>
  <VersionOption label="before">
