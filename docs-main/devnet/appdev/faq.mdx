...
1. **Official Documentation:**
   ...
   - [Operator Documentation](https://docs.dev.sync.global)
...
3. Follow [MainNet onboarding documentation](https://docs.dev.sync.global/validator_operator/validator_onboarding.html)
