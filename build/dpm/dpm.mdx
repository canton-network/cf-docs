...
[Daml Assistant](../component-howtos/smart-contracts/assistant.mdx#daml-assistant).
...
If you prefer a more manual installation process, see [here](manual-install.mdx#dpm-manual-installation).
...
To install unstable SDKs you need to [configure dpm](configuration.mdx#dpm-configuration) to look for them by setting the
...
* [Manual Installation Instructions](manual-install.mdx)
