...
- **Operational overhead** — Running a private synchronizer means operating sequencer and mediator infrastructure in addition to your validator. See the [deployment guide](/testnet/global-synchronizer/extension-synchronizers/deployment) for what this involves.
