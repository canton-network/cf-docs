---
title: "Get the user data of a specific user or the authenticated user"
api: "GET http://localhost:7575/v2/users/{user-id}"
authMethod: "bearer"
...
<div class="x2mdx-ref-hero">
  ...
  <h1 class="x2mdx-ref-title">Get the user data of a specific user or the authenticated user</h1>
...
<div class="x2mdx-ref-meta-grid">
  ...
  <div class="x2mdx-ref-meta-item">
    ...
    <span class="x2mdx-ref-meta-value">getV2UsersUser-id</span>
  </div>
...
<div class="x2mdx-ref-history" aria-label="Reference history">
  ...
  <div class="x2mdx-ref-history-event x2mdx-ref-history-event--changed" id="history-updated-3-5">
    ...
    <p class="x2mdx-ref-history-event-detail">The GET /v2/users/&#123;user-id&#125; operation was updated in this snapshot.</p>
