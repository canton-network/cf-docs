...
**Fix:** Retry the operation with exponential backoff. See [Development Issues](/devnet/appdev/troubleshooting-guide/development-issues) for a retry pattern.

## Ledger API errors

Ledger API runtime error codes (AUTH_INVALID_TOKEN, PACKAGE_NOT_FOUND, PARTY_NOT_KNOWN, PERMISSION_DENIED, etc.) live on their own page: [Ledger API Errors](/devnet/appdev/troubleshooting-guide/ledger-api-errors).
