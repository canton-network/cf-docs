...
Every Scan can list all approved SV scans connected to the network. For example, query from /v0/scans from [|gsf_scan_url|](|gsf_scan_url|), and the response will be something like
