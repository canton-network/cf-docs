...
<div className="x2mdx-ref-operation-shell">
  <div className="x2mdx-ref-operation-main">
    ...
    <div class="x2mdx-ref-hero">
      ...
      <h1 class="x2mdx-ref-title">gRPC API</h1>
      <h2>Details and history</h2>
      <p>Generated Ledger API gRPC reference grouped by package. Operation-first gRPC pages with package-level browsing and recursive related schema sections.</p>
