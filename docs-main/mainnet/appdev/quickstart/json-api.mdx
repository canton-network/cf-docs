...
This guide assumes you're using the Daml Assistant (Daml 3.3.x), which is the active CLI on MainNet and TestNet. Follow installation instructions at the Daml [Assistant]().
