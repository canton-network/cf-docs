...
proliferation of packages in your project.  Use [Multi-Package builds](../build/how-to-build-dar-files.md#multi-package-build) to reliably rebuild these packages as you iterate on your
...
For the same reason, the [Daml sandbox](../../../component-howtos/application-development/dpm-sandbox.md#sandbox-manual) does not support
...
- The package-id selection preference list specified in the submitted command’s
  [package_id_selection_preference](../../../reference/lapi-proto-docs.md#com-daml-ledger-api-v2-commands-package-id-selection-preference) in a command submission.
  ...
  > - **Note:** The [package_id_selection_preference](../../../reference/lapi-proto-docs.md#com-daml-ledger-api-v2-commands-package-id-selection-preference)
...
- For command submissions that use a by-package-name template ID
  ...
  create command [here](../../../reference/lapi-proto-docs.md#com-daml-ledger-api-v2-createcommand))
...
in the [template-id request filter field](../../../reference/lapi-proto-docs.md#com-daml-ledger-api-v2-templatefilter-template-id).
...
To manage the complexity of working with multiple packages at once, we recommend using [multi-package builds](../build/how-to-build-dar-files.md#multi-package-build).
...
[Multi-package builds](../build/how-to-build-dar-files.md#multi-package-build) help
