...
Check the [reference documentation](/sdks-tools/api-reference/splice-scan-bulk-data-api#events) for more details on the `verdicts` admin command.
...
See [participant docs](/overview/reference/participant-overview) for general guidelines.
