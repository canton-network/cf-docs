{/* source: canton-network-utilities / canton-network-utilities/devnet/overview/registry-user-guide/activity-markers.rst */}
...
| **provider**  | (1-w) \* 0.6 |
| **registrar** | (1-w) \* 0.4 |
<Note>1. The **provider** **must** define beneficiary weights that sum to exactly 1 for the instrument
...
3. If the **operator** changes its weight to w’ in the AppRewardConfiguration, the
   ...
   (e.g., to  (1 - w’) \* 0.6 and (1 - w’) \* 0.4 in the case above).</Note>
