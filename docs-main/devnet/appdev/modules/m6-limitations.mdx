...
- [Upgrade Compatibility](/devnet/appdev/modules/m6-upgrade-compatibility) -- Full compatibility rules for SCU
- [Package Naming](/devnet/appdev/modules/m6-package-naming) -- Naming conventions that account for breaking changes
- [Smart Contract Upgrades in Production](/devnet/appdev/modules/m7-smart-contract-upgrades) -- Operational considerations for rollouts
