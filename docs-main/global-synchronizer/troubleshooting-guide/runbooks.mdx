---
title: "Runbooks"
description: "Operational runbooks for common validator incidents with step-by-step procedures"
---

import CantonGlobalSynchronizerTroubleshootingGuideRunbooksL62 from "/snippets/canton-docs/global-synchronizer_troubleshooting-guide_runbooks_L62.mdx";
...
3. **Act** -- Execute the appropriate fix. Follow the relevant runbook below or the [troubleshooting methodology](/docs-main/global-synchronizer/troubleshooting-guide/troubleshooting-methodology).
...
<CantonGlobalSynchronizerTroubleshootingGuideRunbooksL62 />

If `extraTrafficRemainder` is 0 or very low, traffic is exhausted.
