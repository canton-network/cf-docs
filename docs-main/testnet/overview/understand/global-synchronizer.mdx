...
- **[Glossary](/testnet/overview/understand/glossary)** - Terminology reference
- **[Validator Operations](/testnet/global-synchronizer/understand/introduction)** - Deploy your own validator
- **[Deployment Progression](/testnet/appdev/modules/m5-deployment-progression)** - Deploy applications across environments
<div className="todo">
