{/* source: canton / canton/3.4/sdk/tutorials/app-dev/external_signing_onboarding_multihosted.rst */}
...
It is a simple extension to the [onboard external party tutorial](external_signing_onboarding_lapi.mdx#tutorial-onboard-external-party-lapi).

## Prerequisites

Make sure that you have completed the [onboard external party tutorial](external_signing_onboarding_lapi.mdx#tutorial-onboard-external-party-lapi)
