...
Aim for high coverage on all choices that will run in production. See the [testing guide](/devnet/appdev/modules/m3-testing) for a detailed walkthrough.

## Related Pages

- [Testing Daml Contracts](/devnet/appdev/modules/m3-testing) -- Full testing tutorial with examples
- [Sandbox](/devnet/sdks-tools/development-tools/sandbox) -- Integration testing beyond Daml Script
- [dpm command reference](/devnet/sdks-tools/cli-tools/dpm) -- `dpm test` options and flags

{/* COPIED_START source="docs-website:docs/replicated/daml/3.5/sdk/tutorials/smart-contracts/daml-scripts.rst" hash="aaa6a370" */}

<Warning title="Pre-reviewed Content - Do Not Modify">
This section was copied from existing reviewed documentation.
**Source:** `docs-website:docs/replicated/daml/3.5/sdk/tutorials/smart-contracts/daml-scripts.rst`
...
<figure>
<img src="./images/daml-scripts/scenario_results1.png" alt="images/daml-scripts/scenario_results1.png" />
</figure>
...
<figure>
<img src="./images/daml-scripts/tabular_view1.png" alt="images/daml-scripts/tabular_view1.png" />
</figure>
...
<figure>
<img src="./images/daml-scripts/failure.png" alt="images/daml-scripts/failure.png" />
</figure>
...
<figure>
<img src="./images/daml-scripts/failuretable.png" alt="images/daml-scripts/failuretable.png" />
</figure>
...
Contracts are also archived whenever a [consuming choice](/devnet/overview/reference/ledger-model-detailed#choices-in-the-ledger-model) is exercised.
...
<figure>
<img src="./images/daml-scripts/archived.png" alt="images/daml-scripts/archived.png" />
</figure>
...
<figure>
<img src="./images/daml-scripts/tx_graph.png" alt="images/daml-scripts/tx_graph.png" />
</figure>
