```shell
  @ participant1.health.ping(participant2)
      res10: Duration = 3107 milliseconds

  @ participant2.health.ping(participant3)
      res11: Duration = 1628 milliseconds
        ...
        trafficStatesOrErrors = Map(
          PAR::participant1::12201ff69b1d... -> Right(
            value = TrafficState(
              ...
              lastConsumedCost = 0,
              timestamp = 2026-02-14T22:55:45.787621Z,
              serial = 2,
          ...
          PAR::participant3::1220d6908163... -> Right(
            value = TrafficState(
              extraTrafficLimit = 0,
              extraTrafficConsumed = 0,
              baseTrafficRemainder = 16325,
              lastConsumedCost = 0,
              timestamp = 2026-02-14T22:55:45.787621Z,
              availableTraffic = 16325
            )
          ),
          PAR::participant2::1220a4d7463b... -> Right(
            value = TrafficState(
              extraTrafficLimit = 0,
              extraTrafficConsumed = 0,
              baseTrafficRemainder = 15448,
              lastConsumedCost = 0,
              timestamp = 2026-02-14T22:55:45.787621Z,
              availableTraffic = 15448
            )
          )
        )
      )
