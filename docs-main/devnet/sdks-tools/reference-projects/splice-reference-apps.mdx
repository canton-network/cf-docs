...
- [cn-quickstart](/devnet/sdks-tools/reference-projects/cn-quickstart) -- Full-stack example application that runs on Splice infrastructure
- [Canton Coin](/devnet/overview/understand/canton-coin) -- Overview of Canton Coin and its role in the network
- [Global Synchronizer](/devnet/overview/understand/global-synchronizer) -- How the synchronizer infrastructure works
- [Integrations](/devnet/integrations/overview) -- Wallet and exchange integration patterns
