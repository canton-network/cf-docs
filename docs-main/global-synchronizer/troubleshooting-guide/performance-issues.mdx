...
description: "Resolving slow transactions, resource exhaustion, and database bottlenecks"
---

import CantonGlobalSynchronizerTroubleshootingGuidePerformanceIssuesL151 from "/snippets/canton-docs/global-synchronizer_troubleshooting-guide_performance-issues_L151.mdx";
import CantonGlobalSynchronizerTroubleshootingGuidePerformanceIssuesL16 from "/snippets/canton-docs/global-synchronizer_troubleshooting-guide_performance-issues_L16.mdx";
...
<CantonGlobalSynchronizerTroubleshootingGuidePerformanceIssuesL16 />

If `extraTrafficRemainder` is near zero, top up immediately and enable auto-top-up to prevent recurrence.
...
- **Missing indexes.** After a major upgrade, run `ANALYZE` on the participant database to update query planner statistics.
...
<CantonGlobalSynchronizerTroubleshootingGuidePerformanceIssuesL151 />
