...
<Card title="Configuration" icon="gear" href="/devnet/global-synchronizer/deployment/configuration">
  Review configuration options for your upgraded node.
</Card>

<Card title="Super Validator Setup" icon="server" href="/devnet/global-synchronizer/deployment/super-validator-setup">
