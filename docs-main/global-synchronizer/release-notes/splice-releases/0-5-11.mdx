---
title: "0.5.11"
description: "Splice 0.5.11 release notes."
---

{/* GENERATED_RELEASE_NOTES target="splice" format="split-release" version="0.5.11" source="bceda3ba526cef70abc0a4d197b250272f6ad4f0" */}
...
- SV app
  ...
  - Add a new config parameter to control whether the SV app should enable free confirmation responses
    ...
    [CIP-104 - Traffic-Based App Rewards](https://github.com/canton-foundation/cips/blob/main/cip-0104/cip-0104.md#incremental-roll-out).
