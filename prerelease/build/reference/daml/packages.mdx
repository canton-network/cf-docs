<!-- source: daml / daml/3.5/sdk/reference/daml/packages.rst -->
...
Refer to the [section on decoding DARs and DALF files](../../component-howtos/development-tooling-authors/how-to-parse-daml-archive-files.md#inspecting-dars).
