...
The topology transaction hash needs to be signed externally following the [documentation for external signing](/appdev/deep-dives/external-signing-topology).
