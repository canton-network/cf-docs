...
Upstream docs: [Open](<https://javadoc.io/doc/com.daml/bindings-java/3.5.7/com/daml/ledger/api/v2/admin/UserManagementServiceGrpc.UserManagementServiceImplBase.html>)
...
| --- | --- | --- | --- | --- |
| [Open](<https://javadoc.io/doc/com.daml/bindings-java/3.5.7/com/daml/ledger/api/v2/admin/UserManagementServiceGrpc.UserManagementServiceImplBase.html#%3Cinit%3E%28%29>) | `UserManagementServiceImplBase()` | `3.5.7` | - | - |
| [Open](<https://javadoc.io/doc/com.daml/bindings-java/3.5.7/com/daml/ledger/api/v2/admin/UserManagementServiceGrpc.UserManagementServiceImplBase.html#bindService%28%29>) | `bindService()` | `3.5.7` | - | - |
