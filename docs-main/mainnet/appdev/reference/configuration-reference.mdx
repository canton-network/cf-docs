...
For multi-package project configuration, see [Building and Packaging](/mainnet/appdev/modules/m3-building-packaging) which covers `multi-package.yaml` structure and dependency resolution.

### DPM Environment Variables

For DPM environment variable details, see [Building and Packaging](/mainnet/appdev/modules/m3-building-packaging).
