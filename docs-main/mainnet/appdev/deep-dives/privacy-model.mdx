...
- [Privacy Model Explained](/mainnet/overview/learn/privacy-model) -- Technical overview of sub-transaction privacy at the protocol level
- [Privacy Differences from Ethereum](/mainnet/appdev/modules/m2-privacy-differences) -- How Canton's model compares to public blockchains
- [Design Patterns](/mainnet/appdev/modules/m3-design-patterns) -- Patterns for authorization and multi-party workflows
