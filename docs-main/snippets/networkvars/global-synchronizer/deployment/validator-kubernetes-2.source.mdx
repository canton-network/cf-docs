...
<Snippet
  ...
  startAfter="SCAN_CLIENT_CONFIGURATION_START"
  endBefore="SCAN_CLIENT_CONFIGURATION_END"
  normalize="baseline"
  language="yaml"
/>
...
<Snippet
  source="https://github.com/canton-network/splice/blob/4c670142843c198ed93f106824d8e33d9dec5c8c/apps/app/src/pack/examples/sv-helm/standalone-validator-values.yaml"
  startAfter="SYNCHRONIZER_CONFIGURATION_START"
  endBefore="SYNCHRONIZER_CONFIGURATION_END"
  normalize="baseline"
  language="yaml"
/>
