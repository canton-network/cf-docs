{/* source: splice-wallet-kernel / splice-wallet-kernel/devnet/src/traffic/index.rst */}

# Traffic

Below is a high-level summary of the [Sycnrhonizer Traffic Fees page](https://docs.sync.global/deployment/traffic.html) in the Splice Validator documentation.
