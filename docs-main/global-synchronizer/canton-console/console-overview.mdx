...
- [Essential Commands](/docs-main/global-synchronizer/canton-console/essential-commands) — Key commands for health checks, party and package management
- [Debugging Workflows](/docs-main/global-synchronizer/canton-console/debugging-workflows) — Step-by-step diagnostic procedures
