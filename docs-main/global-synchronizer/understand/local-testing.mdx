...
1.  Download the release artifacts from the [Download Bundle](https://github.com/digital-asset/decentralized-canton-sync/releases/download/v0.6.3/0.6.3_splice-node.tar.gz) link, and extract the bundle:
...
- [Canton Console How-To](https://docs.digitalasset.com/operate/3.4/howtos/operate/console/console.html?)
- [Canton Console commands](https://docs.digitalasset.com/operate/3.4/reference/console.html)
