...
<Note>
For detailed upgrade procedures, see the [Upgrade Procedures](/testnet/global-synchronizer/production-operations/upgrade-procedures) page.
</Note>
...
- [Environment Configuration](/testnet/appdev/modules/m5-environment-configuration) — DPM configuration for each environment
- [CI/CD Integration](/testnet/appdev/modules/m5-ci-cd-integration) — Automating the promotion pipeline
