...
For Prometheus metrics endpoints, scraping configuration, and Grafana dashboards, see [Monitoring Setup](/testnet/global-synchronizer/production-operations/monitoring-setup).
