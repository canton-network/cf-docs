{/* source: quickstart / quickstart/3.4/sdk/quickstart/configure/project-structure-overview.rst */}

<a id="quickstart-project-structure-guide"></a>
...
Work through the [Explore the Canton Network Application Quickstart demo](../operate/explore-the-demo.mdx#quickstart-explore-the-demo) guide for the complete workflow walkthrough.
...
Review the [Canton Utility Setup](https://docs.digitalasset.com/utilities/devnet/setup/index.html#canton-utility-setup) if you require utility deployment support.
...
See [Using the JSON Ledger API](../operate/json-api.mdx#quickstart-json-ledger-api) for detailed port usage and authentication patterns.
...
See [Debugging and troubleshooting with lnav](../operate/lnav-in-cn.mdx#quickstart-debugging-and-troubleshooting-lnav) for log analysis techniques.
