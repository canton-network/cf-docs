...
- [Canton Coin and Traffic](/testnet/appdev/modules/m4-canton-coin) -- How traffic credits and CC work for application developers
- [Getting Your App Featured](/testnet/overview/understand/getting-app-featured) -- Promotional opportunities on Canton Network
- [Canton Coin overview](/testnet/overview/understand/canton-coin) -- Tokenomics, validator rewards, and governance
