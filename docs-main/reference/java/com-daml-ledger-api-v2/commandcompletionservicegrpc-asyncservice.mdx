...
Upstream docs: [Open](<https://javadoc.io/doc/com.daml/bindings-java/3.5.6/com/daml/ledger/api/v2/CommandCompletionServiceGrpc.AsyncService.html>)
...
| --- | --- | --- | --- | --- |
| [Open](<https://javadoc.io/doc/com.daml/bindings-java/3.5.6/com/daml/ledger/api/v2/CommandCompletionServiceGrpc.AsyncService.html#completionStream%28com.daml.ledger.api.v2.CommandCompletionServiceOuterClass.CompletionStreamRequest,io.grpc.stub.StreamObserver%29>) | `completionStream(CommandCompletionServiceOuterClass.CompletionStreamRequest, StreamObserver<CommandCompletionServiceOuterClass.CompletionStreamResponse>)` | `3.5.6` | - | - |
