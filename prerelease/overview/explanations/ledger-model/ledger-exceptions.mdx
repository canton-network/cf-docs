<!-- source: daml / daml/3.5/overview/explanations/ledger-model/ledger-exceptions.rst -->
...
In the previous section on [consistency](ledger-integrity.md#da-model-consistency),
...
[the old definition](ledger-integrity.md#da-ledgers-authorization-rules).
