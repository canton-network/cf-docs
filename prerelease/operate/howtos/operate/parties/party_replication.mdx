<!-- source: canton / canton/3.5/participant/howtos/operate/parties/party_replication.rst -->
...
@ target.dars.upload("dars/CantonExamples.dar")
    res7: String = "69f6fc47c97947ec96f28e5a9c6cd368fd79d45e2e27298556073ef8809d5a2b"
```
...
@ val flagStatus = target.parties
    ...
    flagStatus : PartyOnboardingFlagStatus = FlagSet(earliest safe time to clear the flag = 2026-01-10T22:42:08.291431Z)
```
