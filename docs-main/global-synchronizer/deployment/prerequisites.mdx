...
<Card title="Onboarding Process" icon="user-plus" href="/global-synchronizer/deployment/onboarding-process">
  Get onboarded with an SV sponsor.
</Card>

<Card title="Installation" icon="download" href="/global-synchronizer/deployment/deployment-options">
