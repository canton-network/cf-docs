...
When a Daml project is compiled, it produces a [DAR](../../reference/glossary.md#glos-dar-file)
...
More information on the exact structure of the zip file is [available in the explanation on Daml packages and archive files](../../explanations/daml-packages-and-archive-files.md#structure-of-an-archive-file).
