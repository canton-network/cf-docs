---
title: "GET /v0/ans-entries/by-party/:party"
...
sidebarTitle: "/v0/ans-entries/by-party/:party"
---
...
<div class="x2mdx-ref-hero">
  ...
  <p class="x2mdx-ref-summary">If present, the first ANS entry for user `party` according to `name` lexicographic order.</p>
