...
**Network fees** are paid in Canton Coin (CC) for transaction traffic. The amount depends on your transaction volume. Validators earn rewards that can offset these costs. Check the current reward rates on the [Global Synchronizer Foundation](https://sync.global/) website.
