...
description: "Get a complete Canton Network application running locally with the cn-quickstart project"
---
...
- **Observability tooling** with Grafana dashboards and log aggregation

## Pages in this section

<CardGroup cols={2}>
  <Card title="Prerequisites and Installation" icon="download" href="/docs-main/appdev/quickstart/prerequisites">
    System requirements, dependencies, and step-by-step installation
  </Card>
  <Card title="Project Structure" icon="folder-tree" href="/docs-main/appdev/quickstart/project-structure">
    How the QuickStart project is organized and what each component does
  </Card>
  <Card title="Running the Demo" icon="play" href="/docs-main/appdev/quickstart/running-the-demo">
