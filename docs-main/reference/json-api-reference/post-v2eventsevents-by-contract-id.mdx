---
title: "Get the create and the consuming exercise event for the contract with the provided ID"
...
<div class="x2mdx-ref-hero">
  ...
  <h1 class="x2mdx-ref-title">Get the create and the consuming exercise event for the contract with the provided ID</h1>
...
<div class="x2mdx-ref-meta-grid">
  ...
  <div class="x2mdx-ref-meta-item">
    ...
    <span class="x2mdx-ref-meta-value">postV2EventsEvents-by-contract-id</span>
  </div>
...
curl --request POST \
  ...
  --data '{"contractId":"string","eventFormat":{"filtersByParty":{},"filtersForAnyParty":{},"verbose":false}}'
```
