...
This page covers the metrics that matter most for operational health of your validator or SV node. For the complete metrics catalog, see the [Metrics Reference](/devnet/global-synchronizer/reference/metrics-reference).
...
- [Monitoring Setup](/devnet/global-synchronizer/production-operations/monitoring-setup) — Configuring Prometheus and Grafana
