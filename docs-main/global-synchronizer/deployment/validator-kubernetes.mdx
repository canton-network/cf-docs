...
{/* snippet-source: https://github.com/canton-network/splice/blob/4c670142843c198ed93f106824d8e33d9dec5c8c/apps/app/src/pack/examples/sv-helm/standalone-validator-values.yaml; authored-at: docs-main/global-synchronizer/deployment/validator-kubernetes.source.mdx:1142 */}
```yaml
...
{/* snippet-source: https://github.com/canton-network/splice/blob/4c670142843c198ed93f106824d8e33d9dec5c8c/apps/app/src/pack/examples/sv-helm/validator-values.yaml; authored-at: docs-main/global-synchronizer/deployment/validator-kubernetes.source.mdx:1164 */}
```yaml
...
{/* snippet-source: https://github.com/canton-network/splice/blob/4c670142843c198ed93f106824d8e33d9dec5c8c/apps/app/src/pack/examples/sv-helm/validator-values.yaml; authored-at: docs-main/global-synchronizer/deployment/validator-kubernetes.source.mdx:1174 */}
```yaml
...
{/* snippet-source: https://github.com/canton-network/splice/blob/4c670142843c198ed93f106824d8e33d9dec5c8c/apps/app/src/pack/examples/sv-helm/validator-values.yaml; authored-at: docs-main/global-synchronizer/deployment/validator-kubernetes.source.mdx:1202 */}
```yaml
