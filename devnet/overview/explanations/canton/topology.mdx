...
controlling key(see [Decentralization](decentralization.md#decentralization)).
...
parties (see [Local and external parties](external-party.md#overview-canton-external-parties)). Canton key holders use the keys listed in
these topology mappings for various use cases across the layers of Canton’s
communication protocols (see [Protocols on One Synchronizer](protocol.md#protocols)) except for topology management.
...
commit](protocol.md#protocol-two-phase-commit) protocol for the party’s transactions and
...
* **Confirmation**: the Participant Node confirms or rejects Daml Transactions
  as part of the [two-phase commit](protocol.md#protocol-two-phase-commit) protocol.
...
Nodes (see [Decentralized parties](decentralization.md#decentralized-parties)).
...
The various layers of Canton’s protocol (see [Protocols on One Synchronizer](protocol.md#protocols)) rely on topology
...
[two-phase commit protocol](protocol.md#protocol-two-phase-commit) for Daml
