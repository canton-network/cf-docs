<!-- source: daml / daml/3.5/overview/reference/compatibility.rst -->
...
Major Ledger API versions behave like stable features in [Status Definitions](status-definitions.md). They are supported from the time they are first released as “stable” to the point where they are removed from Integration Components and Daml following a 12 month deprecation cycle. The earliest point a major Ledger API version can be deprecated is with the release of the next major version. The earliest it can be removed is 12 months later with a major version release of the Integration Components.
