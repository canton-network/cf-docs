...
import CantonGlobalSynchronizerFaqL155 from "/snippets/canton-docs/global-synchronizer_faq_L155.mdx";
import CantonGlobalSynchronizerFaqL174 from "/snippets/canton-docs/global-synchronizer_faq_L174.mdx";
import CantonGlobalSynchronizerFaqL374 from "/snippets/canton-docs/global-synchronizer_faq_L374.mdx";
import CantonGlobalSynchronizerFaqL471 from "/snippets/canton-docs/global-synchronizer_faq_L471.mdx";
import CantonGlobalSynchronizerFaqL530 from "/snippets/canton-docs/global-synchronizer_faq_L530.mdx";
import CantonGlobalSynchronizerFaqL572 from "/snippets/canton-docs/global-synchronizer_faq_L572.mdx";
import CantonGlobalSynchronizerFaqL798 from "/snippets/canton-docs/global-synchronizer_faq_L798.mdx";
...
**Monitor progress:**
<CantonGlobalSynchronizerFaqL155 />
...
**Via Canton Console:**
<CantonGlobalSynchronizerFaqL174 />
...
4. **Use Canton Console** for deeper investigation:
   <CantonGlobalSynchronizerFaqL374 />
</Accordion>
...
**Export node ID dump:**
<CantonGlobalSynchronizerFaqL471 />
...
3. **Node ID dump**
   <CantonGlobalSynchronizerFaqL530 />
...
4. **Tune connection pools:**
   <CantonGlobalSynchronizerFaqL572 />
...
1. **Official Documentation:**
   - [What is Canton?](/overview/understand/what-is-canton)
   - [Operator Documentation](/global-synchronizer)
...
| **Forum** | [forum.canton.network](https://forum.canton.network/) | Community |
...
**Via Canton Console:**
<CantonGlobalSynchronizerFaqL798 />
</Accordion>
