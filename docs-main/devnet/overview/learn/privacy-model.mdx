...
- **[The Global Synchronizer](/devnet/overview/understand/global-synchronizer)** - Understand the public network infrastructure
- **[Developer Track Module 3: Daml Development](/devnet/appdev/modules/m3-dev-environment)** - Apply privacy patterns in code
- **[Glossary](/devnet/overview/understand/glossary)** - Terminology reference including privacy-related terms
