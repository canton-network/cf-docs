{/* source: canton / canton/3.4/participant/howtos/operate/ha/ha.rst */}
...
<Note>Starting from Canton 2.4.0, participant replication is enabled by default when using supported storage.</Note>
...
This is possible with [HAProxy](http://www.haproxy.org/) using the following example configuration:
