...
See [Configure the Wallet Gateway](/integrations/wallet-gateway/guides/configure) for every option, and
[Networks & identity providers](/integrations/wallet-gateway/guides/networks-and-identity) to
...
<CardGroup cols={2}>
  <Card title="Configure the Wallet Gateway" href="/integrations/wallet-gateway/guides/configure">
    All configuration options for kernel, server, and store.
  </Card>
  <Card title="Networks & identity providers" href="/integrations/wallet-gateway/guides/networks-and-identity">
    Connect to a validator and set up authentication.
  </Card>
  <Card title="Manage wallets" href="/integrations/wallet-gateway/guides/manage-wallets">
    Create and manage wallets through the User UI or User API.
  </Card>
  <Card title="Deploy" href="/integrations/wallet-gateway/operate/deploy">
