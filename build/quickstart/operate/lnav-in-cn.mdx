{/* source: quickstart / quickstart/3.4/sdk/quickstart/operate/lnav-in-cn.rst */}

<a id="quickstart-debugging-and-troubleshooting-lnav"></a>
...
>   * [lnav download & documentation](#lnav-download-documentation)
>   * [Install Canton lnav format](#install-canton-lnav-format)
> * [Capture Quickstart logs](#capture-quickstart-logs)
> * [Find the logs](#find-the-logs)
> * [Canton logs](#canton-logs)
> * [Navigating events](#navigating-events)
>   * [Search for an event](#search-for-an-event)
>   * [Filter an event](#filter-an-event)
>   * [Clear filter-in results](#clear-filter-in-results)
>   * [Generate events for analysis](#generate-events-for-analysis)
>   * [Quick workflow summary](#quick-workflow-summary)
> * [Search by Trace ID](#search-by-trace-id)
>   * [Find a Trace ID](#find-a-trace-id)
>   * [Filter by Trace ID](#filter-by-trace-id)
> * [Power Use of lnav](#power-use-of-lnav)
> * [Further exploration of lnav clogs](#further-exploration-of-lnav-clogs)
> * [Mark and copy lines](#mark-and-copy-lines)
> * [Find errors, warnings, and trace IDs](#find-errors-warnings-and-trace-ids)
> * [Time](#time)
...
>   * [Gathering logs contents into a directory](#gathering-logs-contents-into-a-directory)
>   * [Common lnav shortcuts](#common-lnav-shortcuts)
...
![lnav version](quickstart/operate/images/lnav-version.png)

If you’re unfamiliar with lnav, read [their docs](https://docs.lnav.org/en/v0.13.1/).
...
![Splice lnav format](quickstart/operate/images/lnav-hyperledger-labs.png)
...
![Capture logs](quickstart/operate/images/lnav-make-capture-logs.png)
...
![List logs](quickstart/operate/images/lnav-ls-logs.png)
...
![lnav app install request event](quickstart/operate/images/lnav-app-install-request-event.png)
...
![lnav filter-in app install request](quickstart/operate/images/lnav-filter-in-app-install-request.png)
...
For detailed step-by-step instructions with screenshots, see [Explore the Canton Network Application Quickstart demo](explore-the-demo.mdx#quickstart-explore-the-demo).

## Search by Trace ID

The logs include an [OpenTelemetry trace](https://opentelemetry.io/docs/concepts/signals/traces/) identifier (trace-id) for analysis purposes.
...
![trace id filtering](quickstart/operate/images/lnav-filter-in-listlicenses.png)

Select and copy the Trace ID of any entry.

For example, “835a02159672310b58c2b106b482654d”

<Warning>Your trace ID will be unique. Copying this example will result in 0 results.</Warning>
...
![lnav trace id](quickstart/operate/images/lnav-trace-id.png)
...
![lnav file origin](quickstart/operate/images/lnav-view-log-origination.png)

Use the right cursor key to view the log entry.

![lnav log entry](quickstart/operate/images/lnav-view-log-entry.png)
...
![expand collapse lnav metadata](quickstart/operate/images/lnav-collapse-expand-metadata.png)
...
![lnav time toggle](quickstart/operate/images/lnav-time-toggle.png)
...
Read the `lnav` documentation for a full list of [available commands](https://docs.lnav.org/en/latest/commands.html#commands).
...
![lnav prune logs](quickstart/operate/images/lnav-prune-logs.png)

## Troubleshooting

If `lnav` crashes it may also force quit the capture logs script and delete all of the files in the `logs/` directory.

![lnav troubleshooting](quickstart/operate/images/lnav-troubleshooting.png)
