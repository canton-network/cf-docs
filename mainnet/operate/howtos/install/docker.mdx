...
This image requires you to initialize the participant via a bootstrap script. See [Manual identity initialization](../operate/identity/manual_identity_init.md#setup-manual-identity) for more details.
