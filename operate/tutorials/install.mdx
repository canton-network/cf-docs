...
<Note>
Please also consult the more [detailed section on storage configurations](../howtos/configure/storage/storage.mdx#storage-config).
</Note>
...
<Note>
By default, the node will initialize itself automatically using the identity commands [Topology Administration](../reference/console.mdx#identity-commands).
