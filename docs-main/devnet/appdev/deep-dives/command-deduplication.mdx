...
description: "How Daml command deduplication works and how applications can use it to achieve exactly-once ledger changes."
---

{/* COPIED_START source="docs-website:docs/replicated/daml/3.5/sdk/sdlc-howtos/applications/develop/command-deduplication.rst" hash="1579db0f" */}

<Warning title="Pre-reviewed Content - Do Not Modify">
This section was copied from existing reviewed documentation.
**Source:** `docs-website:docs/replicated/daml/3.5/sdk/sdlc-howtos/applications/develop/command-deduplication.rst`
