---
title: "POST /registry/transfer-instruction/v2/transfer-factory"
description: "Get the factory and choice context for initiating a transfer workflow."
api: "POST https://example.com/registry/transfer-instruction/v2/transfer-factory"
...
<div class="x2mdx-ref-hero">
  ...
  <p class="x2mdx-ref-summary">Get the factory and choice context for initiating a transfer workflow.</p>
...
const response = await fetch('https://example.com/registry/transfer-instruction/v2/transfer-factory', {
  method: 'POST',
  headers: {
...
curl_setopt_array($curl, [
    CURLOPT_URL => 'https://example.com/registry/transfer-instruction/v2/transfer-factory',
...
func main() {
  req, _ := http.NewRequest("POST", "https://example.com/registry/transfer-instruction/v2/transfer-factory", bytes.NewBufferString(`{
  "choiceArguments": {},
  "excludeDebugFields": false
}`))
...
var request = HttpRequest.newBuilder()
    .uri(URI.create("https://example.com/registry/transfer-instruction/v2/transfer-factory"))
    .header("Content-Type", "application/json")
...
uri = URI('https://example.com/registry/transfer-instruction/v2/transfer-factory')
