...
- [Two-Layer Consensus](/devnet/overview/learn/two-layer-consensus) — how the consensus layers interact
- [Architecture Overview](/devnet/overview/learn/architecture) — component responsibilities
- [Privacy Model](/devnet/overview/learn/privacy-model) — what each party can see
