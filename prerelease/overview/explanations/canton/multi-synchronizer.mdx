<!-- source: canton / canton/3.5/overview/explanations/canton/multi-synchronizer.rst -->
...
Participant Nodes execute Daml transactions using a Synchronizer [Synchronizer](synchronizers.md#synchronizer-architecture), which can be either
...
* **Unassignment**
  ...
  The unassignment goes though the same phases as the [transaction protocol](protocol.md#protocols).
* **Assignment**
  ...
  The assignment goes though the same phases as the [transaction protocol](protocol.md#protocols).
...
* In the [running example](#multi-synchronizer-running-example), Alice loses the ability to exercise
  ...
  choices on the Iou.
* [Decentralized parties](decentralization.md#decentralized-parties) cannot submit Daml transactions but should be able to submit
