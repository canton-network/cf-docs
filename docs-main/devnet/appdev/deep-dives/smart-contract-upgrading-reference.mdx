---
title: "Smart Contract Upgrading Reference"
description: "Detailed rules for package validation on upload, and runtime upgrade and downgrade of contracts, choice arguments, and results."
---

{/* COPIED_START source="docs-website:docs/replicated/daml/3.5/sdk/reference/smart-contract-upgrades.rst" hash="9f2fcd76" */}

<Warning title="Pre-reviewed Content - Do Not Modify">
This section was copied from existing reviewed documentation.
**Source:** `docs/replicated/daml/3.5/sdk/reference/smart-contract-upgrades.rst`
