...
- **dpm** -- See [dpm installation](/devnet/sdks-tools/cli-tools/dpm) for setup instructions
...
For a full introduction to the Daml language, see [Module 3: Daml Smart Contracts](/devnet/appdev/modules/m3-dev-environment).
...
- [dpm command reference](/devnet/sdks-tools/cli-tools/dpm) -- Full list of `dpm` commands and options
- [Daml Studio](/devnet/sdks-tools/development-tools/daml-studio) -- VS Code extension for Daml development
- [Sandbox](/devnet/sdks-tools/development-tools/sandbox) -- Local single-node testing environment
