...
as described in the [Visualizing a transaction section](../finding-and-reading-data/index.md#visualizing-a-transaction).
...
1. continuously monitor holdings changes using [token standard history parser](../token-standard/index.md#list-holding-transactions).
