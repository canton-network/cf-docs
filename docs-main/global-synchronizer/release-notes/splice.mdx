  ...
  - Summary of Breaking Changes:
    ...
    - Breaking API Changes:
      ...
      - Scan App will no longer return featured app rights as part of the choice context for CC transfers and allocations.
        We expect the SVs to vote on enabling this as part of the breaking config changes slot for this release.
    ...
    - Protocol Changes:
      ...
      - (*) The protocol version remains 35, but the ordering layer is switched from CometBFT to CantonBFT which requires an LSU.
        Final confirmation that this will indeed be rolled out on this release will be announced soon.

    - Daml Model Changes:

      - Add Daml support for delaying minting of development fund coupons and blacklisting development fund managers.
        We expect the SVs to vote on enabling this as part of the breaking config changes slot for this release.
  ...
  - Daml
    ...
    - Implement all Token Standard V2 APIs for Amulet, which adds the following new features to Amulet:
      ...
      - Greatly simplify the parsing of Amulet transaction history for wallets
        ...
        [V2.EventLog_HoldingsChange](#type-splice-api-token-transfereventsv2-eventlogholdingschange-79855) events.
