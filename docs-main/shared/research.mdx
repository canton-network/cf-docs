...
description: "Research publications explaining Daml, Canton, and their underlying theory"
---

{/* COPIED_START source="docs-website:docs/replicated/canton/3.5/overview/reference/research.rst" hash="85f542c1" */}

Daml, Canton, and their underlying theory are described in the following research publications:

- [Daml: A Smart Contract Language for Securely Automating Real-World Multi-Party Business Workflows](https://arxiv.org/abs/2303.03749)
  ...
  *Daml: A Smart Contract Language for Securely Automating Real-World Multi-Party Business Workflows.*
  In: [arXiv:2303.03749](https://arxiv.org/abs/2303.03749), 2023.
  ...
  **Abstract:**
  ...
  1. Include simple means for specifying policies for access and authorization.
  1. Support the composition of simple workflows into complex ones, even when the simple workflows have already been deployed.
...
- [A Structured Semantic Domain for Smart Contracts](https://www.canton.io/publications/csf2019-abstract.pdf)
  describes how Canton relates to [Daml](https://www.daml.com) and the [ledger model](/overview/reference/ledger-model-detailed).

  Extended abstract presented at [Computer Security Foundations 2019](https://web.stevens.edu/csf2019/index.html).

- [Authenticated Data Structures As Functors in Isabelle/HOL](https://www.canton.io/publications/fmbc2020.pdf)
  ...
  - Andreas Lochbihler and Ognjen Maric.
    *Authenticated Data Structures As Functors in Isabelle/HOL.*
    In: Bruno Bernardo and Diego Marmsoler (eds.) [Formal Methods for Blockchain](https://fmbc.gitlab.io/2020/) 2020.
    OASIcs vol. 84, 6:1-6:15, 2020.
  - [DOI](https://doi.org/10.4230/OASIcs.FMBC.2020.6)
  - [Preprint PDF](https://www.canton.io/publications/fmbc2020.pdf)
  - [Pre-recorded talk](https://www.youtube.com/watch?v=A9Q4G_pCSj4)
  - [Live presentation (1:48 to 12:50)](https://www.youtube.com/watch?v=mTM5D6MeBRw)

  A [longer version](https://www.canton.io/publications/iw2020.pdf) was presented at the [Isabelle Workshop 2020](https://sketis.net/isabelle/isabelle-workshop-2020) ([recording](https://www.youtube.com/watch?v=GvSnSL8eSEw)).
  The [Isabelle theories](https://www.isa-afp.org/entries/ADS_Functor.html) are available in the Archive of Formal Proofs.
...
- [A semantic domain for privacy-aware smart contracts and interoperable sharded ledgers](https://www.canton.io/publications/cpp2021-slides.pdf)

  [Lightning talk](https://popl21.sigplan.org/details/CPP-2021-certified-programs-and-proofs-lightning-talks/6/A-semantic-domain-for-privacy-aware-smart-contracts-and-interoperable-sharded-ledgers) presented at [Certified Proofs and Programs 2021](https://popl21.sigplan.org/home/CPP-2021).
  ...
  **Abstract:**
  ...
  1. The synchronization due to vector clocks cannot cause deadlocks.
