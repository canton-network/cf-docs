{/* source: daml / daml/3.4/sdk/reference/daml/file-structure.rst */}
{/* Copyright (c) 2023 Digital Asset (Switzerland) GmbH and/or its affiliates. All rights reserved. */}
{/* SPDX-License-Identifier: Apache-2.0 */}

# Reference: Daml File Structure

This page gives reference information on the structure of Daml files outside of [templates](templates.mdx).
...
<a id="daml-ref-contract-identifiers"></a>
