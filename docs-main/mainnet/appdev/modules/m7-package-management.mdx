...
- Communicate upgrade timelines (see [Upgrade Deployment](/mainnet/appdev/modules/m6-deployment))
...
- [Security Best Practices](/mainnet/appdev/modules/m7-security) — Securing your packages and deployment pipeline
