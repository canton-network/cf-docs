...
- [Testing Strategies](/devnet/appdev/modules/m5-testing-strategies) — Testing pyramid and approaches for Canton applications
- [Deployment Progression](/devnet/appdev/modules/m5-deployment-progression) — Moving from LocalNet to DevNet, TestNet, and MainNet
