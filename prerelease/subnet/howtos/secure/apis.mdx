<!-- source: canton / canton/3.5/synchronizer/howtos/secure/apis.rst -->
...
this if the namespace root key fingerprint included is not permissioned  (see [Bootstrap a permissioned Synchronizer](../operate/bootstrap.md#permissioned-synchronizer)) or if the
