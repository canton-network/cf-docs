...
- **Operational overhead** — Running a dedicated synchronizer means operating sequencer and mediator infrastructure in addition to your validator. See the [deployment guide](/global-synchronizer/extension-synchronizers/deployment) for what this involves.
