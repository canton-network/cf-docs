...
<Danger>the topology controller is deprecated so the below section for **my-grpc-admin-api** is not needed anymore.</Danger>
...
<Danger>The value for some of the audiences in localnet would have to be adjusted to match “[https://canton.network.global](https://canton.network.global)”.
This is specifically the LEDGER_API_AUTH_AUDIENCE & VALIDATOR_AUTH_AUDIENCE.</Danger>
