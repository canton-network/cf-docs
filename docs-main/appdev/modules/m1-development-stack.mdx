...
**Install:** See the [Daml Studio installation guide](https://docs.digitalasset.com/build/3.4/component-howtos/smart-contracts/daml-studio.html#install) for setup instructions.
