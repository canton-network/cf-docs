...
- Generated at (UTC): `2026-03-31T19:25:46.434390+00:00`
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| [View](ledger-bindings-api-lifecycle/bindings-java) | `com.daml:bindings-java` | `java` | `3.4.8, 3.4.9, 3.4.10, 3.4.11` | `1453` | `2` | `2` | `1` |
| [View](ledger-bindings-api-lifecycle/bindings-scala-2-13) | `com.daml:bindings-scala_2.13` | `scala` | `2.10.0, 2.10.1, 2.10.2, 2.10.3` | `321` | `0` | `0` | `0` |
