...
You can self-feature your application on DevNet for testing purposes. Log into the Wallet UI as the validator operator user & Use the "Self-grant featured app rights" button in your Wallet UI to self-feature your party. This lets you verify that your markers are created correctly and that the SV automation converts them into reward coupons, without going through the formal review process.
