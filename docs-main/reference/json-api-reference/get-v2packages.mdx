...
<div class="x2mdx-ref-hero">
  ...
  <p class="x2mdx-ref-summary">Returns the identifiers of all supported packages.</p>
...
const response = await fetch('http://localhost:7575/v2/packages', {
  method: 'GET',
  headers: {
...
curl_setopt_array($curl, [
    CURLOPT_URL => 'http://localhost:7575/v2/packages',
...
func main() {
  req, _ := http.NewRequest("GET", "http://localhost:7575/v2/packages", nil)
...
var request = HttpRequest.newBuilder()
    .uri(URI.create("http://localhost:7575/v2/packages"))
    .header("Authorization", "Bearer <token>")
...
uri = URI('http://localhost:7575/v2/packages')
...
<div class="x2mdx-ref-history" aria-label="Reference history">
  ...
  <div class="x2mdx-ref-history-event x2mdx-ref-history-event--changed" id="history-updated-3-5">
    ...
    <p class="x2mdx-ref-history-event-detail">The GET /v2/packages operation was updated in this snapshot.</p>
