...
api: "GET http://localhost:7575/v2/state/connected-synchronizers"
authMethod: "bearer"
playground: "interactive"
sidebarTitle: "/v2/state/connected-synchronizers"
---
...
<div class="x2mdx-ref-hero">
  ...
  <p class="x2mdx-ref-summary">Get the list of connected synchronizers at the time of the query.</p>
...
<ParamField query="identityProviderId" type="string">
...
<ResponseField name="connectedSynchronizers" type="ConnectedSynchronizer[]">
...
<ResponseField name="synchronizerAlias" type="string" required>
...
Invalid value, Invalid value for: query parameter party, Invalid value for: query parameter participantId, Invalid value for: query parameter identityProviderId
...
<div class="x2mdx-ref-history" aria-label="Reference history">
  ...
  <div class="x2mdx-ref-history-event x2mdx-ref-history-event--changed" id="history-updated-3-5">
    ...
    <p class="x2mdx-ref-history-event-detail">The GET /v2/state/connected-synchronizers operation was updated in this snapshot.</p>
