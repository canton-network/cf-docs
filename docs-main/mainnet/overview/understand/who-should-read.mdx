...
<Card title="Application Developers" icon="code" href="/mainnet/appdev/get-started/choose-your-path">
...
<Card title="Ethereum/Web3 Developers" icon="ethereum" href="/mainnet/appdev/modules/m2-canton-for-ethereum-devs">
...
<Card title="Node Operators" icon="server" href="/mainnet/global-synchronizer/understand/introduction">
...
<Card title="Solution Architects" icon="diagram-project" href="/mainnet/overview/understand/five-minute-overview">
...
|--------------|------------|
| Understand what Canton is in 5 minutes | [Five-Minute Overview](/mainnet/overview/understand/five-minute-overview) |
| Learn why privacy matters for blockchain | [The Problem Canton Solves](/mainnet/overview/understand/the-problem) |
| See how Canton components work together | [Architecture Overview](/mainnet/overview/learn/architecture) |
| Write my first smart contract | [Module 3: Daml Smart Contracts](/mainnet/appdev/modules/m3-dev-environment) |
| Run the example application | [QuickStart](/mainnet/appdev/quickstart) |
| Deploy a validator node | [Validator Setup](/mainnet/global-synchronizer/understand/introduction) |
| Integrate a wallet into my app | [Integrations Overview](/mainnet/integrations/overview) |
...
<Card title="Support" icon="headset" href="/mainnet/shared/support-channels">
