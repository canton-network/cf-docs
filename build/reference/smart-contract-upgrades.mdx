...
[Smart Contract Upgrade](../sdlc-howtos/smart-contracts/upgrade/smart-contract-upgrades.mdx#smart-contract-upgrades). This document acts as a thorough reference.
...
<a id="upgrades-utility-package"></a>
...
non-[serializable](https://github.com/digital-asset/daml/blob/main/sdk/daml-lf/spec/daml-lf-2.rst#serializable-types)
...
1. The participant looks up versions *v_prev* and *v_next* of *p* in its package
   ...
   *p* smaller than *v*, and *v_next* is the smallest version of *p*
   ...
   ![image](reference/smart-contract-upgrades/images/upgrade-static-checks-order.svg)
...
| ```daml<br/>module M where<br/><br/>template T1<br/>  with<br/>    p : Party<br/>  where<br/>    signatory p<br/>```   | ```daml<br/>module M where<br/><br/>  template T1<br/>    with<br/>      p : Party<br/>    where<br/>      signatory p<br/><br/>  template T2<br/>    with<br/>      p : Party<br/>    where<br/>      signatory p<br/>```   |
|------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| ```daml<br/>template T<br/>    with<br/>      p : Party<br/>    where<br/>      signatory p<br/>```   | ```daml<br/>template T<br/>    with<br/>      p : Party<br/>      x1 : Optional Int<br/>    where<br/>      signatory p<br/>```   |
|-------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------|
...
| ```daml<br/>template T<br/>  with<br/>    p : Party<br/>  where<br/>    signatory p<br/>```   | ```daml<br/>template T<br/>  with<br/>    x1 : Optional Int<br/>    p : Party<br/>  where<br/>    signatory p<br/>```   |
|-----------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------|

Below, the template on the right is **not** a valid upgrade of the
template on the left because it drops parameter `x1`.

| ```daml<br/>template T<br/>  with<br/>    p : Party<br/>    x1 : Int<br/>  where<br/>    signatory p<br/>```   | ```daml<br/>template T<br/>  with<br/>    p : Party<br/>  where<br/>    signatory p<br/>```   |
|----------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------|
...
| ```daml<br/>template T<br/>  with<br/>    p : Party<br/>    x1 : Int<br/>  where<br/>    signatory p<br/>```   | ```daml<br/>template T<br/>  with<br/>    p : Party<br/>    x1 : Text<br/>  where<br/>    signatory p<br/>```   |
|----------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------|
...
| ```daml<br/>template T<br/>  with<br/>    p : Party<br/>  where<br/>    signatory p<br/>```   | ```daml<br/>template T<br/>  with<br/>    p : Party<br/>  where<br/>    signatory p<br/><br/>    choice C : ()<br/>      controller p<br/>      do<br/>        return ()<br/>```   |
|-----------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| ```daml<br/>choice C : ()<br/>  with<br/>    x1 : Int<br/>  controller p<br/>  do<br/>    return ()<br/>```   | ```daml<br/>choice C : ()<br/>  with<br/>    x1 : Int<br/>    x2 : Optional Text<br/>  controller p<br/>  do<br/>    return ()<br/>```   |
|---------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------|
...
| ```daml<br/>choice C : ()<br/>  with<br/>    x1 : Int<br/>  controller p<br/>  do<br/>    return ()<br/>```   | ```daml<br/>choice C : ()<br/>  with<br/>    x2 : Optional Text<br/>    x1 : Int<br/>  controller p<br/>  do<br/>    return ()<br/>```   |
|---------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------|
...
| ```daml<br/>choice C : ()<br/>  with<br/>    x1 : Int<br/>  controller p<br/>  do<br/>    return ()<br/>```   | ```daml<br/>choice C : ()<br/>  with<br/>  controller p<br/>  do<br/>    return ()<br/>```   |
|---------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------|
...
| ```daml<br/>choice C : ()<br/>  controller p<br/>  do<br/>    return ()<br/>```   | ```daml<br/>choice C : Int<br/>  controller p<br/>  do<br/>    return 1<br/>```   |
|-----------------------------------------------------------------------------------|-----------------------------------------------------------------------------------|
...
| ```daml<br/> module M where<br/><br/>data A = A<br/>```   | ```daml<br/>module M where<br/><br/>data A = A<br/>data B = B<br/>```   |
|-----------------------------------------------------------|-------------------------------------------------------------------------|
...
| ```daml<br/>module M where<br/><br/>data A = A<br/>  with<br/>    x : Int -> Int<br/>```   | ```daml<br/>module M where<br/><br/>data A = A<br/>  with<br/>```   |
|--------------------------------------------------------------------------------------------|---------------------------------------------------------------------|
...
| ```daml<br/>module M where<br/><br/>data A = A<br/>  with<br/>```   | ```daml<br/>module M where<br/><br/>data A = A | B<br/>```   |
|---------------------------------------------------------------------|--------------------------------------------------------------|

Below, the module on the right is **not** a valid upgrade of the module
on the left because it drops the serializable data type `A`.

| ```daml<br/>module M where<br/><br/>data A = A<br/>```   | ```daml<br/>module M where<br/>```   |
|----------------------------------------------------------|--------------------------------------|
...
| ```daml<br/>module M where<br/><br/>data A = A<br/>  with<br/>```   | ```daml<br/>module M where<br/><br/>data A = A<br/>  with<br/>    x : Optional (Int -> Int)<br/>```   |
|---------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------|
...
| ```daml<br/>data T = T with<br/>  x1 : Int<br/>```   | ```daml<br/>data T = T with<br/> x1 : Int<br/> x2 : Optional Text<br/>```   |
|------------------------------------------------------|-----------------------------------------------------------------------------|
...
| ```daml<br/>data T = T with<br/>  x1 : Int<br/>```   | ```daml<br/>data T = T with<br/>  x2 : Optional Text<br/>  x1 : Int<br/>```   |
|------------------------------------------------------|-------------------------------------------------------------------------------|

Below, the record on the right is **not** a valid upgrade of the record
on the left because it drops field `x2`.

| ```daml<br/>data T = T with<br/>  x1 : Int<br/>  x2 : Text<br/>```   | ```daml<br/>data T = T with<br/>  x1 : Int<br/>```   |
|----------------------------------------------------------------------|------------------------------------------------------|
...
| ```daml<br/>data T = T with<br/>  x1 : Int<br/>```   | ```daml<br/>data T = T with<br/>  x1 : Text<br/>```   |
|------------------------------------------------------|-------------------------------------------------------|
...
| ```haskell<br/>data T =<br/>  A Int | B Text<br/>```   | ```haskell<br/>data T =<br/>  A Int | B Text | C Bool<br/>```   |
|--------------------------------------------------------|-----------------------------------------------------------------|

Below, the variant on the right is a valid upgrade of the variant on the
left. It adds a new optional field to constructor `B`.

| ```haskell<br/>data T =<br/>  A | B { x : Int }<br/>```   | ```haskell<br/>data T =<br/>  A | B { x : Int, y : Optional Text }<br/>```   |
|-----------------------------------------------------------|------------------------------------------------------------------------------|
...
| ```haskell<br/>data T =<br/>  A Int | B Text<br/>```   | ```haskell<br/>data T =<br/>  A Int | C Bool | B Text<br/>```   |
|--------------------------------------------------------|-----------------------------------------------------------------|

Below, the variant on the right is **not** a valid upgrade of the
variant on the left because it changes the order of its constructors.

| ```haskell<br/>data T =<br/>  A Int | B Text<br/>```   | ```haskell<br/>data T =<br/>  B Text | A Int<br/>```   |
|--------------------------------------------------------|--------------------------------------------------------|

Below, the variant on the right is **not** a valid upgrade of the
variant on the left because it drops constructor `B`.

| ```haskell<br/>data T =<br/>  A Int | B Text<br/>```   | ```haskell<br/>data T =<br/>  A Int<br/>```   |
|--------------------------------------------------------|-----------------------------------------------|
...
| ```haskell<br/>data T =<br/>  A Int | B Text<br/>```   | ```haskell<br/>data T =<br/>  A Int | B Bool<br/>```   |
|--------------------------------------------------------|--------------------------------------------------------|
...
| ```haskell<br/>data T =<br/>  A Int | B<br/>```   | ```haskell<br/>data T =<br/>  A Int | B { x : Optional Text }<br/>```   |
|---------------------------------------------------|-------------------------------------------------------------------------|
...
| ```haskell<br/>data T =<br/>  A | B<br/>```   | ```haskell<br/>data T =<br/>  A | B | C Int<br/>```   |
|-----------------------------------------------|-------------------------------------------------------|
...
variants](#data-types---variants) apply, only without constructor
arguments.
...
|--------------------------------------------------------------------------|-------------------------------------------------------------------------------|
| ```daml<br/>module Dep where<br/><br/>data U = C1<br/>data V = V<br/>``` | ```daml<br/>module Dep where<br/><br/>data U = C1 | C2<br/>data V = V<br/>``` |

Then below, the module on the right is a valid upgrade of the module on
the left.

| ```daml<br/>module Main where<br/><br/>-- imported from q-1.0.0<br/>import qualified Dep<br/><br/>data T = T Dep.U<br/>```   | ```daml<br/>module Main where<br/><br/>-- imported from q-2.0.0<br/>import qualified Dep<br/><br/>data T = T Dep.U<br/>```   |
|------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------|
...
| ```daml<br/>module Main where<br/><br/>-- imported from q-2.0.0<br/>import qualified Dep<br/><br/>data T = T Dep.V<br/>```   | ```daml<br/>module Main where<br/><br/>-- imported from q-1.0.0<br/>import qualified Dep<br/><br/>data T = T Dep.V<br/>```   |
|------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------|
...
| ```daml<br/>data Tree a =<br/>  Tree with<br/>    label : a<br/>    children : [Tree a]<br/>```   | ```daml<br/>data Tree b =<br/>  Tree with<br/>    label : b<br/>    children : [Tree b]<br/>    cachedSize : Optional Int<br/>```   |
|---------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------|
...
| ```daml<br/>module M where<br/><br/>data T = T {}<br/><br/>data Demo = Demo with<br/>  field1 : List T<br/>  field2 : Map T T<br/>  field3 : Optional T<br/>```   | ```daml<br/>module M where<br/><br/>data T = T { i : Optional Int }<br/><br/>data Demo = Demo with<br/>  field1 : List T<br/>  field2 : Map T T<br/>  field3 : Optional T<br/>```   |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| ```daml<br/>module M where<br/><br/>data C a = C { x : a }<br/><br/>data Demo = Demo with<br/>  field1 : C T<br/>```   | ```daml<br/>module M where<br/><br/>data C a = C { x : a, y : Optional Int }<br/><br/>data Demo = Demo with<br/>  field1 : C T<br/>```   |
|------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------|
...
| ```daml<br/>template T<br/>  with<br/>    p : Party<br/>    i : Int<br/>  where<br/>    signatory p<br/><br/>    interface instance I for T where<br/>      view = IView i<br/>      m = i<br/>```   | ```daml<br/>template T<br/>  with<br/>    p : Party<br/>    i : Int<br/>    j : Optional Int<br/>  where<br/>    signatory p<br/><br/>    interface instance I for T where<br/>      view = IView (fromOptional i j)<br/>      m = fromOptional i j<br/>```   |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| ```daml<br/>template T3<br/>  with<br/>    p : Party<br/>    i : Int<br/>  where<br/>    signatory p<br/>```   | ```daml<br/>template T3<br/>  with<br/>    p : Party<br/>    i : Int<br/>  where<br/>    signatory p<br/><br/>    interface instance I for T3 where<br/>      view = IView i<br/>      m = i<br/>```   |
|----------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| ```daml<br/>template T2<br/>  with<br/>    p : Party<br/>    i : Int<br/>  where<br/>    signatory p<br/><br/>    interface instance I for T2 where<br/>      view = IView i<br/>      m = i<br/>```   | ```daml<br/>template T2<br/>  with<br/>    p : Party<br/>    i : Int<br/>  where<br/>    signatory p<br/>```   |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------|
...
template selection, as detailed in [the next
...
|-----------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------|
| ```daml<br/>module Dep where<br/><br/>template U<br/>  with<br/>    p : Party<br/>  where<br/>    signatory p<br/>``` | ```daml<br/>module Dep where<br/><br/>template U<br/>  with<br/>    p : Party<br/>    t : Optional Text<br/>  where<br/>    signatory p<br/>``` |
...
| ```daml<br/>template T<br/>  with<br/>    p : Party<br/>  where<br/>    signatory p<br/><br/>    interface instance I for T where<br/>      view = IView {}<br/>```   | ```daml<br/>template T<br/>  with<br/>    p : Party<br/>    i : Optional Int<br/>  where<br/>    signatory p<br/><br/>    interface instance I for T where<br/>      view = IView {}<br/>```   |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
<a id="dynamic-target-template-selection"></a>
...
[dynamic package
resolution](../sdlc-howtos/smart-contracts/upgrade/smart-contract-upgrades.mdx#dynamic-package-resolution-in-command-submission)  determine the target template at runtime.
...
|---------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------|
| ```daml<br/>template T<br/>  with<br/>    p : Party<br/>  where<br/>    signatory p<br/>``` | ```daml<br/>template T<br/>  with<br/>    p : Party<br/>    t : Optional Text<br/>  where<br/>    signatory p<br/>``` |
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ```daml<br/>template Inst<br/>  with<br/>    p : Party<br/>  where<br/>    signatory p<br/><br/>    interface instance I for T where<br/>      view = IView<br/>      getInt = 1<br/>``` | ```daml<br/>template Inst<br/>  with<br/>    p : Party<br/>  where<br/>    signatory p<br/><br/>    interface instance I for T where<br/>      view = IView<br/>      getInt = 2<br/>``` |
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ```daml<br/>module M where<br/><br/>data Ret = Ret with<br/><br/>template V<br/>  with<br/>    p : Party<br/>  where<br/>    signatory p<br/><br/>    choice C : Ret<br/>      with<br/>        i : Int<br/>      controller p<br/>      do return Ret<br/>``` | ```daml<br/>module M where<br/><br/>data Ret = Ret with<br/>  j : Optional Int<br/><br/>template V<br/>  with<br/>     p : Party<br/>   where<br/>     signatory p<br/><br/>     choice C : Ret<br/>       with<br/>         i : Int<br/>         j : Optional Int<br/>       controller p<br/>       do return Ret with j = j<br/>``` |
...
protocol
buffers](https://protobuf.dev/programming-guides/proto3/#updating).
...
| ```daml<br/>data T = T with<br/>  x1 : T1<br/>  ...<br/>  xn : Tn<br/>```   | ```daml<br/>data T = T with<br/>  x1 : T1'<br/>  ...<br/>  xn : Tn'<br/>  y1 : Optional U1<br/>  ...<br/>  ym : Optional Um<br/>```   |
|-----------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------|
...
| ```daml<br/>data V =<br/>  = C1 T1<br/>  | ...<br/>  | Cn Tn<br/>```   | ```daml<br/>data V =<br/>  = C1 T1'<br/>  | ...<br/>  | Cn Tn'<br/>  | D1 U1<br/>  | ...<br/>  | Dm Um<br/>```   |
|------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------|
...
| In `p-1.0.0`:                                                                                   | In `p-2.0.0`:                                                                                                                                                         |
|-------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ```daml<br/>template T<br/>  with<br/>    sig : Party<br/>  where<br/>    signatory sig<br/>``` | ```daml<br/>template T<br/>  with<br/>    sig : Party<br/>    additionalSig : Optional Party<br/>  where<br/>    signatory sig, fromOptional [] additionalSig<br/>``` |
...
| In `p-1.0.0`:                                                                                   | In `p-2.0.0`:                                                                                        |
|-------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------|
| ```daml<br/>template T<br/>  with<br/>    sig : Party<br/>  where<br/>    signatory sig<br/>``` | ```daml<br/>template T<br/>  with<br/>    sig : Party<br/>  where<br/>    signatory sig, sig<br/>``` |
...
| ```daml<br/>template T<br/>  with<br/>    sig : Party<br/>    n : Int<br/>  where<br/>    signatory sig<br/>    ensure n >= 0<br/>```   | ```daml<br/>template T<br/>  with<br/>    sig : Party<br/>    n : Int<br/>  where<br/>    signatory sig<br/>    ensure n > 0<br/>```   |
|-----------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------|
...
| In `p-1.0.0`:                                                                                                                                                                                      | In `p-2.0.0`:                                                                                                                                                                                          |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ```daml<br/>template T<br/>  with<br/>    p : Party<br/>    i : Int<br/>  where<br/>    signatory p<br/><br/>    interface instance I for T where<br/>      view = IView i<br/>      m = i<br/>``` | ```daml<br/>template T<br/>  with<br/>    p : Party<br/>    i : Int<br/>  where<br/>    signatory p<br/><br/>    interface instance I for T where<br/>      view = IView (i+1)<br/>      m = i<br/>``` |
...
[dynamic package
resolution](../sdlc-howtos/smart-contracts/upgrade/smart-contract-upgrades.mdx#dynamic-package-resolution-in-command-submission).
