...
The **[Splice Wallet Kernel](https://github.com/hyperledger-labs/splice-wallet-kernel) SDK** provides a set of TypeScript libraries for dApp, wallet, and exchange libraries for integrating with the Canton Network.
It is covered in the [Integrations](/docs-main/integrations/overview) section.
