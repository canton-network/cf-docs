...
: * [openapi](../../reference/json-api/openapi.md#reference-json-api-openapi)
  * [asyncapi](../../reference/json-api/asyncapi.md#reference-json-api-asyncapi)
  * [the gRPC Ledger API](https://docs.daml.com/app-dev/ledger-api.html).
...
: [Authorization](../../sdlc-howtos/applications/secure/authorization.md#authorization).
...
- `createArguments` field contains contract fields as defined in the Daml template and formatted according to [Daml-LF JSON encoding](../../reference/json-api/lf-value-specification.md#reference-json-lf-value-specification).
...
- `payload` – the initial contract fields as defined in the Daml template and formatted according to [Daml-LF JSON encoding](../../reference/json-api/lf-value-specification.md#reference-json-lf-value-specification),
- `choiceInterfaceId` – *optional* template or interface that defines the choice, same format as `templateId`,
- `choice` – Daml contract choice, that is being exercised,
- `argument` – contract choice argument(s).
