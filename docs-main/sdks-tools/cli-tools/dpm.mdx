...
- `dpm add`:                      Add opt-in components and dars to project
- `dpm update`:                   Update opt-in components and dars in project
...
You can also view the published versions and tags of a component via `dpm tags` (see the [Listing tags](/sdks-tools/cli-tools/dpm.mdx#listing-available-tags-and-versions) docs section).

See the [Opt-in Components](/appdev/modules/m5-environment-configuration#opt-in-components) docs section to learn how to use these components in your project.
...
Similarly to components, you can publish dars to an OCI repository:
...
You should now be able to see the published version via `dpm tags` see the [Listing tags](/sdks-tools/cli-tools/dpm.mdx#listing-available-tags-and-versions) docs section).
...
## Listing available tags and versions

You can use the `dpm tags` command to view published versions and tags for a _specific_ component or dar.
