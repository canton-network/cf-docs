...
Recall the architecture diagram from the [Integration Architecture](architecture.mdx#integration-architecture) section:
...
* **Tx History Ingestion**: keep track of the last ingested offset in the Canton Integration DB.
  ...
  the individual [Integration Workflows](workflows.mdx#integration-workflows) descriptions for details.
* **Withdrawal Automation**: make it stateless, so that it can just restart.
  ...
  the [1-Step Withdrawal Workflow](workflows.mdx#one-step-withdrawal-workflow) and
  the [Multi-Step Withdrawal Workflow](workflows.mdx#multi-step-withdrawal-workflow).
* **Multi-Step Deposit Automation**: make it stateless, so that it can just restart.
  This is in line with how we recommend to implement the [Multi-Step Deposit Workflow](workflows.mdx#multi-step-deposit-workflow).
...
* **Withdrawal Automation**:
  recall from [1-Step Withdrawal Workflow](workflows.mdx#one-step-withdrawal-workflow) that the Withdrawal Automation
...
* **Multi-Step Deposit Automation**: the approach is analogous to the one for Withdrawal Automation.
  ...
  Recall from [Multi-Step Deposit Workflow](workflows.mdx#multi-step-deposit-workflow) that the Multi-Step Deposit Automation
...
As explained in [MVP for Canton Coin](workflows.mdx#mvp-for-cc), the Registry API Server of the token admin for
