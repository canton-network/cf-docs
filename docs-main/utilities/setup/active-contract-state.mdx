...
![](pictures/acs-disable-websockets-1.png)

3. Toggle the "WebSockets" switch to disable it.

![](pictures/acs-disable-websockets-2.png)
...
![](pictures/acs-clear-local-storage-1.png)

3. Press the "Clear" button on the "Active Contract Storage" tile.

![](pictures/acs-clear-local-storage-2.png)
