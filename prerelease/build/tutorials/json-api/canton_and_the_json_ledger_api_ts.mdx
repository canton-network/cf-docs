<!-- source: canton / canton/3.5/sdk/tutorials/json-api/canton_and_the_json_ledger_api_ts.rst -->
...
A [TypeScript](canton_and_the_json_ledger_api_ts_websocket.md#tutorial-canton-and-the-json-ledger-api-ts-websocket) version is also available that demonstrates how to create a JSON Ledger API client for use in a web browser.
