---
title: "GET /v2/packages/:package-id"
description: "Returns the contents of a single package."
api: "GET http://localhost:7575/v2/packages/{package-id}"
authMethod: "bearer"
playground: "interactive"
sidebarTitle: "/v2/packages/:package-id"
---
...
<div class="x2mdx-ref-hero">
  ...
  <p class="x2mdx-ref-summary">Returns the contents of a single package.</p>
...
```bash cURL
curl --request GET \
  --url 'http://localhost:7575/v2/packages/{package-id}' \
...
const response = await fetch('http://localhost:7575/v2/packages/{package-id}', {
  method: 'GET',
  headers: {
...
curl_setopt_array($curl, [
    CURLOPT_URL => 'http://localhost:7575/v2/packages/{package-id}',
...
func main() {
  req, _ := http.NewRequest("GET", "http://localhost:7575/v2/packages/{package-id}", nil)
...
var request = HttpRequest.newBuilder()
    .uri(URI.create("http://localhost:7575/v2/packages/{package-id}"))
    .header("Authorization", "Bearer <token>")
...
uri = URI('http://localhost:7575/v2/packages/{package-id}')
...
<div class="x2mdx-ref-history" aria-label="Reference history">
  ...
  <div class="x2mdx-ref-history-event x2mdx-ref-history-event--changed" id="history-updated-3-5">
    ...
    <p class="x2mdx-ref-history-event-detail">The GET /v2/packages/&#123;package-id&#125; operation was updated in this snapshot.</p>
