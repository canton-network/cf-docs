<!-- source: canton / canton/3.5/participant/howtos/troubleshoot/FAQ.rst -->
...
[currently maintained PostgreSQL releases](https://www.postgresql.org/support/versioning/).
...
If Canton is unable to find included configuration files, please read the section on [including configuration files](../configure/general/conf_file.md#include-configuration)
