...
{/* Generated from validator-kubernetes.source.mdx. Edit validator-kubernetes.source.mdx, then run npm run snippets:generate. */}
...
4)  Please download the release artifacts containing the sample Helm value files, from here: <a href="https://github.com/digital-asset/decentralized-canton-sync/releases/download/v0.7.0/0.7.0_splice-node.tar.gz">Download Bundle (DevNet 0.7.0)</a>, and extract the bundle:
...
4)  Please download the release artifacts containing the sample Helm value files, from here: <a href="https://github.com/digital-asset/decentralized-canton-sync/releases/download/v0.6.14/0.6.14_splice-node.tar.gz">Download Bundle (TestNet 0.6.14)</a>, and extract the bundle:
...
4)  Please download the release artifacts containing the sample Helm value files, from here: <a href="https://github.com/digital-asset/decentralized-canton-sync/releases/download/v0.6.13/0.6.13_splice-node.tar.gz">Download Bundle (MainNet 0.6.13)</a>, and extract the bundle:
...
{/* Generated from validator-kubernetes-2.source.mdx. Edit validator-kubernetes-2.source.mdx, then run npm run snippets:generate. */}
...
{/* snippet-source: https://github.com/canton-network/splice/blob/4c670142843c198ed93f106824d8e33d9dec5c8c/apps/app/src/pack/examples/sv-helm/standalone-validator-values.yaml; authored-at: docs-main/snippets/networkvars/global-synchronizer/deployment/validator-kubernetes-2.source.mdx:24 */}
```yaml
scanClient:
  scanType: "bft"
...
{/* snippet-source: https://github.com/canton-network/splice/blob/4c670142843c198ed93f106824d8e33d9dec5c8c/apps/app/src/pack/examples/sv-helm/standalone-validator-values.yaml; authored-at: docs-main/snippets/networkvars/global-synchronizer/deployment/validator-kubernetes-2.source.mdx:42 */}
```yaml
synchronizer:
  connectionType: "bft"
...
{/* snippet-source: https://github.com/canton-network/splice/blob/4c670142843c198ed93f106824d8e33d9dec5c8c/apps/app/src/pack/examples/sv-helm/standalone-validator-values.yaml; authored-at: docs-main/global-synchronizer/deployment/validator-kubernetes.source.mdx:1159 */}
```yaml
...
{/* snippet-source: https://github.com/canton-network/splice/blob/4c670142843c198ed93f106824d8e33d9dec5c8c/apps/app/src/pack/examples/sv-helm/validator-values.yaml; authored-at: docs-main/global-synchronizer/deployment/validator-kubernetes.source.mdx:1181 */}
```yaml
...
{/* snippet-source: https://github.com/canton-network/splice/blob/4c670142843c198ed93f106824d8e33d9dec5c8c/apps/app/src/pack/examples/sv-helm/validator-values.yaml; authored-at: docs-main/global-synchronizer/deployment/validator-kubernetes.source.mdx:1191 */}
```yaml
...
{/* snippet-source: https://github.com/canton-network/splice/blob/4c670142843c198ed93f106824d8e33d9dec5c8c/apps/app/src/pack/examples/sv-helm/validator-values.yaml; authored-at: docs-main/global-synchronizer/deployment/validator-kubernetes.source.mdx:1219 */}
```yaml
