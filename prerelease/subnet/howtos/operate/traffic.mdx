<!-- source: canton / canton/3.5/synchronizer/howtos/operate/traffic.rst -->
      ...
      trafficStatesOrErrors = Map(
        PAR::participant1::12201ff69b1d... -> Right(
          value = TrafficState(
            ...
            lastConsumedCost = 0,
            timestamp = 2026-01-10T22:40:19.607693Z,
      ...
      trafficStatesOrErrors = Map(
        PAR::participant1::12201ff69b1d... -> Right(
          value = TrafficState(
            ...
            baseTrafficRemainder = 20000,
            lastConsumedCost = 0,
            timestamp = 2026-01-10T22:40:19.937264Z,
            serial = 2,
...
@ participant1.health.ping(participant2)
    res10: Duration = 1078 milliseconds
```

```none
@ participant2.health.ping(participant3)
    res11: Duration = 963 milliseconds
```
      ...
      trafficStatesOrErrors = Map(
        PAR::participant1::12201ff69b1d... -> Right(
          value = TrafficState(
            extraTrafficLimit = 1000000,
            extraTrafficConsumed = 0,
            baseTrafficRemainder = 17733,
            lastConsumedCost = 0,
            timestamp = 2026-01-10T22:40:22.232773Z,
            serial = 2,
            availableTraffic = 1017733
          )
        ),
        MED::mediator1::122009299340... -> Right(
          value = TrafficState(
        ...
        PAR::participant3::1220d6908163... -> Right(
          value = TrafficState(
            extraTrafficLimit = 0,
            extraTrafficConsumed = 0,
            baseTrafficRemainder = 16249,
            lastConsumedCost = 0,
            timestamp = 2026-01-10T22:40:22.232773Z,
            availableTraffic = 16249
          )
        ),
        PAR::participant2::1220a4d7463b... -> Right(
          value = TrafficState(
            extraTrafficLimit = 0,
            extraTrafficConsumed = 0,
            baseTrafficRemainder = 12689,
            lastConsumedCost = 0,
            timestamp = 2026-01-10T22:40:22.232773Z,
            availableTraffic = 12689
          )
        )
      )
    )
