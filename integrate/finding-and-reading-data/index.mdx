...
for instance on the getTransactionById or listHoldingTransactions ([Detailed here](../token-standard/index.mdx#list-holding-transactions)).
...
Here is an example on how a “tap” event looks like ([Performing tap](../token-standard/index.mdx#performing-tap)):
