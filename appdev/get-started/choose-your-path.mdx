...
4. [Module 3: Daml Smart Contracts](/appdev/modules/m3-daml) - Start coding
5. [QuickStart](/appdev/quickstart) - Run the example application

**Time estimate:** Plan for 2-3 days to complete the core learning path.
</Accordion>
...
3. [Module 3: Daml Smart Contracts](/appdev/modules/m3-daml) - Learn Daml syntax
4. [QuickStart](/appdev/quickstart) - See it in action
...
**Time estimate:** 1-2 days if you can dedicate focused time.
</Accordion>
...
**Time estimate:** 1-2 days for the conceptual shift.
</Accordion>
...
**Time estimate:** 2-4 hours for comprehensive understanding.
</Accordion>
...
<Note>
The QuickStart requires Docker with at least 8GB RAM allocated. See [QuickStart Prerequisites](/appdev/quickstart/prerequisites) for detailed requirements.
</Note>
