...
For the gRPC Ledger API, set the token as a call credential. For the JSON API, include it in the `Authorization` header.

## Overriding SDK Components
