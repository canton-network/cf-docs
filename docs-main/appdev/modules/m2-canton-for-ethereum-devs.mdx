...
contract Agreement {
    ...
    bool public approvedPartyA;
    bool public approvedPartyB;
    bool public executed;

    constructor(address partyA_, address partyB_, string memory terms_) {
        partyA = partyA_;
        partyB = partyB_;
        terms = terms_;
    }
    ...
    function approve() public {
        require(msg.sender == partyA || msg.sender == partyB, "Not a signatory");
        require(!executed, "Agreement already executed");

        if (msg.sender == partyA) {
            require(!approvedPartyA, "Already approved");
            approvedPartyA = true;
        } else {
            require(!approvedPartyB, "Already approved");
            approvedPartyB = true;
        }
    }
    
    function execute() public {
        require(msg.sender == partyA || msg.sender == partyB, "Not a controller");
        require(!executed, "Agreement already executed");
        if (msg.sender == partyA) {
            require(approvedPartyB, "Party B didn't approve");
        } else {
            require(approvedPartyA, "Party A didn't approve");
        }
