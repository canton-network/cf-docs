<!-- source: canton / canton/3.5/participant/howtos/secure/keys/key_restrictions.rst -->
...
@ myNode.topology.namespace_delegations.list(
    ...
    res6: Seq[com.digitalasset.canton.admin.api.client.data.topology.ListNamespaceDelegationResult] = Vector(
      ListNamespaceDelegationResult(
        context = BaseResult(
          storeId = Authorized,
          validFrom = 2026-01-10T22:39:28.169076Z,
          validUntil = None,
          sequenced = 2026-01-10T22:39:28.169076Z,
          operation = Replace,
          transactionHash = TxHash(hash = SHA-256:6a54a2d03a15...),
