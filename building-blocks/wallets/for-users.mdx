...
Your wallet shows your Canton Coin balance. Unlike other cryptocurrencies:
...
<Card title="How Canton Wallets Differ" icon="code-compare" href="/building-blocks/wallets/canton-vs-web3">
