...
For Slack, mailing lists, and support contacts, see [Staying connected](/docs-main/global-synchronizer/deployment/onboarding-process#staying-connected) in the onboarding process page.
