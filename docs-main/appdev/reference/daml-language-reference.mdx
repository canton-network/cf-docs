...
Optional. Lets you specify a combination of a party and other data that uniquely identifies a contract of this template. See `contractkeys`.

maintainers
`maintainer` keyword

Required if you have specified a `key`. Keys are only unique to a `maintainer`. See `contractkeys`.
...
{/* COPIED_START source="docs-website:docs/replicated/daml/3.4/sdk/reference/daml/stdlib/index.rst" hash="33e68583" */}

<Warning title="Pre-reviewed Content - Do Not Modify">
This section was copied from existing reviewed documentation.
**Source:** `docs/replicated/daml/3.4/sdk/reference/daml/stdlib/index.rst`
Reviewers: Skip this section. Remove markers after final approval.
</Warning>
