<!-- source: canton / canton/3.5/participant/howtos/configure/general/command_line.rst -->
...
The section on [static configuration](conf_file.md#static-configuration) explains how to write a configuration file.
...
[a command line interface](../../operate/console/console.md#canton-console) (REPL) which allows to conveniently
...
a [remote console](../../operate/console/console.md#canton-remote-console) that provides the interactive user experience,
...
There are several log related options that can be specified. Refer to [Logging](../../observe/monitoring.md#logging) for more details.
