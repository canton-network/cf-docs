...
description: "dApp SDK adapter registration and wallet discovery"
---

{/* COPIED_START source="wallet-gateway:docs/dapp-building/dapp-sdk/discovery.md@82ec39c9" hash="1e4522ea" */}
