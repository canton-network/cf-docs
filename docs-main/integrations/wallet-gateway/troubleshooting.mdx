...
description: "Common Wallet Gateway issues and fixes"
---

{/* COPIED_START source="wallet-gateway:docs/dapp-building/wallet-gateway/troubleshooting/index.md@82ec39c9" hash="f67950b4" */}
