...
- [Reassignment Protocol](/mainnet/overview/reference/reassignment-protocol) -- detailed protocol mechanics for unassignment and assignment
- [Architecture Overview](/mainnet/overview/learn/architecture) -- how synchronizers, validators, and the Global Synchronizer fit together
