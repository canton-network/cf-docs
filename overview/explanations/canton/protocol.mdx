...
<Note>This page focuses on a single Synchronizer deployment.
[Multi-synchronizer](multi-synchronizer.mdx#multiple-synchronizers) support is discussed separately.</Note>
...
<Note>* Participant and mediator nodes connect only to sequencer nodes.
  In particular, they do not exchange messages directly.
* Participant Nodes can connect to one or several sequencers.</Note>
