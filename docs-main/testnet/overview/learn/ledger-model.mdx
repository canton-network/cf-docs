...
See [Working with Time](/testnet/appdev/modules/m3-working-with-time) for the full set of time primitives available in Canton 3.x.
...
- [Contract Templates](/testnet/appdev/modules/m3-contract-templates) — write your first Daml contracts
- [Choices](/testnet/appdev/modules/m3-choices) — add behavior to contracts
- [Privacy Model](/testnet/overview/learn/privacy-model) — how views enable privacy
