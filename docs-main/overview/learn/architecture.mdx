...
description: "Visual understanding of how Canton Network components work together"
---

{/* COPIED_START source="docs-website:docs/replicated/pqs/3.4/component-howtos/pqs/configure.rst" hash="335e84e6" */}
...
Consult [Configuration options](/integrations/pqs/configuration-options) how to configure each command.

## Transactions data source

To understand how PQS stores data, you need to understand the [Ledger Model](/appdev/reference/daml-index). In simple terms, the Daml ledger is composed of a sequence of transactions, which contain events. Events can be:
