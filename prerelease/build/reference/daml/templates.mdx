...
For the structure of a template, see [Overview: Template Structure](structure).
...
- See [Reference: Choices](choices) for full reference information.
...
- The clause must start with the keywords `interface instance`, followed by
  ...
  must be implemented.
- See [Reference: Interfaces](interfaces) for full reference information on interfaces, or
