{/* source: splice-wallet-kernel / splice-wallet-kernel/devnet/src/exchange-integration/overview.rst */}

<a id="exchange-integration-overview"></a>
...
![milestone and delivery dependency diagram](exchange-integration/images/delivery_dependencies.png)
...
The workflows build on the [Canton Network Token Standard](https://docs.dev.sync.global/app_dev/token_standard/index.html) which is the foundation for
...
* [Setup DevNet node and/or use LocalNet](testing.mdx#test-node-setup)
* [Setup Exchange Parties](node-operations.mdx#exchange-parties-setup)
* [1-Step Deposit Workflow](workflows.mdx#one-step-deposit-workflow)
* [1-Step Withdrawal Workflow](workflows.mdx#one-step-withdrawal-workflow)
* [Support restore from validator node backup](disaster-recovery.mdx#restore-from-validator-node-backup)
* [Support hard synchronizer migration](node-operations.mdx#hard-synchronizer-migration)
...
* [Multi-Step Withdrawal Workflow](workflows.mdx#multi-step-withdrawal-workflow), which resolves the limitation that users must setup a CC transfer preapproval to receive withdrawals.
* [Canton Network Token Onboarding](workflows.mdx#token-onboarding)
...
* [Earning App Rewards for Withdrawals](extensions.mdx#withdrawal-app-rewards)
* [Earning App Rewards for Deposits](extensions.mdx#deposit-app-rewards)
* [Sharing App Rewards with your Customers](extensions.mdx#share-rewards-with-customers)
...
>   [Wallet SDK](../integrating-with-canton-network/index.mdx#install-wallet-sdk) to simplify building your integration.
