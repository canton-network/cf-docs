...
- [LocalNet Development](/testnet/appdev/modules/m5-localnet-development) — Set up and work with the cn-quickstart LocalNet environment
- [CI/CD Integration](/testnet/appdev/modules/m5-ci-cd-integration) — Automate your test pipeline
