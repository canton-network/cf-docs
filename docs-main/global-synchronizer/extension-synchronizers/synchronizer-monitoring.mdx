...
#\. Link the reference documentation. \<<https://github.com/DACH-NY/canton/issues/25832>\> \#. Link the Admin API Protobuf reference docs once available. \<<https://github.com/DACH-NY/canton/issues/26126>\>
