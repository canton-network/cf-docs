...
<Card title="Application Developers" icon="code" href="/testnet/appdev/get-started/choose-your-path">
...
<Card title="Ethereum/Web3 Developers" icon="ethereum" href="/testnet/appdev/modules/m2-canton-for-ethereum-devs">
...
<Card title="Node Operators" icon="server" href="/testnet/global-synchronizer/understand/introduction">
...
<Card title="Solution Architects" icon="diagram-project" href="/testnet/overview/understand/five-minute-overview">
...
|--------------|------------|
| Understand what Canton is in 5 minutes | [Five-Minute Overview](/testnet/overview/understand/five-minute-overview) |
| Learn why privacy matters for blockchain | [The Problem Canton Solves](/testnet/overview/understand/the-problem) |
| See how Canton components work together | [Architecture Overview](/testnet/overview/learn/architecture) |
| Write my first smart contract | [Module 3: Daml Smart Contracts](/testnet/appdev/modules/m3-dev-environment) |
| Run the example application | [QuickStart](/testnet/appdev/quickstart) |
| Deploy a validator node | [Validator Setup](/testnet/global-synchronizer/understand/introduction) |
| Integrate a wallet into my app | [Integrations Overview](/testnet/integrations/overview) |
...
<Card title="Support" icon="headset" href="/testnet/shared/support-channels">
