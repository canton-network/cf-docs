...
import CantonGlobalSynchronizerExtensionSynchronizersPrivateSynchronizersL77 from "/snippets/canton-docs/global-synchronizer_extension-synchronizers_private-synchronizers_L77.mdx";
...
<CantonGlobalSynchronizerExtensionSynchronizersPrivateSynchronizersL77 />
...
- [Hybrid Synchronizer Pattern](/mainnet/global-synchronizer/extension-synchronizers/hybrid-synchronizer-pattern) — Combining public and private synchronizers
- [Deployment](/mainnet/global-synchronizer/extension-synchronizers/deployment) — Deploying extension synchronizer infrastructure
- [Linking Validators](/mainnet/global-synchronizer/extension-synchronizers/linking-validator-multi-sync) — Multi-synchronizer validator configuration
