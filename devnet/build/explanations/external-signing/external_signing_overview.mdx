...
Instructions on how to compute the hash are available [here](external_signing_hashing_algorithm.md#external-signing-hashing-algo).
...
Refer to the [external party onboarding tutorial](../../tutorials/app-dev/external_signing_onboarding.md#tutorial-onboard-external-party) for a hands-on demonstration of onboarding an external party.

* [External Signing Hashing Algorithm](external_signing_hashing_algorithm.md)
