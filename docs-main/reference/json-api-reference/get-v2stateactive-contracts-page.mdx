---
title: "GET /v2/state/active-contracts-page"
description: "Deprecated Use POST version of this endpoint"
api: "GET http://localhost:7575/v2/state/active-contracts-page"
authMethod: "bearer"
...
<div class="x2mdx-ref-hero">
  ...
  <p class="x2mdx-ref-summary">Deprecated Use POST version of this endpoint</p>
...
func main() {
  req, _ := http.NewRequest("GET", "http://localhost:7575/v2/state/active-contracts-page", bytes.NewBufferString(`{
  "activeAtOffset": 123,
  "eventFormat": {
    "filtersByParty": {},
    "filtersForAnyParty": {
