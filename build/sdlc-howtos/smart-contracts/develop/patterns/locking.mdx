{/* source: daml / daml/3.4/sdk/sdlc-howtos/smart-contracts/develop/patterns/locking.rst */}
...
* [Lock by Archiving](locking/locking-by-archiving.mdx)
* [Lock by Safekeeping](locking/locking-by-safekeeping.mdx)
* [Lock by State](locking/locking-by-state.mdx)
