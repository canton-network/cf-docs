---
title: "Networks & identity providers"
description: "Connect the Wallet Gateway to a Canton validator and configure how users authenticate."
---
...
user (see `server.admin` in [Configure the Wallet Gateway](/integrations/wallet-gateway/guides/configure))
...
[Manage wallets](/integrations/wallet-gateway/guides/manage-wallets).
