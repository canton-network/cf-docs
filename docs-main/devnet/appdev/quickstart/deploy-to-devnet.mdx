...
document, the most up to date version is 0.6.2.
...
The following link downloads the `0.6.2 splice-node` release. Move the
...
[https://github.com/digital-asset/decentralized-canton-sync/releases/download/v0.6.2/0.6.2_splice-node.tar.gz](https://github.com/digital-asset/decentralized-canton-sync/releases/download/v0.6.2/0.6.2_splice-node.tar.gz)
...
saving the most recent version. e.g. `SPLICE_VERSION=0.6.2`
