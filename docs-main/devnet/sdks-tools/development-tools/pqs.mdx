...
See [Backend Development](/devnet/appdev/modules/m4-backend-dev) for detailed code examples.

## Related Pages

- [Backend development](/devnet/appdev/modules/m4-backend-dev) -- Using PQS in a Java backend
- [Ledger API](/devnet/sdks-tools/api-reference/ledger-api) -- The underlying transaction stream that PQS consumes
- [LocalNet](/devnet/sdks-tools/development-tools/localnet) -- Pre-configured PQS instances for local development
