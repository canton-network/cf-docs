...
- **SPONSOR_SV_URL** — The URL of the SV app of your SV sponsor. This should be of the form [https://sv.sv-1.unknown_cluster.global.canton.network.YOUR_SV_SPONSOR](https://sv.sv-1.unknown_cluster.global.canton.network.YOUR_SV_SPONSOR), e.g., if the Global Synchronizer Foundation is your sponsor use [https://sv.sv-1.unknown_cluster.global.canton.network.sync.global](https://sv.sv-1.unknown_cluster.global.canton.network.sync.global).
