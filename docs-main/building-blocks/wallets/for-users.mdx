...
| **Hold CIP-0056 assets** | Hold any CIP-0056 compliant token |
...
Your wallet shows your Canton Coin and other CIP-0056 compliant token balances. Unlike other cryptocurrencies:
...
<Card title="How Canton Wallets Differ" icon="code-compare" href="/docs-main/building-blocks/wallets/canton-vs-web3">
