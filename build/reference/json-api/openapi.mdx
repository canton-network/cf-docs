...
* OpenAPI fetch for typescript [https://openapi-ts.dev/openapi-fetch/](https://openapi-ts.dev/openapi-fetch/)
</Note>
<Note>
Due to technical constraints, some fields are incorrectly marked as required, even though they can be omitted in JSON Ledger API. Refer to the component descriptions for accurate details.
