...
For Auth0 instructions and more details on configuring authentication, see [Configuring Authentication](/devnet/global-synchronizer/deployment/installation#configuring-authentication).
