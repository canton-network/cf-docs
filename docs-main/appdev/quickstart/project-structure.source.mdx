...
description: "Understand the Canton Network QuickStart project layout and component architecture"
---
...
Work through the [Running the Demo](/appdev/quickstart/running-the-demo) guide for the complete workflow walkthrough.
...
- `flake.nix` / `flake.lock` - Pin dependencies at the repository root for reproducible builds
...
Health check endpoints for each validator are in `docker/modules/localnet/docker/splice/health-check.sh`.
...
<Snippet
  source="https://github.com/digital-asset/cn-quickstart/blob/77e46ee7ddbe8bf1b921111778e33eb399e33ad3/sdk/docs/sharable/sdk/quickstart/configure/project-structure-overview.rst"
  lines="182..184"
  normalize="preserve"
  language="bash"
/>

See [Using the JSON Ledger API](/appdev/quickstart/json-api) for detailed port usage and authentication patterns.
...
See [Debugging and troubleshooting with lnav](/appdev/quickstart/lnav) for log analysis techniques.
