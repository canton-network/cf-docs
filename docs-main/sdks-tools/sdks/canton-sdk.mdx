...
Canton is the development toolchain you use to build, test, and deploy applications on Canton Network. It bundles the Daml compiler, code generation tools, a local sandbox environment, and the `dpm` package manager into a single installable distribution.
...
<Card title="cn-quickstart" icon="rocket" href="/docs-main/sdks-tools/reference-projects/cn-quickstart">
  A complete example application built with Canton.
</Card>
