<!-- source: canton / canton/3.5/participant/howtos/recover/repairing.rst -->
...
2. The Synchronizer loss may have resulted in active contract set inconsistencies. In such cases the
   ...
   Participant Nodes should be removed or added. Refer to [troubleshooting ACS commitments](../troubleshoot/commitments.md#troubleshoot-commitments)
...
7. If there are ACS inconsistencies, refer to [troubleshooting ACS commitments](../troubleshoot/commitments.md#troubleshoot-commitments) to identify
