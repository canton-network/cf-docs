...
![A diagram of the Delegation pattern, in which the CoinPoA contract allows a party who is not the coin's owner to exercise a choice on the TransferProposal contract.](sdlc-howtos/smart-contracts/develop/patterns/images/delegation.png)
