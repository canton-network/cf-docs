...
Answers to questions that come up regularly in Canton Network application development. For validator operations questions, see the [Common Issues FAQ](/testnet/appdev/faq).
...
There are also community-maintained bindings for some languages. See the [language bindings](/testnet/sdks-tools/language-bindings/community) page.
...
Applications can apply for featured status through the Canton Improvement Proposal (CIP) process. Start by reviewing the [CIP introduction](/testnet/overview/understand/cips-introduction) and the [getting your app featured](/testnet/overview/understand/getting-app-featured) guide.
