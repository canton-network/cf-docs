...
sidebarTitle: "/v2/state/active-contracts"
---
...
<div class="x2mdx-ref-hero">
  ...
  <p class="x2mdx-ref-summary">Query active contracts list (blocking call). Querying active contracts is an expensive operation and if possible should not be repeated often. Consider querying active contracts initially (for a given offset) and then repeatedly call one of `/v2/updates/...`endpoints to get subsequent modifications. You can also use websockets to get updates with better performance.</p>
...
const response = await fetch('http://localhost:7575/v2/state/active-contracts', {
  method: 'POST',
  headers: {
...
curl_setopt_array($curl, [
    CURLOPT_URL => 'http://localhost:7575/v2/state/active-contracts',
...
func main() {
  req, _ := http.NewRequest("POST", "http://localhost:7575/v2/state/active-contracts", bytes.NewBufferString(`{
  "filter": {
    "filtersByParty": {},
    "filtersForAnyParty": {
      "cumulative": [
...
var request = HttpRequest.newBuilder()
    .uri(URI.create("http://localhost:7575/v2/state/active-contracts"))
    .header("Authorization", "Bearer <token>")
    .header("Content-Type", "application/json")
...
uri = URI('http://localhost:7575/v2/state/active-contracts')
...
<div class="x2mdx-ref-history" aria-label="Reference history">
  ...
  <div class="x2mdx-ref-history-event x2mdx-ref-history-event--changed" id="history-updated-3-5">
    ...
    <p class="x2mdx-ref-history-event-detail">The POST /v2/state/active-contracts operation was updated in this snapshot.</p>
