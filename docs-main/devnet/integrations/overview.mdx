...
<Card title="Find a Wallet" icon="wallet" href="/devnet/integrations/wallets/for-users">
  Discover wallet options for managing your Canton Coin.
</Card>

<Card title="Find Apps" icon="grid-2" href="/devnet/integrations/apps/finding-apps">
...
<Card title="Wallet Integration" icon="code" href="/devnet/integrations/wallet/guidance">
  Add wallet functionality to your application using the Wallet SDK.
</Card>

<Card title="Exchange Integration" icon="building-columns" href="/devnet/integrations/exchanges/guidance">
...
<Card title="Integration Patterns" icon="puzzle-piece" href="/devnet/integrations/integration-patterns">
  Common patterns for building integrations.
</Card>

<Card title="Canton Ecosystem" icon="globe" href="/devnet/integrations/ecosystem">
