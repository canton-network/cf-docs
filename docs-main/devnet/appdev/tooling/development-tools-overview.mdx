...
DPM replaces the older `daml` CLI and is the recommended entry point for all build and project tasks. See the [DPM reference](/devnet/sdks-tools/cli-tools/dpm) for the full command set.
...
For full setup instructions, see [IDE Setup](/devnet/appdev/tooling/ide-setup).
...
See [Sandbox](/devnet/sdks-tools/development-tools/sandbox) for configuration options.
...
See [LocalNet](/devnet/sdks-tools/development-tools/localnet) for details.
...
See [PQS](/devnet/sdks-tools/development-tools/pqs) and the [PQS SQL Reference](/api-reference) for schema details and query examples.
...
- [IDE Setup](/devnet/appdev/tooling/ide-setup) -- Configure your editor for Canton development
- [Debugging Tools](/devnet/appdev/tooling/debugging-tools) -- Troubleshoot transactions and contract state
- [The Canton Development Stack](/devnet/appdev/modules/m1-development-stack) -- How all the pieces fit together
