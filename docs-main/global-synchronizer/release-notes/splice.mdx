...
## 0.8.4
  ...
  - Upgrade Canton to `3.5.19`.

## 0.8.3

Note: 0.8.2 is skipped as it packaged a broken `splice-node` executable in the release bundle archive.

  - Upgrade Canton to `3.5.18`.

  - Updated Docker base image to 1.0.14, which updates gRPC health probe to v0.4.57.
