...
Returns the update with the given update_id. Compared to `/v1/updates/{update_id}`, the `/v2/updates/{update_id}` removes the `offset` field in responses, which was hardcoded to 1 in `/v1/updates/{update_id}` for compatibility, and is now removed.
...
<div class="x2mdx-ref-meta-grid">
  ...
  <div class="x2mdx-ref-meta-item">
    ...
    <span class="x2mdx-ref-meta-value">getUpdateByIdV2</span>
  </div>
...
<div class="x2mdx-ref-history" aria-label="Reference history">
  ...
  <div class="x2mdx-ref-history-event x2mdx-ref-history-event--changed" id="history-updated-0-6-0">
    ...
    <p class="x2mdx-ref-history-event-detail">The GET /v2/updates/&#123;update_id&#125; operation was updated in this snapshot.</p>
