...
<div class="x2mdx-ref-hero">
  ...
  <p class="x2mdx-ref-summary">List all existing users.</p>
...
func main() {
  req, _ := http.NewRequest("GET", "http://localhost:7575/v2/users", nil)
...
Invalid value, Invalid value for: query parameter pageSize, Invalid value for: query parameter pageToken
...
<div class="x2mdx-ref-history" aria-label="Reference history">
  ...
  <div class="x2mdx-ref-history-event x2mdx-ref-history-event--changed" id="history-updated-3-5">
    ...
    <p class="x2mdx-ref-history-event-detail">The GET /v2/users operation was updated in this snapshot.</p>
