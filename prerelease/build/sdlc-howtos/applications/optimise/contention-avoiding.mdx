<!-- source: daml / daml/3.5/sdk/sdlc-howtos/applications/optimise/contention-avoiding.rst -->
...
Ledger state is read in the following places within the [Daml Execution Model](../../../tutorials/smart-contracts/compose.md#execution-model) :
