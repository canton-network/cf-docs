...
A Canton Network application may include [app user developed frontends and backends](system-design/daml-app-arch-design.md#arch-options). Lead development with early creation of Daml code as an interface description language for cross-organizational workflows.
...
* The deployment topology depends on the [app architecture](system-design/daml-app-arch-design.md#build-sdlc-howtos-daml-app-arch-design) and requires a pre-configured Canton infrastructure, including app provider and app users on their respective administrative domains.
...
* [App provider](../overview/key_concepts.md#app-provider) should:
  * Deploy the backend and the frontend.
  * Configure the frontend to integrate with IAM.
* [App user](../overview/key_concepts.md#app-user) should:
...
* Balance deployment simplicity with [architectural trade-offs](system-design/daml-app-arch-design.md#properties-summary).
