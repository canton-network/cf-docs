...
<div class="x2mdx-ref-hero">
  ...
  <p class="x2mdx-ref-summary">Query flat transactions update list (blocking call). Provided for backwards compatibility, it will be removed in the Canton version 3.5.0, use v2/updates instead. Notice: This endpoint should be used for small results set. When number of results exceeded node configuration limit (`http-list-max-elements-limit`) there will be an error (`413 Content Too Large`) returned. Increasing this limit may lead to performance issues and high memory consumption.</p>
...
<div class="x2mdx-ref-badges">
  ...
  <a class="x2mdx-ref-badge x2mdx-ref-badge--added" href="#history-added-3-4">Present since at least 3.4</a>
...
const response = await fetch('http://localhost:7575/v2/updates/flats', {
  method: 'POST',
  headers: {
...
curl_setopt_array($curl, [
    CURLOPT_URL => 'http://localhost:7575/v2/updates/flats',
...
func main() {
  req, _ := http.NewRequest("POST", "http://localhost:7575/v2/updates/flats", bytes.NewBufferString(`{
  "beginExclusive": 123,
  "endInclusive": 123,
  "filter": {
    "filtersByParty": {},
...
var request = HttpRequest.newBuilder()
    .uri(URI.create("http://localhost:7575/v2/updates/flats"))
    .header("Authorization", "Bearer <token>")
    .header("Content-Type", "application/json")
...
uri = URI('http://localhost:7575/v2/updates/flats')
