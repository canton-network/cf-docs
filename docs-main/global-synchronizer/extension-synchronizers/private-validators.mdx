---
title: "Private Only Validators that are Just Connected to a Dedicated Synchronizers"
...
If your requirements change, the synchronizer users can can connect your validators to the Global Synchronizer without disrupting your dedicated synchronizer workflows:
