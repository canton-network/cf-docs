...
- Helm - At least v3.11.1 (recommended >= v3.17.0)
...
## Private-only validators

A validator can also run on a dedicated synchronizer without any connection to the Global Synchronizer. See [Private-Only Validators](/global-synchronizer/extension-synchronizers/private-validators).
