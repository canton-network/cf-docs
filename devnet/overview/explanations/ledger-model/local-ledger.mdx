...
* The Ledger API
* The [Daml Ledger Model](index.md#da-ledgers)
...
They are based on the paint counteroffer workflow from the Daml Ledger Model’s [privacy section](ledger-privacy.md#da-model-privacy),
...
It generalizes [ledger consistency](ledger-integrity.md#da-model-consistency) from the Daml Ledger Model as [explained below](#causality-consistency-ledger-model).
...
* [Ledger Consistency](ledger-integrity.md#da-model-ledger-consistency) according to Daml Ledger Model
...
As explained in the Daml Ledger Model, parties see only a [projection](ledger-privacy.md#da-model-projections) of the shared ledger for privacy reasons.
