...
This page gives reference information for Daml expressions that are not [updates](updates.mdx).
...
| `==`, `/=`           | `Bool`, `Text`, `Int`, `Decimal`, `Party`, `Time`, and [identifiers of contracts](file-structure.mdx#daml-ref-contract-identifiers) stemming from the same contract template |
