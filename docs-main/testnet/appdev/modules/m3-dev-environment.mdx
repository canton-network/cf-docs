...
Continue to [Contract Templates](/testnet/appdev/modules/m3-contract-templates) to start building Daml smart contracts.

If you're new to functional programming or want a refresher on Daml's syntax (types, pattern matching, records, type classes), see [Language Fundamentals](/testnet/appdev/modules/m3-language-fundamentals) first. If you have experience with Haskell or other ML-family languages, you can skip it and refer back as needed.