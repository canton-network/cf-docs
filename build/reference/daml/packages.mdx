{/* source: daml / daml/3.4/sdk/reference/daml/packages.rst */}
{/* Copyright (c) 2023 Digital Asset (Switzerland) GmbH and/or its affiliates. All rights reserved. */}
{/* SPDX-License-Identifier: Apache-2.0 */}

<a id="reference-daml-packages"></a>
...
Refer to the [section on decoding DARs and DALF files](../../component-howtos/development-tooling-authors/how-to-parse-daml-archive-files.mdx#inspecting-dars).
