...
<Note>The setup of `dataSourceClassName` and `properties` for PostgreSQL are discussed in the next section.</Note>
...
<Note>The canton distribution provides a script, `config/utils/postgres/db.sh`, to help create the database and users.</Note>
