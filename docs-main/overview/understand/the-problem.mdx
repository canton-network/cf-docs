---
title: "The Problem Canton Solves"
description: "Understanding the privacy-transparency tradeoff in blockchain systems"
---

Blockchain technology promises shared truth between parties who don't fully trust each other. But traditional blockchains achieve this trust through total transparency—everyone sees everything. For many real-world applications, this is a dealbreaker.
...
The transparency problem isn't theoretical. It blocks real adoption:

### Front-Running Risk

When transactions are visible before execution, observers can exploit that information. In traditional finance, this is illegal. On transparent blockchains, it's structural.
...
No enterprise will put sensitive business logic on a system where competitors can read it. Period.

## Imperfect Mitigating Solutions

The industry has tried several approaches to add privacy to transparent blockchains:
...
These approaches all treat privacy as something to add on top of a transparent system. They're fighting against the architecture, not working with it.
...
<Card title="Canton's Solution" icon="lightbulb" href="/docs-main/overview/understand/cantons-solution">
