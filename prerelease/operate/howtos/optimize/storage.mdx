<!-- source: canton / canton/3.5/participant/howtos/optimize/storage.rst -->
...
the [troubleshooting section](../troubleshoot/troubleshooting_guide.md#how-to-measure-db-performance) on how to analyze whether the database is a limiting factor.
