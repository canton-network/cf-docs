...
<Snippet source="https://github.com/digital-asset/canton/blob/eaa9e7a4bf48793acb35aba270b85a970afe6006/community/app/src/test/resources/external-ha-sequencers-remote-admin-parsing.conf" normalize="two-spaces" language="conf" />
