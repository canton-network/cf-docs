...
<div class="x2mdx-ref-operation-bar">
  ...
  <code>/com.digitalasset.canton.mediator.admin.v30.MediatorAdministrationService/GetSchedule</code>
</div>
...
grpcurl \
  -d @ \
  <HOST:PORT> \
  com.digitalasset.canton.mediator.admin.v30.MediatorAdministrationService/GetSchedule <<'EOF'
{}
EOF
```
