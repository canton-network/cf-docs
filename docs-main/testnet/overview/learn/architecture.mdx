...
- **[Privacy Model Explained](/testnet/overview/learn/privacy-model)** - Deep dive into sub-transaction privacy
- **[The Global Synchronizer](/testnet/overview/understand/global-synchronizer)** - Understand the public network infrastructure
- **[Validator Operations](/testnet/global-synchronizer/understand/introduction)** - For those deploying and operating validators
