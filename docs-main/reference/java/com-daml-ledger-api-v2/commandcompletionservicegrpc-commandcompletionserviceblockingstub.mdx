...
Upstream docs: [Open](<https://javadoc.io/doc/com.daml/bindings-java/3.5.6/com/daml/ledger/api/v2/CommandCompletionServiceGrpc.CommandCompletionServiceBlockingStub.html>)
...
| --- | --- | --- | --- | --- |
| [Open](<https://javadoc.io/doc/com.daml/bindings-java/3.5.6/com/daml/ledger/api/v2/CommandCompletionServiceGrpc.CommandCompletionServiceBlockingStub.html#build%28io.grpc.Channel,io.grpc.CallOptions%29>) | `build(Channel, CallOptions)` | `3.5.6` | - | - |
| [Open](<https://javadoc.io/doc/com.daml/bindings-java/3.5.6/com/daml/ledger/api/v2/CommandCompletionServiceGrpc.CommandCompletionServiceBlockingStub.html#completionStream%28com.daml.ledger.api.v2.CommandCompletionServiceOuterClass.CompletionStreamRequest%29>) | `completionStream(CommandCompletionServiceOuterClass.CompletionStreamRequest)` | `3.5.6` | - | - |
