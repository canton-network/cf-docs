...
export const componentDescriptions = {
  ...
  damlSdk: { text: 'Canton ledger software (participants, sequencers, mediators). The compatible Daml SDK version is implied by the Canton version.', link: 'https://github.com/digital-asset/daml/releases', linkText: 'View releases' },
      ...
      <div className="bg-gray-900 rounded-xl border border-gray-800 p-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
          {[
            ...
            { name: 'Canton Releases', url: 'https://github.com/digital-asset/daml/releases' },
