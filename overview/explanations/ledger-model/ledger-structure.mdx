...
<Note>
The [integrity conditions](ledger-integrity.mdx#da-model-integrity) on a ledger require that the happens-before order respects the lifecycle of contracts.
...
We discuss the more general partial orders in the [causality section](local-ledger.mdx#local-ledger).
</Note>
