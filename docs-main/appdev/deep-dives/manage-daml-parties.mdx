---
title: "How to allocate and query Daml parties"
...
Canton Participant Node exposes a [party management](/global-synchronizer/production-operations/party-management) service that allows creation and discovery of [parties](/overview/understand/core-concepts#parties).
This guide explains how to programmatically manipulate the parties using the JSON Ledger API, which is described using OpenAPI specifications.
