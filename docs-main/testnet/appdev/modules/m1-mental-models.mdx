---
title: "Mental Models for Canton"
description: "Building the right intuition for Canton development"
---
...
<Card title="Development Stack" icon="layer-group" href="/testnet/appdev/modules/m1-development-stack">
  Understand the tools you'll use.
</Card>

<Card title="Architecture Overview" icon="diagram-project" href="/testnet/overview/learn/architecture">
