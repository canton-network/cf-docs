---
title: "POST /registry/allocation/v2/settlement-factory"
...
api: "POST https://example.com/registry/allocation/v2/settlement-factory"
...
<div class="x2mdx-ref-hero">
  ...
  <p class="x2mdx-ref-summary">Get the factory and choice context for settling allocations using the `SettlementFactory_SettleBatch` choice. Registries MAY limit the size of the settlement requests that they support. To ensure wide compatibility with apps, registries MUST support all settlement requests that involve at most 25 transfer legs.</p>
...
const response = await fetch('https://example.com/registry/allocation/v2/settlement-factory', {
  method: 'POST',
  headers: {
...
curl_setopt_array($curl, [
    CURLOPT_URL => 'https://example.com/registry/allocation/v2/settlement-factory',
...
func main() {
  req, _ := http.NewRequest("POST", "https://example.com/registry/allocation/v2/settlement-factory", bytes.NewBufferString(`{
  "choiceArguments": {},
  "excludeDebugFields": false
}`))
...
var request = HttpRequest.newBuilder()
    .uri(URI.create("https://example.com/registry/allocation/v2/settlement-factory"))
    .header("Content-Type", "application/json")
...
uri = URI('https://example.com/registry/allocation/v2/settlement-factory')
