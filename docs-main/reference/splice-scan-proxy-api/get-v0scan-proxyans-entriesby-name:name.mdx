...
<div class="x2mdx-ref-hero">
  ...
  <p class="x2mdx-ref-summary">Lookup ans entry by name</p>
...
const response = await fetch('https://example.com/api/validator/v0/scan-proxy/ans-entries/by-name/{name}', {
  method: 'GET',
});
...
curl_setopt_array($curl, [
    CURLOPT_URL => 'https://example.com/api/validator/v0/scan-proxy/ans-entries/by-name/{name}',
...
func main() {
  req, _ := http.NewRequest("GET", "https://example.com/api/validator/v0/scan-proxy/ans-entries/by-name/{name}", nil)
...
var request = HttpRequest.newBuilder()
    .uri(URI.create("https://example.com/api/validator/v0/scan-proxy/ans-entries/by-name/{name}"))
...
uri = URI('https://example.com/api/validator/v0/scan-proxy/ans-entries/by-name/{name}')
