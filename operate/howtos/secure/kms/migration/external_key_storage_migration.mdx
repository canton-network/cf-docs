{/* source: canton / canton/3.4/participant/howtos/secure/kms/migration/external_key_storage_migration.rst */}
{/* Copyright (c) 2025 Digital Asset (Switzerland) GmbH and/or its affiliates. All rights reserved. */}
{/* SPDX-License-Identifier: Apache-2.0 */}

<a id="external-key-storage-migration"></a>
...
Synchronizer
(e.g. [running KMS or JCE with KMS-supported encryption and signing keys](#external-key-storage-interoperability)),
...
<Warning>This only works for a single operator or if all other Participant operators agree and
follow the same steps.</Warning>
...
<a id="external-key-storage-interoperability"></a>
...
See [this table](../../../../reference/crypto_schemes.mdx#canton-supported-schemes) and [this table](../../../../reference/crypto_schemes.mdx#canton-default-schemes) for a description of
