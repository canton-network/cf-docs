...
<Note>* Update examples and notation in the style of the Canton polyglott whitepaper
...
* Remove exceptions
* Extend with time, upgrading (via packages), requester of a commit, explicit disclosure</Note>
...
> 1. What the changes and the ledgers looks like - the [structure](ledger-structure.mdx#ledger-structure) of the Canton Ledger
> 2. Who sees which changes and data - the [privacy model](ledger-privacy.mdx#da-model-privacy) for the Canton Ledger
...
<Note>These Daml templates are for illustration purposes only.
They are not meant for real-world usage as they are heavily simplified.</Note>
```daml
...
* [Structure](ledger-structure.mdx)
* [Valid Ledgers](ledger-validity.mdx)
* [Privacy](ledger-privacy.mdx)
* [Integrity](ledger-integrity.mdx)
* [Time on Daml Ledgers](time.mdx)
* [Causality](local-ledger.mdx)
* [Synchronizer-aware projection](interoperability.mdx)
* [Daml: Define Contract Models Compactly](ledger-daml.mdx)
* [Exceptions](ledger-exceptions.mdx)
