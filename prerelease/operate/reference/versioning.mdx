<!-- source: canton / canton/3.5/participant/reference/versioning.rst -->
...
- Error code format (machine-readable parts, see also [the error code documentation](error_codes.md#error-codes))
...
(\*) The protocol versions marked with \* are the alpha protocol version. To use an alpha protocol version, follow the  [documentation](../howtos/troubleshoot/FAQ.md#how-do-i-enable-alpha-features).
