...
<ParamField path="SPONSOR_SV_URL">
  The URL of the SV app of your SV sponsor. This should be of the form `https://sv.sv-1.dev.global.canton.network.YOUR_SV_SPONSOR"`, e.g., if the Global Synchronizer Foundation is your sponsor use `https://sv.sv-1.dev.global.canton.network.sync.global`.
</ParamField>

<ParamField path="ONBOARDING_SECRET">
...
<ParamField path="TRUSTED_SCAN_URL">
  The scan URL of an SV that you trust and that is reachable by your validator, often your SV sponsor. This should be of the form `https://scan.sv-1.dev.global.canton.network.YOUR_SV_SPONSOR`, e.g., for the Global Synchronizer Foundation SV it is `https://scan.sv-1.dev.global.canton.network.sync.global`
</ParamField>
