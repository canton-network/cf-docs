...
- [https://scan.sv-1.dev.global.canton.network.sync.global/api/scan/v2/updates](https://scan.sv-1.dev.global.canton.network.sync.global/api/scan/v2/updates)
- [https://scan.sv-1.dev.global.canton.network.sync.global/api/scan/v0/state/acs/snapshot-timestamp](https://scan.sv-1.dev.global.canton.network.sync.global/api/scan/v0/state/acs/snapshot-timestamp)
...
- [https://scan.sv-1.test.global.canton.network.sync.global/api/scan/v2/updates](https://scan.sv-1.test.global.canton.network.sync.global/api/scan/v2/updates)
- [https://scan.sv-1.test.global.canton.network.sync.global/api/scan/v0/state/acs/snapshot-timestamp](https://scan.sv-1.test.global.canton.network.sync.global/api/scan/v0/state/acs/snapshot-timestamp)
...
- [https://scan.sv-1.global.canton.network.sync.global/api/scan/v2/updates](https://scan.sv-1.global.canton.network.sync.global/api/scan/v2/updates)
- [https://scan.sv-1.global.canton.network.sync.global/api/scan/v0/state/acs/snapshot-timestamp](https://scan.sv-1.global.canton.network.sync.global/api/scan/v0/state/acs/snapshot-timestamp)
