...
See [Multi-Hosting](/mainnet/appdev/deep-dives/multi-hosting) for implementation details.
...
- [Multi-Hosting](/mainnet/appdev/deep-dives/multi-hosting) — Implementation details for distributing parties across validators
