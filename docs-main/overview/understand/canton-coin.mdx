...
Validators operating on the Global Synchronizer earn CC through **activity rewards**: when a validator's users burn CC for traffic purchases or transfers, the validator mints CC proportional to the amount burned. [CIP-0096](https://github.com/canton-foundation/cips/blob/main/cip-0096/cip-0096.md) discontinued the earlier liveness rewards that paid validators for uptime alone, capping them at $0 effective 2026-04-30 -- activity rewards are now the only validator minting mechanism.
