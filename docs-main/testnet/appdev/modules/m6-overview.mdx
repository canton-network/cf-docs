...
<Card title="Upgrade Compatibility" icon="code-compare" href="/testnet/appdev/modules/m6-upgrade-compatibility">
  What changes are allowed and what breaks compatibility.
</Card>

<Card title="Writing Your First Upgrade" icon="pen" href="/testnet/appdev/modules/m6-writing-first-upgrade">
  Step-by-step tutorial for creating a v2 package.
</Card>

<Card title="Package Selection" icon="list-check" href="/testnet/appdev/modules/m6-package-selection">
  How the ledger resolves which package version to use.
</Card>

<Card title="Testing Upgrades" icon="vial" href="/testnet/appdev/modules/m6-testing-upgrades">
  Verifying upgrade paths before deployment.
</Card>

<Card title="Deploying Upgrades" icon="rocket" href="/testnet/appdev/modules/m6-deployment">
