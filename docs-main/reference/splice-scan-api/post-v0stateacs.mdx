...
<div class="x2mdx-ref-hero">
  ...
  <p class="x2mdx-ref-summary">Deprecated. Please use /v1/state/acs instead. Returns the ACS in creation date ascending order, paged, for a given migration id and record time.</p>
...
const response = await fetch('https://scan.sv-1.global.canton.network.sync.global/api/scan/v0/state/acs', {
  method: 'POST',
  headers: {
...
curl_setopt_array($curl, [
    CURLOPT_URL => 'https://scan.sv-1.global.canton.network.sync.global/api/scan/v0/state/acs',
...
func main() {
  req, _ := http.NewRequest("POST", "https://scan.sv-1.global.canton.network.sync.global/api/scan/v0/state/acs", bytes.NewBufferString(`{
  "migration_id": 123,
  "record_time": "2026-01-01T00:00:00Z",
  "record_time_match": "exact",
  "after": 123,
...
var request = HttpRequest.newBuilder()
    .uri(URI.create("https://scan.sv-1.global.canton.network.sync.global/api/scan/v0/state/acs"))
    .header("Content-Type", "application/json")
...
uri = URI('https://scan.sv-1.global.canton.network.sync.global/api/scan/v0/state/acs')
