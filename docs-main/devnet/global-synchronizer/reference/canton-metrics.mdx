...
{/* COPIED_START source="docs-website:docs/replicated/canton/3.5/participant/reference/metrics.rst" hash="9de8735e" */}

<Warning title="Pre-reviewed Content - Do Not Modify">
This section was copied from existing reviewed documentation.
**Source:** `docs/replicated/canton/3.5/participant/reference/metrics.rst`
