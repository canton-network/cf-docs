...
See [Canton Coin and Traffic](/mainnet/appdev/modules/m4-canton-coin) for how to manage traffic credits.
...
- [Backend Development](/mainnet/appdev/modules/m4-backend-dev) -- Ledger API client setup, including error handling examples
- [Canton Coin and Traffic](/mainnet/appdev/modules/m4-canton-coin) -- Managing traffic to avoid submission failures
- [Observability](/mainnet/appdev/modules/m4-observability) -- Logging and metrics for error tracking
