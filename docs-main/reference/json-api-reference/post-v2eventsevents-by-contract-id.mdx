---
title: "POST /v2/events/events-by-contract-id"
...
api: "POST http://localhost:7575/v2/events/events-by-contract-id"
authMethod: "bearer"
playground: "interactive"
sidebarTitle: "/v2/events/events-by-contract-id"
---
...
<div class="x2mdx-ref-hero">
  ...
  <p class="x2mdx-ref-summary">Get the create and the consuming exercise event for the contract with the provided ID. No events will be returned for contracts that have been pruned because they have already been archived before the latest pruning offset. If the contract cannot be found for the request, or all the contract-events are filtered, a CONTRACT_EVENTS_NOT_FOUND error will be raised.</p>
...
```bash cURL
curl --request POST \
  --url 'http://localhost:7575/v2/events/events-by-contract-id' \
...
const response = await fetch('http://localhost:7575/v2/events/events-by-contract-id', {
  method: 'POST',
  headers: {
...
curl_setopt_array($curl, [
    CURLOPT_URL => 'http://localhost:7575/v2/events/events-by-contract-id',
...
func main() {
  req, _ := http.NewRequest("POST", "http://localhost:7575/v2/events/events-by-contract-id", bytes.NewBufferString(`{
  "contractId": "<string>",
  "eventFormat": {
    "filtersByParty": {},
    "filtersForAnyParty": {
...
var request = HttpRequest.newBuilder()
    .uri(URI.create("http://localhost:7575/v2/events/events-by-contract-id"))
    .header("Authorization", "Bearer <token>")
    .header("Content-Type", "application/json")
...
uri = URI('http://localhost:7575/v2/events/events-by-contract-id')
...
<ResponseField name="created" type="JsCreated">
...
<ResponseField name="archived" type="JsArchived">
...
<div class="x2mdx-ref-history" aria-label="Reference history">
  ...
  <div class="x2mdx-ref-history-event x2mdx-ref-history-event--changed" id="history-updated-3-5">
    ...
    <p class="x2mdx-ref-history-event-detail">The POST /v2/events/events-by-contract-id operation was updated in this snapshot.</p>
