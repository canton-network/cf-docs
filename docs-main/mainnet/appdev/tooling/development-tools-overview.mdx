...
DPM replaces the older `daml` CLI and is the recommended entry point for all build and project tasks. See the [DPM reference](/mainnet/sdks-tools/cli-tools/dpm) for the full command set.
...
For full setup instructions, see [IDE Setup](/mainnet/appdev/tooling/ide-setup).
...
See [Sandbox](/mainnet/sdks-tools/development-tools/sandbox) for configuration options.
...
See [LocalNet](/mainnet/sdks-tools/development-tools/localnet) for details.
...
See [PQS](/mainnet/sdks-tools/development-tools/pqs) and the [PQS SQL Reference](/api-reference) for schema details and query examples.
...
- [IDE Setup](/mainnet/appdev/tooling/ide-setup) -- Configure your editor for Canton development
- [Debugging Tools](/mainnet/appdev/tooling/debugging-tools) -- Troubleshoot transactions and contract state
- [The Canton Development Stack](/mainnet/appdev/modules/m1-development-stack) -- How all the pieces fit together
