...
UTILITIES_IMAGE_VERSION="0.11.4"
AUTH_CLIENT_ID="<see below>"
UTILITY_APP_UTILITY_BACKEND_URL="<see below>"
```

- `AUTH_CLIENT_ID`: the one you [created for the Utility UI](/docs-main/utilities/setup/prerequisites#oidc_setup)

- `UTILITY_APP_UTILITY_BACKEND_URL`: [depends on which network you're connecting to](/docs-main/utilities/reference/operator-backend-api/index#operator_backend_url)
