...
* [Protocols on One Synchronizer](protocol)
* [Synchronizers](synchronizers)
* [Security properties](requirements)
* [Topology management](topology)
* [Participant nodes](participant)
* [Decentralization](decentralization)
* [Local and external parties](external-party)
* [Multiple Synchronizers](multi-synchronizer)
* [Reliability](reliability)
* [Pruning](pruning)
* [Cryptographic keys in Canton](security)
