...
For Prometheus metrics endpoints, scraping configuration, and Grafana dashboards, see [Monitoring Setup](/mainnet/global-synchronizer/production-operations/monitoring-setup).
