---
title: "Observability"
description: "Setting up logging, metrics, and dashboards for Canton applications"
---
...
Canton nodes expose Prometheus-compatible metrics endpoints. When running cn-quickstart locally, the participant node's metrics are available at `http://localhost:10013/metrics` by default.
...
- JVM heap usage consistently above 80% on the participant node

## Further Reading

- [Backend Development](/docs-main/appdev/modules/m4-backend-dev) -- Error handling patterns that pair with observability
- [Canton Coin and Traffic](/docs-main/appdev/modules/m4-canton-coin) -- Monitoring your traffic budget
