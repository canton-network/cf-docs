...
```bash
docker pull \
    europe-docker.pkg.dev/da-images/public/docker/canton-base:3.4.12
docker pull \
    europe-docker.pkg.dev/da-images/public/docker/canton-participant:3.4.12
docker pull \
    europe-docker.pkg.dev/da-images/public/docker/canton-sequencer:3.4.12
docker pull \
    europe-docker.pkg.dev/da-images/public/docker/canton-mediator:3.4.12
```
