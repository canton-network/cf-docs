...
The Canton Coin Scan app is a public-facing application that provides summary information regarding Canton Coin activity on the network. A copy of it is hosted by each Super Validator. Open your browser at [https://scan.sv.YOUR_HOSTNAME](https://scan.sv.YOUR_HOSTNAME) to see your instance of it.
