...
- [Essential Commands](/testnet/global-synchronizer/canton-console/essential-commands) — Key commands for health checks, party and package management
- [Debugging Workflows](/testnet/global-synchronizer/canton-console/debugging-workflows) — Step-by-step diagnostic procedures
