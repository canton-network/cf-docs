{/* source: quickstart / quickstart/3.4/sdk/quickstart/operate/explore-the-demo.rst */}

<a id="quickstart-explore-the-demo"></a>
...
>   * [Login](#login)
>   * [The App Installs Menu](#the-app-installs-menu)
>   * [AppInstallRequest](#appinstallrequest)
>   * [Create a license](#create-a-license)
>   * [Make a payment](#make-a-payment)
>   * [Renew the license](#renew-the-license)
...
Install the [CN App Quickstart](../download/cnqs-installation.html) before beginning this demonstration.
...
![Make setup no auth](quickstart/operate/images/make-setup-noauth.png)

`make setup` **with** OAUTH2:

![Make setup with auth](quickstart/operate/images/make-setup-with-oauth.png)
...
![CN App Quickstart Login screen without Auth](quickstart/operate/images/01-login-app-qs-noauth.png)

**OAUTH2 enabled**

When OAUTH2 is **enabled**, the homepage prompts to login with Keycloak’s OAuth 2.0 portal:

![CN App Quickstart Login screen with Auth](quickstart/operate/images/01-login-app-qs-auth.png)
...
![AppProvider login screen](quickstart/operate/images/login-app-provider-view.png)

### The App Installs Menu

Once you are logged in select **AppInstalls** in the menu.

![App Installs view](quickstart/operate/images/qs-demo-app-installs-view.png)
...
![App Install Request](quickstart/operate/images/04-create-install-req.png)
<Note>If your machine is not powerful enough to host `LocalNet` or if the docker containers are not responsive then the response may show a failure with status code 404 or 000 (as shown in the image below). Increasing Docker memory limit to at least 8 GB should allow the `LocalNet` containers to operate properly.</Note>![App Install Request error](quickstart/operate/images/05-error-app-install.png)
...
![accept request](quickstart/operate/images/accept-awaiting-request.png)

The `AppInstallRequest` is Accepted.

![accepted request](quickstart/operate/images/success-accepted-appinstallrequest.png)
...
![create license](quickstart/operate/images/created-license.png)

Next, navigate to the Licenses menu and select **Renewals**.

![Licenses view](quickstart/operate/images/new-license-select-renewals.png)

A “License Renewal Request” modal opens with an option to renew a license.

![license renewal request modal](quickstart/operate/images/license-renewal-request-modal.png)

Click **New** to open the “Renew License” modal.

![renew license modal](quickstart/operate/images/renew-license-modal.png)
...
![new license renewal request](quickstart/operate/images/new-license-renewal-request.png)
...
1. Reading the [Splice Local Network docs](https://docs.dev.sync.global/app_dev/testing/localnet.html#application-uis).
2. Navigating to the App Provider’s “Tenants” menu.

![AppProvider Tenants menu](quickstart/operate/images/app-provider-tenants.png)
1. Logging into the app as `app-user`, navigating to the Licenses menu, then clicking the **Renewals** action.

![AppUser Licenses menu](quickstart/operate/images/app-user-licenses-menu.png)

If prompted, log in to the CC Wallet as `app-user`.

![Canton Coin Wallet login](quickstart/operate/images/canton-coin-wallet-app-user-log-in.png)
...
![Tap for CC](quickstart/operate/images/tap-canton-wallet.png)
...
![CC Wallet accept allocation](quickstart/operate/images/canton-coin-wallet-allocations-menu.png)
...
![CC Wallet accepted allocation](quickstart/operate/images/canton-coin-wallet-accepted-allocation.png)
...
![complete renewal after payment](quickstart/operate/images/app-provider-complete-renewal-after-payment.png)

A confirmation appears that the license renewal completed successfully.

![renewal success after payment](quickstart/operate/images/license-renewal-completed-successfully.png)
...
![AppUser login screen without Auth](quickstart/operate/images/login-app-user-noauth.png)

**OAUTH2 enabled**

When OAUTH2 is enabled, you log in using the app-user username and password.

![login screen](quickstart/operate/images/01-login-app-qs-auth.png)

Login as `AppUser` with “app-user” as the username and the password is “abc123”.

![AppUser login screen](quickstart/operate/images/appuser-auth-login-view.png)

The AppInstall now shows as accepted.

![accepted AppInstall](quickstart/operate/images/accepted-app-install.png)

The license shows as active.

![logout AppProvider](quickstart/operate/images/app-user-license-active.png)
...
Activate the Canton Console in a terminal from the `quickstart/` directory.
Run:
...
![Participant location in the ledger](quickstart/operate/images/canton-console-participants.png)
```default
participants.all
```
...
![Participant synchronizer](quickstart/operate/images/canton-console-participants-all.png)
...
![App User](quickstart/operate/images/app-user.png)
...
![App Provider](quickstart/operate/images/app-provider.png)
...
![super validator](quickstart/operate/images/sv.png)
...
![Ping yourself](quickstart/operate/images/health-status.png)
...
![Active identifiers](quickstart/operate/images/28-shell-ids.png)
```default
...
![License details](quickstart/operate/images/29-license-details.png)
```default
...
![License renewal request details](quickstart/operate/images/active-quickstart-appinstallrequest.png)
```default
...
![Archived licenses](quickstart/operate/images/30-archive-licenses.png)
...
![CC balance](quickstart/operate/images/36-cc-balance.png)

Select the **Network Info** menu to view SV identification.

![Active SVs](quickstart/operate/images/34-active-svs.png)

The Validators menu shows that the local validator has been registered with the SV.

![Registered validator](quickstart/operate/images/37-registered-validator.png)

## Observability Dashboard

<Note>Observability may no longer work while App Quickstart is under revisions.</Note>

In a web browser, navigate to [http://localhost:3030/dashboards](http://localhost:3030/dashboards) to view
the observability dashboards. Select **Quickstart - consolidated logs**.

![observability dashboard](quickstart/operate/images/38-obs-dash.png)

The default view shows a running stream of all services.

![service stream](quickstart/operate/images/39-service-stream.png)

Change the services filter from “All” to “participant” to view participant logs.
Select any log entry to view its details.

![log entry details](quickstart/operate/images/40-log-entry-details.png)

## SV UIs

Navigate to [http://sv.localhost:4000/](http://sv.localhost:4000/) for the SV Web UI.
The SV view displays data directly from the validator in a GUI that is straightforward to navigate.

Login as ‘sv’.

![SV UI login](quickstart/operate/images/33-sv-ui-login.png)
...
![Validator onboarding](quickstart/operate/images/35-validator-onboarding.png)
...
You might be interested in learning more about the App Quickstart [Canton Network quickstart project structure](../configure/project-structure-overview.mdx#quickstart-project-structure-guide) or the [Development journey in the CN Quickstart lifecycle](../configure/dev-journey-in-cnqs-lifecycle.mdx#quickstart-development-journey-lifecycle).
