...
<div class="x2mdx-ref-hero">
  ...
  <p class="x2mdx-ref-summary">Delete an existing identity provider configuration.</p>
...
func main() {
  req, _ := http.NewRequest("DELETE", "http://localhost:7575/v2/idps/{idp-id}", nil)
...
<div class="x2mdx-ref-history" aria-label="Reference history">
  ...
  <div class="x2mdx-ref-history-event x2mdx-ref-history-event--changed" id="history-updated-3-5">
    ...
    <p class="x2mdx-ref-history-event-detail">The DELETE /v2/idps/&#123;idp-id&#125; operation was updated in this snapshot.</p>
