...
{/* COPIED_START source="docs-website:docs/replicated/daml/3.5/sdk/tutorials/smart-contracts/intro.rst" hash="0f1592f4" */}
...
Continue to [Contract Templates](/devnet/appdev/modules/m3-contract-templates) to start building Daml smart contracts.

If you're new to functional programming or want a refresher on Daml's syntax (types, pattern matching, records, type classes), see [Language Fundamentals](/devnet/appdev/modules/m3-language-fundamentals) first. If you have experience with Haskell or other ML-family languages, you can skip it and refer back as needed.