...
{/* COPIED_START source="docs-website:docs/replicated/canton/3.5/sdk/explanations/external-signing/external_signing_hashing_algorithm.rst" hash="bd159eb2" */}

<Warning title="Pre-reviewed Content - Do Not Modify">
This section was copied from existing reviewed documentation.
**Source:** `docs/replicated/canton/3.5/sdk/explanations/external-signing/external_signing_hashing_algorithm.rst`
