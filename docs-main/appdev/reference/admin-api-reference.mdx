...
The Canton Console provides a more ergonomic interface to Admin API operations. See [Essential Commands](/docs-main/global-synchronizer/canton-console/essential-commands) for commonly used console commands.
...
- [Canton Console](/docs-main/global-synchronizer/canton-console/console-overview) — Interactive console access
- [Canton Admin API (GS)](/docs-main/global-synchronizer/reference/canton-admin-api) — GS-focused Admin API reference
