...
Your Daml application sends requests to the [Ledger API](../../../reference/glossary.md#ledger-api) exposed by a participant node to submit changes to the ledger
...
[access the gRPC Ledger API using Java bindings](../develop/contracts-and-transactions-in-java.md#howto-applications-work-with-contracts-java-authorization)
