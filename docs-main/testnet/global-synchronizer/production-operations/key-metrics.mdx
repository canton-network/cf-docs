...
This page covers the metrics that matter most for operational health of your validator or SV node. For the complete metrics catalog, see the [Metrics Reference](/testnet/global-synchronizer/reference/metrics-reference).
...
- [Monitoring Setup](/testnet/global-synchronizer/production-operations/monitoring-setup) — Configuring Prometheus and Grafana
- [Metrics Reference](/testnet/global-synchronizer/reference/metrics-reference) — Complete metrics catalog
