{/* source: daml / daml/3.4/sdk/sdlc-howtos/applications/optimise/contention-avoiding.rst */}
{/* Copyright (c) 2023 Digital Asset (Switzerland) GmbH and/or its affiliates. All rights reserved. */}
{/* SPDX-License-Identifier: Apache-2.0 */}

<a id="build-howto-avoid-contention-issues"></a>
...
Ledger state is read in the following places within the [Daml Execution Model](../../../tutorials/smart-contracts/compose.mdx#execution-model) :
