...
For tests that need a full multi-validator setup, start [LocalNet](/docs-main/appdev/modules/m5-localnet-development) with Docker Compose instead of the sandbox. This is heavier but covers cross-validator scenarios.
