...
2. **Infrastructure**: Meet the [infrastructure requirements](/devnet/global-synchronizer/understand/infrastructure-requirements)
...
<Card title="Infrastructure Requirements" icon="server" href="/devnet/global-synchronizer/understand/infrastructure-requirements">
  Hardware, software, and network requirements.
</Card>

<Card title="Validator Roles" icon="user-gear" href="/devnet/global-synchronizer/understand/validator-roles">
