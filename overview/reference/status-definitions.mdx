{/* source: daml / daml/3.4/overview/reference/status-definitions.rst */}
...
Features or components covered by these docs are [Stable](#id2) by default. [Stable](#id2) features and components constitute Daml’s “public API” in the sense of [Semantic Versioning](releases.mdx#versioning). Feature and components that are not [Stable](#id2) are called “Early Access” and called out explicitly.
...
| Compatibility                                             | Compatibility is covered by [Portability, Compatibility, and Support Durations](compatibility.mdx).         | Compatibility is covered by [Portability, Compatibility, and Support Durations](compatibility.mdx).                           | The feature may only work against specific Daml integrations, or specific API versions, including Early Access ones. | The feature may only work against specific Daml integrations, or specific API versions, including Early Access ones. |
...
| Distribution and Releases                                 | Distributed as part of regular [releases](releases.mdx).                                                    | Distributed as part of regular [releases](releases.mdx).                                                                      | Distributed as part of regular [releases](releases.mdx).                                                             | Releases and distribution may be separate.                                                                           |
...
| Deprecation                                               | May be removed with any new major version 12 months after the date of deprecation.                          | May be removed with any new minor version 1 month after the date of deprecation.                                              | May be removed without warning.                                                                                      | May be removed without warning.                                                                                      |
| Covered by [Semantic Versioning](releases.mdx#versioning) | Yes, part of the “public API”.                                                                              | No, but breaking changes will be documented.                                                                                  | No, and changes may be poorly documented.                                                                            | No, and changes may be poorly documented.                                                                            |
| **Documentation**                                         |                                                                                                             |                                                                                                                               |                                                                                                                      |                                                                                                                      |
| Basic Use                                                 | Fully documented as part of main docs.                                                                      | Fully documented as part of main docs.                                                                                        | Basic documentation as part of main docs.                                                                            | Documentation may be sparse and separate from the main docs.                                                         |
| API, Functionality, and Gaps                              | Fully documented as part of main docs.                                                                      | Fully documented as part of main docs.                                                                                        | Rough indication of targeted functionality and current limitations.                                                  | May be undocumented.                                                                                                 |
| Compatibility                                             | Covered by [Portability, Compatibility, and Support Durations](compatibility.mdx).                          | Covered by [Portability, Compatibility, and Support Durations](compatibility.mdx).                                            | Current compatibility documented as part of main docs.                                                               | May be undocumented.                                                                                                 |
