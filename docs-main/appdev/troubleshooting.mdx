...
For Canton trace IDs, context extraction patterns, and detailed lnav workflows, see [Log Analysis](/appdev/tooling/debugging-tools#log-analysis) in the debugging tools page.
