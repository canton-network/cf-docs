---
title: "POST /v2/updates/update-by-id"
...
api: "POST http://localhost:7575/v2/updates/update-by-id"
authMethod: "bearer"
playground: "interactive"
sidebarTitle: "/v2/updates/update-by-id"
---
...
<div class="x2mdx-ref-hero">
  ...
  <p class="x2mdx-ref-summary">Lookup an update by its ID. If there is no update with this ID, or all the events are filtered, an UPDATE_NOT_FOUND error will be raised.</p>
...
```bash cURL
curl --request POST \
  --url 'http://localhost:7575/v2/updates/update-by-id' \
...
const response = await fetch('http://localhost:7575/v2/updates/update-by-id', {
  method: 'POST',
  headers: {
...
curl_setopt_array($curl, [
    CURLOPT_URL => 'http://localhost:7575/v2/updates/update-by-id',
...
func main() {
  req, _ := http.NewRequest("POST", "http://localhost:7575/v2/updates/update-by-id", bytes.NewBufferString(`{
  "updateId": "<string>",
  "updateFormat": {
    "includeTransactions": {
      "eventFormat": {
...
var request = HttpRequest.newBuilder()
    .uri(URI.create("http://localhost:7575/v2/updates/update-by-id"))
    .header("Authorization", "Bearer <token>")
    .header("Content-Type", "application/json")
...
uri = URI('http://localhost:7575/v2/updates/update-by-id')
...
<div class="x2mdx-ref-history" aria-label="Reference history">
  ...
  <div class="x2mdx-ref-history-event x2mdx-ref-history-event--changed" id="history-updated-3-5">
    ...
    <p class="x2mdx-ref-history-event-detail">The POST /v2/updates/update-by-id operation was updated in this snapshot.</p>
