...
2. **Infrastructure**: Meet [infrastructure requirements](/testnet/global-synchronizer/understand/infrastructure-requirements)
...
<Card title="Validator Setup" icon="server" href="/testnet/global-synchronizer/understand/introduction">
  Begin deploying your validator node.
</Card>

<Card title="Infrastructure Requirements" icon="list-check" href="/testnet/global-synchronizer/understand/infrastructure-requirements">
