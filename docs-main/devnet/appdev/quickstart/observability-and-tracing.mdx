...
description: "Observe and trace requests across Canton quickstart components."
---

{/* COPIED_START source="docs-website:docs/replicated/quickstart/3.5/sdk/quickstart/observe/observability-troubleshooting-overview.rst" hash="57ec2d59" */}

<Warning title="Pre-reviewed Content - Do Not Modify">
This section was copied from existing reviewed documentation.
**Source:** `docs/replicated/quickstart/3.5/sdk/quickstart/observe/observability-troubleshooting-overview.rst`
...
- Local ledger inspection via Daml shell ([https://docs.daml.com/tools/daml-shell/index.html](https://docs.daml.com/tools/daml-shell/index.html))
...
This enables remote debugging of the Java component backend in the user application (backend-service). You can use this to connect an IDE Debugger to the service at runtime if required. We recommend Grafana as your first resort, along with the consolidated logs in Loki. This keeps the system debuggable in production.
...
![AppProvider accepting AppInstallRequest](/images/docs_website/01-app-provider-app-installs.png)

The usual browser-based developer inspection tools can extract the relevant correlation ids:

![Browser developer tools showing correlating ids](/images/docs_website/02-browser-inspection-tool.png)
...
![Browser developer tools showing HTTP call to Backend-Service](/images/docs_website/03-http-backend-service-call.png)

![Browser tool showing payload of HTTP call to Backend-Service](/images/docs_website/04-payload.png)

![Browser tool showing HTTP response from Backend-Service](/images/docs_website/05-http-response.png)
...
![Grafana consolidated logs query for command-id](/images/docs_website/06-grafana-consolidated-logs.png)
...
![Nginx log entry for command-id](/images/docs_website/07-nginx-log.png)
...
![Participant Node log entry for command-id](/images/docs_website/08-participant-node-aggregated-log.png)

Was notified that the transaction was successfully committed to the Canton Ledger:

![Participant Node log entry for transaction commit](/images/docs_website/09-committed-transaction.png)

And finally added to the App-Provider’s local ledger:[^10]

![Participant Node log entry for transaction added to ledger](/images/docs_website/10-app-provider-local-ledger.png)
...
|-----------------|-----|--------------------------------------|
| T ransaction Id |     | 122053c509d405e77eab680a855…2d10bb   |
...
![Tempo span logs link](/images/docs_website/12-temo-span.png)
...
![logs](/images/docs_website/13-logs.png)
...
![Loki query](/images/docs_website/18-loki-query.png)
...
[^4]: Further documentation is available at [https://docs.daml.com/tools/daml-shell/index.html](https://docs.daml.com/tools/daml-shell/index.html)
