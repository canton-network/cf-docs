...
- [LocalNet Development](/devnet/appdev/modules/m5-localnet-development) — Set up and work with the cn-quickstart LocalNet environment
- [CI/CD Integration](/devnet/appdev/modules/m5-ci-cd-integration) — Automate your test pipeline
