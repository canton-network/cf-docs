...
1. Review [infrastructure requirements](/mainnet/global-synchronizer/understand/infrastructure-requirements)
...
1. Start with the [QuickStart](/mainnet/appdev/quickstart)
