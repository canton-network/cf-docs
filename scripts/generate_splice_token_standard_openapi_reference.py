...
DEFAULT_SOURCE_CONFIG = REPO_ROOT / "config" / "x2mdx" / "splice-token-standard-openapi" / "source-artifacts.json"
DEFAULT_CACHE_DIR = REPO_ROOT / ".internal" / "cache" / "x2mdx" / "splice-openapi"
DEFAULT_MANIFEST = REPO_ROOT / ".internal" / "generated" / "x2mdx" / "splice-token-standard-openapi" / "manifest.json"
DEFAULT_OUTPUT_DIR = REPO_ROOT / "docs-main" / "reference" / "splice-token-standard-openapi"
DEFAULT_DOCS_JSON = REPO_ROOT / "docs-main" / "docs.json"
DEFAULT_SOURCE_NAME = "Splice token-standard OpenAPI specs from published decentralized-canton-sync release bundles"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Download published decentralized-canton-sync OpenAPI bundles, materialize the token-standard specs, and render Mintlify pages."
    )
