...
This page covers the metrics that matter most for operational health of your validator or SV node. For the complete metrics catalog, see the [Metrics Reference](/mainnet/global-synchronizer/reference/metrics-reference).
...
- [Monitoring Setup](/mainnet/global-synchronizer/production-operations/monitoring-setup) — Configuring Prometheus and Grafana
- [Metrics Reference](/mainnet/global-synchronizer/reference/metrics-reference) — Complete metrics catalog
