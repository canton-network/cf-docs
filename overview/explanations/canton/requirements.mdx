{/* source: canton / canton/3.4/overview/explanations/canton/requirements.rst */}
...
<a id="system-model-and-trust-assumptions"></a>
...
As detailed in the :ref:`Daml ledger model <da-ledgers>`, the Daml ledger interoperability protocol
...
.. image:: /explanations/canton/images/requirements/da-ledger-architecture.svg
   :width: 100%
   :align: center
...
* **Synchronization**. I want the platform to provide a
  virtual ledger (according to the :ref:`Daml ledger model
...
* **No unnecessary rejections**. I want the system to add all my well-authorized
  ...
  **Exception 2**: If my change request contains an exercise on a contract identifier, and I have not witnessed
  ...
  :ref:`projection of the shared ledger <da-model-projections>` (according to the Daml ledger model), then my change
  request may fail.
...
**Maximum transaction depth:** 100
  ...
  **Example:** The following transaction has a depth of 2:
  ...
  .. image:: /explanations/canton/images/requirements/action-structure-paint-offer.svg
     :align: left
     :width: 70%
...
.. image:: /explanations/canton/images/requirements/consistency-exception-model.svg
   :align: center
   :width: 100%
...
.. image:: /explanations/canton/images/requirements/consistency-exception-ledger.svg
   :align: center
   :width: 100%

.. https://www.lucidchart.com/documents/edit/770beafe-28cf-4e2d-9183-029e8141c7c8/0
.. image:: /explanations/canton/images/requirements/consistency-exception-no-create.svg
   :align: center
   :width: 100%
...
.. image:: /explanations/canton/images/requirements/double-spend-with-stakeholders.svg
   :width: 100%
   :align: center
...
.. image:: /explanations/canton/images/requirements/privacy-leaks-dvp.svg
   :align: center
   :width: 80% */}
{/* comment
.. .. toctree::
