...
import ExternalSpliceMainSpliceRstCodeDocsSrcSvOperatorSvOperationsYaml296 from "/snippets/external/splice/main/splice-rst-code-docs-src-sv-operator-sv-operations-yaml-296.mdx";
import ExternalSpliceMainSpliceRstCodeDocsSrcSvOperatorSvOperationsYaml309 from "/snippets/external/splice/main/splice-rst-code-docs-src-sv-operator-sv-operations-yaml-309.mdx";
import ExternalSpliceMainSpliceRstCodeDocsSrcSvOperatorSvOperationsSql344 from "/snippets/external/splice/main/splice-rst-code-docs-src-sv-operator-sv-operations-sql-344.mdx";
import ExternalSpliceMainSpliceRstCodeDocsSrcSvOperatorSvOperationsSql359 from "/snippets/external/splice/main/splice-rst-code-docs-src-sv-operator-sv-operations-sql-359.mdx";
import ExternalSpliceMainSpliceRstCodeDocsSrcSvOperatorSvOperationsBash482 from "/snippets/external/splice/main/splice-rst-code-docs-src-sv-operator-sv-operations-bash-482.mdx";
import ExternalSpliceMainSpliceRstCodeDocsSrcSvOperatorSvOperationsBash507 from "/snippets/external/splice/main/splice-rst-code-docs-src-sv-operator-sv-operations-bash-507.mdx";
...
- Used for identifying your node *before* it was onboarded to the system. See `sv-identity`.
...
- Used within the CometBFT network spanned by SVs for operating the global synchronizer. See `cometbft-identity`.
...
2.  If the SV whose weight is being adjusted defined `extraBeneficiaries` (as described in `sv-helm`), they will have to update them accordingly. Namely:
