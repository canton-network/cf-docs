...
<Card title="Core Concepts" icon="book" href="/mainnet/overview/understand/core-concepts">
  Understand parties, validators, and synchronizers.
</Card>

<Card title="Start Building" icon="code" href="/mainnet/appdev/get-started/choose-your-path">
