...
The following code examples show you how to initialize the wallet-sdk.

Static configuration initialization where an auth config and ledgerClientUrl are configured. This is the default config that can be used in combination with a non-altered [Localnet](https://docs.canton.network/sdks-tools/development-tools/localnet) running instance.
