...
See [Backend Development](/testnet/appdev/modules/m4-backend-dev) for detailed code examples.

## Related Pages

- [Backend development](/testnet/appdev/modules/m4-backend-dev) -- Using PQS in a Java backend
- [Ledger API](/testnet/sdks-tools/api-reference/ledger-api) -- The underlying transaction stream that PQS consumes
- [LocalNet](/testnet/sdks-tools/development-tools/localnet) -- Pre-configured PQS instances for local development
