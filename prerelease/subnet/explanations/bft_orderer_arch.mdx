<!-- source: canton / canton/3.5/synchronizer/explanations/bft_orderer_arch.rst -->
...
[Sequencer backend](../howtos/configure/sequencer_backend.md#sequencer-backend) options for Synchronizers. When active, the BFT Orderer runs as
...
security and configuration, refer to the [Sequencer backend](../howtos/configure/sequencer_backend.md#sequencer-backend) page.
...
To dynamically [onboard a new Sequencer](../howtos/operate/new_nodes.md#dynamically-adding-sequencers), the Sequencer requires
