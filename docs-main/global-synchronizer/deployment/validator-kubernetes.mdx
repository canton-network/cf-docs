...
You can offer your users a [Wallet Gateway](/integrations/wallet-gateway/overview) and the [Splice Portfolio](/sdks-tools/development-tools/splice-portfolio/overview) next to the wallet UI. Splice does not ship Helm charts for them; see [Wallet Gateway and Splice Portfolio](/global-synchronizer/deployment/validator-wallet-gateway) for how to deploy the upstream charts alongside your validator.
