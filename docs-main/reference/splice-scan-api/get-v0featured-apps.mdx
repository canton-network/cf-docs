---
title: "List every `FeaturedAppRight` registered with the DSO on the ledger"
...
<div class="x2mdx-ref-hero">
  ...
  <h1 class="x2mdx-ref-title">List every `FeaturedAppRight` registered with the DSO on the ledger</h1>
...
<div class="x2mdx-ref-meta-grid">
  ...
  <div class="x2mdx-ref-meta-item">
    ...
    <span class="x2mdx-ref-meta-value">listFeaturedAppRights</span>
  </div>
