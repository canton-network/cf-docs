...
The Canton Console provides a more ergonomic interface to Admin API operations. See [Essential Commands](/mainnet/global-synchronizer/canton-console/essential-commands) for commonly used console commands.
...
- [Canton Console](/mainnet/global-synchronizer/canton-console/console-overview) — Interactive console access
