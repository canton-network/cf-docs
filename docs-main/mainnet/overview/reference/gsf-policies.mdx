...
For details on the CIP process, including how to propose one, see [CIP Reference](/mainnet/overview/reference/what-are-cips). The full list of CIPs is maintained at [github.com/global-synchronizer-foundation/cips](https://github.com/global-synchronizer-foundation/cips).
...
- [SV Governance Reference](/mainnet/overview/reference/sv-governance-reference) -- technical details on the DSO party and voting mechanics
