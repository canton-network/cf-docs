...
<dl class="x2mdx-ref-meta-grid">
  ...
  <a class="x2mdx-ref-card" href="/reference/wallet-gateway-json-rpc/operations/user-api/generateapikey">
...
<dl class="x2mdx-ref-meta-grid">
  ...
  <a class="x2mdx-ref-card" href="/reference/wallet-gateway-json-rpc/operations/user-api/listapikeys">
...
<dl class="x2mdx-ref-meta-grid">
  ...
  <a class="x2mdx-ref-card" href="/reference/wallet-gateway-json-rpc/operations/user-api/listsigningprovidervaults">

    <div class="x2mdx-ref-card-head">
      <h3>listSigningProviderVaults</h3>
...
<dl class="x2mdx-ref-meta-grid">
  ...
  <a class="x2mdx-ref-card" href="/reference/wallet-gateway-json-rpc/operations/user-api/removeapikey">
