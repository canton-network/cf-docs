...
| --- | --- | --- | --- | --- | --- | --- |
| [`dApp API`](/reference/wallet-gateway-json-rpc/specs/dapp-api) | `Spec` | Splice Wallet JSON-RPC dApp API | `0.20.0` | `0.23.0` | - | - |
| [`Remote dApp API`](/reference/wallet-gateway-json-rpc/specs/dapp-remote-api) | `Spec` | Splice Wallet JSON-RPC Remote dApp API | `0.20.0` | `0.23.0` | - | - |
| [`Signing API`](/reference/wallet-gateway-json-rpc/specs/signing-api) | `Spec` | Wallet JSON-RPC Signing API | `0.20.0` | - | - | - |
| [`User API`](/reference/wallet-gateway-json-rpc/specs/user-api) | `Spec` | Splice Wallet JSON-RPC User API | `0.20.0` | `0.21.0`, `0.22.0`, `0.23.0` | - | - |
