...
For Prometheus metrics endpoints, scraping configuration, and Grafana dashboards, see [Monitoring Setup](/devnet/global-synchronizer/production-operations/monitoring-setup).
