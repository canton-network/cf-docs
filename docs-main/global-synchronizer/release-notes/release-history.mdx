...
This page provides a high-level overview of all Global Synchronizer software releases. For detailed notes per version, see [Release Notes](/global-synchronizer/release-notes/release-notes).
