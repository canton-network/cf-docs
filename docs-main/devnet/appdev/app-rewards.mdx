...
- [Canton Coin and Traffic](/devnet/appdev/modules/m4-canton-coin) -- How traffic credits and CC work for application developers
- [Getting Your App Featured](/devnet/overview/understand/getting-app-featured) -- Promotional opportunities on Canton Network
- [Canton Coin overview](/devnet/overview/understand/canton-coin) -- Tokenomics, validator rewards, and governance
