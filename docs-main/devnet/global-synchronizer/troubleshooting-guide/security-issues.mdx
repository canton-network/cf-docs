...
import CantonGlobalSynchronizerTroubleshootingGuideSecurityIssuesL132 from "/snippets/canton-docs/global-synchronizer_troubleshooting-guide_security-issues_L132.mdx";
...
<CantonGlobalSynchronizerTroubleshootingGuideSecurityIssuesL132 />

Key rotation requires careful coordination. Always test in a non-production environment first.

{/* COPIED_START source="docs-website:docs/replicated/canton/3.5/participant/howtos/troubleshoot/tls.rst" hash="633553d6" */}

<Warning title="Pre-reviewed Content - Do Not Modify">
This section was copied from existing reviewed documentation.
**Source:** `docs-website:docs/replicated/canton/3.5/participant/howtos/troubleshoot/tls.rst`
