...
For a detailed explanation of visibility rules, see [Privacy Model Explained](/testnet/overview/learn/privacy-model).
...
You can grant audit access at the smart contract level by adding an auditor party as an observer. The auditor sees the contract and all events that affect it, without being able to modify it. See the [Privacy Model](/testnet/overview/learn/privacy-model) page for code examples of auditor patterns.
...
- [Privacy Model Explained](/testnet/overview/learn/privacy-model) -- Full details on sub-transaction privacy
- [Security Best Practices](/testnet/appdev/modules/m7-security) -- Securing your Canton application
- [Architecture Overview](/testnet/overview/learn/architecture) -- How validators and synchronizers relate
