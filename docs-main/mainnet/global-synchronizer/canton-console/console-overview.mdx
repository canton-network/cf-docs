...
docker run -it --rm --network host \
  ...
  digitalasset/canton:3.4.12 --console
```

Replace `3.4.12` with the Canton version matching your deployment. Check available versions at [Docker Hub](https://hub.docker.com/r/digitalasset/canton/tags).
...
- [Essential Commands](/mainnet/global-synchronizer/canton-console/essential-commands) — Key commands for health checks, party and package management
- [Debugging Workflows](/mainnet/global-synchronizer/canton-console/debugging-workflows) — Step-by-step diagnostic procedures
