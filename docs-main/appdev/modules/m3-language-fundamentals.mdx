...
Daml has its own version of the [Hoogle](https://hoogle.haskell.org/) search engine, which offers search both by name and by signature. For a pure standard library search, use [https://hoogle.daml.com](https://hoogle.daml.com).
