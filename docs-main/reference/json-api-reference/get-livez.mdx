...
<div class="x2mdx-ref-hero">
  ...
  <p class="x2mdx-ref-summary">Checks if the service is alive</p>
...
const response = await fetch('http://localhost:7575/livez', {
  method: 'GET',
  headers: {
...
curl_setopt_array($curl, [
    CURLOPT_URL => 'http://localhost:7575/livez',
...
func main() {
  req, _ := http.NewRequest("GET", "http://localhost:7575/livez", nil)
...
var request = HttpRequest.newBuilder()
    .uri(URI.create("http://localhost:7575/livez"))
    .header("Authorization", "Bearer <token>")
...
uri = URI('http://localhost:7575/livez')
