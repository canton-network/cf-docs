...
The following example shows how to specify a custom `foo` component,
local `codegen-python` component, and a `damlc` default component without relying on an sdk-version:

``` yaml
# daml.yaml

components:
  # component "damlc" at version 3.5.2
  - damlc:3.5.2
...
<Warning>
When using this Dpm Components feature, you should not specify
