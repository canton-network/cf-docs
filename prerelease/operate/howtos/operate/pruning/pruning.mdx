<!-- source: canton / canton/3.5/participant/howtos/operate/pruning/pruning.rst -->
<!-- Copyright (c) 2026 Digital Asset (Switzerland) GmbH and/or its affiliates. All rights reserved. -->
<!-- SPDX-License-Identifier: Apache-2.0 -->

<a id="participant-node-pruning-howto"></a>
...
Refer to the backup and restore for specifics.
