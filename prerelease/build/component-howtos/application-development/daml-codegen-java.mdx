<!-- source: daml / daml/3.5/sdk/component-howtos/application-development/daml-codegen-java.rst -->
...
See [How to work with contracts and transactions in Java](../../sdlc-howtos/applications/develop/contracts-and-transactions-in-java.md#howto-applications-work-with-contracts-java) for details on how to use the generated classes. See the sections below for guidance on setting up and invoking the codegen.

## Install

Install the Daml Codegen for Java by [installing DPM](../../dpm/dpm.md#dpm).
...
A [Daml record](../../reference/daml/data-types.md#daml-ref-record-types) is represented by a Java class with fields that have the same name as the Daml record fields. A Daml field having the type of another record is represented as a field having the type of the generated class for that record.
...
An enum type is a simplified [sum type](../../reference/daml/data-types.md#daml-ref-sum-types) with multiple
...
The Daml Codegen uses Java Generic types to represent [Daml parameterized types](../../reference/daml/data-types.md#daml-ref-parameterized-types).
