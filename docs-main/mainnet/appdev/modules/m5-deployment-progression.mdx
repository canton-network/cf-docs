...
<Note>
For detailed upgrade procedures, see the [Upgrade Procedures](/mainnet/global-synchronizer/production-operations/upgrade-procedures) page.
</Note>
...
- [Environment Configuration](/mainnet/appdev/modules/m5-environment-configuration) — DPM configuration for each environment
- [CI/CD Integration](/mainnet/appdev/modules/m5-ci-cd-integration) — Automating the promotion pipeline
