---
title: "POST /registry/allocations/v1/:allocationId/choice-contexts/execute-transfer"
...
sidebarTitle: "/registry/allocations/v1/:allocationId/choice-contexts/execute-transfer"
---
...
<div class="x2mdx-ref-hero">
  ...
  <p class="x2mdx-ref-summary">Get the choice context to execute a transfer on an allocation.</p>
...
const response = await fetch('https://example.com/registry/allocations/v1/{allocationId}/choice-contexts/execute-transfer', {
  method: 'POST',
  headers: {
...
curl_setopt_array($curl, [
    CURLOPT_URL => 'https://example.com/registry/allocations/v1/{allocationId}/choice-contexts/execute-transfer',
...
func main() {
  req, _ := http.NewRequest("POST", "https://example.com/registry/allocations/v1/{allocationId}/choice-contexts/execute-transfer", bytes.NewBufferString(`{
  "meta": {},
  "excludeDebugFields": false
}`))
...
var request = HttpRequest.newBuilder()
    .uri(URI.create("https://example.com/registry/allocations/v1/{allocationId}/choice-contexts/execute-transfer"))
    .header("Content-Type", "application/json")
...
uri = URI('https://example.com/registry/allocations/v1/{allocationId}/choice-contexts/execute-transfer')
