---
title: "Participant High Availability"
description: "Configure active/passive participant replicas with shared storage and load balancer health checks"
---

import ExternalCantonMainCommunityAppSrcTestScalaComDigitalassetCantonIntegrationTestsHaSetPassive from "/snippets/external/canton/main/community/app/src/test/scala/com/digitalasset/canton/integration/tests/ha-set-passive.mdx";
import ExternalCantonMainCommunityAppSrcTestResourcesHealthCheckIsActive from "/snippets/external/canton/main/community/app/src/test/resources/health-check-is-active.mdx";

{/* COPIED_START source="canton:docs-open/src/sphinx/participant/howtos/operate/ha/ha.rst" */}
...
<ExternalCantonMainCommunityAppSrcTestScalaComDigitalassetCantonIntegrationTestsHaSetPassive />
...
<ExternalCantonMainCommunityAppSrcTestResourcesHealthCheckIsActive />
...
See also [High Availability](/global-synchronizer/production-operations/high-availability) for synchronizer HA and related console commands.
