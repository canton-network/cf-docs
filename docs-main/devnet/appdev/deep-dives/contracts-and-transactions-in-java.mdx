---
title: "Contracts and Transactions in Java"
description: "Work with Daml contracts and transactions through the Java client libraries."
---

import DevelopPomSnippetDependencyBindingsJava from '/snippets/daml-docs/develop_pom_snippet_dependency_bindings_java.mdx';


{/* COPIED_START source="docs-website:docs/replicated/daml/3.5/sdk/sdlc-howtos/applications/develop/contracts-and-transactions-in-java.rst" hash="b2acac32" */}

<Warning title="Pre-reviewed Content - Do Not Modify">
This section was copied from existing reviewed documentation.
**Source:** `docs/replicated/daml/3.5/sdk/sdlc-howtos/applications/develop/contracts-and-transactions-in-java.rst`
