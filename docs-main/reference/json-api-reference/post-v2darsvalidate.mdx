...
<div class="x2mdx-ref-hero">
  ...
  <p class="x2mdx-ref-summary">Validates the DAR and checks the upgrade compatibility of the DAR&#x27;s packages with the set of the already vetted packages on the target vetting synchronizer. See ValidateDarFileRequest for details regarding the target vetting synchronizer. The operation has no effect on the state of the participant or the Canton ledger: the DAR payload and its packages are not persisted neither are the packages vetted.</p>
...
Invalid value, Invalid value for: body, Invalid value for: query parameter synchronizerId
...
<div class="x2mdx-ref-history" aria-label="Reference history">
  ...
  <div class="x2mdx-ref-history-event x2mdx-ref-history-event--changed" id="history-updated-3-5">
    ...
    <p class="x2mdx-ref-history-event-detail">The POST /v2/dars/validate operation was updated in this snapshot.</p>
