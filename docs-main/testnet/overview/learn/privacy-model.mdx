...
- **[The Global Synchronizer](/testnet/overview/understand/global-synchronizer)** - Understand the public network infrastructure
- **[Developer Track Module 3: Daml Development](/testnet/appdev/modules/m3-dev-environment)** - Apply privacy patterns in code
- **[Glossary](/testnet/overview/understand/glossary)** - Terminology reference including privacy-related terms
