...
{/* Source: splice/docs/src/overview/overview.rst, splice/docs/src/background/tokenomics/ (overview, traffic, sv_live, val_live, feat_app_act_marker), splice/docs/src/deployment/traffic.rst, splice/daml/splice-amulet/daml/Splice/Issuance.daml */}
...
{/* Begin block from splice/docs/src/overview/overview.rst lines 58-69 */}
...
{/* Begin block from splice/docs/src/deployment/traffic.rst lines 57-67 */}
...
{/* End block from traffic.rst */}

### Extra Traffic (Purchased by Burning CC)

{/* Begin block from splice/docs/src/background/tokenomics/traffic_tokenomics.rst lines 10-17 */}
...
{/* End block from traffic_tokenomics.rst */}
...
- **`SvRewardCoupon`** -- one per Super Validator per round. SV minting rights are granted by the tokenomics committee through the [CIP process](https://github.com/global-synchronizer-foundation/cips) in exchange for operating SV infrastructure or contributing key resources.
