...
<Card title="Use Cases" icon="building" href="/devnet/overview/understand/use-cases">
...
<Card title="Architecture Deep Dive" icon="diagram-project" href="/devnet/overview/learn/architecture">
  Understand how components work together technically.
</Card>

<Card title="Privacy Model" icon="lock" href="/devnet/overview/learn/privacy-model">
