<!-- source: daml / daml/3.5/sdk/tutorials/smart-contracts/contracts.rst -->
...
In [Test templates using Daml scripts](daml-scripts.md), you’ll learn about how to try out the `Token` contract template in Daml’s inbuilt Daml Script testing language.
