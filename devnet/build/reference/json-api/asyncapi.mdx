...
The specification covers streaming (websockets) endpoints - for regular endpoints (HTTP) please see [JSON Ledger API OpenAPI definition](openapi.md#reference-json-api-openapi)

Properties of type: {} (any Json value) are Daml values as defined in the Daml template and formatted according to [Daml-LF JSON encoding](lf-value-specification.md#reference-json-lf-value-specification).
