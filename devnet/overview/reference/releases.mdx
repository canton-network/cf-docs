...
Weekly snapshot and Minor releases follow a common process. The process is documented [in the Daml repository.](https://github.com/digital-asset/daml/blob/main/release/RELEASE)  Only the schedule for Minor releases is covered below.
