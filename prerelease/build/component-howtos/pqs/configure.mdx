<!-- source: pqs / pqs/3.5/component-howtos/pqs/configure.rst -->
...
SQL functions (see [SQL API](references/sql-api.md#pqs-references-sql-api)), and this **cannot be changed**. Since a change in scope will result in a
...
`created_event_blob` (see [How do stakeholders disclose contracts to submitters?](../../sdlc-howtos/applications/develop/explicit-contract-disclosure.md#stakeholder-contract-share)) from the respective event.
