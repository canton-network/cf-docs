...
<Note>Canton creates, manages and upgrades the database schema directly on startup.</Note>
...
<Warning>The following storage configurations are not supported for production deployments. They are provided for testing, development, and experimental purposes only.</Warning>
