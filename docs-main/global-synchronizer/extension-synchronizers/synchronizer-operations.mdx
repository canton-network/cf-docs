...
This page is a reference for configuring, bootstrapping, and operating synchronizer nodes. For a step-by-step dedicated synchronizer walkthrough (Helm, databases, initialize, connect validators), see [Deploying a Dedicated Synchronizer](/global-synchronizer/extension-synchronizers/deployment).
