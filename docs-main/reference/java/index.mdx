...
| NAME | STATUS | SUMMARY |
| --- | --- | --- |
| [`com.daml.ledger.javaapi.data`](com-daml-ledger-javaapi-data/index) | 🟢 `3.4.8` 🔵 `3.4.11` | 142 types. No lifecycle changes in selected range. |
| [`com.daml.ledger.javaapi.data.codegen`](com-daml-ledger-javaapi-data-codegen/index) | 🟢 `3.4.8` | 31 types. No lifecycle changes in selected range. |
| [`com.daml.ledger.javaapi.data.codegen.json`](com-daml-ledger-javaapi-data-codegen-json/index) | 🟢 `3.4.8` | 12 types. No lifecycle changes in selected range. |
