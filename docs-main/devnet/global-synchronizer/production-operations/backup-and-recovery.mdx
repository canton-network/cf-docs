...
<div className="todo">
**TODO (DevNet, Splice 0.6.x):** Splice 0.6 removes Hard Domain Migration (HDM)-based recovery in favor of Logical Synchronizer Upgrade (LSU). Disaster-recovery procedures that depend on migration dumps or migration ID coordination need rewriting for LSU. See [Splice 0.6 release notes](https://docs.dev.sync.global/release_notes.html).
</div>
...
- [Security Operations](/devnet/global-synchronizer/production-operations/security-operations) — Key management and security hardening
- [Upgrade Procedures](/devnet/global-synchronizer/production-operations/upgrade-procedures) — Major and minor upgrade processes

{/* COPIED_START source="docs-website:docs/replicated/canton/3.5/participant/howtos/recover/repairing.rst" hash="a821b734" */}

<Warning title="Pre-reviewed Content - Do Not Modify">
This section was copied from existing reviewed documentation.
**Source:** `docs-website:docs/replicated/canton/3.5/participant/howtos/recover/repairing.rst`
Reviewers: Skip this section. Remove markers after final approval.
</Warning>
