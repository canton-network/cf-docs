...
{/* COPIED_START source="docs-website:canton/3.4/sdk/tutorials/json-api/canton_and_the_json_ledger_api.rst" hash="json-api-command-submit" */}

<Warning title="Pre-reviewed Content - Do Not Modify">
This section was adapted from existing reviewed documentation.
**Source:** `canton/3.4/sdk/tutorials/json-api/canton_and_the_json_ledger_api.rst`
...
{/* COPIED_START source="docs-website:canton/3.4/sdk/tutorials/json-api/canton_and_the_json_ledger_api.rst" hash="json-api-acs-query" */}
...
- [Ledger API](/mainnet/sdks-tools/api-reference/ledger-api) — gRPC Ledger API overview
- [Ledger API Reference (AppDev)](/api-reference) — Detailed service documentation
- [Wallet Configuration](/mainnet/integrations/wallet/configuration) — SDK configuration including JSON API endpoints
