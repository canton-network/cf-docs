...
You can also view the published versions and tags of a component via `dpm tags` (see the [Listing tags](/sdks-tools/cli-tools/dpm#listing-available-tags-and-versions-in-an-oci-repository) docs section).
...
You should now be able to see the published version via `dpm tags` see the [Listing tags](/sdks-tools/cli-tools/dpm#listing-available-tags-and-versions) docs section.
