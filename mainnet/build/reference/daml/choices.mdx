...
This page gives reference information on choices. For information on the high-level structure of a choice, see [Overview: Template Structure](structure.md).
...
- The choice body contains `Update` expressions. For detail on this, see [Reference: Updates](updates.md).
