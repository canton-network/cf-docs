<!-- source: canton / canton/3.5/participant/howtos/secure/kms/migration/kms_migration.rst -->
...
1. [Migrate to encrypted private key storage with a Key Management Service (KMS)](encrypted_key_storage_migration.md#encrypted-key-storage-migration)
...
2. [Migrate to external key storage with a Key Management Service (KMS)](external_key_storage_migration.md#external-key-storage-migration)
...
* [Migrate to encrypted private key storage with KMS](encrypted_key_storage_migration.md)
* [Migrate to external key storage with a KMS](external_key_storage_migration.md)
