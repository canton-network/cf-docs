...
This section will be expanded in a future update. Topology metrics track synchronizer membership changes and party-to-participant mappings. For monitoring guidance, see [Performance Optimization](/docs-main/global-synchronizer/production-operations/performance-optimization).
