...
Aim for high coverage on all choices that will run in production. See the [testing guide](/testnet/appdev/modules/m3-testing) for a detailed walkthrough.

## Related Pages

- [Testing Daml Contracts](/testnet/appdev/modules/m3-testing) -- Full testing tutorial with examples
- [Sandbox](/testnet/sdks-tools/development-tools/sandbox) -- Integration testing beyond Daml Script
- [dpm command reference](/testnet/sdks-tools/cli-tools/dpm) -- `dpm test` options and flags
...
Contracts are also archived whenever a [consuming choice](/testnet/overview/reference/ledger-model-detailed#choices-in-the-ledger-model) is exercised.
