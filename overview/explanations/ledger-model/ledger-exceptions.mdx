{/* source: daml / daml/3.4/overview/explanations/ledger-model/ledger-exceptions.rst */}
{/* Copyright (c) 2023 Digital Asset (Switzerland) GmbH and/or its affiliates. All rights reserved. */}
{/* SPDX-License-Identifier: Apache-2.0 */}
<Note>This page is a work in progress. It may contain incomplete or incorrect information.</Note>

<a id="da-model-exceptions"></a>

# Exceptions

<Note>Exceptions have been deleted from 3.3 and will be replaced via an explicit failure mechanism
Therefore, document the failure mechanism but get rid of this entire doc</Note>
...
{/* https://lucid.app/lucidchart/fb34c83b-8db7-4063-83f1-38e796225fe4/edit */}![The paint agreement flowchart incorporating a rollback from Bank1 and a transfer from Bank2.](explanations/ledger-model/images/exception-structure-example.svg)
...
{/* https://lucid.app/lucidchart/8f18f7be-89b8-42f9-93a2-b995a5030a9e/edit */}![The paint agreement flowchart with a nested rollback as described in the preceding paragraph.](explanations/ledger-model/images/exception-structure-example-nested.svg)

## Consistency

In the previous section on [consistency](ledger-integrity.mdx#da-model-consistency),
...
![The paint agreement flowchart with rollbacks, showing continuity for a scenario where Bank1 provides the Iou.](explanations/ledger-model/images/exception-integrity-continuity-1.svg)

The second:

{/* https://lucid.app/lucidchart/f1f92199-ae41-4de2-b1bf-0925d3ab89c9/edit */}![The paint agreement flowchart with rollbacks, showing continuity for a scenario where Bank2 provides the Iou.](explanations/ledger-model/images/exception-integrity-continuity-2.svg)

And the third:

{/* https://lucid.app/lucidchart/77d97798-8651-41dc-bb8b-abecf05f81bb/edit */}![The paint agreement flowchart with rollbacks, showing continuity for a scenario where the transaction is cancelled.](explanations/ledger-model/images/exception-integrity-continuity-3.svg)
...
{/* https://lucid.app/lucidchart/3aa5922f-ec30-4896-8bbc-56703549c7e5/edit */}![Three flowcharts where a transaction leads to act1, act2, and act3; each has two rollbacks, but the rollbacks are placed differently in each.](explanations/ledger-model/images/exception-normalization-1.svg)
...
{/* https://lucid.app/lucidchart/8a5a09a1-5473-4abf-a72a-57bf03b56794/edit */}![The same set of three transactions as above, illustrating how they all normalize to the center flowchart as described below.](explanations/ledger-model/images/exception-normalization-2.svg)
...
[the old definition](ledger-integrity.mdx#da-ledgers-authorization-rules).
...
{/* https://lucid.app/lucidchart/1714e8d2-0c2d-4bbf-9b48-2266b2cd6c9d/edit */}![A flowchart with the portions invisible to Bank1 in light gray and the visible portion in dark gray, with the visible portion after normalization illustrated as a simpler flowchart at bottom right.](explanations/ledger-model/images/exception-projection-example.svg)
...
{/* https://lucid.app/lucidchart/2d48d3db-bfcd-4936-b3f2-efe29470b2b6/edit */}![A flowchart showing the transaction that results when Daml creates a rollback node due to an exception.](explanations/ledger-model/images/exception-daml-example.svg)
