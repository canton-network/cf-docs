...
See [Storage Optimization](../../optimize/storage.md#optimize-storage).

### Backup

See [Backup and Restore](../../recover/backup-restore.md#backup-and-restore).

### Setup HA

See [High Availability Usage](../../operate/ha/ha.md#ha-user-manual).
