<!-- source: daml / daml/3.5/overview/explanations/ledger-model/ledger-integrity.rst -->
...
The link between Daml and contract models is explained in more detail in a [later section](ledger-daml.md#da-model-daml).
