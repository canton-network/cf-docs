...
build Daml Archive (.dar) files](../../sdlc-howtos/smart-contracts/build/how-to-build-dar-files.md#build-howto-build-dar-files)
...
In [Data types](data.md) you will learn about Daml’s type system, and how you
