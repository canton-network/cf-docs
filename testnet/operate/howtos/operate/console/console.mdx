...
[TLS](../../secure/apis/tls.md#tls-configuration) with mutual authentication.
...
but the participant references also support some [generic commands](../../../reference/console.md#participants-references) for actions that often have to be performed for many
...
This service is then used by the console command [health.ping](../../../reference/console.md#health-ping).
