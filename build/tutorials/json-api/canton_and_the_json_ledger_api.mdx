{/* source: canton / canton/3.4/sdk/tutorials/json-api/canton_and_the_json_ledger_api.rst */}
{/* Copyright (c) 2025 Digital Asset (Switzerland) GmbH and/or its affiliates. All rights reserved. */}
{/* SPDX-License-Identifier: Apache-2.0 */}

<a id="tutorial-canton-and-the-json-ledger-api"></a>
...
(check installed dpm version by entering in bash console `dpm version --active`, it should be at least )
```
...
<Note>To simplify this tutorial, no security-related configuration is used. You will be able to send commands as any user.</Note>
...
<Note>You can use the http://localhost:757/livez endpoint to check whether the server is running. It might be used as a health check in production environments.</Note>
...
Read more about the OpenAPI and AsyncAPI specifications for the Canton JSON Ledger API: [JSON Ledger API references](../../reference/json-api/json-api.mdx#references-json-api).

### Authentication and security

Read how to configure and use jwt token to access JSON Ledger API [Access Tokens](../../explanations/json-api/index.mdx#json-api-access-tokens).

### Error codes

For more information about error codes returned by the JSON Ledger API, see [HTTP Status Codes](../../explanations/json-api/index.mdx#json-error-codes).
