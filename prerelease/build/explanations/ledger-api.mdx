<!-- source: daml / daml/3.5/sdk/explanations/ledger-api.rst -->
...
Ledger API services as [JSON Ledger API](json-api/index.md#json-api).

For a high level introduction to the services see [The gRPC Ledger API Services](ledger-api-services.md#ledger-api-services).
...
You can access the gRPC Ledger API via the [Java bindings](../component-howtos/application-development/client-libraries/java-client-libraries.md#component-howtos-application-development-java-client-libraries-bindings-java).
...
If you don’t want to use the gRPC API, you can also use the [JSON Ledger API](json-api/index.md#json-api). This API is formally
described using an [openapi](../reference/json-api/openapi.md#reference-json-api-openapi) and [asyncapi](../reference/json-api/asyncapi.md#reference-json-api-asyncapi)
...
When you [compile Daml source into a .dar file](../sdlc-howtos/smart-contracts/build/how-to-build-dar-files.md#build-howto-build-dar-files), the underlying format is Daml-LF. Daml-LF is similar to Daml, but is stripped down to a core set of features. The relationship between the surface Daml syntax and Daml-LF is loosely similar to that between Java and JVM bytecode.
...
For the most part the translation of types from Daml to Daml-LF should not be surprising. [This page goes through all the cases in detail](../reference/damllf/daml-lf-translation.md#daml-lf-translation).
