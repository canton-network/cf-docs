...
- Communicate upgrade timelines (see [Upgrade Deployment](/devnet/appdev/modules/m6-deployment))
...
- [Security Best Practices](/devnet/appdev/modules/m7-security) — Securing your packages and deployment pipeline
