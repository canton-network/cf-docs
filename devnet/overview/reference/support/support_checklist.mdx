<!-- source: canton / canton/3.4/overview/reference/support/support_checklist.rst -->
<!-- Copyright (c) 2025 Digital Asset (Switzerland) GmbH and/or its affiliates. All rights reserved. -->
<!-- SPDX-License-Identifier: Apache-2.0 -->

<a id="support-checklist"></a>
...
The troubleshooting guide goes into detail on how to use the information and tools
...
* **Download the Health Dump**
  > Using the admin console, you can run node.health.dump() to download a health dump of the node.
...
* **Access to Readable Logs**
  ...
  > If you need custom loggers, please add them as an extension to the built-in [logback.xml](https://github.com/digital-asset/canton/blob/main/community/app/src/main/resources/logback.xml).
