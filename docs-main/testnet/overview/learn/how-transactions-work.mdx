...
- [Architecture Overview](/testnet/overview/learn/architecture) -- How validators, synchronizers, and applications fit together
- [Privacy Model Explained](/testnet/overview/learn/privacy-model) -- Detailed explanation of sub-transaction privacy and view decomposition
- [Two-Layer Consensus](/testnet/overview/learn/two-layer-consensus) -- The consensus protocol in more technical detail
