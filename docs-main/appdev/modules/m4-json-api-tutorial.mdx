...
Read more about the OpenAPI and AsyncAPI specifications for the Canton JSON Ledger API: [JSON API configuration](/sdks-tools/api-reference/json-api#configuration).
