...
{/* COPIED_START source="canton:release-notes/3.4.11.md" */}

<Warning title="Pre-reviewed Content - Do Not Modify">
This section was copied verbatim from upstream Canton release notes. **Source:** `release-notes/3.4.11.md` Reviewers: skip this section.
</Warning>
