<!-- source: quickstart / quickstart/3.5/sdk/quickstart/operate/explore-the-demo.rst -->
...
You might be interested in learning more about the App Quickstart [Canton Network quickstart project structure](../configure/project-structure-overview.md#quickstart-project-structure-guide) or the [Development journey in the CN Quickstart lifecycle](../configure/dev-journey-in-cnqs-lifecycle.md#quickstart-development-journey-lifecycle).
