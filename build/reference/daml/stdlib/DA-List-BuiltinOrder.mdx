{/* source: daml / daml/3.4/sdk/reference/daml/stdlib/DA-List-BuiltinOrder.rst */}
...
[dedupOn]()
: : [Ord](Prelude.mdx#class-ghc-classes-ord-6395) k => (v -> k) -> [v] -> [v]
  <br/>
...
[sortOn]()
: : [Ord](Prelude.mdx#class-ghc-classes-ord-6395) b => (a -> b) -> [a] -> [a]
  <br/>
