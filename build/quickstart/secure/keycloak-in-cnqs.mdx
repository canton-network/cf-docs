...
</Note>![Keycloak user details](quickstart/secure/images/61-keycloak-alice.png)
...
</Note>![Keycloak user details](quickstart/secure/images/61-keycloak-participant.png)
