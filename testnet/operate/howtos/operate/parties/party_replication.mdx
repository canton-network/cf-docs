...
1. [Create the party](parties.md#party-management), either in the namespace of a
   participant or in a dedicated namespace.
2. [Vet packages](../packages/packages.md#package-vetting).
...
[Create a party](parties.md#party-management) Alice:
...
[Vet packages](../packages/packages.md#package-vetting) on the target participant(s) **before** proceeding.
...
Ensure the target participant [vets all packages](../packages/packages.md#package-vetting) associated with
