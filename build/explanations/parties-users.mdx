{/* source: canton / canton/3.4/sdk/explanations/parties-users.rst */}
{/* Copyright (c) 2025 Digital Asset (Switzerland) GmbH and/or its affiliates. All rights reserved. */}
{/* SPDX-License-Identifier: Apache-2.0 */}

<a id="parties-and-users"></a>

# Parties and users on a Canton ledger

Identifying parties and users is an important part of building a workable Canton application. Recall these definitions from the [Get started with Canton and the JSON Ledger API](../tutorials/json-api/canton_and_the_json_ledger_api.mdx#tutorial-canton-and-the-json-ledger-api):
...
<Note>If you are working with a Canton sandbox, the keys are generated randomly. As a consequence the suffix will look different locally and every time you restart Sandbox and you will get a different party ID.</Note>
