...
- **dpm** -- See [dpm installation](/mainnet/sdks-tools/cli-tools/dpm) for setup instructions
...
For a full introduction to the Daml language, see [Module 3: Daml Smart Contracts](/mainnet/appdev/modules/m3-dev-environment).
...
- [dpm command reference](/mainnet/sdks-tools/cli-tools/dpm) -- Full list of `dpm` commands and options
- [Daml Studio](/mainnet/sdks-tools/development-tools/daml-studio) -- VS Code extension for Daml development
- [Sandbox](/mainnet/sdks-tools/development-tools/sandbox) -- Local single-node testing environment
