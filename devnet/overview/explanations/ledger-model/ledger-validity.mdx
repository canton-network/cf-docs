...
[Consistency](ledger-integrity.md#da-model-consistency)
...
[Conformance](ledger-integrity.md#da-model-conformance)
: Only a restricted set of actions is allowed on a given contract.

[Authorization](ledger-integrity.md#da-model-authorization)
