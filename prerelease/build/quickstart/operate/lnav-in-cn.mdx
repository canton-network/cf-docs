<!-- source: quickstart / quickstart/3.5/sdk/quickstart/operate/lnav-in-cn.rst -->
...
For detailed step-by-step instructions with screenshots, see [Explore the Canton Network Application Quickstart demo](explore-the-demo.md#quickstart-explore-the-demo).
