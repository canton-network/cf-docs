...
description: "Daml-LF type conversion, JSON encoding, Protobuf mapping, and DAR file structure"
---
...
```daml
-- Code from: code-snippets/LfTranslation.daml
...
```daml
-- Code from: code-snippets/LfResults.daml
-- [Include actual code example here]
```
...
```protobuf
-- Code from: code-snippets/notation.proto
-- [Include actual code example here]
```
...
```daml
-- Code from: code-snippets/notation.payload
-- [Include actual code example here]
```
...
```daml
-- Code from: code-snippets/Types.daml
-- [Include actual code example here]
```
...
```daml
-- Code from: code-snippets/records.payload
-- [Include actual code example here]
```
...
```daml
-- Code from: code-snippets/MySumType.payload
-- [Include actual code example here]
```
...
```daml
-- Code from: code-snippets/Templates.daml
-- [Include actual code example here]
```
...
```daml
-- Code from: code-snippets/CreateMySimpleTemplate.payload
-- [Include actual code example here]
```
...
```daml
-- Code from: code-snippets/CreatedEventMySimpleTemplate.payload
-- [Include actual code example here]
```
...
```daml
-- Code from: code-snippets/ExerciseMySimpleTemplate.payload
-- [Include actual code example here]
```
...
```daml
-- Code from: code-snippets/ExerciseByKeyMySimpleTemplate.payload
-- [Include actual code example here]
```
...
Note that `name` and `version` will be `null for packages in Daml-LF \ prints all of the code in the main package of that DAR file in a human-readable format.
...
The `inspect` tool also accepts DALF files; running dpm damlc inspect on a DALF file prints all of the code in that DALF file.
