---
title: "Values in the Ledger API"
description: "Validation, normalization, and dynamic package resolution rules for values exchanged over the Ledger API."
---

{/* COPIED_START source="docs-website:docs/replicated/daml/3.5/sdk/reference/smart-contract-upgrades.rst#values-in-the-ledger-api" */}

<Warning title="Pre-reviewed Content - Do Not Modify">
This section was copied from existing reviewed documentation.
**Source:** `docs/replicated/daml/3.5/sdk/reference/smart-contract-upgrades.rst` (section: Values in the Ledger API)
