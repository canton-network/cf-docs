...
| Write my first smart contract | [Module 3: Daml Smart Contracts](/docs-main/appdev/modules/m3-dev-environment) |
| Run the example application | [QuickStart](/docs-main/appdev/quickstart) |
| Deploy a validator node | [Validator Setup](/docs-main/global-synchronizer/understand/introduction) |
| Integrate a wallet into my app | [Integrations Overview](/docs-main/integrations/overview) |
