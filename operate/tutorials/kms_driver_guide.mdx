{/* source: canton / canton/3.4/participant/tutorials/kms_driver_guide.rst */}
{/* Copyright (c) 2025 Digital Asset (Switzerland) GmbH and/or its affiliates. All rights reserved. */}
{/* SPDX-License-Identifier: Apache-2.0 */}

<a id="kms-driver-guide"></a>
...
Canton uses [pureconfig](https://pureconfig.github.io/) configuration library
...
[canton-kms-driver-testing](https://digitalasset.jfrog.io/ui/repos/tree/General/canton-kms-driver-testing).
