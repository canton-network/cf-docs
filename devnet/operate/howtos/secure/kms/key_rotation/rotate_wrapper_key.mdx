...
To permanently delete the previous key, see [Delete Canton node keys](../../keys/key_management.md#deleting-canton-keys).
...
First, you must create a new wrapper key in your KMS that meets the requirements described [here](../mode/encrypted_key_storage.md#wrapper-key-requirements).
