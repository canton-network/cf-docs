...
2.  Allow [Direnv](#clone-from-github) to provision the development toolchain from the repository root: `direnv allow`
3.  Verify that the [Docker Desktop](#docker) app is running on your computer: `docker info`
4.  Login to Docker repositories via the terminal: `docker login`
