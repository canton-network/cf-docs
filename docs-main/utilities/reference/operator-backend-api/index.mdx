...
The API specifications and base URLs for the Token Standard endpoints are documented [here](/docs-main/utilities/overview/registry-user-guide/token-standard#operator_backend_token_standard_endpoints).
