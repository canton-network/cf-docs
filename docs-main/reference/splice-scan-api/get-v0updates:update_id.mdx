---
title: "GET /v0/updates/:update_id"
...
sidebarTitle: "/v0/updates/:update_id"
---
...
<div class="x2mdx-ref-hero">
  ...
  <p class="x2mdx-ref-summary">**Deprecated**, use /v2/updates/&#123;update_id&#125; instead.</p>
...
const response = await fetch('https://scan.sv-1.global.canton.network.sync.global/api/scan/v0/updates/{update_id}', {
  method: 'GET',
});
...
curl_setopt_array($curl, [
    CURLOPT_URL => 'https://scan.sv-1.global.canton.network.sync.global/api/scan/v0/updates/{update_id}',
...
func main() {
  req, _ := http.NewRequest("GET", "https://scan.sv-1.global.canton.network.sync.global/api/scan/v0/updates/{update_id}", nil)
...
var request = HttpRequest.newBuilder()
    .uri(URI.create("https://scan.sv-1.global.canton.network.sync.global/api/scan/v0/updates/{update_id}"))
...
uri = URI('https://scan.sv-1.global.canton.network.sync.global/api/scan/v0/updates/{update_id}')
