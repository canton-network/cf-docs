...
| [`/v2/package-vetting`](#endpoint-path-v2-package-vetting) | 🟢 `v3.4` 🔵 `v3.5` | GET: Lists which participant node vetted what packages on which synchronizer. Can be called by any authenticated user.; POST: Update the vetted packages of this participant |
