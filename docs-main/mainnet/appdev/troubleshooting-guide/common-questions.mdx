...
Answers to questions that come up regularly in Canton Network application development. For validator operations questions, see the [Common Issues FAQ](/mainnet/appdev/faq).
...
There are also community-maintained bindings for some languages. See the [language bindings](/mainnet/sdks-tools/language-bindings/community) page.
...
Applications can apply for featured status through the Canton Improvement Proposal (CIP) process. Start by reviewing the [CIP introduction](/mainnet/overview/understand/cips-introduction) and the [getting your app featured](/mainnet/overview/understand/getting-app-featured) guide.
