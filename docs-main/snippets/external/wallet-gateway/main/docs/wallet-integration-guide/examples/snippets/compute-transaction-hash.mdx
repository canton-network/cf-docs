<!-- source-snippet repo="splice-wallet-kernel" path="docs/wallet-integration-guide/examples/snippets/compute-transaction-hash.ts" commit="fd1b4b3e5fd5daad189225cb2b585a0ab3b5f67f" snippet="docs/wallet-integration-guide/examples/snippets/compute-transaction-hash" location="fullFile" -->
```typescript
