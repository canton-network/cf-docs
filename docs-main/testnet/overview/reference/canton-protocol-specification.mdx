...
<CardGroup cols={2}>
  <Card title="Ledger Model (Detailed)" icon="layer-group" href="/testnet/overview/reference/ledger-model-detailed">
    The extended UTXO model: templates, stakeholders, choices, transaction structure, views, and witnesses.
  </Card>
  <Card title="Smart Contract Consensus" icon="handshake" href="/testnet/overview/reference/smart-contract-consensus">
    Proof of Stakeholder validation, privacy-preserving consensus, and trust domain comparisons.
  </Card>
  <Card title="Ordering Consensus" icon="arrow-down-1-9" href="/testnet/overview/reference/ordering-consensus">
    Sequencer and mediator architecture, BFT ordering service, and the ISS-inspired consensus protocol.
  </Card>
  <Card title="Transaction Lifecycle" icon="rotate" href="/testnet/overview/reference/transaction-lifecycle">
    The complete five-phase lifecycle from preparation through commit.
  </Card>
  <Card title="Topology" icon="diagram-project" href="/testnet/overview/reference/topology">
...
The [Transaction Lifecycle](/testnet/overview/reference/transaction-lifecycle) page covers each phase in full detail.
