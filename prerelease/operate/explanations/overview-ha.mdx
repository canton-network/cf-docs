<!-- source: canton / canton/3.5/participant/explanations/overview-ha.rst -->
...
Canton components expose a [health endpoint](../howtos/observe/monitoring.md#health-check), for checking the health of the components and their subcomponents.
