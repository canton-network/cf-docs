...
import CANTON_DOCS_CN_GS_DEPLOYMENT_CONFIGURATION_LEDGER_ADMIN_HOCON_0 from "/snippets/external/canton/main/docs-open/target/snippet_json_data/docs-cn/docs-global-synchronizer-deployment-configuration-ledger-admin-hocon-0.mdx";
import CANTON_DOCS_CN_GS_DEPLOYMENT_CONFIGURATION_KMS_HOCON_1 from "/snippets/external/canton/main/docs-open/target/snippet_json_data/docs-cn/docs-global-synchronizer-deployment-configuration-kms-hocon-1.mdx";
...
<CANTON_DOCS_CN_GS_DEPLOYMENT_CONFIGURATION_LEDGER_ADMIN_HOCON_0 />
...
<CANTON_DOCS_CN_GS_DEPLOYMENT_CONFIGURATION_KMS_HOCON_1 />
