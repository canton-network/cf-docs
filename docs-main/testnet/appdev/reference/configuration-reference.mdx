...
import CantonAppdevReferenceConfigurationReferenceL21 from "/snippets/canton-docs/appdev_reference_configuration-reference_L21.mdx";
import CantonAppdevReferenceConfigurationReferenceL42 from "/snippets/canton-docs/appdev_reference_configuration-reference_L42.mdx";
import CantonAppdevReferenceConfigurationReferenceL95 from "/snippets/canton-docs/appdev_reference_configuration-reference_L95.mdx";


Canton nodes use [HOCON](https://github.com/lightbend/config/blob/master/HOCON.md) (Human-Optimized Config Object Notation) for its static configuration files. Static configuration covers settings that must be known at process startup, such as storage backends, API ports, and node identities. Dynamic settings like party registration and synchronizer connections are managed at runtime through the [console](/testnet/global-synchronizer/reference/canton-console-reference) or administration APIs.
...
<CantonAppdevReferenceConfigurationReferenceL21 />
...
<CantonAppdevReferenceConfigurationReferenceL42 />
...
<CantonAppdevReferenceConfigurationReferenceL95 />
...
For multi-package project configuration, see [Building and Packaging](/testnet/appdev/modules/m3-building-packaging) which covers `multi-package.yaml` structure and dependency resolution.

### DPM Environment Variables

For DPM environment variable details, see [Building and Packaging](/testnet/appdev/modules/m3-building-packaging).
