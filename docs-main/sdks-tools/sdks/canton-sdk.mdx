...
The Canton SDK (is the development toolchain you use to build, test, and deploy applications on Canton Network. It bundles the Daml compiler, code generation tools, a local sandbox environment, and the `dpm` package manager into a single installable distribution.
