{/* source: canton / canton/3.4/overview/tutorials/canton-demo.rst */}
...
downloading the [release package from github](https://github.com/digital-asset/daml/releases). Then, unpack and
...
<Note>The demo requires JavaFX. Please use a Java runtime of version 11 or greater.</Note>
