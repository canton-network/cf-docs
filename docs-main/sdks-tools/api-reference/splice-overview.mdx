...
- Join the app development discussion in the [\#gsf-global-synchronizer-appdev](https://app.slack.com/client/T03T53E10/C08FQRCRFUN) Slack channel by sending a request to <operations@sync.global> for your Slack organization to be added to the channel.
