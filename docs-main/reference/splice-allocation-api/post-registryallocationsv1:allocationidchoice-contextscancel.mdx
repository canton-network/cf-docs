---
title: "POST /registry/allocations/v1/:allocationId/choice-contexts/cancel"
description: "Get the choice context to cancel an allocation."
api: "POST https://example.com/registry/allocations/v1/{allocationId}/choice-contexts/cancel"
playground: "interactive"
sidebarTitle: "/registry/allocations/v1/:allocationId/choice-contexts/cancel"
---
...
<div class="x2mdx-ref-hero">
  ...
  <p class="x2mdx-ref-summary">Get the choice context to cancel an allocation.</p>
...
```bash cURL
curl --request POST \
  --url 'https://example.com/registry/allocations/v1/{allocationId}/choice-contexts/cancel' \
...
const response = await fetch('https://example.com/registry/allocations/v1/{allocationId}/choice-contexts/cancel', {
  method: 'POST',
  headers: {
...
curl_setopt_array($curl, [
    CURLOPT_URL => 'https://example.com/registry/allocations/v1/{allocationId}/choice-contexts/cancel',
...
func main() {
  req, _ := http.NewRequest("POST", "https://example.com/registry/allocations/v1/{allocationId}/choice-contexts/cancel", bytes.NewBufferString(`{
  "meta": {},
  "excludeDebugFields": false
}`))
...
var request = HttpRequest.newBuilder()
    .uri(URI.create("https://example.com/registry/allocations/v1/{allocationId}/choice-contexts/cancel"))
    .header("Content-Type", "application/json")
...
uri = URI('https://example.com/registry/allocations/v1/{allocationId}/choice-contexts/cancel')
...
The contract ID of the allocation to cancel.
