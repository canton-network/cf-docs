...
<Danger>
The tutorial builds up on the [externally signed topology transactions tutorial](external_signing_topology_transaction.mdx#externally-signed-topology-transaction) by re-using some if its code and concepts.
