<!-- source: canton / canton/3.5/overview/reference/research.rst -->
...
* [A Structured Semantic Domain for Smart Contracts](https://www.canton.io/publications/csf2019-abstract.pdf)
  describes how Canton relates to [Daml](https://www.daml.com) and the [ledger model](https://docs.daml.com/concepts/ledger-model/index.html).
...
* [Authenticated Data Structures As Functors in Isabelle/HOL](https://www.canton.io/publications/fmbc2020.pdf)
  ...
  - [Pre-reecorded talk](https://www.youtube.com/watch?v=A9Q4G_pCSj4)
