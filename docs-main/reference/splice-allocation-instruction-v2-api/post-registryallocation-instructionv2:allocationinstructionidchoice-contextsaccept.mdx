---
title: "POST /registry/allocation-instruction/v2/:allocationInstructionId/choice-contexts/accept"
description: "Get the choice context to accept an allocation instruction."
api: "POST https://example.com/registry/allocation-instruction/v2/{allocationInstructionId}/choice-contexts/accept"
...
<div class="x2mdx-ref-hero">
  ...
  <p class="x2mdx-ref-summary">Get the choice context to accept an allocation instruction.</p>
...
const response = await fetch('https://example.com/registry/allocation-instruction/v2/{allocationInstructionId}/choice-contexts/accept', {
  method: 'POST',
  headers: {
...
curl_setopt_array($curl, [
    CURLOPT_URL => 'https://example.com/registry/allocation-instruction/v2/{allocationInstructionId}/choice-contexts/accept',
...
func main() {
  req, _ := http.NewRequest("POST", "https://example.com/registry/allocation-instruction/v2/{allocationInstructionId}/choice-contexts/accept", bytes.NewBufferString(`{
  "meta": {},
  "excludeDebugFields": false
}`))
...
var request = HttpRequest.newBuilder()
    .uri(URI.create("https://example.com/registry/allocation-instruction/v2/{allocationInstructionId}/choice-contexts/accept"))
    .header("Content-Type", "application/json")
...
uri = URI('https://example.com/registry/allocation-instruction/v2/{allocationInstructionId}/choice-contexts/accept')
