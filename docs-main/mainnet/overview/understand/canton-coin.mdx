...
<Card title="Wallets for Users" icon="wallet" href="/mainnet/integrations/wallets/for-users">
  Manage your Canton Coin.
</Card>

<Card title="Validator Operations" icon="server" href="/mainnet/global-synchronizer/understand/introduction">
