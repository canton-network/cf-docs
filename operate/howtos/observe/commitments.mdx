{/* source: canton / canton/3.4/participant/howtos/observe/commitments.rst */}
{/* Copyright (c) 2025 Digital Asset (Switzerland) GmbH and/or its affiliates. All rights reserved. */}
{/* SPDX-License-Identifier: Apache-2.0 */}

<a id="observe-commitments"></a>
...
same as the state of the participant. More information on commitments is available in the Pruning overview section.
...
[Metrics reference section](../../reference/metrics.mdx#reference-metrics):
...
All metrics below are described in detail in the [Metrics reference section](../../reference/metrics.mdx#reference-metrics).
...
* *Individually monitored*: The operator can optionally select counter-participants whose commitment status it wants to monitor
  ...
  <Note>Any participant, whether *Default* or *Distinguished*, can be added to *Individually monitored*. A distinguished participant
  remains in the *Distinguished* group even if it is *Individually monitored*. In contrast, a *Default* participant that is
  added to *Individually monitored* is removed from the Default group.</Note>
