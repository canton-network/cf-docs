<!-- source: daml / daml/3.5/sdk/reference/daml/functions.rst -->
...
In [Reference: Expressions](expressions.md), the `tubeSurfaceArea` function was defined as:
...
The [Fold](working-with.md#daml-ref-folding) section looks into two useful built-in functions, `foldl` and `foldr`, that also take a function as an argument.
...
You can find many other generic functions including this one in the [Daml standard library](stdlib/index.md#stdlib-reference-base).
