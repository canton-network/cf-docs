<!-- source-snippet repo="splice" path="apps/app/src/pack/examples/sv-helm/standalone-validator-values.yaml" commit="889595d950391fec6acb767c4750ab37bd189a4b" snippet="splice-literal-marker-apps-app-src-pack-examples-sv-helm-standalone-validator-values-scan-client-configuration-start" location="stringMarker:SCAN_CLIENT_CONFIGURATION_START-&gt;SCAN_CLIENT_CONFIGURATION_END" -->
```yaml
  scanClient:
    scanType: "bft"
