...
description: "Common Wallet Gateway problems and how to resolve them."
---
...
- Check whether another Gateway instance is running:
...
See [Signing providers](/integrations/wallet-gateway/signing-providers) for each
provider's setup.
