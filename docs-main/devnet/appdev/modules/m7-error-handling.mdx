...
See [Canton Coin and Traffic](/devnet/appdev/modules/m4-canton-coin) for how to manage traffic credits.
...
- [Backend Development](/devnet/appdev/modules/m4-backend-dev) -- Ledger API client setup, including error handling examples
- [Canton Coin and Traffic](/devnet/appdev/modules/m4-canton-coin) -- Managing traffic to avoid submission failures
- [Observability](/devnet/appdev/modules/m4-observability) -- Logging and metrics for error tracking
