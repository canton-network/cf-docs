...
The generated nav is added under the top-level `API Reference` dropdown as `Splice APIs -> Validator APIs`, with one generated page per validator-family OpenAPI spec in the published bundle family.
