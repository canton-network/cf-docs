...
- [Canton Coin overview](/mainnet/overview/understand/canton-coin) -- Deeper background on CC tokenomics, validator rewards, and governance
- [Backend Development](/mainnet/appdev/modules/m4-backend-dev) -- Handling transaction errors, including insufficient-traffic failures
