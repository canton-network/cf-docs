...
- Communicate upgrade timelines (see [Upgrade Deployment](/testnet/appdev/modules/m6-deployment))
...
- [Security Best Practices](/testnet/appdev/modules/m7-security) — Securing your packages and deployment pipeline
