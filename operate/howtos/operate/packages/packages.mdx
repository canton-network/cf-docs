...
To upload a DAR use the [dars.upload](../../../reference/console.mdx#dars-upload) console command.
...
To list DARs use the [dars.list](../../../reference/console.mdx#dars-list) console command.
...
<Note>Please note that the package **canton-builtin-admin-workflow-ping** is a package that ships with Canton. It contains the Daml templates
used by the `participant.health.ping` command.</Note>
...
To display the contents of a DAR use the [dars.get_contents](../../../reference/console.mdx#dars-get-contents) console command.
...
<Note>All DAR files include packages from the Daml standard library (prefixed with **daml-**), for
example **daml-prim**.</Note>
...
<Note>In the output the `store` called `Authorized` is local to the Participant Node and is not a Synchronizer store.</Note>
...
To remove support for the main DAR package use the [dars.vetting.disable](../../../reference/console.mdx#dars-vetting-disable) console command.
...
<Warning>It’s not possible to unvet a package referenced by active contracts. Attempting this results in a `FAILED_PRECONDITION/TOPOLOGY_PACKAGE_ID_IN_USE` error.</Warning>

Use [dars.vetting.enable](../../../reference/console.mdx#dars-vetting-enable) console command to re-enable the vetting of a package.
...
By default DARs are validated on upload. To independently validate a DAR use the [dars.validate](../../../reference/console.mdx#dars-validate) console command.
...
<Note>Validating a DAR file doesn’t change the Participant Node, no information is persisted.</Note>
...
To inspect packages use the [packages.get_contents](../../../reference/console.mdx#packages-get-contents) console command.
...
To find DARs that reference a package use the [packages.get_references](../../../reference/console.mdx#packages-get-references) console command.
...
Remove the DAR using the [dars.remove](../../../reference/console.mdx#dars-remove) console command:
