...
<CardGroup cols={2}>
  <Card title="Exchange Integration" icon="arrows-rotate" href="/devnet/integrations/overview">
...
1. Review the [Integrations overview](/devnet/integrations/overview) for the full context on exchange and wallet integrations
...
- Familiarity with the [Ledger API](/devnet/sdks-tools/api-reference/ledger-api) and [Java bindings](/devnet/sdks-tools/language-bindings/java)

## Related Pages

- [Integrations overview](/devnet/integrations/overview) -- Wallet and exchange integration patterns
- [Java bindings](/devnet/sdks-tools/language-bindings/java) -- Code generation for Java
- [PQS](/devnet/sdks-tools/development-tools/pqs) -- SQL-based ledger queries used by the Exchange SDK
