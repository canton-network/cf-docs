...
The deployment follows the asynchronous rollout model described in the [Overview](/devnet/appdev/modules/m6-overview):
...
Apply the standard promotion path from [Deployment Progression](/devnet/appdev/modules/m5-deployment-progression):
...
- [Smart Contract Upgrades Overview](/devnet/appdev/modules/m6-overview) — Return to the module overview
- [Testing Upgrades](/devnet/appdev/modules/m6-testing-upgrades) — Verify upgrade paths before deployment
- [Deployment Progression](/devnet/appdev/modules/m5-deployment-progression) — General environment promotion strategy
