<!-- source: canton / canton/3.5/participant/tutorials/getting_started.rst -->
...
@ participant1.health.ping(participant2)
    res13: Duration = 905 milliseconds
```
...
@ participant1.health.ping(p2Id)
    res27: Duration = 653 milliseconds
```
...
@ participants.all.dars.upload("dars/CantonExamples.dar")
    res32: Map[com.digitalasset.canton.console.ParticipantReference, String] = Map(
      Participant 'participant2' -> "69f6fc47c97947ec96f28e5a9c6cd368fd79d45e2e27298556073ef8809d5a2b",
      Participant 'participant1' -> "69f6fc47c97947ec96f28e5a9c6cd368fd79d45e2e27298556073ef8809d5a2b"
    )
```
...
@ val pkgIou = participant1.packages.find_by_module("Iou").head
    pkgIou : PackageDescription = PackageDescription(
      packageId = 69f6fc47c979...,
      name = CantonExamples,
      version = 3.5.0,
      uploadedAt = 2026-01-10T22:40:52.261864Z,
      size = 220840
    )
```
    ...
    createIouCmd : com.daml.ledger.api.v2.commands.Command = Command(
      command = Create(
        value = CreateCommand(
          templateId = Some(
            value = Identifier(
              packageId = "69f6fc47c97947ec96f28e5a9c6cd368fd79d45e2e27298556073ef8809d5a2b",
    ..
```
...
@ participant2.ledger_api.commands.submit(Seq(bank), Seq(createIouCmd))
    res40: com.daml.ledger.api.v2.transaction.Transaction = Transaction(
      updateId = "122069b107f6576f531d5697254e32f3877355099ca9c3c3f7ba2b06c727a4c1b40d",
      commandId = "f7a77f48-d524-4a12-8805-84f5dbf89afc",
      workflowId = "",
      effectiveAt = Some(
        value = Timestamp(
          seconds = 1768084855L,
...
@ participant1.ledger_api.commands.submit(Seq(alice), Seq(createIouCmd))
    ERROR com.digitalasset.canton.integration.EnvironmentDefinition$$anon$3:GettingStartedDocumentationIntegrationTest - Request failed for participant1.
      GrpcClientError: INVALID_ARGUMENT/DAML_AUTHORIZATION_ERROR(8,af02ec27): Interpretation error: Error: node NodeId(0) (69f6fc47c97947ec96f28e5a9c6cd368fd79d45e2e27298556073ef8809d5a2b:Iou:Iou) requires authorizers Bank::1220a4d7463bd34b2ba3704401b48ab41d8f88cdcbe512fc1ef071aad97fef106161, but only Alice::12201ff69b1d24edbf0ee2028a304ea702ee8536790dab1a31e7136e6d90ff6d473c were given
...
@ participant1.ledger_api.commands.submit(Seq(bank), Seq(createIouCmd))
    ERROR com.digitalasset.canton.integration.EnvironmentDefinition$$anon$3:GettingStartedDocumentationIntegrationTest - Request failed for participant1.
      GrpcRequestRefusedByServer: NOT_FOUND/NO_SYNCHRONIZER_ON_WHICH_ALL_SUBMITTERS_CAN_SUBMIT(11,d0b864c2): This participant cannot submit as the given submitter on any connected synchronizer
...
@ participant2.ledger_api.commands.submit(Seq(bob), Seq(createOfferCmd))
    res46: com.daml.ledger.api.v2.transaction.Transaction = Transaction(
      updateId = "122025a0daa3a95bd32cc464a91fc25b9f2a2f8db63398c9ee7d8ffdcd2dd281c9ff",
      commandId = "97c55eb7-2ce1-49c2-8c2b-b2301c1de991",
      workflowId = "",
      effectiveAt = Some(
        value = Timestamp(
    ..
...
@ participant1.ledger_api.commands.submit(Seq(alice), Seq(acceptOffer))
    res53: com.daml.ledger.api.v2.transaction.Transaction = Transaction(
      updateId = "1220f2931284a1bc6f5f6a9ae5f9cf85d2fd5c4f41915c63d749fe714546dc73d6e2",
      commandId = "9d7172dd-15a3-402d-aebf-2b6f2fb5074a",
      workflowId = "",
      effectiveAt = Some(
        value = Timestamp(
    ..
