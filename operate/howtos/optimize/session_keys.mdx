...
You can read more about the rationale and security considerations in [Session Keys](../../explanations/security.mdx#canton-security).
...
When using [external KMS (Key Management Service) provider](../secure/kms/mode/external_key_storage.mdx#external-key-storage) you can control how
