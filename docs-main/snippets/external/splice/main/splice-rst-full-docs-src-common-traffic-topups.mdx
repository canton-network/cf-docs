<!-- source-snippet repo="splice" path="docs/src/common/traffic_topups.rst" commit="889595d950391fec6acb767c4750ab37bd189a4b" snippet="splice-rst-full-docs-src-common-traffic-topups" location="fullFile" -->
