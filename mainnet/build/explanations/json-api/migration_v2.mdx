...
> Always  consult [JSON Ledger API OpenAPI definition](../../reference/json-api/openapi.md#reference-json-api-openapi) for exact details and usage.
...
Check [JSON Ledger API OpenAPI definition](../../reference/json-api/openapi.md#reference-json-api-openapi) for details.
