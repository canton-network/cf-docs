{/* source: splice-wallet-kernel / splice-wallet-kernel/devnet/src/usdcx-support/index.rst */}
...
([CIP-56](https://github.com/global-synchronizer-foundation/cips/blob/main/cip-0056/cip-0056.md)) as defined through
...
Refer to [this example values file](https://docs.digitalasset.com/usdc/xreserve/mainnet-technical-setup.html#example-values-file) for the specific values of the disclosed contracts.
