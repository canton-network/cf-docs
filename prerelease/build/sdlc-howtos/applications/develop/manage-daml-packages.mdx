<!-- source: canton / canton/3.5/sdk/sdlc-howtos/applications/develop/manage-daml-packages.rst -->
<!-- Copyright (c) 2026 Digital Asset (Switzerland) GmbH and/or its affiliates. All rights reserved. -->
<!-- SPDX-License-Identifier: Apache-2.0 -->

<a id="howto-applications-manage-daml-packages"></a>
...
[OpenAPI specifications](../../../reference/json-api/openapi.md#reference-json-api-openapi).

To learn about the Daml packages, see [Daml packages and archive (.dar) files](../../../explanations/daml-packages-and-archive-files.md#daml-packages-and-daml-archive-files).
