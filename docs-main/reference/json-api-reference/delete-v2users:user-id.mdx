...
api: "DELETE http://localhost:7575/v2/users/{user-id}"
authMethod: "bearer"
...
<div class="x2mdx-ref-hero">
  ...
  <p class="x2mdx-ref-summary">Delete an existing user and all its rights.</p>
...
func main() {
  req, _ := http.NewRequest("DELETE", "http://localhost:7575/v2/users/{user-id}", nil)
...
<div class="x2mdx-ref-history" aria-label="Reference history">
  ...
  <div class="x2mdx-ref-history-event x2mdx-ref-history-event--changed" id="history-updated-3-5">
    ...
    <p class="x2mdx-ref-history-event-detail">The DELETE /v2/users/&#123;user-id&#125; operation was updated in this snapshot.</p>
