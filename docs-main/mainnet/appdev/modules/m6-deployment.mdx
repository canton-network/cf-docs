...
The deployment follows the asynchronous rollout model described in the [Overview](/mainnet/appdev/modules/m6-overview):
...
5. **Vet the new package** — AT the target date, all parties complete the transition by vetting the v2 package. After this date, v1 workflows may be decommissioned by unvetting the v1 packages.
...
Apply the standard promotion path from [Deployment Progression](/mainnet/appdev/modules/m5-deployment-progression):
...
- [Smart Contract Upgrades Overview](/mainnet/appdev/modules/m6-overview) — Return to the module overview
- [Testing Upgrades](/mainnet/appdev/modules/m6-testing-upgrades) — Verify upgrade paths before deployment
- [Deployment Progression](/mainnet/appdev/modules/m5-deployment-progression) — General environment promotion strategy
