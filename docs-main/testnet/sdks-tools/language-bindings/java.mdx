...
- [daml codegen java reference](/testnet/sdks-tools/cli-tools/dpm) -- Command options and flags
- [TypeScript bindings](/reference/typescript) -- Alternative bindings for TypeScript/JavaScript
- [Backend development](/testnet/appdev/modules/m4-backend-dev) -- Patterns for building Canton backends in Java
