...
- [Use the Ledger API to onboard a party using an external key to sign transactions](external_signing_onboarding_lapi.md#tutorial-onboard-external-party-lapi)
- [Use the Ledger API to onboard a multi-hosted external party](external_signing_onboarding_multihosted.md#tutorial-onboard-external-multi-hosted)
- [Create a contract using external signing](external_signing_submission.md#tutorial-externally-signed-transactions)
- [Exercise a choice on a contract using external signing](external_signing_submission_part_2.md#tutorial-externally-signed-transactions-part-2)
...
- [Use the Admin API to onboard an external party](external_signing_onboarding.md#tutorial-onboard-external-party)
- [Build, sign and submit topology transactions](external_signing_topology_transaction.md#externally-signed-topology-transaction)
...
[onboard an external party using the Ledger API](external_signing_onboarding_lapi.md#tutorial-onboard-external-party-lapi).
...
Please follow the following tutorial to learn how to [setup a multi-hosted party using the Ledger API](external_signing_onboarding_multihosted.md#tutorial-onboard-external-multi-hosted)
...
- [Use the Admin API to onboard an external party](external_signing_onboarding_multihosted.md#tutorial-onboard-external-multi-hosted)
- [Build, sign and submit topology transactions](external_signing_topology_transaction.md#externally-signed-topology-transaction)
...
Please refer to the [external signing overview](../../explanations/external-signing/external_signing_overview.md#sdk-external-signing-overview) for a more detailed explanation.
...
- [Create a contract using external signing](external_signing_onboarding_multihosted.md#tutorial-onboard-external-multi-hosted)
- [Exercise a choice on a contract using external signing](external_signing_onboarding_multihosted.md#tutorial-onboard-external-multi-hosted)
