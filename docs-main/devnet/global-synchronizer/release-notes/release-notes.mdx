...
The current production release of the Global Synchronizer software on DevNet is **Splice 0.6.2** running on **Canton 3.5.1**.
...
For the full upgrade procedure, see [Upgrade Procedures](/devnet/global-synchronizer/production-operations/upgrade-procedures).
...
For details on individual releases, see [Current Release](/devnet/global-synchronizer/release-notes/current-release) and [Minor Releases](/devnet/global-synchronizer/release-notes/minor-releases).


This page provides a high-level overview of all Global Synchronizer software releases. For detailed notes on recent releases, see [Current Release](/devnet/global-synchronizer/release-notes/current-release) and [Minor Releases](/devnet/global-synchronizer/release-notes/minor-releases).
