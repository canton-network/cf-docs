...
<Card title="Wallets for Users" icon="wallet" href="/devnet/integrations/wallets/for-users">
  Manage your Canton Coin.
</Card>

<Card title="Validator Operations" icon="server" href="/devnet/global-synchronizer/understand/introduction">
