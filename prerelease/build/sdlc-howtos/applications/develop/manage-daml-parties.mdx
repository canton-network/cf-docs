<!-- source: canton / canton/3.5/sdk/sdlc-howtos/applications/develop/manage-daml-parties.rst -->
...
explains how to programmatically manipulate the parties using the JSON Ledger API, which is described using [OpenAPI specifications](../../../reference/json-api/openapi.md#reference-json-api-openapi).
