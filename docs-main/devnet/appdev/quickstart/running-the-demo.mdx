...
{/* COPIED_START source="docs-website:docs/replicated/quickstart/3.5/sdk/quickstart/operate/explore-the-demo.rst" hash="e3cafd0e" */}
...
Install the [CN App Quickstart](/devnet/appdev/quickstart/prerequisites) before beginning this demonstration.
...
You've completed a business operation in the CN App Quickstart and have been introduced to the basics of the Canton Console and Daml Shell. We encourage you to explore the CN App Quickstart codebase and modify it to meet your business needs. You might be interested in learning more about the [App Quickstart project structure](/devnet/appdev/quickstart/project-structure) or the application development modules in [Module 4: Building Applications](/devnet/appdev/modules/m4-building-apps-intro).
