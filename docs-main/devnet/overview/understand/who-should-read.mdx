...
<Card title="Application Developers" icon="code" href="/devnet/appdev/get-started/choose-your-path">
...
<Card title="Ethereum/Web3 Developers" icon="ethereum" href="/devnet/appdev/modules/m2-canton-for-ethereum-devs">
...
<Card title="Node Operators" icon="server" href="/devnet/global-synchronizer/understand/introduction">
...
<Card title="Solution Architects" icon="diagram-project" href="/devnet/overview/understand/five-minute-overview">
...
|--------------|------------|
| Understand what Canton is in 5 minutes | [Five-Minute Overview](/devnet/overview/understand/five-minute-overview) |
| Learn why privacy matters for blockchain | [The Problem Canton Solves](/devnet/overview/understand/the-problem) |
| See how Canton components work together | [Architecture Overview](/devnet/overview/learn/architecture) |
| Write my first smart contract | [Module 3: Daml Smart Contracts](/devnet/appdev/modules/m3-dev-environment) |
| Run the example application | [QuickStart](/devnet/appdev/quickstart) |
| Deploy a validator node | [Validator Setup](/devnet/global-synchronizer/understand/introduction) |
| Integrate a wallet into my app | [Integrations Overview](/devnet/integrations/overview) |
...
<Card title="Support" icon="headset" href="/devnet/shared/support-channels">
