...
Install the [CN App Quickstart](/mainnet/appdev/quickstart/prerequisites) before beginning this demonstration.
...
You've completed a business operation in the CN App Quickstart and have been introduced to the basics of the Canton Console and Daml Shell. We encourage you to explore the CN App Quickstart codebase and modify it to meet your business needs. You might be interested in learning more about the [App Quickstart project structure](/mainnet/appdev/quickstart/project-structure) or the application development modules in [Module 4: Building Applications](/mainnet/appdev/modules/m4-building-apps-intro).
