<!-- source: daml / daml/3.5/sdk/sdlc-howtos/smart-contracts/build/how-to-build-dar-files.rst -->
...
The `dpm new <package-name>` command provides pre-made templates for various package structures and tutorials, see [this DPM page](../../../dpm/dpm.md#dpm-operate) for more information.
...
See [Environment Variable Interpolation](../../../component-howtos/smart-contracts/assistant/config-files.md#id1) for more information.
...
See [Daml Build Options](../../../component-howtos/smart-contracts/flags.md#daml-build-flags) for a full list of dpm build options, or run `dpm build --help`, which includes options for changing the `:brokenref:`LF <lf-version>`` version and configuring warnings. All of these options can also be provided via `build-options` above.
Consider reading [Recommended Build Options](../../../component-howtos/smart-contracts/assistant/config-files.md#id2) for our recommended set of warning flags.
...
Once added to the `daml.yaml`, modules from the dependency .dar can be imported from the modules of this package. In the event of collision between module names, either with this package or other dependencies, see [module-prefixes](../../../component-howtos/smart-contracts/assistant/config-files.md#daml-yaml-module-prefixes).
