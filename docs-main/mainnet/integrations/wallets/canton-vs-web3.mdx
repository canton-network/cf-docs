...
<Card title="Wallet for Developers" icon="code" href="/mainnet/integrations/overview">
  Integrate wallet functionality into your app.
</Card>

<Card title="Token Standard" icon="coins" href="/mainnet/overview/understand/cips-introduction">
