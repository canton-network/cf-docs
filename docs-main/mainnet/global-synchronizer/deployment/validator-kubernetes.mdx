...
This page walks through deploying a Canton Network validator on Kubernetes using Helm charts. For Docker Compose, see [Docker Compose Validator Deployment](/mainnet/global-synchronizer/deployment/validator-docker-compose).

## Before you begin

Confirm that you have completed the [onboarding process](/mainnet/global-synchronizer/deployment/onboarding-process) and have the following ready:
...
<Card title="Authorization Setup" icon="lock" href="/mainnet/global-synchronizer/deployment/authorization-setup">
