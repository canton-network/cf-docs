...
<Card title="Wallet for Developers" icon="code" href="/devnet/integrations/overview">
  Integrate wallet functionality into your app.
</Card>

<Card title="Token Standard" icon="coins" href="/devnet/overview/understand/cips-introduction">
