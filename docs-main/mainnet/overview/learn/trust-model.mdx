...
- [Two-Layer Consensus](/mainnet/overview/learn/two-layer-consensus) — how the consensus layers interact
- [Architecture Overview](/mainnet/overview/learn/architecture) — component responsibilities
- [Privacy Model](/mainnet/overview/learn/privacy-model) — what each party can see
