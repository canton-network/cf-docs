...
You can read more about the rationale and security considerations in [Cryptographic keys in Canton](/overview/learn/cryptographic-keys#kms-with-session-signing-keys).
