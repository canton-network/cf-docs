...
<Card title="Node Operators" icon="server" href="/docs-main/global-synchronizer/understand/introduction">
...
| **Building Blocks** | Wallets, apps, components, and integrations | Developers, Users |
