...
<div class="x2mdx-ref-operation-bar">
  ...
  <code>/com.digitalasset.canton.sequencer.admin.v30.SequencerPruningAdministrationService/GetSchedule</code>
</div>
...
grpcurl \
  -d @ \
  <HOST:PORT> \
  com.digitalasset.canton.sequencer.admin.v30.SequencerPruningAdministrationService/GetSchedule <<'EOF'
{}
EOF
```
