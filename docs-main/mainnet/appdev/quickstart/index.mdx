...
<CardGroup cols={2}>
  <Card title="Prerequisites and Installation" icon="download" href="/mainnet/appdev/quickstart/prerequisites">
    System requirements, dependencies, and step-by-step installation
  </Card>
  <Card title="Project Structure" icon="folder-tree" href="/mainnet/appdev/quickstart/project-structure">
    How the QuickStart project is organized and what each component does
  </Card>
  <Card title="Running the Demo" icon="play" href="/mainnet/appdev/quickstart/running-the-demo">
