...
- [cn-quickstart](/testnet/sdks-tools/reference-projects/cn-quickstart) -- Full-stack example application that runs on Splice infrastructure
- [Canton Coin](/testnet/overview/understand/canton-coin) -- Overview of Canton Coin and its role in the network
- [Global Synchronizer](/testnet/overview/understand/global-synchronizer) -- How the synchronizer infrastructure works
- [Integrations](/testnet/integrations/overview) -- Wallet and exchange integration patterns
