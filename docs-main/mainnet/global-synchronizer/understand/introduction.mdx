...
2. **Infrastructure**: Meet the [infrastructure requirements](/mainnet/global-synchronizer/understand/infrastructure-requirements)
...
<Card title="Infrastructure Requirements" icon="server" href="/mainnet/global-synchronizer/understand/infrastructure-requirements">
  Hardware, software, and network requirements.
</Card>

<Card title="Validator Roles" icon="user-gear" href="/mainnet/global-synchronizer/understand/validator-roles">
