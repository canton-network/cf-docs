...
<a id="synchronizer-order-of-backups"></a>
...
<a id="synchronizer-restore-caveats"></a>
...
<a id="synchronizer-database-replication-dr"></a>
...
caveats as with backup restore the participants should either use synchronous
