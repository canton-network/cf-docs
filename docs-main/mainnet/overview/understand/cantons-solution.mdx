...
<Card title="Use Cases" icon="building" href="/mainnet/overview/understand/use-cases">
...
<Card title="Architecture Deep Dive" icon="diagram-project" href="/mainnet/overview/learn/architecture">
  Understand how components work together technically.
</Card>

<Card title="Privacy Model" icon="lock" href="/mainnet/overview/learn/privacy-model">
