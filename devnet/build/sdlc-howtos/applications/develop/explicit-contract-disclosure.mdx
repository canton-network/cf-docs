...
In Daml, you must specify who can view data using [stakeholder](../../../reference/glossary.md#stakeholder) annotations in your template definitions.
...
The following snippet of [Daml Script](../../../reference/glossary.md#daml-script) models the setup of the trade between the parties.
...
associated [CreatedEvent](../../../reference/lapi-proto-docs.md#com-daml-ledger-api-v2-createdevent),
...
by conventional means, such as HTTPS, SFTP, or e-mail. A [DisclosedContract](../../../reference/lapi-proto-docs.md#com-daml-ledger-api-v2-disclosedcontract) can
be constructed from the fields of the same name from the original contract’s `CreatedEvent`.

#### NOTE
The `created_event_blob` field in `CreatedEvent` (used to construct the [DisclosedContract](../../../reference/lapi-proto-docs.md#com-daml-ledger-api-v2-disclosedcontract))
is populated **only** on demand for `GetUpdates`, `GetUpdateTrees`, and `GetActiveContracts` streams.

To learn more, see [configuring event format](../../../explanations/ledger-api-services.md#event-format).

<a id="submitter-disclosed-contract"></a>

## Attaching a disclosed contract to a command submission

A disclosed contract can be attached as part of the `Command`’s [disclosed_contracts](../../../reference/lapi-proto-docs.md#com-daml-ledger-api-v2-commands-disclosed-contracts)
and requires the following fields (see [DisclosedContract](../../../reference/lapi-proto-docs.md#com-daml-ledger-api-v2-disclosedcontract) for content details) to be populated from
