...
| [`connect`](#method-connect) | 🟢 `v0.23` | Ensures ledger connectivity and returns the connected network information. |
| [`connected`](#method-connected) | 🟢 `v0.23` | Informs when the user connects to a network. |
| [`disconnect`](#method-disconnect) | 🟢 `v0.23` | Invoke a disconnect of the wallet gateway session. |
...
| [`listAccounts`](#method-listaccounts) | 🟢 `v0.23` | - |
| [`onStatusChanged`](#method-onstatuschanged) | 🟢 `v0.23` | - |
| [`prepareExecute`](#method-prepareexecute) | 🟢 `v0.23` | Prepares, signs, and executes a transaction. |
