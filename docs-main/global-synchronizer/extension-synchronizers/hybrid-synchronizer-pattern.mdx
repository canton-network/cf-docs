...
description: "Running private synchronizers alongside the Global Synchronizer for mixed public and private workflows"
---

import CantonGlobalSynchronizerExtensionSynchronizersHybridSynchronizerPatternL84 from "/snippets/canton-docs/global-synchronizer_extension-synchronizers_hybrid-synchronizer-pattern_L84.mdx";
...
<CantonGlobalSynchronizerExtensionSynchronizersHybridSynchronizerPatternL84 />
...
- **Operational overhead** — Running a private synchronizer means operating sequencer and mediator infrastructure in addition to your validator. See the [deployment guide](/docs-main/global-synchronizer/extension-synchronizers/deployment) for what this involves.
