...
refer to the documentation on [how to parse Daml archive files](../component-howtos/development-tooling-authors/how-to-parse-daml-archive-files.md#how-to-parse-daml-archive-files).
