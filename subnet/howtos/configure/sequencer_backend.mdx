{/* source: canton / canton/3.4/synchronizer/howtos/configure/sequencer_backend.rst */}
...
> - [High availability](../operate/ha.mdx#ha-sequencer)
> - [Pruning](../operate/pruning.mdx#sequencer-pruning)
> - [Optimization](../optimize/sequencer.mdx#optimize-sequencer)
...
configure peer endpoints, or do so [using admin commands](../operate/new_nodes.mdx#dynamically-adding-sequencers) later.
...
For more details on authentication, visit the [secure Synchronizer page](../secure/apis.mdx#secure-synchronizer-apis).

### Configure dedicated storage (optional)

To use dedicated storage, configure storage under config as for the top-level
[Sequencer storage configuration](storage.mdx#sync-storage-config).
...
> - Separate [backups](../recover/index.mdx#synchronizer-backup-and-restore)
...
For details on the related concepts, check the [BFT Orderer explanation page](../../explanations/bft_orderer_arch.mdx#bft-orderer-arch).
