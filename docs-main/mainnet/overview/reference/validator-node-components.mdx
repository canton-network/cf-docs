...
For a full description of these steps, see [Transaction Lifecycle](/mainnet/overview/reference/transaction-lifecycle).
...
- **Topology store** -- identity mappings, key registrations, and party-to-participant assignments (see [Topology](/mainnet/overview/reference/topology))
...
<Card title="Transaction Lifecycle" icon="arrows-spin" href="/mainnet/overview/reference/transaction-lifecycle">
  How the Canton protocol processes a transaction from submission to commit.
</Card>

<Card title="Topology" icon="sitemap" href="/mainnet/overview/reference/topology">
  Identity management, key registrations, and party-to-participant mappings.
</Card>

<Card title="Super Validator Components" icon="server" href="/mainnet/overview/reference/super-validator-components">
  Additional components that Super Validators operate beyond a standard validator.
</Card>

<Card title="Canton Coin Tokenomics" icon="coins" href="/mainnet/overview/reference/canton-coin-tokenomics">
