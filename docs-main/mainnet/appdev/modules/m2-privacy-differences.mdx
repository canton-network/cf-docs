...
<Card title="Smart Contract Paradigm" icon="code" href="/mainnet/appdev/modules/m2-smart-contract-paradigm">
  Understand Daml's immutable contract model vs. Solidity.
</Card>

<Card title="Privacy Model Deep Dive" icon="lock" href="/mainnet/overview/learn/privacy-model">
