...
| **Network model** | Connect to any RPC | Connect to your validator |
| **Identity** | Pseudonymous address | Party identifier |
| **Transfer model** | Single-step | Can be multi-step |
...
<Card title="Wallet for Developers" icon="code" href="/building-blocks/wallets/for-developers">
