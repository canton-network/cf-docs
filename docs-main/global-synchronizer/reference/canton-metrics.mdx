...
{/* GENERATED_FROM source="digital-asset/canton" ref="v3.5.15" path="docs-open/src/sphinx/participant/reference/metrics.rst" */}
...
### daml.participant.traffic-enforcement.allowed-submission-on-lookup-failures

> - **Summary**: Number of times a submission was allowed, but traffic information couldn't be fetched
> - **Description**: The number of times the system has allowed a submission to proceed despite a failure to fetch traffic information.
> - **Type**: meter
> - **Qualification**: Errors

### daml.participant.traffic-enforcement.balance-lookups
...
### daml.participant.traffic-enforcement.insufficient-balance-rejections

> - **Summary**: Number of times an account did not have enough traffic to perform an action
> - **Description**: The number of times the system has rejected an action due to insufficient traffic balance.
> - **Type**: meter
> - **Qualification**: Traffic
