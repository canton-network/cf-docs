...
- [Daml SDK](/testnet/sdks-tools/sdks/daml-sdk) -- What the SDK includes and how versions work
- [Sandbox](/testnet/sdks-tools/development-tools/sandbox) -- Local testing environment started by `dpm sandbox`
- [Daml Studio](/testnet/sdks-tools/development-tools/daml-studio) -- VS Code extension launched by `dpm studio`
- [Daml Script](/testnet/sdks-tools/cli-tools/daml-script) -- Writing and running tests with `dpm test`
...
The settings under `auth-services` are described in detail in [API configuration documentation](/testnet/global-synchronizer/reference/security-configuration#jwt-authorization)
