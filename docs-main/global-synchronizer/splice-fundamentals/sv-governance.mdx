...
For continuously changing parameters like the USD-to-CC conversion rate, each SV operator publishes their preferred value on-ledger. The DSO party uses the median of all published values. This prevents any single SV from disproportionately influencing the rate while still reflecting the collective judgment of the SV operators.
