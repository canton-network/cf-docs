---
title: "dApp API"
description: "The Wallet Gateway's CIP-0103 dApp API, and where it is documented."
---
...
[openrpc-dapp-api.json](https://github.com/canton-network/wallet-gateway/blob/main/api-specs/openrpc-dapp-api.json).
