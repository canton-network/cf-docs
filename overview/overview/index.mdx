{/* source: daml / daml/3.4/overview/overview/index.rst */}
...
Continue diving into [Multi-Party Applications](multiparty-application-intro.mdx#overview-multiparty-applications-intro) in the respective section of the manual.
...
Continue diving into the Canton requirements and learn more about how Canton
is different from other ledgers.
...
![A network with three synchronizers, including the global sync and four participant nodes, each hosting one or
more parties. Each participant node can connect to different synchronizers at their own discretion.](overview/arch-intro-2b.png)
...
* [Multi-party applications](multiparty-application-intro.mdx)
* [The Canton Network](canton.mdx)
* [Featured Use Cases](featured-use-cases.mdx)
