...
Recall that the [Integration Architecture](architecture.md#integration-architecture), shown in the diagram below, relies on two stateful components:
...
As explained in the [Canton Integration Components](architecture.md#canton-integration-components) section of the [Integration Architecture](architecture.md#integration-architecture),
...
In the context of the recommended [Integration Workflows](workflows.md#integration-workflows), this data loss
affects:

* **.dar file uploads**: handle this by repeating the upload of all `.dar` files that were uploaded after the backup.
  This should be a rare event, as [token onboarding](workflows.md#token-onboarding) is infrequent.
...
Likewise, the write in Step 3 of the [1-Step Withdrawal Workflow](workflows.md#one-step-withdrawal-workflow)
...
See Step 2 in the [1-Step Withdrawal Workflow](workflows.md#one-step-withdrawal-workflow) and
Step 2 in the [Multi-Step Withdrawal Workflow](workflows.md#multi-step-withdrawal-workflow) for details.
