...
Aim for high coverage on all choices that will run in production. See the [testing guide](/mainnet/appdev/modules/m3-testing) for a detailed walkthrough.

## Related Pages

- [Testing Daml Contracts](/mainnet/appdev/modules/m3-testing) -- Full testing tutorial with examples
- [Sandbox](/mainnet/sdks-tools/development-tools/sandbox) -- Integration testing beyond Daml Script
- [dpm command reference](/mainnet/sdks-tools/cli-tools/dpm) -- `dpm test` options and flags
...
Contracts are also archived whenever a [consuming choice](/mainnet/overview/reference/ledger-model-detailed#choices-in-the-ledger-model) is exercised.
