...
| NAME | STATUS | SUMMARY |
| --- | --- | --- |
| [`createKey`](#method-createkey) | 🟢 `v0.23` | Create a new key at the Wallet Provider. |
| [`getConfiguration`](#method-getconfiguration) | 🟢 `v0.23` | - |
| [`getKeys`](#method-getkeys) | 🟢 `v0.23` | Get a list of public keys availabile for signing. |
| [`getTransaction`](#method-gettransaction) | 🟢 `v0.23` | Get the status of a single transaction by its ID. |
| [`getTransactions`](#method-gettransactions) | 🟢 `v0.23` | Get the status of multiple transactions, filtering by txIds or publicKeys. Either publicKeys or txIds must be provided. |
| [`setConfiguration`](#method-setconfiguration) | 🟢 `v0.23` | Set configuration parameters for the Wallet Provider. The paramaters will change depending on the Wallet Provider implementation |
| [`signTransaction`](#method-signtransaction) | 🟢 `v0.23` | Uses the Wallet Provider to sign a transaction. This will likely be an asynchronous operation. |
| [`subscribeTransactions`](#method-subscribetransactions) | 🟢 `v0.23` | Subscribe to updates for specific transactions. The server will emit updates when the status of the specified transactions have changed. On initial subscription, the server will emit the current status of all subscribed transactions. |
