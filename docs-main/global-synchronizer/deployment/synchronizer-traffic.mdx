...
```bash
curl -X POST --header "Content-Type: application/json" --header "Accept: application/json" -d "{}" https://scan.sv-1.dev.global.canton.network.sync.global/api/scan/v0/amulet-rules | jq ".amulet_rules_update.contract.payload.configSchedule.initialValue.decentralizedSynchronizer.fees"
```
...
```bash
curl -X POST --header "Content-Type: application/json" --header "Accept: application/json" -d "{}" https://scan.sv-1.test.global.canton.network.sync.global/api/scan/v0/amulet-rules | jq ".amulet_rules_update.contract.payload.configSchedule.initialValue.decentralizedSynchronizer.fees"
```
Above command will return a JSON object similar to the following:
...
```bash
curl -X POST --header "Content-Type: application/json" --header "Accept: application/json" -d "{}" https://scan.sv-1.global.canton.network.sync.global/api/scan/v0/amulet-rules | jq ".amulet_rules_update.contract.payload.configSchedule.initialValue.decentralizedSynchronizer.fees"
```
Above command will return a JSON object similar to the following:
