...
import CANTON_DOCS_CN_GS_PERFORMANCE_OPTIMIZATION_BATCHING_SIZE_HOCON_2 from "/snippets/external/canton/main/docs-open/target/snippet_json_data/docs-cn/docs-global-synchronizer-performance-optimization-batching-size-hocon-2.mdx";
...
- **Synchronizer assignment** — Move high-frequency bilateral workflows to a dedicated synchronizer where no traffic fees apply.
...
<CANTON_DOCS_CN_GS_PERFORMANCE_OPTIMIZATION_BATCHING_SIZE_HOCON_2 />
...
For participant replication, fail-over, and load balancer health checks, see [Participant high availability](/global-synchronizer/production-operations/high-availability-participant).
