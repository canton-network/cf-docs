---
title: "Submit a single reassignment"
...
<div class="x2mdx-ref-hero">
  ...
  <h1 class="x2mdx-ref-title">Submit a single reassignment</h1>
...
<div class="x2mdx-ref-meta-grid">
  ...
  <div class="x2mdx-ref-meta-item">
    ...
    <span class="x2mdx-ref-meta-value">postV2CommandsAsyncSubmit-reassignment</span>
  </div>
...
<div class="x2mdx-ref-history" aria-label="Reference history">
  ...
  <div class="x2mdx-ref-history-event x2mdx-ref-history-event--changed" id="history-updated-3-5">
    ...
    <p class="x2mdx-ref-history-event-detail">The POST /v2/commands/async/submit-reassignment operation was updated in this snapshot.</p>
...
curl --request POST \
  ...
  --data '{"reassignmentCommands":{"workflowId":"string","userId":"string","commandId":"string","submitter":"string","submissionId":"string","commands":[{}]}}'
```
