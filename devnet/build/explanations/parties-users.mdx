...
Identifying parties and users is an important part of building a workable Canton application. Recall these definitions from the [Get started with Canton and the JSON Ledger API](../tutorials/json-api/canton_and_the_json_ledger_api.md#tutorial-canton-and-the-json-ledger-api):
