---
title: "List all active `VoteRequest`\\ s"
...
<div class="x2mdx-ref-hero">
  ...
  <h1 class="x2mdx-ref-title">List all active `VoteRequest`\ s</h1>
...
<div class="x2mdx-ref-meta-grid">
  ...
  <div class="x2mdx-ref-meta-item">
    ...
    <span class="x2mdx-ref-meta-value">listDsoRulesVoteRequests</span>
  </div>
