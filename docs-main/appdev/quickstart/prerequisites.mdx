...
description: "Set up your development environment and install the Canton Network QuickStart"
---
...
**Source:** `docs/replicated/quickstart/3.4/sdk/quickstart/download/cnqs-installation.rst`
...
- After installation, [explore the demo](/docs-main/appdev/quickstart/running-the-demo) to complete a business operation in the example application.
- For an overview of how the Quickstart project is structured, read the [project structure guide](/docs-main/appdev/quickstart/project-structure).
- Learn about debugging features in the observability and troubleshooting section of the [cn-quickstart repository](https://github.com/digital-asset/cn-quickstart).
...
If you are familiar with the prerequisites, use these abbreviated installation instructions. More detailed instructions are provided below.
...
![Daml SDK unpacking](/images/docs_website/06-unpack-sdk.png)
