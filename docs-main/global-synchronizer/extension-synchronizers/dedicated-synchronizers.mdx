...
A dedicated synchronizer is not a private blockchain but dedicated capacity on the shared Canton Network. That's why we it is “dedicated” and not “private.”
...
Organizations deploying or planning to deploy a private synchronizer must understand the following operational obligations:
