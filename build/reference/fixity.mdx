{/* source: daml / daml/3.4/sdk/reference/fixity.rst */}
{/* Copyright (c) 2025 Digital Asset (Switzerland) GmbH and/or its affiliates. All rights reserved. */}
{/* SPDX-License-Identifier: Apache-2.0 */}

<a id="reference-fixity-and-associativity"></a>
...
<Note>Non-associative operators are not to be confused with operators that are both
...
operator has been declared as left-associative</Note>
