...
<div class="x2mdx-ref-hero">
  ...
  <h1 class="x2mdx-ref-title">Idps idp id</h1>
...
<div class="x2mdx-ref-meta-grid">
  ...
  <div class="x2mdx-ref-meta-item">
    ...
    <span class="x2mdx-ref-meta-value">patchV2IdpsIdp-id</span>
  </div>
...
<div class="x2mdx-ref-history" aria-label="Reference history">
  ...
  <div class="x2mdx-ref-history-event x2mdx-ref-history-event--changed" id="history-updated-3-5">
    ...
    <p class="x2mdx-ref-history-event-detail">The PATCH /v2/idps/&#123;idp-id&#125; operation was updated in this snapshot.</p>
...
curl --request PATCH \
  ...
  --data '{"identityProviderConfig":{"identityProviderId":"string","isDeactivated":false,"issuer":"string","jwksUrl":"string","audience":"string"},"updateMask":{"paths":["string"],"unknownFields":{}}}'
```
