<!-- source-snippet repo="splice-wallet-kernel" path="docs/wallet-integration-guide/examples/scripts/13-rewards-for-deposits/index.ts" commit="fd1b4b3e5fd5daad189225cb2b585a0ab3b5f67f" snippet="docs/wallet-integration-guide/examples/scripts/13-rewards-for-deposits" location="fullFile" -->
```typescript
  ...
  // This example script implements the App Rewards for Deposits extension; see the splice-wallet-kernel wallet-integration-guide source for upstream details.
