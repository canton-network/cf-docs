...
- roll out a new synchronizer as a repair strategy in order to [recover from a lost synchronizer](/global-synchronizer/production-operations/repair-canton-nodes#recovering-from-a-lost-synchronizer)
