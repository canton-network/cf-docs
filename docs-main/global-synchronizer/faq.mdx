...
> You can check your validator's rewards by checking the transaction history and look for transaction that mints validator rewards. Note that validator liveness rewards were discontinued by [CIP-0096](https://github.com/canton-foundation/cips/blob/main/cip-0096/cip-0096.md), effective 2026-04-30 -- validators now earn only through activity rewards.
>
