...
```bash
daml codegen java .daml/dist/my-project.dar -o generated-java
```
...
- [daml codegen java reference](/mainnet/sdks-tools/cli-tools/dpm) -- Command options and flags
- [TypeScript bindings](/reference/typescript) -- Alternative bindings for TypeScript/JavaScript
- [Backend development](/mainnet/appdev/modules/m4-backend-dev) -- Patterns for building Canton backends in Java
