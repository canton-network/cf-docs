...
2.  Extract the latest version of the `splice-util-featured-app-proxies.dar` file from the release bundle (<a href="https://github.com/digital-asset/decentralized-canton-sync/releases/download/v0.7.2/0.7.2_splice-node.tar.gz">Download Bundle (DevNet 0.7.2)</a>).
...
2.  Extract the latest version of the `splice-util-featured-app-proxies.dar` file from the release bundle (<a href="https://github.com/digital-asset/decentralized-canton-sync/releases/download/v0.6.14/0.6.14_splice-node.tar.gz">Download Bundle (MainNet 0.6.14)</a>).
