...
It is covered in the [Integrations](/devnet/integrations/overview) section.
...
**Canton Console** is a Scala-based REPL for managing Canton nodes directly. Operators and advanced developers use it for topology management, party administration, and debugging. See the [Global Synchronizer section](/devnet/global-synchronizer/understand/introduction) for operational details.
