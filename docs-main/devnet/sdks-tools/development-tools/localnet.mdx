...
**Use the [Sandbox](/devnet/sdks-tools/development-tools/sandbox)** when you need:
...
- [cn-quickstart](/devnet/sdks-tools/reference-projects/cn-quickstart) -- Repository overview and project structure
- [Sandbox](/devnet/sdks-tools/development-tools/sandbox) -- Lightweight single-node alternative
- [QuickStart walkthrough](/devnet/appdev/quickstart/running-the-demo) -- Step-by-step guide to running the demo application
