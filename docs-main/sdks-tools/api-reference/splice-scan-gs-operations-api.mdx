---
title: "Scan Global Synchronizer Operations API"
description: "Validator liveness, DSO info, and governance state"
---
...
Rather than `Listing_all_Validators`, which can yield a large number of irrelevant records, /v0/validators/validator-faucets?validator_ids=... yields only liveness information about the specified validators.
