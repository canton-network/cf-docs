...
The Sandbox does not include a synchronizer, wallet services, or Canton Coin. For those features, use [LocalNet](/devnet/sdks-tools/development-tools/localnet).
...
- [dpm command reference](/devnet/sdks-tools/cli-tools/dpm) -- `dpm sandbox` options
- [LocalNet](/devnet/sdks-tools/development-tools/localnet) -- Full multi-validator environment for integration testing
- [Daml Script](/devnet/sdks-tools/cli-tools/daml-script) -- In-process testing without a running node
- [Testing Daml Contracts](/devnet/appdev/modules/m3-testing) -- Complete testing guide
