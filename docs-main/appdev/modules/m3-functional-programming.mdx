...
import DamlTutorialsSmartContractsIntroAssetMultiTradeExample from "/snippets/external/daml/main/tutorials-smart-contracts-daml-daml-intro-9-daml-test-intro-asset-multi-trade-fora-example-begin.mdx";
...
<DamlTutorialsSmartContractsIntroAssetMultiTradeExample />
