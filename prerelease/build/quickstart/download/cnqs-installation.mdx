<!-- source: quickstart / quickstart/3.5/sdk/quickstart/download/cnqs-installation.rst -->
...
> * After installation, [Explore the Canton Network Application Quickstart demo](../operate/explore-the-demo.md#quickstart-explore-the-demo) to complete a business operation in the example application.
> * For an overview of how the Quickstart project is structured, read [Canton Network quickstart project structure](../configure/project-structure-overview.md#quickstart-project-structure-guide).
> * Learn about debugging features in the [Canton Network Quickstart observability & troubleshooting overview](../observe/observability-troubleshooting-overview.md#quickstart-observability-troubleshooting-overview).
