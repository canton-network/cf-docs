...
<Card title="Find a Wallet" icon="wallet" href="/docs-main/integrations/wallets/for-users">
  Discover wallet options for managing your Canton Coin.
</Card>

<Card title="Find Apps" icon="grid-2" href="/docs-main/integrations/apps/finding-apps">
...
<Card title="Wallet Integration" icon="code" href="/docs-main/integrations/wallet/guidance">
  Add wallet functionality to your application using the Wallet SDK.
</Card>

<Card title="Exchange Integration" icon="building-columns" href="/docs-main/integrations/exchanges/guidance">
...
<Card title="Integration Patterns" icon="puzzle-piece" href="/docs-main/integrations/integration-patterns">
  Common patterns for building integrations.
</Card>

<Card title="Canton Ecosystem" icon="globe" href="/docs-main/integrations/ecosystem">
