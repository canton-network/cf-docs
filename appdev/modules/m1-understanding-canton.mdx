...
[Continue to Mental Models →](/appdev/modules/m1-mental-models)

### Development Stack

Understand the tools and technologies you'll use.

[Continue to Development Stack →](/appdev/modules/m1-development-stack)

### Module 2 or Module 3

Choose your path based on your background:
- **Module 2**: If you have Ethereum/blockchain experience
- **Module 3**: If you're ready to start writing Daml
...
| Section | Time |
|---------|------|
| Mental Models | 30-45 minutes |
| Development Stack | 30 minutes |
| **Total** | ~1 hour |

This investment pays off significantly when you start coding.

## Next Steps

<Card title="Mental Models" icon="brain" href="/appdev/modules/m1-mental-models">
  Build intuition for how Canton works.
</Card>
