...
{/* GENERATED_FROM source="digital-asset/canton" ref="v3.5.15" asset="canton-open-source-3.5.15.tar.gz" digest="sha256:a11453d98917be6136cb2eaa3f800f5b67ee59ecff75907f7b59b4ccfd3766b8" command_count="679" */}

# Console Commands

This reference is generated from runtime help metadata in the public Canton 3.5.15 release. Commands marked Preview, Testing, or Repair are outside the stable command surface.
...
<div id="global_secret.get_signing_key" />

### `global_secret.get_signing_key`
...
- `usage`: `com.daml.nonempty.NonEmpty[Set[com.digitalasset.canton.crypto.SigningKeyUsage]]`

**Returns:** `com.digitalasset.canton.crypto.Signature`

<div id="global_secret.sign_1" />
...
- `hash`: `com.google.protobuf.ByteString`
- `party`: `com.digitalasset.canton.topology.ExternalParty`
- `useAllKeys`: `Boolean`

**Returns:** `Seq[com.digitalasset.canton.crypto.Signature]`

<div id="global_secret.sign_2" />
...
- `tx`: `com.digitalasset.canton.topology.transaction.TopologyTransaction[Op,M]`
- `party`: `com.digitalasset.canton.topology.ExternalParty`
- `protocolVersion`: `com.digitalasset.canton.version.ProtocolVersion`

**Returns:** `(tx: com.digitalasset.canton.topology.transaction.TopologyTransaction[Op,M], party: com.digitalasset.canton.topology.ExternalParty, protocolVersion: com.digitalasset.canton.version.ProtocolVersion): com.digitalasset.canton.topology.transaction.SignedTopologyTransaction[Op,M]`
...
Aggregate status info of all participants, sequencers, and mediators

**Returns:** `com.digitalasset.canton.admin.api.client.data.CantonStatus`
...
<div id="pruning.clear_schedule" />

### `pruning.clear_schedule`

Deactivates scheduled pruning on all prunable nodes
...
<div id="pruning.set_schedule" />

### `pruning.set_schedule`

Sets the pruning schedule on prunable nodes
...
<div id="repair.acs.read_from_file" />

### `repair.acs.read_from_file`
...
<div id="repair.acs.write_contracts_to_file" />
...
<div id="repair.identity.download" />
...
- `node`: `com.digitalasset.canton.console.LocalInstanceReference`
- `synchronizerId`: `com.digitalasset.canton.topology.SynchronizerId`
- `protocolVersion`: `com.digitalasset.canton.version.ProtocolVersion`
- `targetPath`: `String`

<div id="repair.identity.help" />

### `repair.identity.help`
...
### Ledger Api › Command Completions
...
### Ledger Api › Command Submission › Command Submission

<div id="ledger_api.commands.external" />

#### `ledger_api.commands.external`

Submit commands on behalf of external parties

**Returns:** `com.digitalasset.canton.console.commands.BaseLedgerApiAdministration.ledger_api.commands.external.type`

### Ledger Api › EventQuery
...
### Ledger Api › Interactive Submission
...
### Ledger Api › Ledger Api (Java bindings)
...
### Ledger Api › Ledger Api (Java bindings) › Command Submission (Java bindings)
...
### Ledger Api › Ledger Api (Java bindings) › Command Submission (Java bindings) › Command Submission

<div id="ledger_api.javaapi.commands.external" />

#### `ledger_api.javaapi.commands.external`

Submit commands on behalf of external parties

**Returns:** `com.digitalasset.canton.console.commands.BaseLedgerApiAdministration.ledger_api.javaapi.commands.external.type`

### Ledger Api › Ledger Api (Java bindings) › EventQuery
...
### Ledger Api › Ledger Api (Java bindings) › Interactive Submission
...
### Ledger Api › Ledger Api (Java bindings) › State (Java bindings)
...
### Ledger Api › Ledger Api (Java bindings) › State (Java bindings) › Active Contracts (Java bindings)
...
### Ledger Api › Ledger Api (Java bindings) › Updates (Java bindings)
...
### Ledger Api › Ledger Api Identity Provider Configuration Management
...
### Ledger Api › Ledger Api Users › Ledger Api User Rights
...
### Ledger Api › State › Active Contracts
...
#### `ledger_api.state.acs.count` (Testing)
...
<div id="ledger_api.traffic.get_account" />

#### `ledger_api.traffic.get_account` (Testing)

Get account details

Get the details for the specified account-id

**Arguments**

- `accountId`: `String`

**Returns:** `com.digitalasset.canton.tea.v1.GetAccountResponse`

<div id="ledger_api.traffic.help" />

#### `ledger_api.traffic.help`
...
<div id="ledger_api.traffic.update_account" />

#### `ledger_api.traffic.update_account` (Testing)

Update details for the account-id
...
**Returns:** `com.digitalasset.canton.tea.v1.UpdateAccountResponse`
...
### Topology › Decentralized namespaces
...
### Topology › Mediator Synchronizer State
...
### Topology › Namespace delegations
...
### Topology › Owner to key mappings
...
### Topology › Participant Synchronizer Permissions
...
### Topology › Participant Synchronizer States
...
### Topology › Party to key mappings
...
### Topology › Party to participant mappings
...
### Topology › Sequencer Synchronizer State
...
### Topology › Sequencing Parameters State

<div id="topology.sequencing_parameters.get_sequencing_parameters" />

#### `topology.sequencing_parameters.get_sequencing_parameters`

Get the configured sequencing parameters

**Arguments**

- `synchronizerId`: `com.digitalasset.canton.topology.SynchronizerId`

**Returns:** `Option[com.digitalasset.canton.admin.api.client.data.SequencingParameters]`

<div id="topology.sequencing_parameters.help" />

#### `topology.sequencing_parameters.help`
...
<div id="topology.sequencing_parameters.latest" />

#### `topology.sequencing_parameters.latest`

Latest sequencing parameters
...
<div id="topology.sequencing_parameters.list" />

#### `topology.sequencing_parameters.list`
...
**Returns:** `Seq[com.digitalasset.canton.admin.api.client.data.topology.ListSequencingParametersStateResult]`

<div id="topology.sequencing_parameters.propose" />

#### `topology.sequencing_parameters.propose`

Propose changes to sequencing parameters
...
- `synchronizerId`: `com.digitalasset.canton.topology.SynchronizerId`
- `parameters`: `com.digitalasset.canton.admin.api.client.data.SequencingParameters`
- `store`: `Option[com.digitalasset.canton.topology.admin.grpc.TopologyStoreId]`
- `mustFullyAuthorize`: `Boolean`
- `signedBy`: `Option[com.digitalasset.canton.crypto.Fingerprint]`
- `serial`: `Option[com.digitalasset.canton.config.RequireTypes.PositiveInt]`
...
**Returns:** `com.digitalasset.canton.topology.transaction.SignedTopologyTransaction[com.digitalasset.canton.topology.transaction.TopologyChangeOp,com.digitalasset.canton.topology.transaction.SequencingParametersState]`

<div id="topology.sequencing_parameters.propose_update" />

#### `topology.sequencing_parameters.propose_update`

Propose an update to sequencing parameters
...
- `synchronizerId`: `com.digitalasset.canton.topology.SynchronizerId`
- `update`: `com.digitalasset.canton.admin.api.client.data.SequencingParameters => com.digitalasset.canton.admin.api.client.data.SequencingParameters`
- `mustFullyAuthorize`: `Boolean`
- `signedBy`: `Option[com.digitalasset.canton.crypto.Fingerprint]`
- `synchronize`: `Option[com.digitalasset.canton.config.NonNegativeDuration]`
- `force`: `com.digitalasset.canton.topology.ForceFlags`

### Topology › Synchronisation Helpers
...
### Topology › Synchronizer Parameters State
...
### Topology › Synchronizer trust certificates
...
### `authentication.generate_authentication_token` (Testing)
...
<div id="bft.pruning.clear_schedule" />

#### `bft.pruning.clear_schedule`

Deactivate automatic pruning

<div id="bft.pruning.get_bft_schedule" />

#### `bft.pruning.get_bft_schedule`

Inspect the automatic, bft-orderer-specific pruning schedule
...
**Returns:** `Option[com.digitalasset.canton.synchronizer.sequencer.block.bftordering.core.modules.pruning.BftOrdererPruningSchedule]`

<div id="bft.pruning.get_schedule" />

#### `bft.pruning.get_schedule`
...
<div id="bft.pruning.set_bft_schedule" />

#### `bft.pruning.set_bft_schedule`
...
<div id="bft.pruning.set_cron" />

#### `bft.pruning.set_cron`
...
<div id="bft.pruning.set_max_duration" />

#### `bft.pruning.set_max_duration`
...
<div id="bft.pruning.set_min_blocks_to_keep" />

#### `bft.pruning.set_min_blocks_to_keep`
...
<div id="bft.pruning.set_retention" />

#### `bft.pruning.set_retention`
...
<div id="bft.pruning.set_schedule" />

#### `bft.pruning.set_schedule`
...
<div id="bft.pruning.status" />

#### `bft.pruning.status`

Pruning status of the BFT Orderer
...
**Returns:** `com.digitalasset.canton.synchronizer.sequencer.block.bftordering.core.modules.pruning.BftPruningStatus`
