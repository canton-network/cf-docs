...
> > | additionalDebuggingInfo | [Optional](https://docs.digitalasset.com/build/3.4/reference/daml/stdlib/Prelude.html#type-da-internal-prelude-optional-37153) [ContractNotFoundAdditionalInfo](Daml-Script-Internal.mdx#type-daml-script-internal-questions-submit-error-contractnotfoundadditionalinfo-6199) | should always be None in Canton’s case, see https://github.com/digital-asset/daml/issues/17154 |
