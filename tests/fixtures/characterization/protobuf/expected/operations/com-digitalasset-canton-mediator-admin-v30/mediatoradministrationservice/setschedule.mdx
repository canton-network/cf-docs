...
<div class="x2mdx-ref-operation-bar">
  ...
  <code>/com.digitalasset.canton.mediator.admin.v30.MediatorAdministrationService/SetSchedule</code>
</div>
...
grpcurl \
  -d @ \
  <HOST:PORT> \
  com.digitalasset.canton.mediator.admin.v30.MediatorAdministrationService/SetSchedule <<'EOF'
{
  "schedule": {
    "cron": "string",
    "maxDuration": "string",
