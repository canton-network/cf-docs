{/* source: pqs / pqs/3.4/tutorials/app-dev/pqs/index.rst */}
...
* query contracts that get exported with [SQL API](../../../component-howtos/pqs/references/sql-api.mdx#pqs-references-sql-api)

## Prerequisites

{/* Disabling vale here so we can mention scribe.jar */}
{/* vale DigitalAsset.Terms = NO */}

Before running this tutorial, ensure you meet the following prerequisites:

* successful completion of [Get started with Canton and the JSON Ledger API](../../json-api/canton_and_the_json_ledger_api.mdx#tutorial-canton-and-the-json-ledger-api) tutorial
...
* Java 17 or later - installation instructions: [https://docs.oracle.com/en/java/javase/17/install/overview-jdk-installation.html](https://docs.oracle.com/en/java/javase/17/install/overview-jdk-installation.html)
* scribe.jar - download instructions: [Download](../../../component-howtos/pqs/download.mdx#pqs-download)

{/* vale DigitalAsset.Terms = YES */}
...
* [SQL API](../../../component-howtos/pqs/references/sql-api.mdx#pqs-references-sql-api) - for more details on the SQL API provided by PQS
* [How to query contracts and transactions using SQL](../../../sdlc-howtos/applications/develop/pqs/index.mdx#pqs-how-to-query-contracts-and-transactions-using-sql) - for more examples of querying contracts and
