...
Read more about the OpenAPI and AsyncAPI specifications for the Canton JSON Ledger API: [JSON Ledger API references](../../reference/json-api/json-api.md#references-json-api).

### Authentication and security

Read how to configure and use jwt token to access JSON Ledger API [Access Tokens](../../explanations/json-api/index.md#json-api-access-tokens).

### Error codes

For more information about error codes returned by the JSON Ledger API, see [HTTP Status Codes](../../explanations/json-api/index.md#json-error-codes).
