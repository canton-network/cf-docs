<!-- source: canton / canton/3.5/overview/explanations/canton/overview.rst -->
...
* [Protocols on One Synchronizer](protocol.md)
* [Synchronizers](synchronizers.md)
* [Security properties](requirements.md)
* [Topology management](topology.md)
* [Participant nodes](participant.md)
* [Decentralization](decentralization.md)
* [Local and external parties](external-party.md)
* [Multiple Synchronizers](multi-synchronizer.md)
* [Reliability](reliability.md)
* [Pruning](pruning.md)
* [Cryptographic keys in Canton](security.md)
