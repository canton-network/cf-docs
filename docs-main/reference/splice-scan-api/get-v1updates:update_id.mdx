---
title: "GET /v1/updates/:update_id"
...
sidebarTitle: "/v1/updates/:update_id"
---
...
<div class="x2mdx-ref-hero">
  ...
  <p class="x2mdx-ref-summary">Returns the update with the given update_id. Unlike /v0/updates/&#123;update_id&#125;, this endpoint returns responses that are consistent across different scan instances. Event ids returned by this endpoint are not comparable to event ids returned by /v0/updates. The order of items in events_by_id is not defined.</p>
...
const response = await fetch('https://scan.sv-1.global.canton.network.sync.global/api/scan/v1/updates/{update_id}', {
  method: 'GET',
});
...
curl_setopt_array($curl, [
    CURLOPT_URL => 'https://scan.sv-1.global.canton.network.sync.global/api/scan/v1/updates/{update_id}',
...
func main() {
  req, _ := http.NewRequest("GET", "https://scan.sv-1.global.canton.network.sync.global/api/scan/v1/updates/{update_id}", nil)
...
var request = HttpRequest.newBuilder()
    .uri(URI.create("https://scan.sv-1.global.canton.network.sync.global/api/scan/v1/updates/{update_id}"))
...
uri = URI('https://scan.sv-1.global.canton.network.sync.global/api/scan/v1/updates/{update_id}')
