...
<Columns cols={3}>
  <Card title="Overview" icon="book-open" href="/mainnet/overview/understand/what-is-canton">
  ...
  <Card title="App Development" icon="code" href="/mainnet/appdev/get-started/choose-your-path">
  ...
  <Card title="Network Operations" icon="server" href="/mainnet/global-synchronizer/understand/introduction">
...
<Columns cols={3}>
  <Card title="Integrations" icon="plug" href="/mainnet/integrations/overview">
    Review the best practices and requirements for integrating wallets and exchanges with Canton Network.
  </Card>

  <Card title="SDKs and Tools" icon="toolbox" href="/mainnet/sdks-tools/overview">
...
<Columns cols={3}>
  ...
  <Card title="Release Notes" icon="notes" href="/mainnet/global-synchronizer/release-notes/release-notes">
    Review the release details for the latest updates, enhancements, and bug fixes.
  </Card>

  <Card title="Support Channels" icon="people-group" href="/mainnet/shared/support-channels">
