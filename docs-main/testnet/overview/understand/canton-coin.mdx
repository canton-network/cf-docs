...
<Card title="Wallets for Users" icon="wallet" href="/testnet/integrations/wallets/for-users">
  Manage your Canton Coin.
</Card>

<Card title="Validator Operations" icon="server" href="/testnet/global-synchronizer/understand/introduction">
