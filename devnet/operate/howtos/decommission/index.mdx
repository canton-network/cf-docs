...
This guide assumes general familiarity with Canton, in particular [Canton identity management concepts](../operate/identity_management.md#identity-management-user-manual)
and [operations from the Canton console](../operate/console/console.md#canton-console).
...
2. Disconnect the participant to be decommissioned from all synchronizers as described in
   [enabling and disabling connections](../operate/synchronizers/connectivity.md#connectivity-participant-reconnect).
