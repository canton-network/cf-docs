---
title: "Architectural Considerations for Upgrading"
description: "Architectural considerations when upgrading a Canton Network application across versions."
---
...
### Asynchronous Rollout with a Synchronous Switch-Over
...
### Risks of Uncoordinated Switch-Overs
...
### Backward-Compatible Changes to Daml Models
...
<img src="/images/docs_website/optional-1-1.png" className="align-center" alt="v1 Contract Created Before the New Field Existed" />
...
<img src="/images/docs_website/optional-1-2.png" className="align-center" alt="v1 Contract Created Before the New Field Existed" />
...
<img src="/images/docs_website/optional-2-1.png" className="align-center" alt="v2 Contract Created with a New Optional Field" />
...
<img src="/images/docs_website/optional-2-2.png" className="align-center" alt="v2 Contract Created with a New Optional Field" />

This failure prevents data loss in workflows like archive-and-recreate:

<img src="/images/docs_website/optional-2-3.png" className="align-center" alt="v2 Contract Created with a New Optional Field" />
...
#### Daml Record as Choice Return Types
...
#### Adding New Constructors to Variants, Including Enums
...
##### Understanding Contract Archival in Daml
...
### Backward Compatibility in Backend Code
...
<img src="/images/docs_website/package-name.png" className="align-center" alt="Avoid Package Name Conflicts" />
