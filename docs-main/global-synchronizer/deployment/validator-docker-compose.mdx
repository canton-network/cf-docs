...
See [Required Network Parameters](/global-synchronizer/deployment/required-network-parameters) (DevNet tab) for what `MIGRATION_ID`, `SPONSOR_SV_URL`, and `ONBOARDING_SECRET` mean, where to find them, and how to obtain a DevNet onboarding secret automatically.
...
See [Required Network Parameters](/global-synchronizer/deployment/required-network-parameters) (TestNet tab) for what `MIGRATION_ID`, `SPONSOR_SV_URL`, and `ONBOARDING_SECRET` mean and where to find them.
...
See [Required Network Parameters](/global-synchronizer/deployment/required-network-parameters) (MainNet tab) for what `MIGRATION_ID`, `SPONSOR_SV_URL`, and `ONBOARDING_SECRET` mean and where to find them.
