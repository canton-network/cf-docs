{/* source: daml / daml/3.4/sdk/explanations/daml-packages-and-archive-files.rst */}

<a id="daml-packages-and-daml-archive-files"></a>
...
<a id="structure-of-an-archive-file"></a>
...
refer to the documentation on [how to parse Daml archive files](../component-howtos/development-tooling-authors/how-to-parse-daml-archive-files.mdx#how-to-parse-daml-archive-files).
