{/* source: canton / canton/3.4/sdk/reference/json-api/openapi.rst */}
{/* Copyright (c) 2025 Digital Asset (Switzerland) GmbH and/or its affiliates. All rights reserved. */}
{/* SPDX-License-Identifier: Apache-2.0 */}

<a id="reference-json-api-openapi"></a>

# JSON Ledger API OpenAPI definition

Below there is copy of [`OpenAPI`](/reference/json-api/api/openapi.yaml) specification of **JSON Ledger API**.
...
This specification covers regular HTTP/S endpoints - for streaming endpoints (websockets) please navigate to [JSON Ledger API AsyncAPI definitions (websocket access)](asyncapi.mdx#reference-json-api-asyncapi).

Properties without type or of type: {} (any Json value) are Daml values as defined in the Daml template and formatted according to [Daml-LF JSON encoding](lf-value-specification.mdx#reference-json-lf-value-specification).

<Note>OpenAPI code generators are of various quality. Many code generators (for languages/frameworks) do not fully support OpenAPI 3.0.3 specifications, and those that support often contain bugs.
We regularly test:

* java generator from [https://openapi-generator.tech](https://openapi-generator.tech)
* OpenAPI fetch for typescript [https://openapi-ts.dev/openapi-fetch/](https://openapi-ts.dev/openapi-fetch/)</Note>
...
This will be addressed in a future update.</Note>
