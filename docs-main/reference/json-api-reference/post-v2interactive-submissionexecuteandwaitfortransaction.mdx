---
title: "POST /v2/interactive-submission/executeAndWaitForTransaction"
...
sidebarTitle: "/v2/interactive-submission/executeAndWaitForTransaction"
---
...
<div class="x2mdx-ref-hero">
  ...
  <p class="x2mdx-ref-summary">Similar to ExecuteSubmissionAndWait but additionally returns the transaction</p>
...
const response = await fetch('http://localhost:7575/v2/interactive-submission/executeAndWaitForTransaction', {
  method: 'POST',
  headers: {
...
curl_setopt_array($curl, [
    CURLOPT_URL => 'http://localhost:7575/v2/interactive-submission/executeAndWaitForTransaction',
...
func main() {
  req, _ := http.NewRequest("POST", "http://localhost:7575/v2/interactive-submission/executeAndWaitForTransaction", bytes.NewBufferString(`{
  "preparedTransaction": "<string>",
  "partySignatures": {
    "signatures": [
      {
...
var request = HttpRequest.newBuilder()
    .uri(URI.create("http://localhost:7575/v2/interactive-submission/executeAndWaitForTransaction"))
    .header("Authorization", "Bearer <token>")
    .header("Content-Type", "application/json")
...
uri = URI('http://localhost:7575/v2/interactive-submission/executeAndWaitForTransaction')
...
<div class="x2mdx-ref-history" aria-label="Reference history">
  ...
  <div class="x2mdx-ref-history-event x2mdx-ref-history-event--changed" id="history-updated-3-5">
    ...
    <p class="x2mdx-ref-history-event-detail">The POST /v2/interactive-submission/executeAndWaitForTransaction operation was updated in this snapshot.</p>
