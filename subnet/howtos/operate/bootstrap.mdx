{/* source: canton / canton/3.4/synchronizer/howtos/operate/bootstrap.rst */}
...
@ participant1.health.ping(participant1)
    res5: Duration = 1274 milliseconds
```
...
<Note>Before proceeding, ensure that all of the nodes in the decentralized Synchronizer are started.</Note>
...
@ val initialSnapshot = sequencer1.topology.transactions.export_topology_snapshot(store = sequencer1TempStore)
    initialSnapshot : com.google.protobuf.ByteString = <ByteString@7f461eac size=6295 contents="\n\2221\n\303\002\n\f\b\220\244\213\313\006\020\310\302\247\343\001\032\244\002\n\237\002\n\215\001\n\210\001\b\001\020\001\032\201\001\n\177\nD1220...">
```
...
@ val initialSnapshot = sequencer2.topology.transactions.export_topology_snapshot(store = sequencer2TempStore)
    initialSnapshot : com.google.protobuf.ByteString = <ByteString@123fa326 size=6293 contents="\n\2201\n\303\002\n\f\b\220\244\213\313\006\020\330\311\223\267\002\032\244\002\n\237\002\n\215\001\n\210\001\b\001\020\001\032\201\001\n\177\nD1220...">
```
...
@ participant1.health.ping(participant2)
    res43: Duration = 1389 milliseconds
```
...
```none
@ val initialSnapshot = sequencer1.topology.transactions.export_topology_snapshot(store = sequencer1TempStore)
    initialSnapshot : com.google.protobuf.ByteString = <ByteString@5b750fe4 size=8461 contents="\n\210B\n\301\002\n\v\b\250\244\213\313\006\020\370\236\273*\032\244\002\n\237\002\n\215\001\n\210\001\b\001\020\001\032\201\001\n\177\nD1220c...">
```
...
```none
@ val initialSnapshot = sequencer2.topology.transactions.export_topology_snapshot(store = sequencer2TempStore)
    initialSnapshot : com.google.protobuf.ByteString = <ByteString@3b65e9a3 size=8483 contents="\n\236B\n\303\002\n\f\b\250\244\213\313\006\020\250\201\242\243\001\032\244\002\n\237\002\n\215\001\n\210\001\b\001\020\001\032\201\001\n\177\nD1220...">
```
...
@ val initialSnapshot = utils.read_byte_string_from_file("tmp/synchronizer-bootstrapping-files/initial-snapshot.proto")
    initialSnapshot : com.google.protobuf.ByteString = <ByteString@18f1bc70 size=8461 contents="\n\210B\n\301\002\n\v\b\250\244\213\313\006\020\370\236\273*\032\244\002\n\237\002\n\215\001\n\210\001\b\001\020\001\032\201\001\n\177\nD1220c...">
```
...
```none
@ participant1.health.ping(participant2)
    res56: Duration = 1309 milliseconds
```
...
@ participant1.synchronizers.register(sequencer1, alias = synchronizerName, manualConnect = true)
    ERROR com.digitalasset.canton.integration.EnvironmentDefinition$$anon$3:SynchronizerInstallationManual - Request failed for participant1.
      GrpcRequestRefusedByServer: FAILED_PRECONDITION/INITIAL_ONBOARDING_ERROR(9,5473eec7): Transport(Status{code=FAILED_PRECONDITION, description=TOPOLOGY_PARTICIPANT_ONBOARDING_REFUSED(9,5473eec7): The PAR::participant1::12201ff69b1d... can not join the synchronizer because onboarding restrictions are in place, cause=null})
      ...
      cause = "Transport(Status{code=FAILED_PRECONDITION, description=TOPOLOGY_PARTICIPANT_ONBOARDING_REFUSED(9,5473eec7): The PAR::participant1::12201ff69b1d... can not join the synchronizer because onboarding restrictions are in place, cause=null})",
      traceId = '5473eec7a2e2ef3700f4764338848db7',
...
<Note>Propagating and processing topology proposals may require some time, so you may have to retry before the
submission authorization is visible.</Note>
...
```none
@ participant1.health.ping(participant1)
    res15: Duration = 1261 milliseconds
```
