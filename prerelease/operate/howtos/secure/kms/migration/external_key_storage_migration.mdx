<!-- source: canton / canton/3.5/participant/howtos/secure/kms/migration/external_key_storage_migration.rst -->
...
See [this table](../../../../reference/crypto_schemes.md#canton-supported-schemes) and [this table](../../../../reference/crypto_schemes.md#canton-default-schemes) for a description of
