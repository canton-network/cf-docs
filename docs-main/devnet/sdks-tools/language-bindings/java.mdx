...
- [dpm codegen-java reference](/devnet/sdks-tools/cli-tools/dpm) -- Command options and flags
- [TypeScript bindings](/reference/typescript) -- Alternative bindings for TypeScript/JavaScript
- [Backend development](/devnet/appdev/modules/m4-backend-dev) -- Patterns for building Canton backends in Java

{/* COPIED_START source="docs-website:docs/replicated/daml/3.5/sdk/component-howtos/application-development/daml-codegen-java.rst" hash="bbdcc685" */}

<Warning title="Pre-reviewed Content - Do Not Modify">
This section was copied from existing reviewed documentation.
**Source:** `docs-website:docs/replicated/daml/3.5/sdk/component-howtos/application-development/daml-codegen-java.rst`
