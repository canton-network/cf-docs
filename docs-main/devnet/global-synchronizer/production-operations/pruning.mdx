...
import CantonDocsGlobalSynchronizerProductionOperationsPruningL16 from "/snippets/canton-docs/global-synchronizer_production-operations_pruning_L16.mdx";
import CantonDocsGlobalSynchronizerProductionOperationsPruningL45 from "/snippets/canton-docs/global-synchronizer_production-operations_pruning_L45.mdx";
...
<CantonDocsGlobalSynchronizerProductionOperationsPruningL16 />
...
When sequencer pruning is enabled, you must keep historical backups for each pruning window. The time difference between two historical backups must be smaller than the `retentionPeriod`. See the [Backup and Recovery](/devnet/global-synchronizer/production-operations/backup-and-recovery) page for full backup requirements.
...
<CantonDocsGlobalSynchronizerProductionOperationsPruningL45 />
...
{/* COPIED_START source="docs-website:docs/replicated/canton/3.5/participant/howtos/operate/pruning/pruning.rst" hash="4a51fcd8" */}

<Warning title="Pre-reviewed Content - Do Not Modify">
This section was copied from existing reviewed documentation.
**Source:** `docs/replicated/canton/3.5/participant/howtos/operate/pruning/pruning.rst`
...
{/* COPIED_START source="docs-website:docs/replicated/canton/3.5/participant/reference/automatic_pruning.rst" hash="6e2b1915" */}

<Warning title="Pre-reviewed Content - Do Not Modify">
This section was copied from existing reviewed documentation.
**Source:** `docs/replicated/canton/3.5/participant/reference/automatic_pruning.rst`
Reviewers: Skip this section. Remove markers after final approval.
</Warning>
