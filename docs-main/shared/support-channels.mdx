...
**Join at:** [slack.canton.network](https://slack.canton.network)

### Forum

For longer-form technical discussions and searchable knowledge base.

**URL:** [discuss.daml.com](https://discuss.daml.com)
...
| Repository | Purpose |
|------------|---------|
| [hyperledger-labs/splice](https://github.com/hyperledger-labs/splice) | Splice applications |
...
| Production issue (no SLA) | da-support@digitalasset.com |
| Production issue (with SLA) | support@digitalasset.com |
...
| Resource | Content |
|----------|---------|
| [FAQ](/docs-main/appdev/faq) | Common questions |
| [Troubleshooting](/docs-main/appdev/troubleshooting) | Error solutions |
| [Release Notes](/docs-main/global-synchronizer/reference/release-notes) | Version changes |
