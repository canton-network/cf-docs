...
<Columns cols={2}>
  <Card title="Canton Network" icon="notes" href="/cantonfoundation/release-notes">
    Review the release details for the latest updates, enhancements, and bug fixes.
  </Card>

  <Card title="Wallet Integration" icon="notes" href="/wallet/release-notes/wallet-gateway">
    Review the release details for the latest updates, enhancements, and bug fixes.
  </Card>
</Columns>
