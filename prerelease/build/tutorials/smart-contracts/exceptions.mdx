<!-- source: daml / daml/3.5/sdk/tutorials/smart-contracts/exceptions.rst -->
...
`Either` or `Option` as shown in [Data types](data.md). This approach has
...
[language reference](../../reference/daml/exceptions.md#exceptions).
...
doesn’t stop there. In [Work with dependencies](dependencies.md) you will learn how to
