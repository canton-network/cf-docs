...
For installing the `@canton-network/wallet-sdk` and `@canton-network/dapp-sdk` packages with npm, yarn, or pnpm, see the [Wallet SDK Download](/devnet/integrations/wallet/sdk-download#installation) page.
...
The Wallet integration guide is tailored to work with a [LocalNet setup](/devnet/sdks-tools/development-tools/localnet) to make testing and verification easy.
...
To integrate and support tokens, it is recommended to use the Splice documentation here: [https://docs.dev.sync.global/validator_operator/validator_onboarding.html](https://docs.dev.sync.global/validator_operator/validator_onboarding.html)
