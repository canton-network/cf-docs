...
<Note>The default value of the `--pipeline-oauth-scope` parameter is `daml_ledger_api`. Ledger API requires
`daml_ledger_api` in the list of scopes unless custom target scope is configured.</Note>
