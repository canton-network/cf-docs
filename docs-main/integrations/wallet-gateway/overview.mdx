---
title: "Overview"
description: "Connect your own validator and signing provider to any dApp on Canton Network."
---
...
testing. See [Signing providers](/integrations/wallet-gateway/signing-providers).
...
<CardGroup cols={2}>
  ...
  <Card title="Signing providers" href="/integrations/wallet-gateway/signing-providers">
