{/* source: canton / canton/3.4/sdk/tutorials/app-dev/external_signing_overview.rst */}
{/* Copyright (c) 2025 Digital Asset (Switzerland) GmbH and/or its affiliates. All rights reserved. */}
{/* SPDX-License-Identifier: Apache-2.0 */}

<a id="external-signing-overview"></a>
...
- [Use the Ledger API to onboard a party using an external key to sign transactions](external_signing_onboarding_lapi.mdx#tutorial-onboard-external-party-lapi)
- [Use the Ledger API to onboard a multi-hosted external party](external_signing_onboarding_multihosted.mdx#tutorial-onboard-external-multi-hosted)
- [Create a contract using external signing](external_signing_submission.mdx#tutorial-externally-signed-transactions)
- [Exercise a choice on a contract using external signing](external_signing_submission_part_2.mdx#tutorial-externally-signed-transactions-part-2)
...
- [Use the Admin API to onboard an external party](external_signing_onboarding.mdx#tutorial-onboard-external-party)
- [Build, sign and submit topology transactions](external_signing_topology_transaction.mdx#externally-signed-topology-transaction)
...
identifier is a pair of a name and a fingerprint of a public key `<prefix>::<fingerprint>`, as explained in the topology management overview. The public key is used to ultimately verify authorizations with respect to identities, as explained below.
...
nodes is an operational procedure between validator operators, not covered in this section.

<a id="external-parties-hosting-relationships"></a>
...
[onboard an external party using the Ledger API](external_signing_onboarding_lapi.mdx#tutorial-onboard-external-party-lapi).
...
Please follow the following tutorial to learn how to [setup a multi-hosted party using the Ledger API](external_signing_onboarding_multihosted.mdx#tutorial-onboard-external-multi-hosted)
...
the trust assumptions outlined in the party trust model.

<a id="external-parties-admin-api"></a>
...
- [Use the Admin API to onboard an external party](external_signing_onboarding_multihosted.mdx#tutorial-onboard-external-multi-hosted)
- [Build, sign and submit topology transactions](external_signing_topology_transaction.mdx#externally-signed-topology-transaction)
...
Please refer to the [external signing overview](../../explanations/external-signing/external_signing_overview.mdx#sdk-external-signing-overview) for a more detailed explanation.
...
- [Create a contract using external signing](external_signing_onboarding_multihosted.mdx#tutorial-onboard-external-multi-hosted)
- [Exercise a choice on a contract using external signing](external_signing_onboarding_multihosted.mdx#tutorial-onboard-external-multi-hosted)
