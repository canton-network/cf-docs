...
Validator nodes have built-in support for automating this kind of reward sharing, which can configured by the validator operator as part of the validator node configuration.
