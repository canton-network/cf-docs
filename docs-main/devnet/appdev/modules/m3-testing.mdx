...
{/* COPIED_START source="docs-website:docs/replicated/daml/3.5/sdk/tutorials/smart-contracts/tests.rst" hash="b7bc1096" */}
...
See the [QuickStart walkthrough](/devnet/appdev/quickstart/running-the-demo) for instructions on starting LocalNet.