...
2. **Infrastructure**: Meet [infrastructure requirements](/mainnet/global-synchronizer/understand/infrastructure-requirements)
...
<Card title="Validator Setup" icon="server" href="/mainnet/global-synchronizer/understand/introduction">
  Begin deploying your validator node.
</Card>

<Card title="Infrastructure Requirements" icon="list-check" href="/mainnet/global-synchronizer/understand/infrastructure-requirements">
