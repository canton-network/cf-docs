...
Complete [Part 1](external_signing_submission.md#tutorial-externally-signed-transactions) before proceeding.
...
- `ping_created_event`: Event retrieved in the last [step](external_signing_submission.md#tutorial-observe-externally-signed-transaction) of Part 1.
...
#### IMPORTANT
Like in Part 1, the transaction must be [validated](external_signing_submission.md#tutorial-external-signing-validate), [hashed](external_signing_submission.md#canton-recompute-external-transaction-hash) and [signed](external_signing_submission.md#canton-externally-sign-transaction).
