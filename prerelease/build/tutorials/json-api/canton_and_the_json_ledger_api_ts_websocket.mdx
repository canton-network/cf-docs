<!-- source: canton / canton/3.5/sdk/tutorials/json-api/canton_and_the_json_ledger_api_ts_websocket.rst -->
<!-- Copyright (c) 2026 Digital Asset (Switzerland) GmbH and/or its affiliates. All rights reserved. -->
<!-- SPDX-License-Identifier: Apache-2.0 -->

<a id="tutorial-canton-and-the-json-ledger-api-ts-websocket"></a>
