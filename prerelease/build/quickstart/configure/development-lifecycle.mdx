<!-- source: quickstart / quickstart/3.5/sdk/quickstart/configure/development-lifecycle.rst -->

<a id="quickstart-development-lifecycle"></a>
...
> [Separation phase](#separation-phase)
