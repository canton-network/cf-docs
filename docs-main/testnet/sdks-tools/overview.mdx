...
It is covered in the [Integrations](/testnet/integrations/overview) section.
...
**Canton Console** is a Scala-based REPL for managing Canton nodes directly. Operators and advanced developers use it for topology management, party administration, and debugging. See the [Global Synchronizer section](/testnet/global-synchronizer/understand/introduction) for operational details.
