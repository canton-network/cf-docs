...
* [Setup DevNet node and/or use LocalNet](testing.md#test-node-setup)
* [Setup Exchange Parties](node-operations.md#exchange-parties-setup)
* [1-Step Deposit Workflow](workflows.md#one-step-deposit-workflow)
* [1-Step Withdrawal Workflow](workflows.md#one-step-withdrawal-workflow)
* [Support restore from validator node backup](disaster-recovery.md#restore-from-validator-node-backup)
* [Support hard synchronizer migration](node-operations.md#hard-synchronizer-migration)
...
* [Multi-Step Withdrawal Workflow](workflows.md#multi-step-withdrawal-workflow), which resolves the limitation that users must setup a CC transfer preapproval to receive withdrawals.
* [Canton Network Token Onboarding](workflows.md#token-onboarding)
...
* [Earning App Rewards for Withdrawals](extensions.md#withdrawal-app-rewards)
* [Earning App Rewards for Deposits](extensions.md#deposit-app-rewards)
* [Sharing App Rewards with your Customers](extensions.md#share-rewards-with-customers)
...
>   [Wallet SDK](../integrating-with-canton-network/index.md#install-wallet-sdk) to simplify building your integration.
