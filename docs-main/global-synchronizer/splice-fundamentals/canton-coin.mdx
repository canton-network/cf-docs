...
<Warning>
Traffic accounting is per participant -- all parties hosted on the same validator share the same traffic balance. If your traffic balance drops to zero, the sequencer will deny all submissions from your validator until the balance is replenished.
</Warning>
