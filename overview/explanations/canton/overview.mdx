{/* source: canton / canton/3.4/overview/explanations/canton/overview.rst */}
{/* Copyright (c) 2025 Digital Asset (Switzerland) GmbH and/or its affiliates. All rights reserved. */}
{/* SPDX-License-Identifier: Apache-2.0 */}

<a id="canton-overview"></a>
...
familiar with the Daml language and the :external:ref:`hierarchical transactions <actions>` of the
DA ledger model.
...
* [Protocols on One Synchronizer](protocol.mdx)
* [Synchronizers](synchronizers.mdx)
* [Security properties](requirements.mdx)
* [Topology management](topology.mdx)
* [Participant nodes](participant.mdx)
* [Decentralization](decentralization.mdx)
* [Local and external parties](external-party.mdx)
* [Multiple Synchronizers](multi-synchronizer.mdx)
* [Reliability](reliability.mdx)
* [Pruning](pruning.mdx)
* [Cryptographic keys in Canton](security.mdx)
