{/* source: canton / canton/3.4/participant/reference/versioning.rst */}
{/* Copyright (c) 2025 Digital Asset (Switzerland) GmbH and/or its affiliates. All rights reserved. */}
{/* SPDX-License-Identifier: Apache-2.0 */}

<a id="canton-versioning"></a>

# Versioning

## Canton release version

The Canton release version (release version for short) is the primary version assigned to a [Canton release](https://github.com/digital-asset/daml/releases).
...
- Error code format (machine-readable parts, see also [the error code documentation](error_codes.mdx#error-codes))
...
See also the [versioning](https://docs.daml.com/support/releases.html#support-duration) as well as [portability, compatibility and support duration guarantees](https://docs.daml.com/support/compatibility.html) that hold for any Daml application.
...
<a id="release-version-to-protocol-version-table"></a>

(\*) The protocol versions marked with \* are the alpha protocol version. To use an alpha protocol version, follow the  [documentation](../howtos/troubleshoot/FAQ.mdx#how-do-i-enable-alpha-features).
