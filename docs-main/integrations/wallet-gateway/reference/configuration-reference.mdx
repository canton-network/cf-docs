...
description: "Full reference for the Wallet Gateway store backends, backups, signing store, and secrets."
---
...
[Configure the Wallet Gateway](/integrations/wallet-gateway/guides/configure). For networks and
authentication, see [Networks & identity providers](/integrations/wallet-gateway/guides/networks-and-identity).
