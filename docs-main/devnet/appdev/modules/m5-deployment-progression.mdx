...
<Note>
For detailed upgrade procedures, see the [Upgrade Procedures](/devnet/global-synchronizer/production-operations/upgrade-procedures) page.
</Note>
...
- [Environment Configuration](/devnet/appdev/modules/m5-environment-configuration) — DPM configuration for each environment
- [CI/CD Integration](/devnet/appdev/modules/m5-ci-cd-integration) — Automating the promotion pipeline
