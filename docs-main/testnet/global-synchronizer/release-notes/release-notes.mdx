...
The current production release of the Global Synchronizer software on TestNet is **Splice 0.5.18** running on **Canton 3.4.12**.
...
For the full upgrade procedure, see [Upgrade Procedures](/testnet/global-synchronizer/production-operations/upgrade-procedures).


This page covers the minor releases in the current Splice 0.5.x series. Each release corresponds to a Canton 3.4.x version. For the current release, see [Current Release](/testnet/global-synchronizer/release-notes/current-release).
...
For the complete release history including the 0.4.x series, see [Release History](/testnet/global-synchronizer/release-notes/release-history).
...
- Release notes published on the [Splice documentation site](https://docs.test.sync.global/)
...
For details on individual releases, see [Current Release](/testnet/global-synchronizer/release-notes/current-release) and [Minor Releases](/testnet/global-synchronizer/release-notes/minor-releases).


This page provides a high-level overview of all Global Synchronizer software releases. For detailed notes on recent releases, see [Current Release](/testnet/global-synchronizer/release-notes/current-release) and [Minor Releases](/testnet/global-synchronizer/release-notes/minor-releases).
