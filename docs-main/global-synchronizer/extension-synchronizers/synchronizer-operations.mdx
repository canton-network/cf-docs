...
For mediator replicas and horizontally scaled database sequencers, see [Synchronizer high availability](/global-synchronizer/production-operations/high-availability-synchronizer).
