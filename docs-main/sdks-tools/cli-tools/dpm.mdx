...
Download and unpack the latest [windows unstable dpm-sdk archive (.zip)](https://get.digitalasset.com/unstable/install/latest-windows-archive.html),
then follow [Windows Installation](#manual-windows-installation) instructions.
