<!-- source: daml / daml/3.5/sdk/component-howtos/smart-contracts/assistant/config-files.rst -->
...
- `sdk-version`: (required) The SDK version that this project uses.
  ...
  <br/>
- `name`: (required) The name of the project. This is used to manage automatic upgrades between multiple versions of a package. See [Smart Contract Upgrades](../../../sdlc-howtos/smart-contracts/upgrade/smart-contract-upgrades.md#smart-contract-upgrades).
...
- `module-prefixes`: (optional) Module import prefixes, for module name collisions.
  ...
  This is useful for multi-version testing, see [Smart Contract Upgrades](../../../sdlc-howtos/smart-contracts/upgrade/smart-contract-upgrades.md#smart-contract-upgrades).

  <a id="daml-yaml-build-options"></a>
- `build-options`: (optional) A list of flag for `daml build` (See [Daml Build Flags](../flags.md#daml-build-flags)) that will be applied to any action that involves the Compiler.
...
See [Daml Studio Jump to definition](../daml-studio.md#daml-studio-jump-to-def) for more details.
