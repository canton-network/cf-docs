...
The most fundamental multi-party pattern in Daml. Since no party can unilaterally create a contract that binds another party (the [signatory rule](/mainnet/appdev/modules/m3-authorization#signatories-and-authorization)), you need a two-step process:
...
- [Decentralization](/mainnet/appdev/deep-dives/decentralization) — Strategies for decentralizing at each layer
- [Multi-Hosting](/mainnet/appdev/deep-dives/multi-hosting) — Distributing parties across validators for resilience
