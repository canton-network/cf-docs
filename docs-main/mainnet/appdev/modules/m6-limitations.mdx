...
- [Upgrade Compatibility](/mainnet/appdev/modules/m6-upgrade-compatibility) -- Full compatibility rules for SCU
- [Package Naming](/mainnet/appdev/modules/m6-package-naming) -- Naming conventions that account for breaking changes
- [Smart Contract Upgrades in Production](/mainnet/appdev/modules/m7-smart-contract-upgrades) -- Operational considerations for rollouts
