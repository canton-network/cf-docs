...
export const componentDescriptions = {
  ...
  walletGateway: { text: 'Server-side gateway for dApp/validator/wallet communication.', link: 'https://github.com/hyperledger-labs/splice-wallet-kernel', linkText: 'GitHub' },
}
