<!-- source: pqs / pqs/3.5/tutorials/app-dev/pqs/index.rst -->
...
* query contracts that get exported with [SQL API](../../../component-howtos/pqs/references/sql-api.md#pqs-references-sql-api)
...
* successful completion of [Get started with Canton and the JSON Ledger API](../../json-api/canton_and_the_json_ledger_api.md#tutorial-canton-and-the-json-ledger-api) tutorial
...
* scribe.jar - download instructions: [Download](../../../component-howtos/pqs/download.md#pqs-download)
...
* [SQL API](../../../component-howtos/pqs/references/sql-api.md#pqs-references-sql-api) - for more details on the SQL API provided by PQS
* [How to query contracts and transactions using SQL](../../../sdlc-howtos/applications/develop/pqs/index.md#pqs-how-to-query-contracts-and-transactions-using-sql) - for more examples of querying contracts and
