...
Canton participant and synchronizer components can also be configured independently. See the [Canton static configuration docs](https://docs.digitalasset.com/canton/3.5/usermanual/static_conf) for those options.
{/* COPIED_END */}
...
See the Canton documentation on [pruning operations](https://docs.digitalasset.com/canton/3.5/usermanual/pruning) for more details.
