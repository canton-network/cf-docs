...
{/* COPIED_START source="docs-website:docs/replicated/daml/3.5/sdk/component-howtos/application-development/client-libraries/java-client-libraries.rst" hash="6ccddace" */}

<Warning title="Pre-reviewed Content - Do Not Modify">
This section was copied from existing reviewed documentation.
**Source:** `docs/replicated/daml/3.5/sdk/component-howtos/application-development/client-libraries/java-client-libraries.rst`
