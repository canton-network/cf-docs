...
<CardGroup cols={2}>
  <Card title="Exchange Integration" icon="arrows-rotate" href="/mainnet/integrations/overview">
...
1. Review the [Integrations overview](/mainnet/integrations/overview) for the full context on exchange and wallet integrations
...
- Familiarity with the [Ledger API](/mainnet/sdks-tools/api-reference/ledger-api) and [Java bindings](/mainnet/sdks-tools/language-bindings/java)

## Related Pages

- [Integrations overview](/mainnet/integrations/overview) -- Wallet and exchange integration patterns
- [Java bindings](/mainnet/sdks-tools/language-bindings/java) -- Code generation for Java
- [PQS](/mainnet/sdks-tools/development-tools/pqs) -- SQL-based ledger queries used by the Exchange SDK
