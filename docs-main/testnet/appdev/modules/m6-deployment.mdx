...
The deployment follows the asynchronous rollout model described in the [Overview](/testnet/appdev/modules/m6-overview):
...
Apply the standard promotion path from [Deployment Progression](/testnet/appdev/modules/m5-deployment-progression):
...
- [Smart Contract Upgrades Overview](/testnet/appdev/modules/m6-overview) — Return to the module overview
- [Testing Upgrades](/testnet/appdev/modules/m6-testing-upgrades) — Verify upgrade paths before deployment
- [Deployment Progression](/testnet/appdev/modules/m5-deployment-progression) — General environment promotion strategy
