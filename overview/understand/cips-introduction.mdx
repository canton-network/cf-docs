...
- Decisions are documented for reference
...
| CIP | Topic |
|-----|-------|
| **CIP-0054** | Token standard (earlier version) |
| Various | Governance procedures |
...
| [sync.global](https://sync.global) | Governance information |
