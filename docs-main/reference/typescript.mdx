...
| Export | Kind | Introduced | Changes | Removed |
| --- | --- | --- | --- | --- |
| [`Choice`](#interface-choice) | Interface | `3.4.8` | - | - |
| [`ChoiceFrom`](#interface-choicefrom) | Interface | `3.4.8` | - | - |
| [`ContractTypeCompanion`](#interface-contracttypecompanion) | Interface | `3.4.8` | `3.4.9`: members added: `templateIdWithPackageId` | - |
...
| [`Template`](#interface-template) | Interface | `3.4.8` | `3.4.9`: members added: `templateIdWithPackageId` | - |
