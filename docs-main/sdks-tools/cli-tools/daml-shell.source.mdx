...
<Snippet
  source="https://github.com/DACH-NY/daml-shell/blob/b4e42bef9f2fe1dbbb88633d733b06f79cd9ccd3/docs/user/component-howtos/daml-shell/index.rst"
  lines="138..139"
  normalize="preserve"
  language="sh"
/>
...
<Snippet
  source="https://github.com/DACH-NY/daml-shell/blob/b4e42bef9f2fe1dbbb88633d733b06f79cd9ccd3/docs/user/sdlc-howtos/applications/develop/debug/daml-shell/index.rst"
  lines="16..20"
  normalize="preserve"
  language="text"
/>
...
- Filter by a string pattern:
  ...
  <Snippet source="https://github.com/DACH-NY/daml-shell/blob/b4e42bef9f2fe1dbbb88633d733b06f79cd9ccd3/docs/user/sdlc-howtos/applications/develop/debug/daml-shell/index.rst" lines="309..310" normalize="preserve" language="text" />

  Lists contracts where the `owner` field starts with the string `Alice`.

- Filter by a nested numeric field:

  <Snippet source="https://github.com/DACH-NY/daml-shell/blob/b4e42bef9f2fe1dbbb88633d733b06f79cd9ccd3/docs/user/sdlc-howtos/applications/develop/debug/daml-shell/index.rst" lines="317..318" normalize="preserve" language="text" />
...
- Filter with exact string match (note the use of double quotes):
  ...
  <Snippet source="https://github.com/DACH-NY/daml-shell/blob/b4e42bef9f2fe1dbbb88633d733b06f79cd9ccd3/docs/user/sdlc-howtos/applications/develop/debug/daml-shell/index.rst" lines="325..326" normalize="preserve" language="text" />
...
- Combine different conditions:
  ...
  <Snippet source="https://github.com/DACH-NY/daml-shell/blob/b4e42bef9f2fe1dbbb88633d733b06f79cd9ccd3/docs/user/sdlc-howtos/applications/develop/debug/daml-shell/index.rst" lines="334..335" normalize="preserve" language="text" />
