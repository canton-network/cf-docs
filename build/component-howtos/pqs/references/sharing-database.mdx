{/* source: pqs / pqs/3.4/component-howtos/pqs/references/sharing-database.rst */}
...
<Note>Here, the command-line Flyway was used for demonstration purposes. The same applies to other methods of running
Flyway.</Note>
