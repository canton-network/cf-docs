...
api: "GET http://localhost:7575/v2/state/ledger-end"
authMethod: "bearer"
playground: "interactive"
sidebarTitle: "/v2/state/ledger-end"
---
...
<div class="x2mdx-ref-hero">
  ...
  <p class="x2mdx-ref-summary">Get the current ledger end. Subscriptions started with the returned offset will serve events after this RPC was called.</p>
...
const response = await fetch('http://localhost:7575/v2/state/ledger-end', {
  method: 'GET',
  headers: {
...
curl_setopt_array($curl, [
    CURLOPT_URL => 'http://localhost:7575/v2/state/ledger-end',
...
func main() {
  req, _ := http.NewRequest("GET", "http://localhost:7575/v2/state/ledger-end", nil)
...
var request = HttpRequest.newBuilder()
    .uri(URI.create("http://localhost:7575/v2/state/ledger-end"))
    .header("Authorization", "Bearer <token>")
...
uri = URI('http://localhost:7575/v2/state/ledger-end')
...
<ResponseField name="offset" type="integer (int64)">

It will always be a non-negative integer. If zero, the participant view of the ledger is empty. If positive, the absolute offset of the ledger as viewed by the participant. Optional
...
<div class="x2mdx-ref-history" aria-label="Reference history">
  ...
  <div class="x2mdx-ref-history-event x2mdx-ref-history-event--changed" id="history-updated-3-5">
    ...
    <p class="x2mdx-ref-history-event-detail">The GET /v2/state/ledger-end operation was updated in this snapshot.</p>
