...
- [cn-quickstart](/mainnet/sdks-tools/reference-projects/cn-quickstart) -- Full-stack example application that runs on Splice infrastructure
- [Canton Coin](/mainnet/overview/understand/canton-coin) -- Overview of Canton Coin and its role in the network
- [Global Synchronizer](/mainnet/overview/understand/global-synchronizer) -- How the synchronizer infrastructure works
- [Integrations](/mainnet/integrations/overview) -- Wallet and exchange integration patterns
