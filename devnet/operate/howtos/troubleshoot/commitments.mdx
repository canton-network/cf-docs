...
[Error codes reference section](../../reference/error_codes.md#error-codes):
...
* The operator suspects that agreement is slower than it could or should be, e.g., because [commitment monitoring](../observe/commitments.md#observe-commitments)
...
Assume that the operator observes via [commitment monitoring](../observe/commitments.md#observe-commitments) that the participant’s own
...
[admin console](../../reference/console.md#canton-console-reference) (or via gRPC) to understand
...
`commitments.lookup_sent_acs_commitments` in the [admin console](../../reference/console.md#canton-console-reference) (or via gRPC) as a first
...
[counter-participant latency monitoring](../observe/commitments.md#observe-commitments).
...
1. **Inspect the local shared contract metadata**
   ...
   the commitment using the command `commitments.open_commitment` in the [admin console](../../reference/console.md#canton-console-reference)
