...
import CantonGlobalSynchronizerDeploymentInitialValidationL68 from "/snippets/canton-docs/global-synchronizer_deployment_initial-validation_L68.mdx";
...
<CantonGlobalSynchronizerDeploymentInitialValidationL68 />
...
- [Security Operations](/global-synchronizer/production-operations/security-operations) — Key management and security hardening
- [Upgrade Procedures](/global-synchronizer/production-operations/upgrade-procedures) — Major and minor upgrade processes
