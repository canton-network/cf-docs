<!-- source: daml / daml/3.5/sdk/explanations/ledger-api-services.rst -->
...
If you want to read low-level detail about each service, see [the protobuf documentation of the API](../reference/lapi-proto-docs.md#build-reference-lapi-proto-docs).
...
- The submitting parties, that is [act_as](../reference/lapi-proto-docs.md#com-daml-ledger-api-v2-commands-act-as)
- the [user ID](../reference/lapi-proto-docs.md#com-daml-ledger-api-v2-commands-user-id)
- The [command ID](../reference/lapi-proto-docs.md#com-daml-ledger-api-v2-commands-command-id)

#### Application-specific IDs

The following application-specific IDs, all of which are included in completion events, can be set in commands:

- A [submission ID](../reference/lapi-proto-docs.md#com-daml-ledger-api-v2-commands-submission-id), returned to the submitting application only. It may be used to correlate specific submissions to specific completions.
- A [command ID](../reference/lapi-proto-docs.md#com-daml-ledger-api-v2-commands-command-id), returned to the submitting application only; it can be used to correlate commands to completions.
- A [workflow ID](../reference/lapi-proto-docs.md#com-daml-ledger-api-v2-commands-workflow-id), returned as part of the resulting transaction to all applications receiving it. It can be used to track workflows between parties, consisting of several transactions.

For full details, see [the proto documentation for the service](../reference/lapi-proto-docs.md#com-daml-ledger-api-v2-commandsubmissionservice).
...
For details on how to use command deduplication, see the [Command Deduplication Guide](../sdlc-howtos/applications/develop/command-deduplication.md#command-deduplication).
...
see [Explicit contract disclosure](../sdlc-howtos/applications/develop/explicit-contract-disclosure.md#explicit-contract-disclosure).
...
Completions contain the [command ID](../reference/lapi-proto-docs.md#com-daml-ledger-api-v2-commands-command-id) of the completed command, and the completion status of the command. This status indicates failure or success, and your application should use it to update what it knows about commands in flight, and implement any application-specific error recovery.

For full details, see [the proto documentation for the service](../reference/lapi-proto-docs.md#com-daml-ledger-api-v2-commandcompletionservice).
...
For full details, see [the proto documentation for the service](../reference/lapi-proto-docs.md#com-daml-ledger-api-v2-commandservice).
...
For more information, refer to the [the API reference documentation](../reference/lapi-proto-docs.md#com-daml-ledger-api-v2-interactive-interactivesubmissionservice).
...
Transactions contain an [update ID](../reference/lapi-proto-docs.md#com-daml-ledger-api-v2-transaction-update-id) (assigned by the server), a [workflow ID](../reference/lapi-proto-docs.md#com-daml-ledger-api-v2-commands-workflow-id), a [command ID](../reference/lapi-proto-docs.md#com-daml-ledger-api-v2-commands-command-id), and the events in the transaction.
...
For full details, see [the proto documentation for the service](../reference/lapi-proto-docs.md#com-daml-ledger-api-v2-updateservice).
...
`UpdateService` offers transaction subscriptions filtered by templates and interfaces using `GetUpdates` calls. An [event format](../reference/lapi-proto-docs.md#com-daml-ledger-api-v2-eventformat) embedded in `GetUpdatesRequest.update_format.include_transactions` allows:
...
To learn more see [Ledger API reference](../reference/app-dev/ledger-api/index.md#build-reference-ledger-api).
...
You can get these included in requests related to Transactions by setting the `verbose` field in the [event format](../reference/lapi-proto-docs.md#com-daml-ledger-api-v2-eventformat) message to `true`.
...
For full details, see [the proto documentation for the service](../reference/lapi-proto-docs.md#com-daml-ledger-api-v2-stateservice).
...
For full details, see [the proto documentation for the service](../reference/lapi-proto-docs.md#com-daml-ledger-api-v2-eventqueryservice).
...
For more information, refer to the [the API reference documentation](../reference/lapi-proto-docs.md#com-daml-ledger-api-v2-admin-partymanagementservice).
...
their [access rights](../sdlc-howtos/applications/secure/authorization.md#authorization-claims) to that node’s Ledger API services
...
For more information, consult the [the API reference documentation](../reference/lapi-proto-docs.md#com-daml-ledger-api-v2-admin-usermanagementservice) for how to list, create, update, and delete users and their rights.
See the [UserManagementFeature descriptor](../reference/lapi-proto-docs.md#com-daml-ledger-api-v2-usermanagementfeature) to learn about the limits of the User Management Service, e.g., the maximum number of rights per user.
The feature descriptor can be retrieved using the [Version Service](#version-service).

Consult the [Authorization documentation](../sdlc-howtos/applications/secure/authorization.md#authorization) to understand how Ledger API requests are authorized, and how to use User Management to dynamically change an application’s rights.
...
For full details, see [the proto documentation for the service](../reference/lapi-proto-docs.md#com-daml-ledger-api-v2-admin-identityproviderconfigservice).
...
For full details, see [the proto documentation for the service](../reference/lapi-proto-docs.md#com-daml-ledger-api-v2-packageservice).
...
For full details, see [the proto documentation for the service](../reference/lapi-proto-docs.md#com-daml-ledger-api-v2-versionservice).
...
For full details, see [the proto documentation for the service](../reference/lapi-proto-docs.md#com-daml-ledger-api-v2-admin-participantpruningservice).
...
For full details, see [the proto documentation for the service](../reference/lapi-proto-docs.md#com-daml-ledger-api-v2-testing-timeservice).
