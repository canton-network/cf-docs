...
<Note>
Safari users may need to manually map the `app-provider` subdomain in `/etc/hosts`.
...
</Note>![App Install Request error](quickstart/operate/images/05-error-app-install.png)
