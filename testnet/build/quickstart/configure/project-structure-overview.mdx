...
Work through the [Explore the Canton Network Application Quickstart demo](../operate/explore-the-demo.md#quickstart-explore-the-demo) guide for the complete workflow walkthrough.
...
See [Using the JSON Ledger API](../operate/json-api.md#quickstart-json-ledger-api) for detailed port usage and authentication patterns.
...
See [Debugging and troubleshooting with lnav](../operate/lnav-in-cn.md#quickstart-debugging-and-troubleshooting-lnav) for log analysis techniques.
