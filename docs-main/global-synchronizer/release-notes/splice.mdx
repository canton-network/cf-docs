  ...
  - Summary of Breaking Changes:
    ...
    - Protocol Changes:
      ...
      - (*) The protocol version remains 35, but the ordering layer is switched from CometBFT to CantonBFT which requires an LSU.
        This has been performed on DevNet already, for early testing.
        Final confirmation that this will indeed be rolled out to TestNet and MainNet on this release will be announced soon.
