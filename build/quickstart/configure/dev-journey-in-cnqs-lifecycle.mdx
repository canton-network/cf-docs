{/* source: quickstart / quickstart/3.4/sdk/quickstart/configure/dev-journey-in-cnqs-lifecycle.rst */}

<a id="quickstart-development-journey-lifecycle"></a>

# Development journey in the CN Quickstart lifecycle

**Contents**

[Development Journey in the CN Quickstart lifecycle](#development-journey-in-the-cn-qs-lifecycle)

> [CN Quickstart components](#cn-qs-components)
...
| **Target**   | **Description**                                      |
|--------------|------------------------------------------------------|
| make setup   | Configure environment variables and<br/>dependencies |
| make build   | Build all components (Daml, backend,<br/>frontend)   |
| make start   | Start the application stack                          |

The full list of make targets is maintained in the [CN App Quickstart Make target reference](../troubleshoot/cnqs-faq.mdx#make-target-reference).
...
These files use standard formats ([HOCON](https://docs.tibco.com/pub/sfire-sfds/latest/doc/html/hocon/hocon-syntax-reference.html)
for Canton, [YAML](https://yaml.org/spec/1.2.2/) for Docker services, Grafana JSON for dashboards), making them easy to edit with standard tools.
