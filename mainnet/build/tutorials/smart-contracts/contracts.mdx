...
In [Test templates using Daml scripts](daml-scripts), you’ll learn about how to try out the `Token` contract template in Daml’s inbuilt Daml Script testing language.
