...
introduces **traffic-based app rewards**, which replace the activity marker
mechanism described above with reward computation based on actual network
traffic. Once enabled, featured app providers continue to earn rewards
