{/* source: canton / canton/3.4/synchronizer/howtos/secure/limits.rst */}
{/* Copyright (c) 2025 Digital Asset (Switzerland) GmbH and/or its affiliates. All rights reserved. */}
{/* SPDX-License-Identifier: Apache-2.0 */}

<a id="sequencer-resource-limits"></a>
...
[change the dynamic Synchronizer parameters](../operate/dynamic_params.mdx#id1).
...
<Note>Do note that max-requests-in-batch is a network wide parameter and should be the same for all orderers in the network.</Note>
...
You can protect a Synchronizer from excessive traffic from its members by [enabling traffic management](../operate/traffic.mdx#sequencer-traffic).
