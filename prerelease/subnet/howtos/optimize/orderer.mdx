<!-- source: canton / canton/3.5/synchronizer/howtos/optimize/orderer.rst -->
...
Refer to BFT Sequencer for an overview of the BFT Sequencer architecture.
...
Refer to Parameters configuration for more information on Synchronizer
parameters.
...
Refer to Sequencer backend configuration for general information
