...
1.  Download the release artifacts from the <a href="https://github.com/digital-asset/decentralized-canton-sync/releases/download/v0.6.6/0.6.6_splice-node.tar.gz">Download Bundle (DevNet 0.6.6)</a> link, and extract the bundle:
...
1.  Download the release artifacts from the <a href="https://github.com/digital-asset/decentralized-canton-sync/releases/download/v0.6.5/0.6.5_splice-node.tar.gz">Download Bundle (TestNet 0.6.5)</a> link, and extract the bundle:
...
1.  Download the release artifacts from the <a href="https://github.com/digital-asset/decentralized-canton-sync/releases/download/v0.6.4/0.6.4_splice-node.tar.gz">Download Bundle (MainNet 0.6.4)</a> link, and extract the bundle:
