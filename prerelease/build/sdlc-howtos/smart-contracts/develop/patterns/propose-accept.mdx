<!-- source: daml / daml/3.5/sdk/sdlc-howtos/smart-contracts/develop/patterns/propose-accept.rst -->
<!-- Copyright (c) 2023 Digital Asset (Switzerland) GmbH and/or its affiliates. All rights reserved. -->
<!-- SPDX-License-Identifier: Apache-2.0 -->

<a id="propose-accept"></a>
...
![The Propose and Accept Pattern, showing how the CoinIssueProposal contract (a proposal contract), when accepted, returns the CoinIssueAgreement result contract.](sdlc-howtos/smart-contracts/develop/patterns/images/initiateaccept.png)
