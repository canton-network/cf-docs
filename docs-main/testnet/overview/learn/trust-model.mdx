...
- [Two-Layer Consensus](/testnet/overview/learn/two-layer-consensus) — how the consensus layers interact
- [Architecture Overview](/testnet/overview/learn/architecture) — component responsibilities
- [Privacy Model](/testnet/overview/learn/privacy-model) — what each party can see
