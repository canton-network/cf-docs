...
For an introductory overview of CIPs and why they matter, see the [CIPs introduction](/devnet/overview/understand/cips-introduction).
...
- [SV governance reference](/devnet/overview/reference/sv-governance-reference) — On-chain governance mechanics that CIPs feed into after approval
