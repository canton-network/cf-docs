...
<div class="x2mdx-ref-operation-bar">
  ...
  <code>/com.digitalasset.canton.sequencer.admin.v30.SequencerPruningAdministrationService/SetSchedule</code>
</div>
...
grpcurl \
  -d @ \
  <HOST:PORT> \
  com.digitalasset.canton.sequencer.admin.v30.SequencerPruningAdministrationService/SetSchedule <<'EOF'
{
  "schedule": {
    "cron": "string",
    "maxDuration": "string",
