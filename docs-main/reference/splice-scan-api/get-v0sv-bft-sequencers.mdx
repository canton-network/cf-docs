---
title: "Retrieve Canton BFT sequencer configuration for this SV, for each configured Synchronizer"
...
<div class="x2mdx-ref-hero">
  ...
  <h1 class="x2mdx-ref-title">Retrieve Canton BFT sequencer configuration for this SV, for each configured Synchronizer</h1>
...
<div class="x2mdx-ref-meta-grid">
  ...
  <div class="x2mdx-ref-meta-item">
    ...
    <span class="x2mdx-ref-meta-value">listSvBftSequencers</span>
  </div>
...
<div class="x2mdx-ref-history" aria-label="Reference history">
  ...
  <div class="x2mdx-ref-history-event x2mdx-ref-history-event--changed" id="history-updated-0-6-0">
    ...
    <p class="x2mdx-ref-history-event-detail">The GET /v0/sv-bft-sequencers operation was updated in this snapshot.</p>
