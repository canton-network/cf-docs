...
{/* COPIED_START source="docs-website:docs/replicated/daml/3.5/sdk/tutorials/smart-contracts/contracts.rst" hash="9baeec6a" */}
...
In [Choices](/devnet/appdev/modules/m3-choices), you'll learn how to add behavior to your contracts using choices.
