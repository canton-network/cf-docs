---
title: "POST /v2/commands/submit-and-wait"
...
sidebarTitle: "/v2/commands/submit-and-wait"
---
...
<div class="x2mdx-ref-hero">
  ...
  <p class="x2mdx-ref-summary">Submits a single composite command and waits for its result. Propagates the gRPC error of failed submissions including Daml interpretation errors.</p>
...
const response = await fetch('http://localhost:7575/v2/commands/submit-and-wait', {
  method: 'POST',
  headers: {
...
curl_setopt_array($curl, [
    CURLOPT_URL => 'http://localhost:7575/v2/commands/submit-and-wait',
...
func main() {
  req, _ := http.NewRequest("POST", "http://localhost:7575/v2/commands/submit-and-wait", bytes.NewBufferString(`{
  "commands": [
    {
      "CreateAndExerciseCommand": {
        "templateId": "<string>",
...
var request = HttpRequest.newBuilder()
    .uri(URI.create("http://localhost:7575/v2/commands/submit-and-wait"))
    .header("Authorization", "Bearer <token>")
    .header("Content-Type", "application/json")
...
uri = URI('http://localhost:7575/v2/commands/submit-and-wait')
...
<div class="x2mdx-ref-history" aria-label="Reference history">
  ...
  <div class="x2mdx-ref-history-event x2mdx-ref-history-event--changed" id="history-updated-3-5">
    ...
    <p class="x2mdx-ref-history-event-detail">The POST /v2/commands/submit-and-wait operation was updated in this snapshot.</p>
