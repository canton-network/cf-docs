...
- [Canton Network Explorer](https://scan.sv-1.test.global.canton.network.sync.global)
...
1. Review [infrastructure requirements](/testnet/global-synchronizer/understand/infrastructure-requirements)
...
1. Start with the [QuickStart](/testnet/appdev/quickstart)
