...
<Card title="Wallet for Developers" icon="code" href="/testnet/integrations/overview">
  Integrate wallet functionality into your app.
</Card>

<Card title="Token Standard" icon="coins" href="/testnet/overview/understand/cips-introduction">
