...
- After installation, [explore the demo](/mainnet/appdev/quickstart/running-the-demo) to complete a business operation in the example application.
- For an overview of how the Quickstart project is structured, read the [project structure guide](/mainnet/appdev/quickstart/project-structure).
