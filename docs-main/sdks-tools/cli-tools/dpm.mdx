...
{/* COPIED_START source="docs-website:docs/replicated/dpm/3.5/manual-install.rst" hash="a0b738c0" */}
...
{/* literalinclude-slice: manual-install.sh (invalid :lines: range "4-") */}
...
Follow the [Mac/Linux Installation](/appdev/dpm/manual-install#mac-linux-installation) instructions to install an unstable version, but note the differences in VERSION and TARBALL_URL.
...
Download and unpack the latest [windows unstable dpm-sdk archive (.zip)](https://get.digitalasset.com/unstable/install/latest-windows-archive.html), then follow [Windows Installation](/appdev/dpm/manual-install#windows-installation) instructions.
