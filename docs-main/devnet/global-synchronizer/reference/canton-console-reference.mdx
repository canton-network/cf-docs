...
This section will be expanded in a future update. For TLS configuration, see the [Validator Configuration Reference](/devnet/global-synchronizer/reference/configuration-reference).
