{/* source: canton / canton/3.4/participant/howtos/secure/kms/mode/kms_mode.rst */}
...
1. [Enable encrypted private key storage](encrypted_key_storage.mdx#encrypted-key-storage)
...
2. [Enable external key storage](external_key_storage.mdx#external-key-storage)
...
<Note>Throughout this documentation, these modes might be referred to as **envelope encryption** and **external keys**, respectively.</Note>

* [Enable encrypted private key storage with a KMS](encrypted_key_storage.mdx)
* [Enable external key storage with a KMS](external_key_storage.mdx)
