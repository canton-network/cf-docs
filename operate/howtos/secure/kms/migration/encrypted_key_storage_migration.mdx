...
to operate in this mode, as explained [here](../mode/encrypted_key_storage.mdx#encrypted-key-storage). The process is
...
<Warning>This forces Canton to decrypt its private keys and store them in clear; it is not recommended.</Warning>
