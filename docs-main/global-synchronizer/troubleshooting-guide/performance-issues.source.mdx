...
<Snippet
  source="https://github.com/digital-asset/canton/blob/eaa9e7a4bf48793acb35aba270b85a970afe6006/community/app/src/test/resources/documentation-snippets/docs-cn-global-synchronizer_troubleshooting-guide-performance-issues.conf"
  lines="1..3"
  normalize="preserve"
  language="hocon"
/>
