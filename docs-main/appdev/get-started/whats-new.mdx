...
This page tracks significant changes affecting application developers. For infrastructure changes, see [Global Synchronizer Release Notes](/docs-main/global-synchronizer/reference/release-notes).
...
This documentation has been reorganized into four products:

- **Overview**: Canton concepts and architecture
- **App Development**: Developer guides and references
- **Global Synchronizer**: Validator operations
- **Building Blocks**: Wallets, apps, and integrations

Content follows a progressive depth model:
- **Understand**: Conceptual foundations
- **Learn**: Practical guidance
- **Reference**: API and protocol details
...
<Card title="Version Compatibility Dashboard" icon="table" href="/docs-main/shared/version-compatibility">
