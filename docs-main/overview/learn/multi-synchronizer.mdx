...
Contracts can be reassigned from one synchronizer to another through the reassignment protocol:

1. **Unassignment** — The contract is deactivated on its current synchronizer. During this brief period, the contract cannot be used in transactions.
