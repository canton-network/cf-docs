...
| NAME | STATUS | SUMMARY |
| --- | --- | --- |
| [`Choice`](#interface-choice) | 🟢 `v3.4` | Interface. Interface for objects representing Daml choices. |
| [`ChoiceFrom`](#interface-choicefrom) | 🟢 `v3.4` | Interface. The origin companion that contained a [[Choice]]. |
| [`ContractTypeCompanion`](#interface-contracttypecompanion) | 🟢 `v3.4` | Interface. Companion objects for templates and interfaces, containing their choices. |
| [`FromTemplate`](#interface-fromtemplate) | 🟢 `v3.4` | Interface. A mixin for [[InterfaceCompanion]].  This supplies the basis<br/>for the methods of [[ToInterface]].<br/><br/>Even interfaces that retroactively implement for no templates implement this,<br/>because forward implementations still require this marker to work. |
| [`Map`](#interface-map) | 🟢 `v3.4` | Interface. The counterpart of Daml's ``DA.Map.Map K V`` type.<br/><br/>This is an immutable map which compares keys via deep equality. The order of<br/>iteration is unspecified; the only guarantee is that the order in ``keys`` and<br/>``values`` match, i.e. ``m.get(k)`` is (deep-, value-based) equal to<br/>``[...m.values()][[...m.keys()].findIndex((l) => _.isEqual(k, l))]`` |
| [`Serializable`](#interface-serializable) | 🟢 `v3.4` | Interface. Interface for companion objects of serializable types. Its main purpose is<br/>to serialize and deserialize values between raw JSON and typed values. |
| [`Template`](#interface-template) | 🟢 `v3.4` | Interface. Interface for objects representing Daml templates. It is similar to the<br/>``Template`` type class in Daml. |
...
| [`Unit`](#interface-unit) | 🟢 `v3.4` | Interface. The counterpart of Daml's ``()`` type. |
| [`Bool`](#type-alias-bool) | 🟢 `v3.4` | Type Alias. The counterpart of Daml's ``Bool`` type. |
| [`ContractId`](#type-alias-contractid) | 🟢 `v3.4` | Type Alias. The counterpart of Daml's ``ContractId T`` type.<br/><br/>We represent ``ContractId``s as strings. Their exact format of these strings depends on the ledger<br/>the Daml application is running on.<br/><br/>The purpose of the intersection with ``{ [ContractIdBrand]: T }`` is to<br/>prevent accidental use of a ``ContractId<T>`` when a ``ContractId<U>`` is<br/>needed (unless ``T`` is a subtype of ``U``). This technique is known as<br/>"branding" in the TypeScript community. |
| [`Date`](#type-alias-date) | 🟢 `v3.4` | Type Alias. The counterpart of Daml's ``Date`` type.<br/><br/>We represent ``Date``s as strings with format ``YYYY-MM-DD``. |
| [`Decimal`](#type-alias-decimal) | 🟢 `v3.4` | Type Alias. The counterpart of Daml's ``Decimal`` type.<br/><br/>In Daml, Decimal's are the same as Numeric with precision 10. |
| [`DisclosedContract`](#type-alias-disclosedcontract) | 🟢 `v3.4` | Type Alias. A disclosed contract that can be passed on a command submission. |
| [`Int`](#type-alias-int) | 🟢 `v3.4` | Type Alias. The counterpart of Daml's ``Int`` type.<br/><br/>We represent ``Int``s as string in order to avoid a loss of precision. |
| [`Interface`](#type-alias-interface) | 🟢 `v3.4` | Type Alias. An interface type, for use with contract IDs. |
| [`InterfaceCompanion`](#type-alias-interfacecompanion) | 🟢 `v3.4` | Type Alias. Interface for objects representing Daml interfaces. |
| [`List`](#type-alias-list) | 🟢 `v3.4` | Type Alias. The counterpart of Daml's ``[T]`` list type.<br/><br/>We represent lists using arrays. |
| [`Numeric`](#type-alias-numeric) | 🟢 `v3.4` | Type Alias. The counterpart of Daml's ``Numeric`` type.<br/><br/>We represent ``Numeric``s as string in order to avoid a loss of precision. The string must match<br/>the regular expression ``-?(?:0\|[1-9]\d*)(?:\.\d+)?(?:[eE][+-]?\d+)?``. |
| [`Optional`](#type-alias-optional) | 🟢 `v3.4` | Type Alias. The counterpart of Daml's ``Optional T`` type. |
| [`Party`](#type-alias-party) | 🟢 `v3.4` | Type Alias. The counterpart of Daml's ``Party`` type.<br/><br/>We represent ``Party``s as strings matching the regular expression ``[A-Za-z0-9:_\- ]+``. |
| [`TemplateOrInterface`](#type-alias-templateorinterface) | 🟢 `v3.4` | Type Alias |
| [`Text`](#type-alias-text) | 🟢 `v3.4` | Type Alias. The counterpart of Daml's ``Text`` type. |
| [`TextMap`](#type-alias-textmap) | 🟢 `v3.4` | Type Alias. The counterpart of Daml's ``TextMap T`` type.<br/><br/>We represent ``TextMap``s as dictionaries. |
| [`Time`](#type-alias-time) | 🟢 `v3.4` | Type Alias. The counterpart of Daml's ``Time`` type.<br/><br/>We represent ``Times``s as strings with format ``YYYY-MM-DDThh:mm:ss[.ssssss]Z``. |
| [`Bool`](#variable-bool) | 🟢 `v3.4` | Variable. Companion object of the [[Bool]] type. |
| [`Date`](#variable-date) | 🟢 `v3.4` | Variable. Companion object of the [[Date]] type. |
| [`Decimal`](#variable-decimal) | 🟢 `v3.4` | Variable. Companion object of the [[Decimal]] type. |
| [`Int`](#variable-int) | 🟢 `v3.4` | Variable. Companion object of the [[Int]] type. |
| [`Party`](#variable-party) | 🟢 `v3.4` | Variable. Companion object of the [[Party]] type. |
| [`Text`](#variable-text) | 🟢 `v3.4` | Variable. Companion object of the [[Text]] type. |
| [`Time`](#variable-time) | 🟢 `v3.4` | Variable. Companion object of the [[Time]] type. |
| [`Unit`](#variable-unit) | 🟢 `v3.4` | Variable. Companion object of the [[Unit]] type. |
| [`ContractId`](#function-contractid) | 🟢 `v3.4` | Function. Companion object of the [[ContractId]] type. |
| [`emptyMap`](#function-emptymap) | 🟢 `v3.4` | Function |
| [`List`](#function-list) | 🟢 `v3.4` | Function. Companion object of the [[List]] type. |
| [`Map`](#function-map) | 🟢 `v3.4` | Function. Companion function of the [[GenMap]] type. |
| [`Numeric`](#function-numeric) | 🟢 `v3.4` | Function. Companion function of the [[Numeric]] type. |
| [`Optional`](#function-optional) | 🟢 `v3.4` | Function. Companion function of the [[Optional]] type. |
| [`TextMap`](#function-textmap) | 🟢 `v3.4` | Function. Companion object of the [[TextMap]] type. |
