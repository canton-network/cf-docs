...
import ExternalScribeMainScribeRstCodeDocsUserComponentHowtosPqsOptimizeIndexSql194 from "/snippets/pqs/scribe-rst-code-docs-user-component-howtos-pqs-optimize-index-sql-194.mdx";
