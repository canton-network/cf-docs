...
<img src="images/daml-package-dependencies.png" class="align-center" alt="Daml package dependency graph" />
...
- **Valid transactions** -- Every DSO-confirmed transaction satisfies Daml's [ledger validity model](https://docs.daml.com/concepts/ledger-model/ledger-integrity.html#valid-ledgers)
