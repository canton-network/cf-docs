...
<Note>
Prefer to just start by building? The [QuickStart](/appdev/quickstart/prerequisites) walks you through running a full-stack Canton app that you can run on LocalNet.
</Note>
