...
- [Privacy Model Explained](/devnet/overview/learn/privacy-model) -- Technical overview of sub-transaction privacy at the protocol level
- [Privacy Differences from Ethereum](/devnet/appdev/modules/m2-privacy-differences) -- How Canton's model compares to public blockchains
- [Design Patterns](/devnet/appdev/modules/m3-design-patterns) -- Patterns for authorization and multi-party workflows
