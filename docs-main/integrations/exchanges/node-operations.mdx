...
For major protocol changes, the global sychronizer undergoes an
[upgrade procedure](/global-synchronizer/production-operations/validator-upgrades).
...
[Splice docs](/global-synchronizer/production-operations/validator-upgrades).
...
1. Wait for the synchronizer to be paused and your node to have
   ...
   docs](/global-synchronizer/production-operations/validator-upgrades).
