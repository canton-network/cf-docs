...
<Version
  ...
  description={`This section changed between Canton Network 0.6.2 and ${networkData.devnet.versions.splice}. Use ${networkData.devnet.name} for the current DevNet configuration.`}
  defaultLabel={networkData.devnet.name}
>
  <VersionOption label="CN 0.6.2">
...
```
  ...
  <VersionOption label={networkData.devnet.name}>
