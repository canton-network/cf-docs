<!-- source: daml / daml/3.5/sdk/reference/smart-contract-upgrades.rst -->
...
[Smart Contract Upgrade](../sdlc-howtos/smart-contracts/upgrade/smart-contract-upgrades.md#smart-contract-upgrades). This document acts as a thorough reference.
...
[dynamic package
resolution](../sdlc-howtos/smart-contracts/upgrade/smart-contract-upgrades.md#dynamic-package-resolution-in-command-submission)  determine the target template at runtime.
...
[dynamic package
resolution](../sdlc-howtos/smart-contracts/upgrade/smart-contract-upgrades.md#dynamic-package-resolution-in-command-submission).
