...
**Learn more:** [sync.global](https://sync.global)
...
| Tool | Purpose |
|------|---------|
| **Canton SDK** | Core development toolkit |
...
1. Review [infrastructure requirements](/docs-main/global-synchronizer/understand/infrastructure-requirements)
2. Contact a [Super Validator](https://sync.global) for sponsorship
3. Complete the onboarding process
4. Begin operations

### As a Developer

1. Start with the [QuickStart](/docs-main/appdev/quickstart)
2. Learn [Daml](/docs-main/developer/m3-daml)
3. Build and deploy your application
4. Join the [developer community](https://slack.canton.network)

### As an Institution

1. Evaluate Canton for your use case
2. Contact the [Global Synchronizer Foundation](https://sync.global)
...
| [sync.global](https://sync.global) | GSF and validator info |
| [Slack](https://slack.canton.network) | Community discussion |
