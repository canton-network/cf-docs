---
title: "POST /v2/commands/submit-and-wait-for-transaction-tree"
...
api: "POST http://localhost:7575/v2/commands/submit-and-wait-for-transaction-tree"
authMethod: "bearer"
playground: "interactive"
sidebarTitle: "/v2/commands/submit-and-wait-for-transaction-tree"
---
...
<div class="x2mdx-ref-hero">
  ...
  <p class="x2mdx-ref-summary">Submit a batch of commands and wait for the transaction trees response. Provided for backwards compatibility, it will be removed in the Canton version 3.5.0, use submit-and-wait-for-transaction instead.</p>
...
<ResponseField name="transactionTree" type="JsTransactionTree">
...
<div class="x2mdx-ref-history" aria-label="Reference history">
  ...
  <div class="x2mdx-ref-history-event x2mdx-ref-history-event--changed" id="history-updated-3-5">
    ...
    <p class="x2mdx-ref-history-event-detail">The POST /v2/commands/submit-and-wait-for-transaction-tree operation was updated in this snapshot.</p>
