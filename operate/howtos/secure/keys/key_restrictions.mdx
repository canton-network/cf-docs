...
for more information regarding the key management commands.</Note>
...
<Warning>If you define intermediate namespace keys with restricted delegations, you must ensure that all authorizations are
...
error message and code `TOPOLOGY_NO_APPROPRIATE_SIGNING_KEY_IN_STORE`.</Warning>
