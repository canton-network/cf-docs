...
<div class="x2mdx-ref-history" aria-label="Reference history">
  ...
  <div class="x2mdx-ref-history-event x2mdx-ref-history-event--changed" id="history-updated-0-6-9">
    ...
    <p class="x2mdx-ref-history-event-detail">The GET /v0/internal/reward-accounting-process/rounds/&#123;round_number&#125;/activity-totals operation was updated in this snapshot.</p>
