...
The Sandbox does not include a synchronizer, wallet services, or Canton Coin. For those features, use [LocalNet](/mainnet/sdks-tools/development-tools/localnet).
...
- [dpm command reference](/mainnet/sdks-tools/cli-tools/dpm) -- `dpm sandbox` options
- [LocalNet](/mainnet/sdks-tools/development-tools/localnet) -- Full multi-validator environment for integration testing
- [Daml Script](/mainnet/sdks-tools/cli-tools/daml-script) -- In-process testing without a running node
- [Testing Daml Contracts](/mainnet/appdev/modules/m3-testing) -- Complete testing guide
