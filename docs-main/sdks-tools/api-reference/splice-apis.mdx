...
<Note>
**Deprecated** (since `splice-0.4.11`): Use the [Canton Network Token Standard APIs](/overview/reference/cip-0056) instead.
</Note>
...
This specific transfer offer workflow is deprecated in favor of the two-step workflow supported by Canton Coin implementation of the [Canton Network Token Standard](/overview/reference/cip-0056).
...
<Note>
These endpoints are not intended to be used by other applications. If you want to build a wallet of your own, we recommend to build on the [Canton Network Token Standard APIs](/overview/reference/cip-0056) instead.
</Note>
