...
2. **Infrastructure**: Meet the [infrastructure requirements](/testnet/global-synchronizer/understand/infrastructure-requirements)
...
<Card title="Infrastructure Requirements" icon="server" href="/testnet/global-synchronizer/understand/infrastructure-requirements">
  Hardware, software, and network requirements.
</Card>

<Card title="Validator Roles" icon="user-gear" href="/testnet/global-synchronizer/understand/validator-roles">
