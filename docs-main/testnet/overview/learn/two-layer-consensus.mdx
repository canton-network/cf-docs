...
- [Trust Model Overview](/testnet/overview/learn/trust-model) — trust assumptions across each layer
- [Architecture Overview](/testnet/overview/learn/architecture) — how components fit together
- [Privacy Model](/testnet/overview/learn/privacy-model) — sub-transaction privacy in detail
