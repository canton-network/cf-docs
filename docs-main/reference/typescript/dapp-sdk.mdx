...
| Version | Changes |
| --- | --- |
| `1.2.0` | members added: `Command`, `Commands`, `CreateAndExerciseCommand`, `CreateAndExerciseCommandPayload`, `CreateCommand`, `CreateCommandPayload`, `ExerciseByKeyCommand`, `ExerciseByKeyCommandPayload`, `ExerciseCommand`, `ExerciseCommandPayload`; members removed: `JsCommands` |
