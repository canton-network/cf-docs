...
This page walks through deploying a Canton Network validator on Kubernetes using Helm charts. For Docker Compose, see [Docker Compose Validator Deployment](/testnet/global-synchronizer/deployment/validator-docker-compose).

## Before you begin

Confirm that you have completed the [onboarding process](/testnet/global-synchronizer/deployment/onboarding-process) and have the following ready:
...
<Card title="Configuration" icon="gear" href="/testnet/global-synchronizer/deployment/configuration">
  Tune your validator's configuration.
</Card>

<Card title="Authorization Setup" icon="lock" href="/testnet/global-synchronizer/deployment/authorization-setup">
