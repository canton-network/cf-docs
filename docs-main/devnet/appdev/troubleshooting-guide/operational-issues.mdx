...
This page covers problems that arise when your application runs against a live network: DevNet, TestNet, or MainNet. Local development issues are covered in [Development Issues](/devnet/appdev/troubleshooting-guide/development-issues).
...
When the network upgrades (e.g., from Splice 0.5.x to 0.6.x), your validator must run a compatible version. An incompatible validator logs errors like:

```
You don't speak 0.6.x
```
