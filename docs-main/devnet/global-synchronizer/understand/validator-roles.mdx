...
2. **Infrastructure**: Meet [infrastructure requirements](/devnet/global-synchronizer/understand/infrastructure-requirements)
...
<Card title="Validator Setup" icon="server" href="/devnet/global-synchronizer/understand/introduction">
  Begin deploying your validator node.
</Card>

<Card title="Infrastructure Requirements" icon="list-check" href="/devnet/global-synchronizer/understand/infrastructure-requirements">
