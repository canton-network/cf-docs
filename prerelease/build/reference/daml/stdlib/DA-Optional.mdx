<!-- source: daml / daml/3.5/sdk/reference/daml/stdlib/DA-Optional.rst -->
...
[fromSome]()
: : [Optional](Prelude.md#type-da-internal-prelude-optional-37153) a -> a
  <br/>
...
[fromSomeNote]()
: : [Text](Prelude.md#type-ghc-types-text-51952) -> [Optional](Prelude.md#type-da-internal-prelude-optional-37153) a -> a
  <br/>
...
[fromOptional]()
: : a -> [Optional](Prelude.md#type-da-internal-prelude-optional-37153) a -> a
  <br/>
...
[isSome]()
: : [Optional](Prelude.md#type-da-internal-prelude-optional-37153) a -> [Bool](Prelude.md#type-ghc-types-bool-66265)
  <br/>
...
[mapOptional]()
: : (a -> [Optional](Prelude.md#type-da-internal-prelude-optional-37153) b) -> [a] -> [b]
  <br/>
...
[whenSome]()
: : [Applicative](Prelude.md#class-da-internal-prelude-applicative-9257) m => [Optional](Prelude.md#type-da-internal-prelude-optional-37153) a -> (a -> m ()) -> m ()
  <br/>
  Perform some operation on `Some`, given the field inside the
  `Some`.

<a id="function-da-optional-whensome-5861"></a>

[whenSome_]()
: : [Applicative](Prelude.md#class-da-internal-prelude-applicative-9257) m => [Optional](Prelude.md#type-da-internal-prelude-optional-37153) a -> (a -> m b) -> m ()
  <br/>
  Perform some operation on `Some` and discard its result,
  given the field inside the `Some`.

<a id="function-da-optional-whennone-99309"></a>

[whenNone]()
: : [Applicative](Prelude.md#class-da-internal-prelude-applicative-9257) m => [Optional](Prelude.md#type-da-internal-prelude-optional-37153) a -> m a -> m a
  <br/>
  Perform some operation on `None`.
  Otherwise returns content of `Some` pured to Applicative.

<a id="function-da-optional-whennone-43843"></a>

[whenNone_]()
: : [Applicative](Prelude.md#class-da-internal-prelude-applicative-9257) m => [Optional](Prelude.md#type-da-internal-prelude-optional-37153) a -> m b -> m ()
  <br/>
...
[findOptional]()
: : (a -> [Optional](Prelude.md#type-da-internal-prelude-optional-37153) b) -> [a] -> [Optional](Prelude.md#type-da-internal-prelude-optional-37153) b
  <br/>
