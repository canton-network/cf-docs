...
import ExternalScribeMainScribeRstCodeDocsUserComponentHowtosPqsOptimizeIndexSql194 from "/snippets/scribe/scribe-rst-code-docs-user-component-howtos-pqs-optimize-index-sql-194.mdx";
...
The informees for the different type of transaction tree nodes are (also see [projections](/overview/reference/ledger-model/privacy#projection)):
