...
- [Canton Coin overview](/devnet/overview/understand/canton-coin) -- Deeper background on CC tokenomics, validator rewards, and governance
- [Backend Development](/devnet/appdev/modules/m4-backend-dev) -- Handling transaction errors, including insufficient-traffic failures
