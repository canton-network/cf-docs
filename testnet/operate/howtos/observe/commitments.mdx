...
[Metrics reference section](../../reference/metrics.md#reference-metrics):
...
All metrics below are described in detail in the [Metrics reference section](../../reference/metrics.md#reference-metrics).
