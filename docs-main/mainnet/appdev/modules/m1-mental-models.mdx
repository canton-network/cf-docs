...
<Card title="Development Stack" icon="layer-group" href="/mainnet/appdev/modules/m1-development-stack">
  Understand the tools you'll use.
</Card>

<Card title="Architecture Overview" icon="diagram-project" href="/mainnet/overview/learn/architecture">
