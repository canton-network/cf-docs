...
description: "Harden a Wallet Gateway deployment before exposing it to users and dApps."
---
...
- **Use OAuth / OpenID Connect IDPs.** Reserve self-signed tokens for development. See
  [Networks & identity providers](/integrations/wallet-gateway/guides/networks-and-identity#identity-providers).
