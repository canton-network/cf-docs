...
{/* DIVERGENCE: removed three editorial notes ("Refine when addressing #27011", plus a mid-paragraph note about generating example output from integration tests) that leaked into the rendered page as user-facing prose; consolidated into this todo div. Upstream docs-website source (docs/replicated/canton/3.5/participant/howtos/troubleshoot/commitments.rst, hash f64b1ce5) still has them inline. Related to github.com/DACH-NY/canton/issues/27011. */}

<div className="todo">
Refine this section once [DACH-NY/canton#27011](https://github.com/DACH-NY/canton/issues/27011) lands. The command output below is hand-typed; it would be better generated from an actual integration test (our docs tooling supports this via SphinxDocumentationGenerator and its implementations).
</div>
