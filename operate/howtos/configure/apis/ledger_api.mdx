{/* source: canton / canton/3.4/participant/howtos/configure/apis/ledger_api.rst */}
...
- Define **tls** parameter group to to configure [TLS](../../secure/apis/tls.mdx#tls-configuration)
- Define **auth-services** parameter group to to configure [JWT authorization](../../secure/apis/jwt.mdx#jwt-authnz-api-configuration)
- Define **jwt-timestamp-leeway** parameter group to to configure [JWT leeway](../../secure/apis/jwt.mdx#jwt-leeway-configuration)
- Define **keep-alive-server** parameter group to to configure [gRPC keepalive](apis.mdx#keepalive-configuration)
- Define **max-inbound-message-size** parameter to control the [max size of gRPC messages](../../secure/apis/limits.mdx#max-inbound-message-size-configuration)
