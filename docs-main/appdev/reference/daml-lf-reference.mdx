...
<tr className="even">
<td>`Decimal`</td>
<td>`string` (number accepted as input)<a href="#fn2" className="footnote-ref" id="fnref2" role="doc-noteref"><sup>2</sup></a> range: [–(10³⁸–1)÷10¹⁰,(10³⁸–1)÷10¹⁰] format: <code>-?[0-9]{1,28}(\.[0-9]{1,10})?</code></td>
<td>"1234.56"</td>
</tr>
<tr className="odd">
<td>`Timestamp`</td>
...
<tr className="odd">
<td>`Unit`</td>
<td><code>{}</code> empty JSON Object</td>
<td><code>{}</code></td>
</tr>
<tr className="even">
<td>`Text`</td>
...
<tr className="even">
<td>`Record`</td>
<td>JSON `object` <code>{"prop1":val1, ..., "propN":valV}</code></td>
<td><p>.. code-block:</p>
<pre><code>{
...
<tr className="even">
<td>`TextMap`</td>
<td>JSON `object` <code>{"key1":"val1", ..., "keyn":"valn"}</code></td>
