...
For Auth0 instructions and more details on configuring authentication, see [Configuring Authentication](/testnet/global-synchronizer/deployment/installation#configuring-authentication).
