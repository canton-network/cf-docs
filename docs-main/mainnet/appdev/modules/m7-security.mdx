...
- [Package Management](/mainnet/appdev/modules/m7-package-management) — Securing DAR distribution and deployment
- [Performance](/mainnet/appdev/modules/m7-performance) — Optimization strategies for Canton applications

## Advanced Topics

- [Open Tracing in Ledger API Client Applications](/mainnet/appdev/deep-dives/open-tracing) — Adding OpenTelemetry-based distributed tracing to applications using the Ledger API.
- [Authorization](/mainnet/appdev/deep-dives/authorization) — Access tokens, identity providers, scopes, and rights for the Ledger API.
