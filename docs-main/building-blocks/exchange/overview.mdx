...
For detailed USDC integration documentation, see [USDC xReserve documentation](https://docs.digitalasset.com/usdc/xreserve/overview.html).
...
- [Validator Setup](/docs-main/global-synchronizer/understand/introduction) for infrastructure deployment
- [Ledger API](/docs-main/appdev/reference/ledger-api-reference) for API integration
...
<Card title="USDC Integration" icon="dollar-sign" href="https://docs.digitalasset.com/usdc/xreserve/overview.html">
