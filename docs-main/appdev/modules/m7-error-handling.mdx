...
See [Canton Coin and Traffic](/docs-main/appdev/modules/m4-canton-coin) for how to manage traffic credits.
...
- [Backend Development](/docs-main/appdev/modules/m4-backend-dev) -- Ledger API client setup, including error handling examples
- [Canton Coin and Traffic](/docs-main/appdev/modules/m4-canton-coin) -- Managing traffic to avoid submission failures
- [Observability](/docs-main/appdev/modules/m4-observability) -- Logging and metrics for error tracking
