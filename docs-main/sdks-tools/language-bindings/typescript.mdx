...
- Versions compared: `3.4.8`, `3.4.9`, `3.4.10`, `3.4.11`
- Source: `Published @daml/types npm tarballs rendered to local TypeDoc JSON`
- Version filter: `configured @daml/types npm versions`

## Export Diff Summary

| Export | Kind | Introduced | Changed In | Removed |
| --- | --- | --- | --- | --- |
| [`Choice`](#interface-choice) | Interface | `3.4.8` | - | - |
| [`ChoiceFrom`](#interface-choicefrom) | Interface | `3.4.8` | - | - |
| [`ContractTypeCompanion`](#interface-contracttypecompanion) | Interface | `3.4.8` | `3.4.9` | - |
| [`FromTemplate`](#interface-fromtemplate) | Interface | `3.4.8` | - | - |
| [`Map`](#interface-map) | Interface | `3.4.8` | - | - |
| [`Serializable`](#interface-serializable) | Interface | `3.4.8` | - | - |
| [`Template`](#interface-template) | Interface | `3.4.8` | `3.4.9` | - |
| [`ToInterface`](#interface-tointerface) | Interface | `3.4.8` | - | - |
| [`Unit`](#interface-unit) | Interface | `3.4.8` | - | - |
| [`Bool`](#type-alias-bool) | Type Alias | `3.4.8` | - | - |
| [`ContractId`](#type-alias-contractid) | Type Alias | `3.4.8` | - | - |
| [`Date`](#type-alias-date) | Type Alias | `3.4.8` | - | - |
| [`Decimal`](#type-alias-decimal) | Type Alias | `3.4.8` | - | - |
| [`DisclosedContract`](#type-alias-disclosedcontract) | Type Alias | `3.4.8` | - | - |
| [`Int`](#type-alias-int) | Type Alias | `3.4.8` | - | - |
| [`Interface`](#type-alias-interface) | Type Alias | `3.4.8` | - | - |
| [`InterfaceCompanion`](#type-alias-interfacecompanion) | Type Alias | `3.4.8` | - | - |
| [`List`](#type-alias-list) | Type Alias | `3.4.8` | - | - |
| [`Numeric`](#type-alias-numeric) | Type Alias | `3.4.8` | - | - |
| [`Optional`](#type-alias-optional) | Type Alias | `3.4.8` | - | - |
| [`Party`](#type-alias-party) | Type Alias | `3.4.8` | - | - |
| [`TemplateOrInterface`](#type-alias-templateorinterface) | Type Alias | `3.4.8` | `3.4.9` | - |
| [`Text`](#type-alias-text) | Type Alias | `3.4.8` | - | - |
| [`TextMap`](#type-alias-textmap) | Type Alias | `3.4.8` | - | - |
| [`Time`](#type-alias-time) | Type Alias | `3.4.8` | - | - |
| [`Bool`](#variable-bool) | Variable | `3.4.8` | - | - |
| [`Date`](#variable-date) | Variable | `3.4.8` | - | - |
| [`Decimal`](#variable-decimal) | Variable | `3.4.8` | - | - |
| [`Int`](#variable-int) | Variable | `3.4.8` | - | - |
| [`Party`](#variable-party) | Variable | `3.4.8` | - | - |
| [`Text`](#variable-text) | Variable | `3.4.8` | - | - |
| [`Time`](#variable-time) | Variable | `3.4.8` | - | - |
| [`Unit`](#variable-unit) | Variable | `3.4.8` | - | - |
| [`ContractId`](#function-contractid) | Function | `3.4.8` | - | - |
| [`emptyMap`](#function-emptymap) | Function | `3.4.8` | - | - |
| [`List`](#function-list) | Function | `3.4.8` | - | - |
| [`Map`](#function-map) | Function | `3.4.8` | - | - |
| [`Numeric`](#function-numeric) | Function | `3.4.8` | - | - |
| [`Optional`](#function-optional) | Function | `3.4.8` | - | - |
| [`TextMap`](#function-textmap) | Function | `3.4.8` | - | - |
