{/* source: canton / canton/3.4/participant/howtos/secure/keys/namespace_key.rst */}
...
If a Canton node is configured to use a [KMS system](../kms/kms.mdx#kms), then the root key can be administratively isolated,
...
@ val intermediateKeyPath = better.files.File.newTemporaryFile(prefix = "intermediate-key.pub").pathAsString
    intermediateKeyPath : String = "/tmp/intermediate-key.pub14638535798894058154"
```
...
formats, please refer to the following [tables](../../../reference/crypto_schemes.mdx#canton-supported-key-formats).
...
please refer to the following [table](../../../reference/crypto_schemes.mdx#canton-supported-signature-formats):
...
@ participant1.health.status
    res5: NodeStatus[ParticipantStatus] = Participant id: PAR::participant1::1220675d99ed0b9ebb3927e800c80d42279fa908d4c23358c5b7108e5ac44898ba6e
    Uptime: 0.073414s
    Ports:
            ledger: 30022
            admin: 30023
