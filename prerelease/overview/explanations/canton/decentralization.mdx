<!-- source: canton / canton/3.5/overview/explanations/canton/decentralization.rst -->
...
As described in the section [Namespaces](topology.md#topology-namespaces), a namespace is
...
Whenever a topology transaction expects a [unique identifier](topology.md#topology-unique-identifiers), the namespace for that unique identifier can be
...
* **Decentralization of Mediator groups**: the Synchronizer owners can set up
  ...
  commit protocol](protocol.md#protocol-two-phase-commit), before the Sequencers deliver
...
See [Local and external parties](external-party.md#overview-canton-external-parties) for more details.
