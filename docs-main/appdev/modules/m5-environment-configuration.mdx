...
You can use _default components_ that are traditionally part of dpm SDKs, or _optional components_ you create and publish to extend the CLI.  See [Publishing Components](/sdks-tools/cli-tools/dpm#publishing-components) to author your own extensions.
