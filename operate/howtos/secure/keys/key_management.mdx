...
<Note>
Key rotation should be [interleaved with taking a backup](../../recover/backup-restore.mdx#backup-restore-private-key-rotation).
</Note>
...
<Note>
Every Synchronizer imposes a minimum set of cryptographic schemes that its members must support.
