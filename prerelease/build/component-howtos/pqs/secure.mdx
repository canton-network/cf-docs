<!-- source: pqs / pqs/3.5/component-howtos/pqs/secure.rst -->
...
`--pipeline-filter-parties` filter parameter (see [Party filtering](configure.md#pqs-party-filtering)).
...
However, for streaming calls such as [GetUpdates](../../reference/lapi-proto-docs.md#com-daml-ledger-api-v2-updateservice-getupdates) the
...
**Logging**: Ensure that logging is configured (see [Logging](observe.md#pqs-logging)) to avoid logging sensitive information. This
...
[Observe](observe.md#pqs-observe)).
...
old data (eg. PQS [Pruning](operate.md#pqs-pruning)), and ensuring that sensitive information is redacted or deleted as required by
