...
- Coordinate with counterparties who hold contracts affected by the upgrade (see below)
...
- Coordinate the migration with all counterparties who hold affected contracts
