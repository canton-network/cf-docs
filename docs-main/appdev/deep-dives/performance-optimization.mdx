...
{/* Generated from performance-optimization.source.mdx. Edit performance-optimization.source.mdx, then run npm run snippets:generate. */}
...
{/* snippet-source: https://github.com/digital-asset/canton/blob/eaa9e7a4bf48793acb35aba270b85a970afe6006/community/app/src/test/resources/documentation-snippets/command-service-max-commands-in-flight.conf; authored-at: docs-main/appdev/deep-dives/performance-optimization.source.mdx:60 */}
```conf
...
{/* snippet-source: https://github.com/digital-asset/canton/blob/eaa9e7a4bf48793acb35aba270b85a970afe6006/community/app/src/test/resources/documentation-snippets/sequencer-client-throttling.conf; authored-at: docs-main/appdev/deep-dives/performance-optimization.source.mdx:246 */}
```conf
...
{/* snippet-source: https://github.com/digital-asset/canton/blob/67c8a5ae19cfbbcac500b22ba7379d996e907281/community/app/src/test/resources/documentation-snippets/caching-configs.conf; authored-at: docs-main/appdev/deep-dives/performance-optimization.source.mdx:311 */}
```conf
...
{/* snippet-source: https://github.com/DACH-NY/scribe/blob/a12a6a22213ba26a85852d9a6b8c8662a8ab5c3e/docs/user/component-howtos/pqs/optimize/index.rst; authored-at: docs-main/appdev/deep-dives/performance-optimization.source.mdx:1114 */}
```sql
