---
title: "GET /v0/scan-proxy/ans-entries/by-party/:party"
description: "Lookup ans entry by party"
api: "GET https://example.com/api/validator/v0/scan-proxy/ans-entries/by-party/{party}"
playground: "interactive"
sidebarTitle: "/v0/scan-proxy/ans-entries/by-party/:party"
---
...
<div class="x2mdx-ref-hero">
  ...
  <p class="x2mdx-ref-summary">Lookup ans entry by party</p>
...
```bash cURL
curl --request GET \
  --url 'https://example.com/api/validator/v0/scan-proxy/ans-entries/by-party/{party}'
```
...
const response = await fetch('https://example.com/api/validator/v0/scan-proxy/ans-entries/by-party/{party}', {
  method: 'GET',
});
...
curl_setopt_array($curl, [
    CURLOPT_URL => 'https://example.com/api/validator/v0/scan-proxy/ans-entries/by-party/{party}',
...
func main() {
  req, _ := http.NewRequest("GET", "https://example.com/api/validator/v0/scan-proxy/ans-entries/by-party/{party}", nil)
...
var request = HttpRequest.newBuilder()
    .uri(URI.create("https://example.com/api/validator/v0/scan-proxy/ans-entries/by-party/{party}"))
...
uri = URI('https://example.com/api/validator/v0/scan-proxy/ans-entries/by-party/{party}')
